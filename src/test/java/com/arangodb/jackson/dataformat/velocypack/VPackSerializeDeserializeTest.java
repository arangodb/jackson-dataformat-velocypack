...
public class VPackSerializeDeserializeTest {
    ...
    private static final DateFormat DATE_FORMAT = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS+0000");
    ...
    public void fromDate() throws JsonProcessingException {
        ...
        }
        {
            ...
            assertThat(vpack.get("sqlDate").getAsString(), is(new java.sql.Date(1474988621).toString()));
        }
        {
