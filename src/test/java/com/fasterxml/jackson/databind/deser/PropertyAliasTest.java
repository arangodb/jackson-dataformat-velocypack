...
public class PropertyAliasTest extends BaseMapTest
{
    ...
    public void testSimpleAliases() throws Exception
    {
        ...
        bean = MAPPER.readValue(com.fasterxml.jackson.VPackUtils.toVPack(aposToQuotes("{'Name':'Foobar','a':3,'xyz':37}")),
                AliasBean.class);
    ...
    {
        PolyWrapperForAlias value = MAPPER.readValue(com.fasterxml.jackson.VPackUtils.toVPack(aposToQuotes(
    ...
    {
        AliasBean2378 bean = MAPPER.readValue(com.fasterxml.jackson.VPackUtils.toVPack(aposToQuotes(
    ...
    public void testCaseInsensitiveAliases() throws Exception {
        ...
        Pojo2669 pojo = mapper.readValue(com.fasterxml.jackson.VPackUtils.toVPack(text), Pojo2669.class);
        assertNotNull(pojo);
