...
public class TestTreeWithType extends BaseMapTest
{
    ...
    public void testValueAsStringWithoutDefaultTyping() throws Exception {
        ...
        JsonNode jsonNode = MAPPER.readTree(com.fasterxml.jackson.VPackUtils.toVPack(json));
    ...
    public void testIssue353() throws Exception
    {
        ObjectMapper mapper = jsonMapperBuilder()
         ...
         SavedCookie out = mapper.readerFor(SavedCookie.class).readValue(com.fasterxml.jackson.VPackUtils.toVPack(json));
