...
public class VPackIdentityInfoAndBackReferences3964Test extends DatabindTestUtil
{
    /**
     * Fails : Original test
     */
    ...
    public void testOriginalBackReference() throws Exception {
        ...
        Tree tree = MAPPER.readValue(VPackUtils.toVPack(json), Tree.class);
    ...
    public void testLeanWithoutGetterAndSetters() throws Exception {
        ...
        Animal animal = MAPPER.readValue(VPackUtils.toVPack(json), Animal.class);
        // should reach here and pass... but throws Exception and fails
    ...
    public void testLeanWithoutGetterSettersOrCreator() throws Exception {
        ...
        Fish fish = MAPPER.readValue(VPackUtils.toVPack(json), Fish.class);
