...
public class ObjectIdSerializationTest extends DatabindTestUtil
{
    ...
    private final ObjectMapper SORTED_MAPPER = vpackMapperBuilder()
    ...
    public void testSimpleSerializationClass() throws Exception
    {
        ...
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(src));
        assertEquals(EXP_SIMPLE_INT_CLASS, json);

        // and ensure that state is cleared in-between as well:
        json = VPackUtils.toJson(mapper.writeValueAsBytes(src));
        assertEquals(EXP_SIMPLE_INT_CLASS, json);
    }
    ...
    public void testSimpleSerializationProperty() throws Exception
    {
        ...
        String json = VPackUtils.toJson(SORTED_MAPPER.writeValueAsBytes(src));
        assertEquals(EXP_SIMPLE_INT_PROP, json);
        // and second time too, for a good measure
        json = VPackUtils.toJson(SORTED_MAPPER.writeValueAsBytes(src));
        assertEquals(EXP_SIMPLE_INT_PROP, json);
    }
    ...
    {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new EmptyObject()));
    ...
    public void testSerializeWithOpaqueStringId() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(ob1));
        assertNotNull(json);

        // then verify round-trip
        StringIdentifiable output = MAPPER.readValue(VPackUtils.toVPack(json), StringIdentifiable.class);
        ...
        output = MAPPER.readValue(VPackUtils.toVPack(json2), StringIdentifiable.class);
        assertNotNull(output);
    ...
    {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new AlwaysContainer()));
    ...
    public void testAlwaysIdForTree() throws Exception
    {
        ...
        root.child = leaf;
        String json = VPackUtils.toJson(SORTED_MAPPER.writeValueAsBytes(root));
    ...
    public void testColumnMetadata() throws Exception
    {
        ...
        Wrapper deserialized = MAPPER.readValue(VPackUtils.toVPack(json), Wrapper.class);
    ...
    public void testMixedRefsIssue188() throws Exception
    {
        ...
        String json = VPackUtils.toJson(SORTED_MAPPER.writeValueAsBytes(comp));
    ...
    public void testNoDuplicateKeysWithFieldLevelAnnotation() throws Exception
    {
        ...
        final String json = VPackUtils.toJson(MAPPER.writer().writeValueAsBytes(hive));
        try {
    ...
    public void testIncludePropertiesWithIdentityInfo3169() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(c));
    ...
    {
        try {
            VPackUtils.toJson(MAPPER.writeValueAsBytes(new Broken()));
