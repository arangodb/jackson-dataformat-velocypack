 ...
 * {@link Map}-typed property of a Builder-based type must be
...
class ObjectIdWithBuilder5909Test extends DatabindTestUtil
{
    ...
    public void forwardReferenceInCollection() throws Exception
    {
        ...
        EntityContainer container = MAPPER.readValue(VPackUtils.toVPack(json), EntityContainer.class);
    ...
    public void forwardReferenceInSet() throws Exception
    {
        ...
        EntitySetContainer container = MAPPER.readValue(VPackUtils.toVPack(json), EntitySetContainer.class);
        assertEquals(2, container.entities.size());
    ...
    public void forwardReferenceInMap() throws Exception
    {
        ...
        EntityMapContainer container = MAPPER.readValue(VPackUtils.toVPack(json), EntityMapContainer.class);
        assertEquals(2, container.entities.size());
    ...
    public void forwardReferenceInCollectionWithPropertyCreatorBuilder() throws Exception
    {
        ...
        EntityCreatorContainer container = MAPPER.readValue(VPackUtils.toVPack(json), EntityCreatorContainer.class);
    ...
    public void forwardReferenceInTypedArrayWithBuilder() throws Exception
    {
        ...
        EntityArrayContainer container = MAPPER.readValue(VPackUtils.toVPack(json), EntityArrayContainer.class);
    ...
    public void forwardReferenceInCollectionWithDelegatingCreator() throws Exception
    {
        ...
        Entity1706Container container = MAPPER.readValue(VPackUtils.toVPack(json), Entity1706Container.class);
