...
public class ObjectIdWithPolymorphicTest extends DatabindTestUtil
{
    ...
    public void testPolymorphicRoundtrip() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(in1));

        Base result0 = MAPPER.readValue(VPackUtils.toVPack(json), Base.class);
    ...
    public void testIssue811() throws Exception
    {
        ...
        String json = VPackUtils.toJson(om.writeValueAsBytes(p));
        Process restored = om.readValue(VPackUtils.toVPack(json), Process.class);
    ...
    public void testIssue877() throws Exception
    {
        ...
        String json = VPackUtils.toJson(mapper.writer().writeValueAsBytes(myList));
        ListWrapper877<BaseInterfaceImpl877> result =
                mapper.readValue(VPackUtils.toVPack(json), new TypeReference<ListWrapper877<BaseInterfaceImpl877>>() { });
    ...
    public void testObjectAndTypeId() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writer().writeValueAsBytes(inputRoot));

        BaseEntity resultRoot = MAPPER.readValue(VPackUtils.toVPack(json), BaseEntity.class);
    ...
    public void testWithAbstractUsingProp1551() throws Exception
    {
        ...
        VehicleOwnerViaProp[] deserialized = mapper.readValue(VPackUtils.toVPack(serialized), VehicleOwnerViaProp[].class);
...
+"'numberOfDoors':2}},{'ownedVehicle':'123'}]"
        ...
        try {
            mapper.readValue(VPackUtils.toVPack(JSON), VehicleOwnerBroken[].class);
