 ...
 */
public class VPackIdentityHashCodeIssue1546Test extends DatabindTestUtil
{
    ...
    public void testHashSetCorruptionWithIdentityReferences() throws Exception
    {
        ...
        // Deserialize
        Root deserialized = MAPPER.readValue(VPackUtils.toVPack(json), Root.class);
    ...
    public void testHashSetCorruptionWithBackReferences() throws Exception
    {
        ...
        // Deserialize
        Parent deserialized = MAPPER.readValue(VPackUtils.toVPack(json), Parent.class);
