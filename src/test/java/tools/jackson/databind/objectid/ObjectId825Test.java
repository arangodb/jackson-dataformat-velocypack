...
public class ObjectId825Test extends DatabindTestUtil
{
    ...
    static abstract class AbstractAct extends TypedEntity {
        protected ArrayList<Tr> outTr;

        public ArrayList<Tr> getOutTr() { return this.outTr; }
        public void setOutTr(ArrayList<Tr> outTr) { this.outTr = outTr; }
    }

    static abstract class AbstractCond extends AbstractAct { }

    static abstract class AbstractDec extends AbstractAct {
        protected ArrayList<Dec> dec;

        public ArrayList<Dec> getDec() { return this.dec; }
        public void setDec(ArrayList<Dec> dec) { this.dec = dec; }
    }

    static class Ch extends TypedEntity {
        protected ArrayList<? extends AbstractAct> act;

        public ArrayList<? extends AbstractAct> getAct() { return this.act; }
        public void setAct(ArrayList<? extends AbstractAct> act) { this.act = act; }
    }

    static class CTC extends TypedEntity {
        protected ArrayList<CTV> var;

        public CTC() { }

        public ArrayList<CTV> getVar() {
            if (var == null) {
        ...
        public void setVar(ArrayList<CTV> var) { this.var = var; }
    }
    ...
    static class CTV extends TypedEntity {
        protected Ch ch;
        protected ArrayList<? extends AbstractData> locV;

        public Ch getCh() { return this.ch; }
        public void setCh(Ch ch) { this.ch = ch; }

        public ArrayList<? extends AbstractData> getLocV() { return this.locV; }
        public void setLocV(ArrayList<? extends AbstractData> locV) { this.locV = locV; }
    }
    ...
    private final ObjectMapper DEF_TYPING_MAPPER = vpackMapperBuilder()
    ...
    public void testDeserialize() throws Exception {
        ...
        String json = VPackUtils.toJson(DEF_TYPING_MAPPER.writeValueAsBytes(a));
        TestA testADeserialized = DEF_TYPING_MAPPER.readValue(VPackUtils.toVPack(json), TestA.class);
...
"}\n"
        ...
        CTC result = mapper.readValue(VPackUtils.toVPack(INPUT), CTC.class);
    ...
    public void testUserFirstThenContainer2780() throws Exception
    {
        ...
        List<?> result = mapper.readValue(VPackUtils.toVPack(json), List.class);
