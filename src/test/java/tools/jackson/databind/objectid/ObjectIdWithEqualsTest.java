...
public class ObjectIdWithEqualsTest extends DatabindTestUtil
{
    ...
    public void testSimpleEquals() throws Exception
    {
        ...
        Foo foo2 = mapper.readValue(VPackUtils.toVPack(json), Foo.class);
        assertNotNull(foo2);
    ...
    public void testEqualObjectIdsExternal() throws Exception
    {
        ...
        String json = VPackUtils.toJson(mapper.writerFor(new TypeReference<List<Element>>() { })
                .writeValueAsBytes(input));

        Element[] output = mapper.readValue(VPackUtils.toVPack(json), Element[].class);
