...
public class ObjectIdWithTypeInfo4014Test extends DatabindTestUtil
{
    ...
    public void testSimpleDeserializationViaInterface() throws Exception
    {
        ...
        BaseEntity result = MAPPER.readValue(VPackUtils.toVPack(json), BaseEntity.class);
    ...
    public void testSimpleDeserializationWrapperArray() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(foo));
        WrapperArrayEntity result = MAPPER.readValue(VPackUtils.toVPack(json), WrapperArrayEntity.class);
        assertNotNull(result);
    ...
    public void testObjectIdWithInterfaceBaseType5872() throws Exception
    {
        String json = a2q("{'list':["
                ...
                + "'id1'"
                + "]}");
        Container5872 container = MAPPER.readValue(VPackUtils.toVPack(json), Container5872.class);
    ...
    public void testObjectIdWithClassBaseType5872() throws Exception
    {
        String json = a2q("{'list':["
                ...
                + "'id1'"
                + "]}");
        ContainerWithClass5872 container = MAPPER.readValue(VPackUtils.toVPack(json), ContainerWithClass5872.class);
        assertNotNull(container);
        assertNotNull(container.list);
        assertEquals(2, container.list.size());
    ...
    public void testObjectIdWithInterfaceAndBuilder5872() throws Exception
    {
        String json = a2q("{'list':["
                ...
                + "'id1'"
                + "]}");
        ContainerInterfaceWithBuilder5872 container = MAPPER.readValue(VPackUtils.toVPack(json), ContainerInterfaceWithBuilder5872.class);
        assertNotNull(container);
        assertNotNull(container.list);
        assertEquals(2, container.list.size());
    ...
    public void testObjectIdWithClassAndBuilder5872() throws Exception
    {
        String json = a2q("{'list':["
                ...
                + "'id1'"
                + "]}");
        ContainerClassWithBuilder5872 container = MAPPER.readValue(VPackUtils.toVPack(json), ContainerClassWithBuilder5872.class);
        assertNotNull(container);
        assertNotNull(container.list);
        assertEquals(2, container.list.size());
