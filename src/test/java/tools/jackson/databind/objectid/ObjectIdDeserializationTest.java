...
public class ObjectIdDeserializationTest extends DatabindTestUtil
{
    ...
    {
        Identifiable result = MAPPER.readValue(VPackUtils.toVPack(EXP_SIMPLE_INT_CLASS), Identifiable.class);
    ...
    {
        Identifiable result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'value':28, 'next':{'value':29}}")),
                Identifiable.class);
    ...
    public void testSimpleUUIDForClassRoundTrip() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(root));

        UUIDNode result = MAPPER.readValue(VPackUtils.toVPack(json), UUIDNode.class);
    ...
    {
        IdWrapper result = MAPPER.readValue(VPackUtils.toVPack(EXP_SIMPLE_INT_PROP), IdWrapper.class);
    ...
    {
        IdWrapper result = MAPPER.readValue(VPackUtils.toVPack("{\"node\":{\"value\":7,\"next\":{\"node\":1}, \"@id\":1}}")
                ,IdWrapper.class);
        assertEquals(7, result.node.value);
        assertSame(result.node, result.node.next.node);
    }
    ...
    public void testForwardReference() throws Exception
    {
        String json = "{\"employees\":["
                      ...
                      + "]}";
        Company company = MAPPER.readValue(VPackUtils.toVPack(json), Company.class);
    ...
    public void testForwardReferenceInMap() throws Exception
    {
        String json = "{\"employees\":{"
                      ...
                      + "}}";
        MappedCompany company = MAPPER.readValue(VPackUtils.toVPack(json), MappedCompany.class);
    ...
    public void testForwardReferenceAnySetterCombo() throws Exception {
        ...
        AnySetterObjectId value = MAPPER.readValue(VPackUtils.toVPack(json), AnySetterObjectId.class);
    ...
    public void testUnresolvedForwardReference() throws Exception
    {
        String json = "{\"employees\":["
                      ...
                      + "]}";
        try {
            MAPPER.readValue(VPackUtils.toVPack(json), Company.class);
    ...
    public void testUnresolvableAsNull() throws Exception
    {
        IdWrapper w = MAPPER.readerFor(IdWrapper.class)
                ...
                .readValue(VPackUtils.toVPack(a2q("{'node':123}")));
        assertNotNull(w);
        assertNull(w.node);
    }
    ...
    {
        IdentifiableCustom result = MAPPER.readValue(VPackUtils.toVPack(EXP_CUSTOM_VIA_CLASS), IdentifiableCustom.class);
    ...
    {
        IdWrapperExt result = MAPPER.readValue(VPackUtils.toVPack(EXP_CUSTOM_VIA_PROP), IdWrapperExt.class);
    ...
    public void testCustomPoolResolver() throws Exception
    {
        ...
        CustomResolutionWrapper wrapper = MAPPER.readerFor(CustomResolutionWrapper.class)
                .with(attrs).readValue(VPackUtils.toVPack(content));
    ...
    public void testNullObjectId() throws Exception
    {
        Identifiable value = MAPPER.readValue(
                VPackUtils.toVPack(a2q("{'value':3, 'next':null, 'id':null}")), Identifiable.class);
        assertNotNull(value);
    ...
    public void testNullStringPropertyId() throws Exception
    {
        IdentifiableStringId value = MAPPER.readValue(
                VPackUtils.toVPack(a2q("{'value':3, 'next':null, 'id':null}")), IdentifiableStringId.class);
        assertNotNull(value);
        assertEquals(3, value.value);
    }
    ...
    private final ObjectMapper DISABLED_MAPPER = vpackMapperBuilder()
        .disable(DeserializationFeature.FAIL_ON_UNRESOLVED_OBJECT_IDS)
        .build();

    private final ObjectMapper ENABLED_MAPPER = vpackMapperBuilder()
    ...
    public void testSuccessResolvedObjectIds() throws Exception {
        ...
        SomeWrapper wrapper = DEFAULT_MAPPER.readValue(VPackUtils.toVPack(json), SomeWrapper.class);
    ...
    public void testUnresolvedObjectIdsFailure() throws Exception {
        ...
        SomeWrapper wrapper = DISABLED_MAPPER.readValue(VPackUtils.toVPack(json), SomeWrapper.class);
        assertNull(wrapper.node.next.node);

        try {
            // 2. Will fail by default
            DEFAULT_MAPPER.readValue(VPackUtils.toVPack(json), SomeWrapper.class);
        ...
        try {
            ...
            ENABLED_MAPPER.readValue(VPackUtils.toVPack(json), SomeWrapper.class);
            fail("should not pass");
        } catch (UnresolvedForwardReference e) {
            verifyException(e, "Unresolved forward reference", "Object id [2]");
        }
    ...
    public void testWithFieldsInBaseClass1083() throws Exception {
        final String json = a2q("{'schemas': [{\n"
            + "  'name': 'FoodMart'\n"
            + "}]}\n");
        MAPPER.readValue(VPackUtils.toVPack(json), JsonRoot1083.class);
    }
    ...
    public void testAtomicReferenceWithObjectId() throws Exception
    {
        ...
        LinkedEmployeeList result = MAPPER.readValue(VPackUtils.toVPack(json), LinkedEmployeeList.class);
    ...
    public void testObjectIdWithInjectables() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(a));
        ...
        InjectableA output;
        try {
            output = MAPPER.reader(inject).forType(InjectableA.class).readValue(VPackUtils.toVPack(json));
        } catch (Exception e) {
    ...
    public void testForwardReferenceInEnumMap() throws Exception {
        String json = "{\"employees\":{"
                ...
                + "}}";
        EnumMapCompany company = MAPPER.readValue(VPackUtils.toVPack(json), EnumMapCompany.class);
        assertEquals(3, company.employees.size());
    ...
    public void testOrdering1388() throws Exception
    {
        ...
        {
            final String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(Arrays.asList(thing, thing, thing)));
            final List<NamedThing> list = MAPPER.readValue(VPackUtils.toVPack(json), NAMED_THING_LIST_TYPE);
            _assertAllSame(list);
        ...
        // now move it around to have forward references
        {
            ...
            final List<NamedThing> forward = MAPPER.readValue(VPackUtils.toVPack(json), NAMED_THING_LIST_TYPE);
    ...
    {
        final List<NamedThing> l = MAPPER.readValue(VPackUtils.toVPack("[null]"), NAMED_THING_LIST_TYPE);
    ...
    {
        try {
            MAPPER.readValue(VPackUtils.toVPack("[123]"), NAMED_THING_LIST_TYPE);
            fail("Should not pass");
        } catch (UnresolvedForwardReference e) {
    ...
    public void testObjectMapperFailsOnUnresolvedObjectIds5542() throws Exception {
        ...
        try {
            MAPPER.readValue(VPackUtils.toVPack(json), ReaderWrapper5542.class);
    ...
    public void testUnresolvedScalarObjectIdFails2955() throws Exception {
        ...
        try {
            MAPPER.readValue(VPackUtils.toVPack(json), Node2955.class);
            fail("Should have thrown UnresolvedForwardReference");
        } catch (UnresolvedForwardReference e) {
    ...
    public void testUnresolvedScalarObjectIdAsNull2955() throws Exception {
        ...
        Node2955 result = DISABLED_MAPPER.readValue(VPackUtils.toVPack(json), Node2955.class);
        assertNotNull(result);
    ...
    public void testForwardAndUnresolvedScalarObjectIds2955() throws Exception {
        ...
        Owner2955 owner = DISABLED_MAPPER.readValue(VPackUtils.toVPack(json), Owner2955.class);
