...
public class ObjectIdWithCreatorTest extends DatabindTestUtil
{
    ...
    public void testSerializeDeserializeWithCreator() throws Exception {
        ...
        EnclosingForRefsWithCreator result = MAPPER.readValue(VPackUtils.toVPack(json), EnclosingForRefsWithCreator.class);
        assertNotNull(result);
        assertEquals(result.label, e.label);
        // also, compare by re-serializing:
        assertEquals(json, VPackUtils.toJson(MAPPER.writeValueAsBytes(result)));
    }
    ...
    public void testSerializeDeserializeNoCreator() throws Exception {
        ...
        EnclosingForRefWithNoCreator result = MAPPER.readValue(VPackUtils.toVPack(json), EnclosingForRefWithNoCreator.class);
        assertNotNull(result);
        assertEquals(result.label, e.label);
        // also, compare by re-serializing:
        assertEquals(json, VPackUtils.toJson(MAPPER.writeValueAsBytes(result)));
    ...
    public void testObjectIds1261() throws Exception {
        ...
        String initialAnswerString = VPackUtils.toJson(mapper.writeValueAsBytes(initialAnswer));
        JsonNode tree = mapper.readTree(VPackUtils.toVPack(initialAnswerString));
        Answer deserializedAnswer = mapper.readValue(VPackUtils.toVPack(initialAnswerString), Answer.class);
        String reserializedAnswerString = VPackUtils.toJson(mapper.writeValueAsBytes(deserializedAnswer));
        JsonNode newTree = mapper.readTree(VPackUtils.toVPack(reserializedAnswerString));
    ...
    public void testObjectIdWithCreator() throws Exception {
        JsonBean2944 result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'id': 'myId','value': 'myValue'}")),
                JsonBean2944.class);
        assertNotNull(result);
    ...
    public void testCreatorValuePreservedWithIdentityInfo3185() throws Exception
    {
        Pojo3185 result = MAPPER.readValue(
                VPackUtils.toVPack(a2q("{'id': 'valueFromJson'}")), Pojo3185.class);
    ...
    public void testNoForwardReferenceWithCreator3030() throws Exception
    {
        ...
        ContainerABC3030 result = MAPPER.readValue(VPackUtils.toVPack(json), ContainerABC3030.class);
    ...
    public void testObjectIdWithDelegatingCreator() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(Arrays.asList(item, item)));

        List<Item1706> result = MAPPER.readValue(VPackUtils.toVPack(json), new TypeReference<List<Item1706>>() {});
    ...
    public void testObjectIdWithInjectable639() throws Exception
    {
        ...
        parent = mapper.readValue(VPackUtils.toVPack(json), InjectParent639.class);
