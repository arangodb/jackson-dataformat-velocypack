...
public class TestScalaLikeImplicitProperties extends DatabindTestUtil
{
    ...
    public void testValProperty() throws Exception
    {
        ...
        assertEquals("{\"prop\":\"val\"}", VPackUtils.toJson(m.writeValueAsBytes(new ValProperty("val"))));
    }
    ...
    public void testValWithBeanProperty() throws Exception
    {
        ...
        assertEquals("{\"prop\":\"val\"}", VPackUtils.toJson(m.writeValueAsBytes(new ValWithBeanProperty("val"))));
    }
    ...
    public void testVarProperty() throws Exception
    {
        ...
        assertEquals("{\"prop\":\"var\"}", VPackUtils.toJson(m.writeValueAsBytes(new VarProperty("var"))));
        VarProperty result = m.readValue(VPackUtils.toVPack("{\"prop\":\"read\"}"), VarProperty.class);
    ...
    public void testVarWithBeanProperty() throws Exception
    {
        ...
        assertEquals("{\"prop\":\"var\"}", VPackUtils.toJson(m.writeValueAsBytes(new VarWithBeanProperty("var"))));
        VarWithBeanProperty result = m.readValue(VPackUtils.toVPack("{\"prop\":\"read\"}"), VarWithBeanProperty.class);
        assertEquals("read", result.prop());
    }
    ...
    public void testGetterSetterProperty() throws Exception
    {
        ...
        assertEquals("{\"prop\":\"get-set\"}", VPackUtils.toJson(m.writeValueAsBytes(new GetterSetterProperty())));
        GetterSetterProperty result = m.readValue(VPackUtils.toVPack("{\"prop\":\"read\"}"), GetterSetterProperty.class);
        assertEquals("read", result.prop());
    }
