...
public class SetterConflictTest extends DatabindTestUtil
{
    ...
    {
        Issue1033Bean bean = MAPPER.readValue(VPackUtils.toVPack(a2q("{'value':42}")),
                Issue1033Bean.class);
    ...
    public void testConflictingSetters() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        DuplicateSetterBean2979 result = mapper.readValue(VPackUtils.toVPack(a2q("{'bloop':true}")),
    ...
    public void testDuplicateSetterResolutionOk() throws Exception
    {
        ...
        DupSetter3125Bean value = MAPPER.readValue(VPackUtils.toVPack(a2q("{'value':'foo'}")),
    ...
    {
        try {
            MAPPER.readValue(VPackUtils.toVPack(a2q("{'value':'foo'}")),
