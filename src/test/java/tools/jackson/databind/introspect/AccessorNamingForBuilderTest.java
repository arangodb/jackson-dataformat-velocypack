...
public class AccessorNamingForBuilderTest extends DatabindTestUtil
{
    ...
    public void testAccessorCustomWithMethod() throws Exception
    {
        ...
        final ObjectMapper vanillaMapper = vpackMapperBuilder()
                .enable(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES).build();

        // First: without custom strategy, will fail:
        try {
            ValueClassXY xy = vanillaMapper.readValue(VPackUtils.toVPack(json), ValueClassXY.class);
        ...
        final ObjectMapper customMapper = vpackMapperBuilder()
                ...
                .build();
        ValueClassXY xy = customMapper.readValue(VPackUtils.toVPack(json), ValueClassXY.class);
    ...
    public void testBuilderPrefixEmptyViaAnnotation() throws Exception
    {
        ...
        NoPrefixBuilderViaAnnotation result = mapper.readValue(VPackUtils.toVPack(json), NoPrefixBuilderViaAnnotation.class);
    ...
    public void testBuilderPrefixCustomViaAnnotation() throws Exception
    {
        ...
        SetPrefixBuilderViaAnnotation result = mapper.readValue(VPackUtils.toVPack(json), SetPrefixBuilderViaAnnotation.class);
    ...
    public void testBuilderPrefixOverridesJsonPOJOBuilder() throws Exception
    {
        ...
        AnnotationOverrideTest result = mapper.readValue(VPackUtils.toVPack(json), AnnotationOverrideTest.class);
    ...
    public void testFallbackToJsonPOJOBuilderPrefix() throws Exception
    {
        ...
        FallbackToPojoBuilderTest result = mapper.readValue(VPackUtils.toVPack(json), FallbackToPojoBuilderTest.class);
