...
public class DeepVPackTreeTraversingTest extends DatabindTestUtil
{
    ...
    public void testTreeWithArrayWithDefaultConfig() throws Exception
    {
        ...
        try {
            defaultMapper.readTree(VPackUtils.toVPack(doc));
    ...
    {
        final String doc = _nestedDoc(TOO_DEEP_NESTING, "[ ", "] ");
        JsonNode tree = unconstrainedMapper.readTree(VPackUtils.toVPack(doc));
