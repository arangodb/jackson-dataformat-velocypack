        ...
        extends DatabindTestUtil
{
    ...
    void mutableBeanUpdateBuilder() throws Exception {
        MutableBean4356 recreatedBean = MAPPER.readValue(VPackUtils.toVPack("{\"a\": \"Some value\"}"),
    ...
    void immutableBeanUpdateBuilder() throws Exception {
        ImmutableBean4356 recreatedBean = MAPPER.readValue(VPackUtils.toVPack("{\"a\": \"Some value\"}"),
