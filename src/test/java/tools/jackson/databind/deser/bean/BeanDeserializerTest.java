...
public class BeanDeserializerTest
{
    ...
    {
        try {
            MAPPER.readValue(VPackUtils.toVPack("{ \"x\" : 3 }"), Abstract.class);
    ...
    public void testPropertyRemoval() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        Bean bean = mapper.readValue(VPackUtils.toVPack("{\"b\":\"2\"}"), Bean.class);
    ...
    public void testDeserializerReplacement() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        Bean bean = mapper.readValue(VPackUtils.toVPack("{\"a\":\"xyz\"}"), Bean.class);
    ...
    public void testModifyArrayDeserializer() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        Object[] result = mapper.readValue(VPackUtils.toVPack("[1,2]"), Object[].class);
    ...
    public void testModifyCollectionDeserializer() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
            ...
            .build();
        List<?> result = mapper.readValue(VPackUtils.toVPack("[1,2]"), List.class);
    ...
    public void testModifyMapDeserializer() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        Map<?,?> result = mapper.readValue(VPackUtils.toVPack("{\"a\":1,\"b\":2}"), Map.class);
        assertEquals(1, result.size());
    ...
    public void testModifyEnumDeserializer() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        Object result = mapper.readValue(VPackUtils.toVPack(q("B")), EnumABC.class);
    ...
    public void testModifyKeyDeserializer() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        Map<?,?> result = mapper.readValue(VPackUtils.toVPack("{\"a\":1}"), Map.class);
        assertEquals(1, result.size());
    ...
    public void testModifyStdScalarDeserializer() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        Object result = mapper.readValue(VPackUtils.toVPack(q("abcDEF")), String.class);
    ...
    public void testAddOrReplacePropertyIsUsedOnDeserialization() throws Exception {
        ...
        Issue1912Bean result = mapper.readValue(VPackUtils.toVPack("{\"subBean\": {\"a\":\"foo\"}}"), Issue1912Bean.class);
