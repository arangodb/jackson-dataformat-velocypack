...
public class BasicAnnotationsTest extends DatabindTestUtil
{
    ...
    public void testSimpleSetter() throws Exception
    {
        SizeClassSetter result = MAPPER.readValue
            (VPackUtils.toVPack("{ \"other\":3, \"size\" : 2, \"length\" : -999 }"),
    ...
    {
        SizeClassSetter2 result = MAPPER.readValue(VPackUtils.toVPack("{ \"x\": -3 }"),
    ...
    public void testSetterInheritance() throws Exception
    {
        BeanSubClass result = MAPPER.readValue
            (VPackUtils.toVPack("{ \"x\":1, \"z\" : 3, \"y\" : 2 }"),
             BeanSubClass.class);
    ...
    {
        BeanWithDeserialize bean = MAPPER.readValue(VPackUtils.toVPack("{\"a\":3}"), BeanWithDeserialize.class);
        assertNotNull(bean);
    ...
    {
        Issue442Bean bean = MAPPER.readValue(VPackUtils.toVPack("{\"i\":5}"), Issue442Bean.class);
    ...
    {
        ListSubClass result = MAPPER.readValue(VPackUtils.toVPack("[ \"123\" ]"), ListSubClass.class);
    ...
    {
        AnnotatedStringList result = MAPPER.readValue(VPackUtils.toVPack("[ \"...\" ]"), AnnotatedStringList.class);
        assertEquals(1, result.size());
    ...
    {
        AnnotatedBooleanList result = MAPPER.readValue(VPackUtils.toVPack("[ false ]"), AnnotatedBooleanList.class);
        assertEquals(1, result.size());
        Object ob = result.get(0);
    ...
    public void testAnnotationsDisabled() throws Exception
    {
        ...
        AnnoBean bean = MAPPER.readValue(VPackUtils.toVPack("{ \"y\" : 0 }"), AnnoBean.class);
        ...
        bean = m.readValue(VPackUtils.toVPack("{ \"x\" : 0 }"), AnnoBean.class);
        assertEquals(0, bean.value);
    }
    ...
    public void testEnumsWhenDisabled() throws Exception
    {
        ...
        assertEquals(Alpha.B, m.readValue(VPackUtils.toVPack(q("B")), Alpha.class));
    ...
    public void testNoAccessOverrides() throws Exception
    {
        ObjectMapper m = vpackMapperBuilder()
                ...
                .build();
        SimpleBean bean = m.readValue(VPackUtils.toVPack("{\"x\":1,\"y\":2}"), SimpleBean.class);
