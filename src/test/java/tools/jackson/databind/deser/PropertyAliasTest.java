...
public class PropertyAliasTest
{
    ...
    public void testSimpleAliases() throws Exception
    {
        ...
        bean = MAPPER.readValue(VPackUtils.toVPack(a2q("{'Name':'Foobar','a':3,'xyz':37}")),
                AliasBean.class);
    ...
    {
        PolyWrapperForAlias value = MAPPER.readValue(VPackUtils.toVPack(a2q(
    ...
    {
        AliasBean2378 bean = MAPPER.readValue(VPackUtils.toVPack(a2q(
    ...
    public void testCaseInsensitiveAliases() throws Exception {
        ...
        Pojo2669 pojo = mapper.readValue(VPackUtils.toVPack(text), Pojo2669.class);
        assertNotNull(pojo);
    ...
    public void testAliasDeserializedToLastMatchingKey_ascendingKeys() throws Exception {
        ...
        FixedOrderAliasBean ascObj = MAPPER.readValue(VPackUtils.toVPack(ascendingOrderInput), FixedOrderAliasBean.class);
    ...
    public void testAliasDeserializedToLastMatchingKey_descendingKeys() throws Exception {
        ...
        FixedOrderAliasBean descObj = MAPPER.readValue(VPackUtils.toVPack(descendingOrderInput), FixedOrderAliasBean.class);
    ...
    public void testAliasDeserializedToLastMatchingKey_ascendingAliases() throws Exception {
        ...
        AscendingOrderAliasBean ascObj = MAPPER.readValue(VPackUtils.toVPack(input), AscendingOrderAliasBean.class);
        assertEquals("c-value", ascObj.value);
    }
    ...
    public void testAliasDeserializedToLastMatchingKey_descendingAliases() throws Exception {
        ...
        DescendingOrderAliasBean descObj = MAPPER.readValue(VPackUtils.toVPack(input), DescendingOrderAliasBean.class);
    ...
    public void testAliasFallBackToField() throws Exception {
        AliasTestBeanA obj = MAPPER.readValue(VPackUtils.toVPack(a2q(
