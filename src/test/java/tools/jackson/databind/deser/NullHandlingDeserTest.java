...
public class NullHandlingDeserTest
{
    ...
    private final ObjectMapper CONTENT_NULL_FAIL_MAPPER = VPackMapper.builder()
    ...
    public void testNull() throws Exception
    {
        ...
        String str = MAPPER.readValue(VPackUtils.toVPack("null"), String.class);
        assertNull(str);

        StringWrapper w = MAPPER.readValue(VPackUtils.toVPack(a2q("{'str': null}")),
                StringWrapper.class);
        assertNotNull(w);
        assertNull(w.str);
    }
    ...
    public void testAnySetterNulls() throws Exception {
        ...
        AnySetter result = mapper.readValue(VPackUtils.toVPack(nullValue), AnySetter.class);
        ...
        result = reader.readValue(VPackUtils.toVPack(nullValue));
    ...
    public void testCustomRootNulls() throws Exception
    {
        ...
        str = reader.readValue(VPackUtils.toVPack("null"));
        assertNotNull(str);
        assertEquals("funny", str);
    }
    ...
    public void testListOfNulls() throws Exception
    {
        ...
        // should get non-default null directly:
        List<?> deser = mapper.readValue(VPackUtils.toVPack("[null]"), type);
        assertNotNull(deser);
        ...
        deser = reader.readValue(VPackUtils.toVPack("[null]"));
        assertNotNull(deser);
        assertEquals(1, deser.size());
        assertEquals(list.get(0), deser.get(0));
    }
    ...
    public void testMapOfNulls() throws Exception
    {
        ...
        // should get non-default null directly:
        Map<?,?> deser = mapper.readValue(VPackUtils.toVPack("{\"key\":null}"), type);
        assertNotNull(deser);
        assertEquals(1, deser.size());
        ...
        // as well as via ObjectReader
        ObjectReader reader = mapper.readerFor(type);
        deser = reader.readValue(VPackUtils.toVPack("{\"key\":null}"));
        assertNotNull(deser);
        assertEquals(1, deser.size());
        assertEquals("funny", deser.get("key"));
    }
    ...
    public void testPolymorphicDataNull() throws Exception
    {
        ...
        RootData typeAData = MAPPER.readValue(VPackUtils.toVPack(typeA), RootData.class);
        ...
        RootData typeBData = MAPPER.readValue(VPackUtils.toVPack(typeB), RootData.class);
        assertEquals("This works too!", ((TypeB) typeBData.proxy).bValue, "No value for bValue!?");
        String typeBNull =
                "{\"name\":\"TypeBData\", \"type\":\"TypeB\", \"proxy\": null}";
        RootData typeBNullData = MAPPER.readValue(VPackUtils.toVPack(typeBNull), RootData.class);
    ...
    {
        try {
            CONTENT_NULL_FAIL_MAPPER.readValue(VPackUtils.toVPack("{ \"field\": null, \"property\": 1 }"), Map.class);
        ...
        try {
            CONTENT_NULL_FAIL_MAPPER.readValue(VPackUtils.toVPack("{ \"A\": 1, \"B\": null }"), new TypeReference<EnumMap<EnumMapTestEnum, Integer>>() {});
            fail("InvalidNullException expected");
        } catch (InvalidNullException e) {
            verifyException(e, "Invalid `null` value encountered");
        }
    ...
    {
        try {
            CONTENT_NULL_FAIL_MAPPER.readValue(VPackUtils.toVPack("[null, {\"field\": 1}]"),
        ...
        try {
            CONTENT_NULL_FAIL_MAPPER.readValue(VPackUtils.toVPack("[{\"field\": 1}, null]"),
        ...
        try {
            CONTENT_NULL_FAIL_MAPPER.readValue(VPackUtils.toVPack("[\"foo\", null]"), new TypeReference<List<String>>() {});
            fail("InvalidNullException expected");
        } catch (InvalidNullException e) {
            verifyException(e, "Invalid `null` value encountered");
        }
        ...
        try {
            CONTENT_NULL_FAIL_MAPPER.readValue(VPackUtils.toVPack("[\"foo\", null]"), new TypeReference<Set<String>>() {});
            fail("InvalidNullException expected");
        } catch (InvalidNullException e) {
            verifyException(e, "Invalid `null` value encountered");
        }
    ...
    {
        try {
            CONTENT_NULL_FAIL_MAPPER.readValue(VPackUtils.toVPack("[null, {\"field\": 1}]"), Object[].class);
            fail("InvalidNullException expected");
        } catch (InvalidNullException e) {
            verifyException(e, "Invalid `null` value encountered");
        }
        ...
        try {
            CONTENT_NULL_FAIL_MAPPER.readValue(VPackUtils.toVPack("[null, \"foo\"]"), String[].class);
            fail("InvalidNullException expected");
        } catch (InvalidNullException e) {
            verifyException(e, "Invalid `null` value encountered");
        }
