...
public class EnumDeserDupName4409Test extends DatabindTestUtil
{
    ...
    public void testDupNameConflict4409() throws Exception
    {
        assertEquals(ColorMode4409Snake.RGBa,
                MAPPER.readValue(VPackUtils.toVPack(q("RGBa")), ColorMode4409Snake.class));

        assertEquals(q("RGBA"),
                VPackUtils.toJson(MAPPER.writeValueAsBytes(ColorMode4409Snake.RGBA)));
    }
    ...
    public void testEnumAndPropertyNamingStrategy4409() throws Exception {
        ...
        Bug bug = mapper.readValue(VPackUtils.toVPack("{ \"color_mode\": \"RGBa\"}"), Bug.class);
