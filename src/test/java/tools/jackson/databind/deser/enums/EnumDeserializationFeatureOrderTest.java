    ...
    extends DatabindTestUtil
{
    ...
    public void testDeserUnknownUsingDefaultBeforeAsNull() throws Exception {
        ...
        EnumFruit simpleEnumA = reader.readValue(VPackUtils.toVPack(q("")));
    ...
    public void testDeserWithAliasUsingDefault() throws Exception {
        ...
        EnumLetter defaulted = reader.readValue(VPackUtils.toVPack(q("unknownValue")));
    ...
    public void testDeserUnknownEnumMapKeyUsingDefault() throws Exception {
        ...
        EnumMap<EnumFruit, String> result = reader.readValue(VPackUtils.toVPack(JSON));
    ...
    public void testDeserUnknownMapKeyUsingDefault() throws Exception {
        ...
        Map<EnumFruit, String> result = reader.readValue(VPackUtils.toVPack(JSON));
