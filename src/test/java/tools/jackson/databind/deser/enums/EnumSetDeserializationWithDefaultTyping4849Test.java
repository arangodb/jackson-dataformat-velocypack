    ...
    extends DatabindTestUtil
{
            ...
            throws Exception
    {
        ...
        String inputJson = VPackUtils.toJson(MAPPER.writeValueAsBytes(input));
        Object inputDeserialized = MAPPER.readValue(VPackUtils.toVPack(inputJson), Object.class);
        // Then
        ...
        throws Exception
    {
        ...
        // When
        Object deserialized = MAPPER.readValue(VPackUtils.toVPack(input), Object.class);
        // Then
