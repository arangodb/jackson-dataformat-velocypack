...
public class EnumDeserialization3369Test
{
    ...
    {
        final ObjectReader R = newVPackMapper().readerFor(Data3369.class);

        Data3369 data = R.readValue(VPackUtils.toVPack("{\"value\" : \"a\", \"person\" : \"Jeff\", \"age\" : 30}"));
        _verify3369(data, Enum3369.A);

        data = R.readValue(VPackUtils.toVPack("{\"value\" : \"e\", \"person\" : \"Jeff\", \"age\" : 30}"));
        ...
        /*
        data = R.readValue(VPackUtils.toVPack("{\"value\" : [\"a\"], \"person\" : \"Jeff\", \"age\" : 30}"));
        _verify3369(data, null);
