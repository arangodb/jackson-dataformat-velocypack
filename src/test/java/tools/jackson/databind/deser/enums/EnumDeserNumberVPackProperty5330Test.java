 ...
 */
public class EnumDeserNumberVPackProperty5330Test extends DatabindTestUtil
{
    ...
    public void shouldDeserializeFromNumericAndQuotedNumericIndex() throws Exception {
        assertEquals(MyEnum.FOO, MAPPER.readValue(VPackUtils.toVPack("7"), MyEnum.class));
        assertEquals(MyEnum.FOO, MAPPER.readValue(VPackUtils.toVPack(q("7")), MyEnum.class));
    }
    ...
    public void shouldDeserializeEnumMapKeysUsingNumericJsonPropertyIndex() throws Exception {
        ...
        Map<MyEnum, String> result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'7':'lucky'}")), type);
    ...
    public void shouldDeserializeNonNumericJsonPropertyFromStringWithNumberShape() throws Exception {
        ...
        assertEquals(NonNumericEnum.VALUE, MAPPER.readValue(VPackUtils.toVPack(q("NOT_A_NUMBER")), NonNumericEnum.class));
    }
    ...
    public void shouldFallbackToOrdinalForNumericInputWhenJsonPropertyIsNotNumeric() throws Exception {
        ...
        assertEquals(NonNumericEnum.VALUE, MAPPER.readValue(VPackUtils.toVPack("0"), NonNumericEnum.class));
    }
    ...
    public void shouldNotUseNumericJsonPropertyIndexWithoutNumberShape() throws Exception {
        ...
        assertThrows(MismatchedInputException.class, () -> mapper.readValue(VPackUtils.toVPack("7"), MyEnumNoFormat.class));
        assertThrows(MismatchedInputException.class, () -> mapper.readValue(VPackUtils.toVPack("42"), MyEnumNoFormat.class));

        // string token: should map by NAME (i.e. @JsonProperty), regardless of number-shape
        assertEquals(MyEnumNoFormat.FOO, mapper.readValue(VPackUtils.toVPack(q("7")), MyEnumNoFormat.class));
        assertEquals(MyEnumNoFormat.BAR, mapper.readValue(VPackUtils.toVPack(q("42")), MyEnumNoFormat.class));
    }
