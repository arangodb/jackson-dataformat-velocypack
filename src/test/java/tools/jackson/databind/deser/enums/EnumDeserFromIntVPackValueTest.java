...
public class EnumDeserFromIntVPackValueTest
{
    // [databind#1850]
    ...
    {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(Bean1850IntMethod.A));
        Bean1850IntMethod e1 = MAPPER.readValue(VPackUtils.toVPack(json), Bean1850IntMethod.class);
    ...
    {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(Bean1850IntField.A));

        Bean1850IntField e2 = MAPPER.readValue(VPackUtils.toVPack(json), Bean1850IntField.class);
    ...
    {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(Bean1850LongMethod.A));
        Bean1850LongMethod e1 = MAPPER.readValue(VPackUtils.toVPack(json), Bean1850LongMethod.class);
    ...
    {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(Bean1850LongField.A));
        Bean1850LongField e2 = MAPPER.readValue(VPackUtils.toVPack(json), Bean1850LongField.class);
