...
public class CustomValueInstantiatorsTest
{
    ...
    public void testCustomBeanInstantiator() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        MyBean bean = mapper.readValue(VPackUtils.toVPack("{}"), MyBean.class);
        assertNotNull(bean);
    ...
    public void testCustomListInstantiator() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        MyList result = mapper.readValue(VPackUtils.toVPack("[]"), MyList.class);
    ...
    public void testCustomMapInstantiator() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        MyMap result = mapper.readValue(VPackUtils.toVPack("{ \"a\":\"b\" }"), MyMap.class);
        assertNotNull(result);
    ...
    public void testDelegateBeanInstantiator() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        MyBean bean = mapper.readValue(VPackUtils.toVPack("123"), MyBean.class);
        assertNotNull(bean);
    ...
    public void testDelegateListInstantiator() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        MyList result = mapper.readValue(VPackUtils.toVPack("123"), MyList.class);
        assertNotNull(result);
        assertEquals(1, result.size());
    ...
    public void testDelegateMapInstantiator() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        MyMap result = mapper.readValue(VPackUtils.toVPack("123"), MyMap.class);
        assertNotNull(result);
        assertEquals(1, result.size());
    ...
    {
        AnnotatedBeanDelegating value = MAPPER.readValue(VPackUtils.toVPack("{\"a\":3}"), AnnotatedBeanDelegating.class);
        assertNotNull(value);
    ...
    public void testPropertyBasedBeanInstantiator() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        CreatorBean bean = mapper.readValue(VPackUtils.toVPack("{\"secret\":123,\"value\":37}"), CreatorBean.class);
        assertNotNull(bean);
        assertEquals("123", bean._secret);
    }
    ...
    public void testPropertyBasedMapInstantiator() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        MyMap result = mapper.readValue(VPackUtils.toVPack("{\"name\":\"bob\", \"x\":\"y\"}"), MyMap.class);
        assertNotNull(result);
    ...
    public void testBeanFromString() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        MysteryBean result = mapper.readValue(VPackUtils.toVPack(q("abc")), MysteryBean.class);
        assertNotNull(result);
    ...
    public void testBeanFromInt() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        MysteryBean result = mapper.readValue(VPackUtils.toVPack("37"), MysteryBean.class);
        assertNotNull(result);
    ...
    public void testBeanFromLong() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        MysteryBean result = mapper.readValue(VPackUtils.toVPack("9876543210"), MysteryBean.class);
        assertNotNull(result);
    ...
    public void testBeanFromDouble() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        MysteryBean result = mapper.readValue(VPackUtils.toVPack("0.25"), MysteryBean.class);
        assertNotNull(result);
    ...
    public void testBeanFromBoolean() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        MysteryBean result = mapper.readValue(VPackUtils.toVPack("true"), MysteryBean.class);
        assertNotNull(result);
    ...
    public void testPolymorphicCreatorBean() throws Exception
    {
        ...
        PolymorphicBeanBase result = mapper.readValue(VPackUtils.toVPack(JSON), PolymorphicBeanBase.class);
        assertNotNull(result);
    ...
    {
        AnnotatedBean bean = MAPPER.readValue(VPackUtils.toVPack("{}"), AnnotatedBean.class);
        assertNotNull(bean);
    ...
    public void testErrorMessageForMissingCtor() throws Exception
    {
        ...
        try {
            MAPPER.readValue(VPackUtils.toVPack("{ }"), MyBean.class);
    ...
    public void testErrorMessageForMissingStringCtor() throws Exception
    {
        ...
        try {
            MAPPER.readValue(VPackUtils.toVPack("\"foo\""), MyBean.class);
            fail("Should not succeed");
        } catch (InvalidDefinitionException e) {
            verifyException(e, "Cannot construct instance of");
