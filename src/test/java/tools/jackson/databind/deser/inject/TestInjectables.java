...
public class TestInjectables extends DatabindTestUtil
{
    ...
    public void testSimple() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
            ...
            .build();
        InjectedBean bean = mapper.readValue(VPackUtils.toVPack("{\"value\":3}"), InjectedBean.class);
    ...
    public void testWithCtors() throws Exception
    {
        CtorBean bean = MAPPER.readerFor(CtorBean.class)
            ...
            .readValue(VPackUtils.toVPack("{\"age\":55}"));
    ...
    public void testIssue471() throws Exception
    {
        ...
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        Bean471 bean = mapper.readValue(VPackUtils.toVPack(a2q(
"{'x':13,'constructor_value':'constructor','method_value':'method','field_value':'field'}")),
    ...
    public void testTransientField() throws Exception
    {
        TransientBean bean = MAPPER.readerFor(TransientBean.class)
                ...
                .readValue(VPackUtils.toVPack("{\"value\":28}"));
