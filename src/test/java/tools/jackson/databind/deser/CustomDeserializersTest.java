...
public class CustomDeserializersTest
{
    ...
    public void testCustomBeanDeserializer() throws Exception
    {
        ...
        TestBeans beans = MAPPER.readValue(VPackUtils.toVPack(json), TestBeans.class);
        ...
        json = "{\"beans\":[{\"c\":{\"b\":3,\"a\":-4},\"d\":\"\"},"
            +"{\"d\":\"abc\", \"c\":{\"b\":15}}]}";
        beans = MAPPER.readValue(VPackUtils.toVPack(json), TestBeans.class);
    ...
    public void testDelegating() throws Exception
    {
        ...
        ObjectMapper mapper = vpackMapperBuilder()
                .addModule(module)
                .build();
        Immutable imm = mapper.readValue(VPackUtils.toVPack("{\"x\":3,\"y\":7}"), Immutable.class);
    ...
    public void testJsonNodeDelegating() throws Exception
    {
        ...
        ObjectMapper mapper = vpackMapperBuilder()
                .addModule(module)
                .build();
        Immutable imm = mapper.readValue(VPackUtils.toVPack("{\"x\":-10,\"y\":3}"), Immutable.class);
    ...
    public void testIssue882() throws Exception
    {
        ...
        Model deserialized = MAPPER.readValue(VPackUtils.toVPack(json), Model.class);
    ...
    public void testContextReadValue() throws Exception
    {
        ...
        Bean375Outer outer = mapper.readValue(VPackUtils.toVPack("13"), Bean375Outer.class);
        assertEquals(26, outer.inner.x);

        // then with property; should find annotation, turn negative
        Bean375Wrapper w = mapper.readValue(VPackUtils.toVPack("{\"value\":13}"), Bean375Wrapper.class);
    ...
    {
        Issue631Bean bean = MAPPER.readValue(VPackUtils.toVPack(a2q("{'prop':'stuff'}")),
                Issue631Bean.class);
        assertNotNull(bean);
    ...
    public void testCustomStringDeser() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        assertEquals("FOO", mapper.readValue(VPackUtils.toVPack(q("foo")), String.class));
        StringWrapper sw = mapper.readValue(VPackUtils.toVPack("{\"str\":\"foo\"}"), StringWrapper.class);
        assertNotNull(sw);
    ...
    public void testDelegatingDeserializer() throws Exception
    {
       ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        String str = mapper.readValue(VPackUtils.toVPack(q("foo")), String.class);
    ...
    public void testCustomDeserializerWithReadTree() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        ObjectWrapper w = mapper.readValue(VPackUtils.toVPack(a2q("[ 1, { 'a' : 3}, 123 ] ")),
                ObjectWrapper.class);
    ...
    public void testCustomDeserializerWithReadTreeAsValue() throws Exception
    {
        ...
        NamedPoint result = MAPPER.readValue(VPackUtils.toVPack(json), NamedPoint.class);
        assertNotNull(result);
        assertEquals("Foozibald", result.name);
        assertEquals(new Point(13, -4), result.point);

        // and with JavaType variant too
        result = MAPPER.readValue(VPackUtils.toVPack(json), MAPPER.constructType(NamedPoint.class));
        assertNotNull(result);
        assertEquals("Foozibald", result.name);
        assertEquals(new Point(13, -4), result.point);

        // also, try some edge conditions
        result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'name':4}")), NamedPoint.class);
        assertNotNull(result);
