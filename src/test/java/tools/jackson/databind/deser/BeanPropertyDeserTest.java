...
public class BeanPropertyDeserTest extends DatabindTestUtil
{
    ...
    {
        SimpleFieldBean result = MAPPER.readValue(VPackUtils.toVPack("{ \"x\" : -13 }"),
    ...
    {
        SimpleFieldBean2 bean = MAPPER.readValue(VPackUtils.toVPack("{ \"values\" : [ \"x\", \"y\" ] }"),
    ...
    {
        NoAutoDetectBean bean = MAPPER.readValue(VPackUtils.toVPack("{ \"z\" : 7 }"),
    ...
    {
        AbstractWrapper w = MAPPER.readValue(VPackUtils.toVPack("{ \"value\" : \"abc\" }"),
    ...
    {
        DupFieldBean result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'z':3}")), DupFieldBean.class);
    ...
    public void testFailingDups2() throws Exception
    {
        ...
        try {
            DupFieldBean2 result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'foo':28}")), DupFieldBean2.class);
    ...
    {
        OkDupFieldBean result = MAPPER.readValue(VPackUtils.toVPack("{ \"x\" : 1, \"y\" : 2 }"),
    ...
    {
        CollectionBean result = vpackMapperBuilder()
                .enable(MapperFeature.USE_GETTERS_AS_SETTERS)
                .build()
                .readValue
            (VPackUtils.toVPack("{\"values\":[ \"abc\", \"def\" ]}"), CollectionBean.class);
    ...
    {
        ObjectMapper m = vpackMapperBuilder().enable(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES).build();
    ...
    {
        MapBean result = vpackMapperBuilder()
                .enable(MapperFeature.USE_GETTERS_AS_SETTERS)
                .build()
                .readValue
            (VPackUtils.toVPack("{\"values\":{ \"a\": 15, \"b\" : -3 }}"), MapBean.class);
    ...
    public void testSimpleSetterlessMapFailure() throws Exception
    {
        ...
        try {
            m.readValue
                (VPackUtils.toVPack("{\"values\":{ \"a\":3 }}"), MapBean.class);
            fail("Expected an exception");
        } catch (UnrecognizedPropertyException e) {
            verifyException(e, "Unrecognized property");
        }
    ...
    public void testSetterlessPrecedence() throws Exception
    {
        ObjectMapper m = vpackMapperBuilder()
                .enable(MapperFeature.USE_GETTERS_AS_SETTERS)
                .build();
        Dual value = m.readValue(VPackUtils.toVPack("{\"list\":[1,2,3]}"), Dual.class);
        assertNotNull(value);
    ...
    void issue2692() throws Exception {
        ...
        DataBean2692 out = MAPPER.readerFor(DataBean2692.class).readValue(VPackUtils.toVPack(json));
        assertNotNull(out);
    }
    ...
    public void testSpecialization() throws Exception
    {
        ArrayListBean bean = MAPPER.readValue
            (VPackUtils.toVPack("{\"list\":[\"a\",\"b\",\"c\"]}"), ArrayListBean.class);
    ...
    public void testOverride() throws Exception
    {
        WasNumberBean bean = MAPPER.readValue
            (VPackUtils.toVPack("{\"value\" : \"abc\"}"), WasNumberBean.class);
        assertNotNull(bean);
    ...
    public void testConflictResolution() throws Exception
    {
        Overloaded739 bean = MAPPER.readValue
                (VPackUtils.toVPack("{\"value\":\"abc\"}"), Overloaded739.class);
        assertNotNull(bean);
    ...
    {
    	try {
    	MAPPER.readValue(VPackUtils.toVPack("{ }"), ConflictBean.class);
    	} catch (Exception e) {
    ...
    public void testStaticSetterIgnored() throws Exception
    {
        ...
        StaticSetterBean result = m.readValue(VPackUtils.toVPack("{ \"x\":3}"), StaticSetterBean.class);
