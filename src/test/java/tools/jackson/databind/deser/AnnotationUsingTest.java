...
public class AnnotationUsingTest
{
    ...
    public void testClassDeserializer() throws Exception
    {
        ...
        ValueClass result = m.readValue(VPackUtils.toVPack("  123  "), ValueClass.class);
    ...
    public void testMethodDeserializer() throws Exception
    {
        ...
        MethodBean result = m.readValue(VPackUtils.toVPack(" { \"ints\" : 3 } "), MethodBean.class);
    ...
    {
        ObjectMapper m = new VPackMapper();
        ArrayBean result = m.readValue(VPackUtils.toVPack(" { \"values\" : [ 1, 2, 3 ] } "), ArrayBean.class);
        assertNotNull(result);
    ...
    {
        ObjectMapper m = new VPackMapper();
        ListBean result = m.readValue(VPackUtils.toVPack(" { \"values\" : [ 1, 2, 3 ] } "), ListBean.class);
        assertNotNull(result);
    ...
    {
        ObjectMapper m = new VPackMapper();
        MapBean result = m.readValue(VPackUtils.toVPack(" { \"values\" : { \"a\": 1, \"b\":2 } } "), MapBean.class);
        assertNotNull(result);
    ...
    {
        ObjectMapper m = new VPackMapper();
        MapKeyBean result = m.readValue(VPackUtils.toVPack(" { \"values\" : { \"a\": true } } "), MapKeyBean.class);
        assertNotNull(result);
    ...
    {
        ObjectMapper m = new VPackMapper();
        MapKeyMap result = m.readValue(VPackUtils.toVPack(" { \"a\": 13 } "), MapKeyMap.class);
        assertNotNull(result);
        assertNotNull(result);
