...
//        @JsonCreator
    ...
    {
        XY value = MAPPER.readValue(VPackUtils.toVPack(a2q("{'paramName0':1,'paramName1':2}")), XY.class);
        assertNotNull(value);
    ...
    void implicitNameWithNamingStrategy() throws Exception
    {
        ...
        XY value = mapper.readValue(VPackUtils.toVPack(a2q("{'param_name0':1,'param_name1':2}")), XY.class);
        assertNotNull(value);
        assertEquals(1, value.x);
        assertEquals(2, value.y);
    }
    ...
    {
        Bean2932 bean = MAPPER.readValue(VPackUtils.toVPack(a2q("{'paramName0':1,'paramName1':2}")),
                Bean2932.class);
        assertNotNull(bean);
    ...
    public void delegatingInferFromJsonValue() throws Exception
    {
        ...
        assertEquals("123", VPackUtils.toJson(MAPPER.writeValueAsBytes(new XY3654(123))));

        // And then deser, should infer despite existence of "matching" property
        XY3654 result = MAPPER.readValue(VPackUtils.toVPack("345"), XY3654.class);
