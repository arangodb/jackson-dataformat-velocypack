...
public class MultiArgConstructorTest
{
    ...
    public void testMultiArgVisible() throws Exception
    {
        final ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        MultiArgCtorBean bean = mapper.readValue(VPackUtils.toVPack(a2q("{'b':13, 'c':2, 'a':-99}")),
    ...
    public void testMultiArgWithPartialOverride() throws Exception
    {
        final ObjectMapper mapper = vpackMapperBuilder()
                .annotationIntrospector(new MyParamIntrospector())
                .build();
        MultiArgCtorBeanWithAnnotations bean = mapper.readValue(VPackUtils.toVPack(a2q("{'b2':7, 'c':222, 'a':-99}")),
    ...
    public void testMultiArgNotVisible() throws Exception
    {
        final ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        try {
            /*MultiArgCtorBean bean =*/ mapper.readValue(VPackUtils.toVPack(a2q("{'b':13,  'a':-99}")),
                MultiArgCtorBean.class);
    ...
    public void testBigPartial() throws Exception
    {
        ...
        Biggie value = biggieReader.readValue(VPackUtils.toVPack(a2q(
