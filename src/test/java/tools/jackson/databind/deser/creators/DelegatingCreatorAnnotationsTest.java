...
public class DelegatingCreatorAnnotationsTest
{
    ...
    static class Wrapper2016As {
        ...
        public Wrapper2016As(@JsonDeserialize(as = Date.class) Object v) {
            value = v;
        }
    }
    ...
    static class Wrapper2016ContentAs {
        ...
        @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
        public Wrapper2016ContentAs(@JsonDeserialize(contentAs = Date.class) List<Object> v) {
            value = v;
        }
    }
    ...
    {
        Wrapper2016As actual = MAPPER.readValue(VPackUtils.toVPack("123"), Wrapper2016As.class);
    ...
    {
        Wrapper2016ContentAs actual = MAPPER.readValue(VPackUtils.toVPack("[123]"), Wrapper2016ContentAs.class);
    ...
    {
        DelegatingWithCustomDeser2021 actual = MAPPER.readValue(VPackUtils.toVPack(" true "), DelegatingWithCustomDeser2021.class);
