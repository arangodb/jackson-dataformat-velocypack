    ...
    extends DatabindTestUtil
{
    ...
    {
        ConstructorBean bean = MAPPER.readValue(VPackUtils.toVPack("{ \"x\" : 42 }"), ConstructorBean.class);
    ...
    {
        NoArgFactoryBean value = MAPPER.readValue(VPackUtils.toVPack("{\"y\":13}"), NoArgFactoryBean.class);
    ...
    public void testSimpleDoubleConstructor() throws Exception
    {
        ...
        DoubleConstructorBean bean = MAPPER.readValue(VPackUtils.toVPack(exp.toString()), DoubleConstructorBean.class);
    ...
    {
        BooleanConstructorBean bean = MAPPER.readValue(VPackUtils.toVPack(" true "), BooleanConstructorBean.class);
        assertEquals(Boolean.TRUE, bean.b);

        BooleanConstructorBean2 bean2 = MAPPER.readValue(VPackUtils.toVPack(" true "), BooleanConstructorBean2.class);
        assertTrue(bean2.b);
    }
    ...
    public void testSimpleBigIntegerConstructor() throws Exception
    {
        ...
        final BigIntegerWrapper result = MAPPER.readValue(VPackUtils.toVPack(INPUT.toString()), BigIntegerWrapper.class);
    ...
    {
        FactoryBean bean = MAPPER.readValue(VPackUtils.toVPack("{ \"f\" : 0.25 }"), FactoryBean.class);
    ...
    public void testLongFactory() throws Exception
    {
        ...
        LongFactoryBean bean = MAPPER.readValue(VPackUtils.toVPack(String.valueOf(VALUE)), LongFactoryBean.class);
    ...
    {
        String str = "abc";
        StringFactoryBean bean = MAPPER.readValue(VPackUtils.toVPack(q(str)), StringFactoryBean.class);
    ...
    {
        String str = "xyz";
        FromStringBean bean = MAPPER.readValue(VPackUtils.toVPack(q(str)), FromStringBean.class);
        assertEquals(str, bean.value);
    }
    ...
    public void testConstructorAndFactoryCreator() throws Exception
    {
        CreatorBeanWithBoth bean = MAPPER.readValue
            (VPackUtils.toVPack("{ \"a\" : \"xyz\", \"x\" : 12 }"), CreatorBeanWithBoth.class);
    ...
    public void testConstructorAndProps() throws Exception
    {
        ConstructorAndPropsBean bean = MAPPER.readValue
            (VPackUtils.toVPack("{ \"a\" : \"1\", \"b\": 2, \"c\" : true }"), ConstructorAndPropsBean.class);
    ...
    public void testFactoryAndProps() throws Exception
    {
        FactoryAndPropsBean bean = MAPPER.readValue
            (VPackUtils.toVPack("{ \"a\" : [ false, true, false ], \"b\": 2, \"c\" : -1 }"), FactoryAndPropsBean.class);
    ...
    {
        MultiBean bean = MAPPER.readValue(VPackUtils.toVPack("123"), MultiBean.class);
        assertEquals(Integer.valueOf(123), bean.value);
        bean = MAPPER.readValue(VPackUtils.toVPack(q("abc")), MultiBean.class);
        assertEquals("abc", bean.value);
        bean = MAPPER.readValue(VPackUtils.toVPack("0.25"), MultiBean.class);
    ...
    public void testDeferredConstructorAndProps() throws Exception
    {
        DeferredConstructorAndPropsBean bean = MAPPER.readValue
            (VPackUtils.toVPack("{ \"propB\" : \"...\", \"createA\" : [ 1 ], \"propA\" : null }"),
    ...
    public void testDeferredFactoryAndProps() throws Exception
    {
        DeferredFactoryAndPropsBean bean = MAPPER.readValue
            (VPackUtils.toVPack("{ \"prop\" : \"1\", \"ctor\" : \"2\" }"), DeferredFactoryAndPropsBean.class);
    ...
    public void testFactoryCreatorWithRenamingMixin() throws Exception
    {
        ...
        FactoryBean bean = m.readValue(VPackUtils.toVPack("{ \"mixed\" :  20.5 }"), FactoryBean.class);
    ...
    public void testMapWithConstructor() throws Exception
    {
        MapWithCtor result = MAPPER.readValue
            (VPackUtils.toVPack("{\"text\":\"abc\", \"entry\":true, \"number\":123, \"xy\":\"yx\"}"),
             MapWithCtor.class);
        // regular Map entries:
