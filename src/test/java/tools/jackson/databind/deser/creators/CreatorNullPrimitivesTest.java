...
public class CreatorNullPrimitivesTest
{
    ...
    public void testCreatorNullPrimitive() throws Exception {
        ...
        try {
            r.readValue(VPackUtils.toVPack(json));
    ...
    public void testCreatorAbsentPrimitiveShouldDefault() throws Exception {
        ...
        String json = a2q("{'x': 2}");
        JsonEntity result = r.readValue(VPackUtils.toVPack(json));
    ...
    public void testCreatorAbsentPrimitiveInNestedObjectShouldDefault() throws Exception {
        ...
        NestedJsonEntity result = r.readValue(VPackUtils.toVPack(json));
    ...
    public void testRequiredNonNullParam() throws Exception
    {
        ...
        p = personReader.readValue(VPackUtils.toVPack(a2q("{}")));
        ...
        p = r.readValue(VPackUtils.toVPack(a2q("{'name':'John', 'age': null}")));
        assertEquals("John", p.name);
        assertEquals(Integer.valueOf(0), p.age);

        // Third: throws exception if property is missing
        try {
            r.readValue(VPackUtils.toVPack(a2q("{}")));
        ...
        try {
            r.readValue(VPackUtils.toVPack(a2q("{'age': 5, 'name': null}")));
    ...
    void defaultingWithNull2977() throws Exception {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        TestClass2977 result = mapper.readValue(VPackUtils.toVPack(a2q("{'aa': 8}")), TestClass2977.class);
    ...
    void testRecordAbsentPrimitivesShouldDefault() throws Exception {
        ...
        PrimitiveRecord result = MAPPER.readValue(VPackUtils.toVPack(json), PrimitiveRecord.class);
    ...
    void testRecordExplicitNullPrimitiveShouldFail() throws Exception {
        ...
        try {
            MAPPER.readValue(VPackUtils.toVPack(json), PrimitiveRecord.class);
            fail("Should not have succeeded");
        } catch (MismatchedInputException e) {
