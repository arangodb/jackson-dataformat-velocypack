...
public class FactoryCreatorTypeBinding2894Test
{
    ...
    public void testIssue2894() throws Exception
    {
        ...
        final String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(src));
        Wrapper<Value> output = MAPPER.readValue(VPackUtils.toVPack(json),
    ...
    public void testIssue2895() throws Exception
    {
        SimpleWrapper2895<Account2895> wrapper = MAPPER
                ...
                .readValue(VPackUtils.toVPack("{\"object\":{\"id\":1,\"name\":\"name1\"}}"));
