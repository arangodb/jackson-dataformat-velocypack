 ...
 */
public class VPackCreatorModeForEnum3566Test
{
    ...
    public void testEnumACreatorModeDelegating() throws Exception {
        EnumA enum1 = newVPackMapper()
            .readerFor(EnumA.class)
            .readValue(VPackUtils.toVPack(a2q("'AType'")));
    ...
    public void testEnumACreatorModeProperties() throws Exception {
        EnumA enum1 = newVPackMapper()
            .readerFor(EnumA.class)
            .readValue(VPackUtils.toVPack(a2q("{'type':'AType'}")));
    ...
    public void testPojoCreatorModeProperties() throws Exception {
        PojoA pojo1 = newVPackMapper()
            .readValue(VPackUtils.toVPack(a2q("{'type':'properties'}")), PojoA.class);
    ...
    public void testPojoCreatorModeDelegating() throws Exception {
        PojoA pojo1 = newVPackMapper()
            .readValue(VPackUtils.toVPack(a2q("'properties'")), PojoA.class);
    ...
    public void testDelegatingCreatorEnumWrapper() throws Exception {
        DelegatingCreatorEnumWrapper wrapper = newVPackMapper()
            .readValue(VPackUtils.toVPack(a2q("{'enumA':'AType', 'enumB': 'BType'}")), DelegatingCreatorEnumWrapper.class);
    ...
    public void testPropertiesCreatorEnumWrapper() throws Exception {
        PropertiesCreatorEnumWrapper wrapper = newVPackMapper()
            .readValue(VPackUtils.toVPack(a2q("{'enumA':{'type':'AType'}, 'enumC': {'type':'CType'}}")), PropertiesCreatorEnumWrapper.class);
