    ...
    extends DatabindTestUtil
{
    ...
    {
        HashTest test = MAPPER.readValue(VPackUtils.toVPack("{\"type\":\"custom\",\"bytes\":\"abc\" }"), HashTest.class);
    ...
    public void testJackson438() throws Exception
    {
        Exception e = null;
        try {
            MAPPER.readValue(VPackUtils.toVPack("{ \"name\":\"foobar\" }"), BeanFor438.class);
    ...
    {
        try {
            MAPPER.readValue(VPackUtils.toVPack("{\"bar\":\"x\"}"), BrokenCreatorBean.class);
    ...
    public void testCreatorMultipleArgumentWithoutAnnotation() throws Exception {
        AutoDetectConstructorBean value = MAPPER.readValue(VPackUtils.toVPack("{\"bar\":\"bar\",\"foo\":\"foo\"}"),
    ...
    {
        try {
            MAPPER.readValue(VPackUtils.toVPack(q("abc")), IgnoredCtor.class);
    ...
    {
        AbstractBase bean = MAPPER.readValue(VPackUtils.toVPack("{\"a\":3}"), AbstractBase.class);
        assertNotNull(bean);
    ...
    {
        Issue700Bean value = MAPPER.readValue(VPackUtils.toVPack("{ \"item\" : \"foo\" }"), Issue700Bean.class);
        assertNotNull(value);
    }
    ...
    public void testConstructorChoice() throws Exception {
        MultiPropCreator1476 pojo = MAPPER.readValue(VPackUtils.toVPack("{ \"intField\": 1, \"stringField\": \"foo\" }"),
    ...
    {
        ConstructorBeanPropsExplicit4515 bean = MAPPER.readValue(VPackUtils.toVPack("{ \"x\" : 42 }"),
    ...
    {
        ConstructorBeanPropsWithName4515 bean = MAPPER.readValue(VPackUtils.toVPack("{ \"x\" : 28 }"),
    ...
    {
        FactoryBeanPropsExplicit4515 bean = MAPPER.readValue(VPackUtils.toVPack("{ \"f\" : 0.5 }"),
