...
public class PolymorphicPropsCreatorsTest extends DatabindTestUtil
{
    ...
    public void testManualPolymorphicDog() throws Exception
    {
        ...
        Animal animal = MAPPER.readValue(VPackUtils.toVPack("{ \"type\":\"dog\", \"name\":\"Fido\", \"barkVolume\" : 95.0 }"), Animal.class);
    ...
    public void testManualPolymorphicCatBasic() throws Exception
    {
        ...
        Animal animal = MAPPER.readValue(VPackUtils.toVPack("{ \"name\" : \"Macavity\", \"type\":\"cat\", \"lives\":18, \"likesCream\":false }"), Animal.class);
    ...
    public void testManualPolymorphicCatWithReorder() throws Exception
    {
        ...
        Animal animal = MAPPER.readValue(VPackUtils.toVPack("{ \"likesCream\":true, \"name\" : \"Venla\", \"type\":\"cat\" }"), Animal.class);
        assertEquals(Cat.class, animal.getClass());
    ...
    public void testManualPolymorphicWithNumbered() throws Exception
    {
         ...
         AbstractRoot result = r.readValue(VPackUtils.toVPack(json));
    ...
    public void testSubtypes113() throws Exception
    {
        ...
        String id = "nice dogy";
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(new AnimalWrapper113(new Dog113(id))));
//System.err.println("JSON = "+json);
        AnimalWrapper113 wrapper = mapper.readValue(VPackUtils.toVPack(json), AnimalWrapper113.class);
