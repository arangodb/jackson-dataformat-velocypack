    ...
    extends DatabindTestUtil
{
    ...
    void testDeserializeToNullWhenAllPropertiesAreNull()
    {
        Localized3 result = MAPPER.readValue(
                VPackUtils.toVPack("{ \"en\": null, \"de\": null, \"fr\": null }"),
                Localized3.class);
    ...
    {
        Localized3 result = MAPPER.readValue(
                VPackUtils.toVPack("{ \"en\": \"Hello\", \"de\": null, \"fr\": null }"),
                Localized3.class);
    ...
    void testDeserializeReadingAfterCreatorProps()
    {
        ...
        try {
            enabled.readValue(VPackUtils.toVPack("{ \"unknown\": null, \"en\": null, \"de\": null, \"fr\": null, \"unknown2\": \"hello\" }"));
    ...
    public void testUsesDeserializersNullValue() throws Exception {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        Container container = mapper.readValue(VPackUtils.toVPack("{}"), Container.class);
    ...
    public void testCreatorReturningNull597()
    {
        ...
        assertNull(MAPPER.readValue(VPackUtils.toVPack(json), JsonEntity.class));
    }
}
