...
public class AnySetterForCreator562Test extends DatabindTestUtil
{
    ...
    public void mapAnySetterViaCreator562() throws Exception
    {
        ...
        POJO562 pojo = MAPPER.readValue(VPackUtils.toVPack(a2q(
                "{'a':'value', 'b':42, 'c': 111}"
                )),
                POJO562.class);
        ...
        pojo = MAPPER.readValue(VPackUtils.toVPack(a2q(
                "{'b':42, 'a':'value', 'c': 111}"
                )),
                POJO562.class);
        ...
        pojo = MAPPER.readValue(VPackUtils.toVPack(a2q("{'a':'value2'}")), POJO562.class);
    ...
    public void mapAnySetterViaCreatorWhenBothCreatorAndFieldAreAnnotated() throws Exception
    {
        ...
        POJO562WithAnnotationOnBothCtorParamAndField pojo = MAPPER.readValue(VPackUtils.toVPack(a2q(
                "{'a':'value', 'b':42, 'c': 111}"
                )),
    ...
    public void mapAnySetterViaCreatorAndField() throws Exception
    {
        POJO562WithField pojo = MAPPER.readValue(
                VPackUtils.toVPack(a2q("{'a':'value', 'b':'xyz', 'c': 'abc'}")),
    ...
    public void testNodeAnySetterViaCreator562() throws Exception
    {
        PojoWithNodeAnySetter pojo = MAPPER.readValue(
                VPackUtils.toVPack(a2q("{'a':'value', 'b':42, 'c': 111}")),
        ...
        pojo = MAPPER.readValue(VPackUtils.toVPack(a2q("{'a':'ok'}")), PojoWithNodeAnySetter.class);
    ...
    {
        ObjectMapper failOnNullMapper = vpackMapperBuilder()
        ...
        POJO562 value = failOnNullMapper.readValue(VPackUtils.toVPack(a2q("{'a':'value'}")), POJO562.class);
    ...
    {
        ObjectMapper failOnMissingMapper = vpackMapperBuilder()
            .enable(DeserializationFeature.FAIL_ON_MISSING_CREATOR_PROPERTIES).build();

        // Actually missing (no any props encountered)
        try {
            failOnMissingMapper.readValue(VPackUtils.toVPack(a2q("{'a':'value'}")), POJO562.class);
        ...
        POJO562 value = failOnMissingMapper.readValue(VPackUtils.toVPack(a2q("{'a':'value','b':'x'}")), POJO562.class);
    ...
    {
        ObjectMapper failOnBothMapper = vpackMapperBuilder()
            .enable(DeserializationFeature.FAIL_ON_NULL_CREATOR_PROPERTIES)
            .enable(DeserializationFeature.FAIL_ON_MISSING_CREATOR_PROPERTIES)
            .build();
        try {
            failOnBothMapper.readValue(VPackUtils.toVPack(a2q("{'a':'value'}")), POJO562.class);
            fail("Should not pass");
        } catch (MismatchedInputException e) {
            verifyException(e, "Missing creator property");
        }
    ...
    {
        try {
            MAPPER.readValue(VPackUtils.toVPack("{}"), MultipleAny562.class);
            fail("Should not pass");
    ...
    public void testAnySetterViaCreator562Disabled() throws Exception
    {
        ...
        try {
            MAPPER.readerFor(PojoWithDisabled.class)
                    ...
                    .readValue(VPackUtils.toVPack(a2q("{'a':'value', 'b':42, 'c': 111}")));
            fail("Should not pass");
