...
public class DelegatingCreatorsTest
{
    ...
    public void testBooleanDelegate() throws Exception
    {
        ...
        BooleanBean bb = MAPPER.readValue(VPackUtils.toVPack("true"), BooleanBean.class);
        assertEquals(Boolean.TRUE, bb.value);

        // but also with value conversion from String
        bb = MAPPER.readValue(VPackUtils.toVPack(q("true")), BooleanBean.class);
        assertEquals(Boolean.TRUE, bb.value);
    }
    ...
    {
        IntegerBean bb = MAPPER.readValue(VPackUtils.toVPack("-13"), IntegerBean.class);
        assertEquals(Integer.valueOf(-13), bb.value);

        // but also with value conversion from String (unless blocked)
        bb = MAPPER.readValue(VPackUtils.toVPack(q("127")), IntegerBean.class);
    ...
    {
        LongBean bb = MAPPER.readValue(VPackUtils.toVPack("11"), LongBean.class);
        assertEquals(Long.valueOf(11L), bb.value);

        // but also with value conversion from String (unless blocked)
        bb = MAPPER.readValue(VPackUtils.toVPack(q("-99")), LongBean.class);
    ...
    public void testWithCtorAndDelegate() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        CtorBean711 bean = mapper.readValue(VPackUtils.toVPack("38"), CtorBean711.class);
    ...
    public void testWithFactoryAndDelegate() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        FactoryBean711 bean = mapper.readValue(VPackUtils.toVPack("38"), FactoryBean711.class);
        assertEquals(38, bean.age);
    ...
    {
        Value592 value = MAPPER.readValue(VPackUtils.toVPack("{\"a\":1,\"b\":2}"), Value592.class);
        assertNotNull(value);
    ...
    public void testIssue465() throws Exception
    {
        ...
        Map<String,Long> map = MAPPER.readValue(VPackUtils.toVPack(JSON), Map.class);
        assertEquals(1, map.size());
        assertEquals(Integer.valueOf(12), map.get("A"));

        MapBean bean = MAPPER.readValue(VPackUtils.toVPack(JSON), MapBean.class);
        ...
        map = MAPPER.readValue(VPackUtils.toVPack(EMPTY_JSON), Map.class);
        assertEquals(0, map.size());

        bean = MAPPER.readValue(VPackUtils.toVPack(EMPTY_JSON), MapBean.class);
    ...
    public void testMultipleCreators2353() throws Exception
    {
        ...
        SuperToken2353 result = MAPPER.readValue(VPackUtils.toVPack(q("Bob")), SuperToken2353.class);
        assertEquals("Bob", result.username);

        // and then properties-based
        result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'name':'Billy', 'time':123}")), SuperToken2353.class);
    ...
    {
        NoFieldSingletonWithDelegatingCreator deserialized = MAPPER.readValue(VPackUtils.toVPack("{}"),
    ...
    {
        NoFieldSingletonWithPropertiesCreator deserialized = MAPPER.readValue(VPackUtils.toVPack("{}"),
    ...
    {
        NoFieldSingletonWithDefaultCreator deserialized = MAPPER.readValue(VPackUtils.toVPack("{}"),
    ...
    {
        final String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new HeroBattle1003(new Superman1003())));
        final HeroBattle1003 battle = MAPPER.readValue(VPackUtils.toVPack(json), HeroBattle1003.class);
    ...
    public void testAbstractDelegateWithCreator() throws Exception
    {
        ...
        Issue580Bean result = MAPPER.readValue(VPackUtils.toVPack(json), Issue580Bean.class);
    ...
    public void testViaConstructor() throws Exception
    {
        ConstructorFromMap result = MAPPER.readValue
            (VPackUtils.toVPack("{ \"x\":1, \"y\" : \"abc\" }"), ConstructorFromMap.class);
    ...
    {
        FactoryFromPoint result = MAPPER.readValue(VPackUtils.toVPack("{ \"x\" : 3, \"y\" : 4 }"), FactoryFromPoint.class);
    ...
    {
        FactoryFromDecimalString result = MAPPER.readValue(VPackUtils.toVPack("\"12.57\""), FactoryFromDecimalString.class);
        assertNotNull(result);
