...
public class ConstructorDetectorTest extends DatabindTestUtil
{
    ...
    {
        SingleArgNotAnnotated value = MAPPER_PROPS.readValue(VPackUtils.toVPack(a2q("{'value' : 137 }")),
    ...
    {
        SingleArgNotAnnotated value = MAPPER_PROPS.readValue(VPackUtils.toVPack(a2q("{'value' : 137.0 }")),
            SingleArgNotAnnotated.class);
        assertEquals(137, value.v);
    }
    ...
    {
        SingleArgByte value = MAPPER_PROPS.readValue(VPackUtils.toVPack(a2q("{'value' : -99 }")),
            SingleArgByte.class);
    ...
    {
        SingleArgShort value = MAPPER_PROPS.readValue(VPackUtils.toVPack(a2q("{'value' : 137 }")),
    ...
    public void test1ArgDefaultsToPropertiesLong() throws Exception
    {
        ...
        SingleArgLong value = MAPPER_PROPS.readValue(VPackUtils.toVPack(a2q("{'value' : " + val + " }")),
            SingleArgLong.class);
    ...
    {
        SingleArgFloat value = MAPPER_PROPS.readValue(VPackUtils.toVPack(a2q("{'value' : 136.99 }")),
    ...
    {
        SingleArgDouble value = MAPPER_PROPS.readValue(VPackUtils.toVPack(a2q("{'value' : 999999999999999999.99 }")),
    ...
    {
        SingleArgNoMode value = MAPPER_PROPS.readValue(VPackUtils.toVPack(a2q("{'value' : 137 }")),
    ...
    {
        SingleArg1498 value = MAPPER_PROPS.readValue(VPackUtils.toVPack(a2q("{'bar' : 404 }")),
                SingleArg1498.class);
    ...
    {
        TwoArgsNotAnnotated value = MAPPER_PROPS.readValue(VPackUtils.toVPack(a2q("{'a' : 3, 'b':4 }")),
    ...
    public void test1ArgDefaultsToPropsMultipleCtors() throws Exception
    {
        ...
        try {
            MAPPER_PROPS.readerFor(SingleArg2CtorsNotAnnotated.class)
                    ...
                    .readValue(VPackUtils.toVPack(a2q("{'value' : 137 }")));
    ...
    public void test1ArgDefaultsToDelegatingNoAnnotation() throws Exception
    {
        ...
        SingleArgNotAnnotated value = MAPPER_DELEGATING.readValue(VPackUtils.toVPack("1972"), SingleArgNotAnnotated.class);
    ...
    public void test1ArgDefaultsToDelegatingNoMode() throws Exception
    {
        ...
        SingleArgNoMode value = MAPPER_DELEGATING.readValue(VPackUtils.toVPack(" 2812 "), SingleArgNoMode.class);
    ...
    public void test1ArgDefaultsToHeuristics() throws Exception
    {
        ...
        SingleArgNotAnnotated v1 = mapper.readValue(VPackUtils.toVPack(DOC), SingleArgNotAnnotated.class);
        assertEquals(13117, v1.v);

        // and ditto for mode-less
        SingleArgNoMode v2 = mapper.readValue(VPackUtils.toVPack(DOC), SingleArgNoMode.class);
...
/*
    public void test1ArgFailsNoAnnotation() throws Exception
    {
        ...
        try {
            MAPPER_EXPLICIT.readValue(VPackUtils.toVPack(" 2812 "), SingleArgNotAnnotated.class);
            fail("Should not pass");
        } catch (InvalidDefinitionException e) {
    ...
    */
    ...
    public void test1ArgFailsNoMode() throws Exception
    {
        ...
        try {
            MAPPER_EXPLICIT.readValue(VPackUtils.toVPack(" 2812 "), SingleArgNoMode.class);
            fail("Should not pass");
        } catch (InvalidDefinitionException e) {
    ...
    public void test1ArgRequiresAnnotation() throws Exception
    {
        ...
        SingleArgNotAnnotated value = MAPPER_MUST_ANNOTATE.readValue(VPackUtils.toVPack("{ }"),
                SingleArgNotAnnotated.class);
        assertEquals(new SingleArgNotAnnotated().v, value.v);

        // But if no such ctor, will fail
        try {
            MAPPER_MUST_ANNOTATE.readValue(VPackUtils.toVPack(" { } "), SingleArg1498.class);
            fail("Should not pass");
        } catch (InvalidDefinitionException e) {
    ...
    {
        try {
            MAPPER_MUST_ANNOTATE.readValue(VPackUtils.toVPack(" { } "), TwoArgsNotAnnotated.class);
            fail("Should not pass");
        } catch (InvalidDefinitionException e) {
            verifyException(e, "no Creators, like default constructor");
        }
    ...
    void nullHandlingCreator3241() throws Exception {
        ...
        try {
            mapper.readValue(VPackUtils.toVPack("{ \"field\": null }"), Input3241.class);
    ...
    {
        Foo4860 result = mapper.readValue(VPackUtils.toVPack(input), Foo4860.class);
        assertEquals(output, VPackUtils.toJson(mapper.writeValueAsBytes(result)));
    }
    ...
    private VPackMapper.Builder mapperBuilder() {
