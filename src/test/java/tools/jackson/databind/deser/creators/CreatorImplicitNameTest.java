    ...
    extends DatabindTestUtil
{
    ...
    public void testBindingOfImplicitCreatorNames() throws Exception
    {
        ObjectMapper m = vpackMapperBuilder()
                ...
                .build();
        String json = VPackUtils.toJson(m.writeValueAsBytes(new Issue792Bean("a", "b")));
    ...
    {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new Bean2()));
    ...
    {
        PasswordBean bean = MAPPER.readValue(VPackUtils.toVPack(a2q("{'value':7,'password':'foo'}")),
                PasswordBean.class);
    ...
    {
        final ObjectMapper mapper4545 = vpackMapperBuilder()
        ...
        try {
            mapper4545.readerFor(Payload4545.class)
                    ...
                    .readValue(VPackUtils.toVPack(jsonPayload));
