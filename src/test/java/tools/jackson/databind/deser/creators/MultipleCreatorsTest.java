    ...
    extends DatabindTestUtil
{
    ...
    public void testThatPropertiesCreatorIsUsed() throws Exception
    {
        ...
        OuterBean4602 result = MAPPER.readValue(VPackUtils.toVPack(json), OuterBean4602.class);
    ...
    {
        OuterBean4602 result = MAPPER.readValue(VPackUtils.toVPack("{ \"bean\": [ \"a\", \"b\", \"c\"] }"),
                OuterBean4602.class);
    ...
    {
        ExampleDto2962 result = MAPPER.readValue(VPackUtils.toVPack("42"), ExampleDto2962.class);
