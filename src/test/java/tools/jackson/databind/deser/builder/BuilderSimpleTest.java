...
public class BuilderSimpleTest
{
    ...
    {
        Object o = MAPPER.readValue(VPackUtils.toVPack(a2q("{'x':1,'y':2}")), ValueClassXY.class);
    ...
    public void testSimpleWrapper() throws Exception
    {
        ValueClassXYWrapper w = MAPPER
                ...
                .readValue(VPackUtils.toVPack(a2q("{'xy': {'x':1, 'foo':3, 'y':2, 'bar':'abc'}}")));
        // note: ctor adds one to both values
    ...
    public void testSimpleWithIgnores() throws Exception
    {
        ...
        try {
            o = MAPPER.readValue(VPackUtils.toVPack(json), ValueClassXY.class);
    ...
    public void testMultiAccess() throws Exception
    {
        ...
        ValueClassABC value = MAPPER.readValue(VPackUtils.toVPack(json), ValueClassABC.class);
        assertNotNull(value);
        ...
        value = MAPPER.readValue(VPackUtils.toVPack(a2q("{'c':3,'d':5,'b':-9}")), ValueClassABC.class);
        assertNotNull(value);
    ...
    public void testImmutable() throws Exception
    {
        ...
        ValueImmutable value = MAPPER.readValue(VPackUtils.toVPack(json), ValueImmutable.class);
    ...
    public void testCustomWith() throws Exception
    {
        ...
        ValueFoo value = MAPPER.readValue(VPackUtils.toVPack(json), ValueFoo.class);
    ...
    public void testBuilderMethodReturnMoreGeneral() throws Exception
    {
        ...
        ValueInterface value = MAPPER.readValue(VPackUtils.toVPack(json), ValueInterface.class);
    ...
    {
        final String json = "{\"x\":1}";
        ValueInterface2 value = MAPPER.readValue(VPackUtils.toVPack(json), ValueInterface2.class);
        assertEquals(2, value.getX());
    }
    ...
    {
        SelfBuilder777 result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'x':3}")),
    ...
    public void testWithAnySetter822() throws Exception
    {
        ...
        ValueClass822 value = MAPPER.readValue(VPackUtils.toVPack(json), ValueClass822.class);
    ...
    public void testPOJOConfigResolution1557() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        ValueFoo value = mapper.readValue(VPackUtils.toVPack("{\"value\":1}"), ValueFoo.class);
        assertEquals(1, value.value);
    }
    ...
    public void testPrivateInnerBuilder() throws Exception
    {
        ...
        Value2354 result = MAPPER.readValue(VPackUtils.toVPack(json), Value2354.class);
