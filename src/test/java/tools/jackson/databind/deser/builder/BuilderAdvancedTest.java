...
public class BuilderAdvancedTest extends DatabindTestUtil
{
    ...
    public void testWithInjectable() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        InjectableXY bean = mapper.readValue(VPackUtils.toVPack(a2q("{'y':3,'x':7}")),
                InjectableXY.class);
    ...
    public void testWithExternalTypeId() throws Exception
    {
        ...
        ExternalBean2580 result = mapper.readValue(VPackUtils.toVPack(json), ExternalBean2580.class);
