...
public class BuilderWithCreatorTest
{
    ...
    public void testWithPropertiesCreator() throws Exception
    {
        ...
        PropertyCreatorValue value = MAPPER.readValue(VPackUtils.toVPack(json), PropertyCreatorValue.class);
    ...
    {
        final int EXP = 139;
        IntCreatorValue value = MAPPER.readValue(VPackUtils.toVPack(String.valueOf(EXP)),
    ...
    public void testWithDelegatingIntCreator() throws Exception
    {
        ...
        DoubleCreatorValue value = MAPPER.readValue(VPackUtils.toVPack(String.valueOf(EXP)),
    ...
    public void testWithDelegatingBooleanCreator() throws Exception
    {
        ...
        BooleanCreatorValue value = MAPPER.readValue(VPackUtils.toVPack(String.valueOf(EXP)),
