...
public class BuilderDeserializationTest2486
{
    ...
    public void testPOJOWithArrayCreatorFromObjectRepresentation() throws Exception {
        ...
        final MyPOJOWithArrayCreator deserialized = MAPPER.readValue(VPackUtils.toVPack(json), MyPOJOWithArrayCreator.class);
    ...
    public void testPOJOWithPrimitiveCreatorFromObjectRepresentation() throws Exception {
        final String json = a2q("{ 'index': 123 }");
        final MyPOJOWithPrimitiveCreator deserialized = MAPPER.readValue(VPackUtils.toVPack(json), MyPOJOWithPrimitiveCreator.class);
        assertEquals(123, deserialized.getIndex());
    }
    ...
    public void testPOJOBuilderWithArrayCreatorFromObjectRepresentation() throws Exception {
        final String json = a2q("{ 'index': 123 }");
        final MyPOJOWithArrayCreator.Builder deserialized = MAPPER.readValue(VPackUtils.toVPack(json), MyPOJOWithArrayCreator.Builder.class);
    ...
    public void testPOJOBuilderWithPrimitiveCreatorFromObjectRepresentation() throws Exception {
        final String json = a2q("{ 'index': 123 }");
        final MyPOJOWithPrimitiveCreator.Builder deserialized = MAPPER.readValue(VPackUtils.toVPack(json), MyPOJOWithPrimitiveCreator.Builder.class);
        assertEquals(123, deserialized.index);
    }
