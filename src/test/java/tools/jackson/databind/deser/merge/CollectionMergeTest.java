...
public class CollectionMergeTest
{
    ...
    {
        CollectionWrapper w = MAPPER.readValue(VPackUtils.toVPack(a2q("{'bag':['b']}")), CollectionWrapper.class);
    ...
    {
        MergedList w = MAPPER.readValue(VPackUtils.toVPack(a2q("{'values':['x']}")), MergedList.class);
    ...
    {
        MergedEnumSet result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'abc':['A']}")), MergedEnumSet.class);
