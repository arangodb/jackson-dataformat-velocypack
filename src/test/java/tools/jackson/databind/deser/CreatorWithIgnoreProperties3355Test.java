    ...
    extends DatabindTestUtil
{
    ...
    public void testDeserFailing() throws Exception
    {
        ...
        Common3355 object = MAPPER.readValue(VPackUtils.toVPack(objectJson), Common3355.class);
        ContainerFail3355 container = MAPPER.readValue(VPackUtils.toVPack(containersJson), ContainerFail3355.class);
    ...
    public void testDeserPassing() throws Exception
    {
        ...
        final ContainerFail3355 container = MAPPER.readValue(VPackUtils.toVPack(containersJson), ContainerFail3355.class);
        final Common3355 object = MAPPER.readValue(VPackUtils.toVPack(objectJson), Common3355.class);
