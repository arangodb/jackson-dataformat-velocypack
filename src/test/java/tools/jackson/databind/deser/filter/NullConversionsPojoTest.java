...
public class NullConversionsPojoTest
{
    ...
    public void testFailOnNull() throws Exception
    {
        ...
        NullFail result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'noNulls':'foo', 'nullsOk':null}")),
                NullFail.class);
        ...
        try {
            result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'noNulls':null}")),
                    NullFail.class);
        ...
        try {
            /* NullFailCtor r =*/ MAPPER.readValue(VPackUtils.toVPack(a2q("{'noNulls':null}")),
                    NullFailCtor.class);
            fail("Should not pass");
        } catch (InvalidNullException e) {
            verifyException(e, "property \"noNulls\"");
        ...
        try {
            /* NullFailCtor r =*/ MAPPER.readValue(VPackUtils.toVPack("{ }"), NullFailCtor.class);
            fail("Should not pass");
        } catch (InvalidNullException e) {
            verifyException(e, "property \"noNulls\"");
        }
    ...
    public void testFailOnNullWithDefaults() throws Exception
    {
        ...
        NullsForString def = MAPPER.readValue(VPackUtils.toVPack(json), NullsForString.class);
        ...
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        try {
            mapper.readValue(VPackUtils.toVPack(json), NullsForString.class);
            fail("Should not pass");
        } catch (InvalidNullException e) {
    ...
    {
        NullAsEmpty result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'nullAsEmpty':'foo', 'nullsOk':null}")),
                NullAsEmpty.class);
        assertEquals("foo", result.nullAsEmpty);
        assertNull(result.nullsOk);

        // and then see that nulls are not ok for non-nullable
        result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'nullAsEmpty':null}")),
                NullAsEmpty.class);
        ...
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        NullsForString named = mapper.readValue(VPackUtils.toVPack(json), NullsForString.class);
    ...
    {
        NullAsEmptyCtor result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'nullAsEmpty':'foo', 'nullsOk':null}")),
        ...
        result = MAPPER.readValue(VPackUtils.toVPack(a2q("{}")), NullAsEmptyCtor.class);
        assertEquals("", result._nullAsEmpty);
    }
    ...
    public void testDeserializeMissingCollectionFieldAsEmpty() throws Exception {
        ...
        Issue3645BeanA actual = MAPPER.readValue(VPackUtils.toVPack(json), Issue3645BeanA.class);
