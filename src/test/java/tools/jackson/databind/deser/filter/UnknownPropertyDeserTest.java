...
public class UnknownPropertyDeserTest extends DatabindTestUtil
{
    ...
    public void testUnknownHandlingDefault() throws Exception
    {
        try {
            MAPPER.readerFor(TestBean.class)
                    ...
                    .readValue(VPackUtils.toVPack(JSON_UNKNOWN_FIELD));
    ...
    public void testUnknownHandlingIgnoreWithHandler() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        TestBean result = mapper.readValue(VPackUtils.toVPack(JSON_UNKNOWN_FIELD), TestBean.class);
    ...
    {
        IgnoreSome result = MAPPER.readValue(VPackUtils.toVPack("{ \"a\":1,\"b\":2,\"c\":\"x\",\"d\":\"y\"}"),
                IgnoreSome.class);
    ...
    public void testClassWithIgnoreUnknown() throws Exception
    {
        IgnoreUnknown result = MAPPER.readValue
            (VPackUtils.toVPack("{\"b\":3,\"c\":[1,2],\"x\":{ },\"a\":-3}"), IgnoreUnknown.class);
    ...
    {
        IgnoreUnknownAnySetter value = MAPPER.readValue(VPackUtils.toVPack("{\"x\":\"y\", \"a\":\"b\"}"),  IgnoreUnknownAnySetter.class);
        assertNotNull(value);
    ...
    {
      IgnoreUnknownUnwrapped value = MAPPER.readValue(VPackUtils.toVPack("{\"a\":1, \"b\":2}"),  IgnoreUnknownUnwrapped.class);
      assertNotNull(value);
    ...
    public void testClassWithUnknownAndIgnore() throws Exception
    {
        ...
        ImplicitIgnores result = MAPPER.readValue
            (VPackUtils.toVPack("{\"a\":1,\"b\":2,\"c\":3 }"), ImplicitIgnores.class);
        assertEquals(3, result.c);

        // but "d" is not defined, so should still error
        try {
            MAPPER.readValue(VPackUtils.toVPack("{\"a\":1,\"b\":2,\"c\":3,\"d\":4 }"), ImplicitIgnores.class);
    ...
    {
        XYZWrapper1 result = MAPPER.readValue(VPackUtils.toVPack("{\"value\":{\"y\":2,\"x\":1,\"z\":3}}"), XYZWrapper1.class);
    ...
    {
        XYZWrapper2 result = MAPPER.readValue(VPackUtils.toVPack("{\"value\":{\"y\":2,\"x\":1,\"z\":3}}"),
                XYZWrapper2.class);
    ...
    {
        MapWithoutX result = MAPPER.readValue(VPackUtils.toVPack("{\"values\":{\"x\":1,\"y\":2}}"), MapWithoutX.class);
    ...
    {
        ObjectMapper vpackMapper = vpackMapperBuilder()
        ...
        List<Bean987> deserializedList = vpackMapper.readValue(VPackUtils.toVPack(input),
