 ...
 */
public class VPackIgnoreProperties1622Test
    extends DatabindTestUtil
{
    ...
    */
    ...
    public void raceConditionWithChildFirst() throws Exception
    {
        ...
        String parentJson = VPackUtils.toJson(MAPPER.writeValueAsBytes(parent));
        String childJson = VPackUtils.toJson(MAPPER.writeValueAsBytes(child));

        // Deserialize child first - this triggers the race condition
        Child deserializedChild = MAPPER.readValue(VPackUtils.toVPack(childJson), Child.class);
        ...
        Parent deserializedParent = MAPPER.readValue(VPackUtils.toVPack(parentJson), Parent.class);
    ...
    public void workaroundWithAllowSetters() throws Exception
    {
        ...
        ChildForWorkaround deserializedChild = MAPPER.readValue(VPackUtils.toVPack(childJson), ChildForWorkaround.class);
        assertNotNull(deserializedChild);
        assertEquals("Child1", deserializedChild.getName());

        // Now deserialize parent - should work with allowSetters workaround
        ParentWithWorkaround deserializedParent = MAPPER.readValue(VPackUtils.toVPack(parentJson), ParentWithWorkaround.class);
        assertNotNull(deserializedParent);
        assertEquals("Parent1", deserializedParent.getName());
        assertEquals(1, deserializedParent.getChildren().size());
        assertEquals("Child1", deserializedParent.getChildren().get(0).getName());
    ...
    public void testJsonCreatorWithIgnoreProperties() throws Exception {
        ...
        ChildWithCreator child = MAPPER.readValue(VPackUtils.toVPack(json), ChildWithCreator.class);
    ...
    public void testBuilderWithIgnoreProperties() throws Exception {
        ...
        ChildWithBuilder child = MAPPER.readValue(VPackUtils.toVPack(json), ChildWithBuilder.class);
    ...
    public void testMultiLevelNestedWithIgnoreProperties() throws Exception {
        ...
        ParentNested parent = MAPPER.readValue(VPackUtils.toVPack(json), ParentNested.class);
    ...
    public void testRecordWithIgnoreProperties() throws Exception {
        ...
        ChildRecord child = MAPPER.readValue(VPackUtils.toVPack(json), ChildRecord.class);
