...
public class NullConversionsSkipTest {
    ...
    public void testSkipNullField() throws Exception
    {
        ...
        NullSkipField result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'noNulls':'foo', 'nullsOk':null}")),
                NullSkipField.class);
    ...
    {
        NullSkipMethod result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'noNulls':'foo', 'nullsOk':null}")),
    ...
    public void testEnumAsNullThenSkip() throws Exception
    {
        Pojo2015 p = MAPPER.readerFor(Pojo2015.class)
                ...
                .readValue(VPackUtils.toVPack("{\"number\":\"THREE\"}"));
    ...
    public void testSkipNullWithDefaults() throws Exception
    {
        ...
        StringValue result = MAPPER.readValue(VPackUtils.toVPack(json), StringValue.class);
        ...
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        result = mapper.readValue(VPackUtils.toVPack(json), StringValue.class);
