...
public class NullConversionsForEnumsTest
{
    ...
    {
        NullValueAsEmpty<EnumSet<ABC>> result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'value': null }")),
    ...
    {
        NullValueAsEmpty<EnumMap<ABC, String>> result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'value': null }")),
    ...
    {
        NullContentAsEmpty<EnumMap<ABC, String>> result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'values': {'B':null} }")),
    ...
    {
        NullContentSkip<EnumSet<ABC>> result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'values': [ null ]}")),
    ...
    {
        NullContentSkip<EnumMap<ABC, String>> result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'values': {'B':null} }")),
