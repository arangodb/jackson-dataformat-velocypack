...
public class JacksonTypesDeserTest
{
    ...
    public void testTokenStreamLocation() throws Exception
    {
        ...
        String ser = VPackUtils.toJson(MAPPER.writer()
                .writeValueAsBytes(loc));
        TokenStreamLocation result = MAPPER.readValue(VPackUtils.toVPack(ser), TokenStreamLocation.class);
...
//        assertEquals(loc.getSourceRef(), result.getSourceRef());
    ...
    public void testJavaType() throws Exception
    {
        ...
        // first simple type:
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(tf.constructType(String.class)));
        assertEquals(q(String.class.getName()), json);
        // and back
        JavaType t = MAPPER.readValue(VPackUtils.toVPack(json), JavaType.class);
        assertNotNull(t);
    ...
    public void testTokenBufferWithSample() throws Exception
    {
        ...
        try (TokenBuffer result = MAPPER.readValue(VPackUtils.toVPack(SAMPLE_DOC_JSON_SPEC), TokenBuffer.class)) {
    ...
    public void testTokenBufferWithSequence() throws Exception
    {
        ...
        JsonParser p = mapper.createParser(VPackUtils.toVPack("[ 32, [ 1 ], \"abc\", { \"a\" : true } ]"));
    ...
    public void testDeeplyNestedArrays() throws Exception
    {
        VPackFactory jsonFactory = VPackFactory.builder()
                ...
                .build();
        try (JsonParser p = VPackMapper.builder(jsonFactory).build().createParser(VPackUtils.toVPack(
