...
public class MapEntryDeserializationTest extends DatabindTestUtil
{
    ...
    {
        Map.Entry<String, Integer> result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'foo':42}")),
    ...
    {
        Map.Entry<String, String> result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'key':'value'}")),
    ...
    {
        Map.Entry<Integer, String> result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'123':'hello'}")),
    ...
    {
        Map.Entry<String, String> result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'key':null}")),
                new TypeReference<Map.Entry<String, String>>() { });
        assertNotNull(result);
        assertEquals("key", result.getKey());
    ...
    public void testEntryInHolder() throws Exception
    {
        EntryHolder result = MAPPER.readValue(
                VPackUtils.toVPack(a2q("{'entry':{'abc':99}}")), EntryHolder.class);
        assertNotNull(result);
    ...
    {
        try {
            MAPPER.readValue(VPackUtils.toVPack(a2q("{}")),
                    new TypeReference<Map.Entry<String, Integer>>() { });
    ...
    {
        try {
            MAPPER.readValue(VPackUtils.toVPack(a2q("{'a':1,'b':2}")),
                    new TypeReference<Map.Entry<String, Integer>>() { });
    ...
    {
        List<Map.Entry<String, Integer>> result = MAPPER.readValue(VPackUtils.toVPack(a2q("[{'a':1},{'b':2},{'c':3}]")),
    ...
    {
        Map.Entry<String, StringWrapper> result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'key':{'str':'wrapped'}}")),
    ...
    {
        Map.Entry<String, List<Integer>> result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'nums':[1,2,3]}")),
    ...
    public void testPojoWrappedFormat() throws Exception
    {
        PojoFormatEntryHolder result = MAPPER.readValue(
                VPackUtils.toVPack(a2q("{'entry':{'key':'myKey','value':55}}")),
    ...
    {
        PojoFormatEntryHolder result = MAPPER.readValue(
                VPackUtils.toVPack(a2q("{'entry':{'key':'k','value':null}}")),
                PojoFormatEntryHolder.class);
        assertNotNull(result);
        assertNotNull(result.entry);
    ...
    {
        PojoFormatEntryHolder result = MAPPER.readValue(
                VPackUtils.toVPack(a2q("{'entry':{'key':null,'value':10}}")),
                PojoFormatEntryHolder.class);
        assertNotNull(result);
        assertNotNull(result.entry);
    ...
    public void testRoundTrip() throws Exception
    {
        ...
        Map.Entry<String, Integer> result = MAPPER.readValue(VPackUtils.toVPack(json),
                new TypeReference<Map.Entry<String, Integer>>() { });
        assertNotNull(result);
