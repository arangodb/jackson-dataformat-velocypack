...
//        public BrokenMap(boolean dummy, boolean dummy2) { super(); }
    ...
    public void testBigUntypedMap() throws Exception
    {
        ...
        Object bound = MAPPER.readValue(VPackUtils.toVPack(json), Object.class);
    ...
    public void testUntypedMap2() throws Exception
    {
        ...
        HashMap<String,Object> result = /*(HashMap<String,Object>)*/ MAPPER.readValue(VPackUtils.toVPack(JSON), HashMap.class);
    ...
    {
        final ObjectWrapperMap map = MAPPER.readValue(VPackUtils.toVPack(UNTYPED_MAP_JSON), ObjectWrapperMap.class);
        assertNotNull(map);
        _doTestUntyped(map);
    }
    ...
    public void testGenericMap() throws IOException
    {
        final Map<String, ObjectWrapper> map = MAPPER.readValue
            (VPackUtils.toVPack(UNTYPED_MAP_JSON),
    ...
    public void testFromEmptyString() throws Exception
    {
        ObjectMapper m = vpackMapperBuilder()
                ...
                .build();
        Map<?,?> result = m.readValue(VPackUtils.toVPack(q("")), Map.class);
        assertNull(result);
    }
    ...
    public void testExactStringIntMap() throws Exception
    {
        ...
        Map<String,Integer> result = MAPPER.readValue
            (VPackUtils.toVPack(JSON), new TypeReference<HashMap<String,Integer>>() { });
    ...
    public void testIntBooleanMap() throws Exception
    {
        ...
        Map<?,?> result = MAPPER.readValue
            (VPackUtils.toVPack(JSON), new TypeReference<HashMap<Integer,Boolean>>() { });
        assertNotNull(result);
        assertEquals(HashMap.class, result.getClass());
    ...
    public void testExactStringStringMap() throws Exception
    {
        ...
        Map<String,String> result = MAPPER.readValue
            (VPackUtils.toVPack(JSON), new TypeReference<TreeMap<String,String>>() { });
    ...
    public void testGenericStringIntMap() throws Exception
    {
        ...
        Map<String,Integer> result = MAPPER.readValue
            (VPackUtils.toVPack(JSON), new TypeReference<Map<String,Integer>>() { });
        assertNotNull(result);
        assertInstanceOf(Map.class, result);
        assertEquals(3, result.size());
    ...
    {
        final AbstractMapWrapper result = MAPPER.readValue(VPackUtils.toVPack("{\"values\":{\"foo\":42}}"),
    ...
    public void testMapUpdate()
    {
        ...
        result = MAPPER.readerFor(Map.class)
                .withValueToUpdate(map)
                .readValue(VPackUtils.toVPack("{\"key\": null }"));
        assertSame(map, result);
        ...
        result = MAPPER.readerFor(Map.class)
                .withValueToUpdate(map)
                .readValue(VPackUtils.toVPack("{\"key\": false }"));
        assertSame(map, result);
        assertEquals(1, map.size());
    ...
    public void testEnumMap() throws Exception
    {
        ...
        EnumMap<CollectionDeserializationTest.Key,String> result = MAPPER.readValue
            (VPackUtils.toVPack(JSON), new TypeReference<EnumMap<CollectionDeserializationTest.Key,String>>() { });
    ...
    public void testMapWithEnums() throws Exception
    {
        ...
        // to get typing, must use type reference
        Map<?,?> result = MAPPER.readValue(VPackUtils.toVPack(JSON), new TypeReference<Map<CollectionDeserializationTest.Key,CollectionDeserializationTest.Key>>() { });
    ...
    public void testEnumPolymorphicSerializationTest() throws Exception
    {
        ...
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(listContainer));
        listContainer = mapper.readValue(VPackUtils.toVPack(json), ListContainer.class);
        ...
        json = VPackUtils.toJson(mapper.writeValueAsBytes(enumMapContainer));
        enumMapContainer = mapper.readValue(VPackUtils.toVPack(json), EnumMapContainer.class);
    }
    ...
    public void testDateMap() throws Exception
    {
    	 ...
    	 HashMap<Date,String> result=  MAPPER.readValue
    	            (VPackUtils.toVPack(JSON), new TypeReference<HashMap<Date,String>>() { });
    ...
    public void testCalendarMap() throws Exception
    {
        ...
        HashMap<Calendar,String> result = MAPPER.readValue
                (VPackUtils.toVPack(JSON), new TypeReference<HashMap<Calendar,String>>() { });
    ...
    public void testUUIDKeyMap() throws Exception
    {
         ...
         String JSON = "{ \""+key+"\":4}";
         Map<UUID,Object> result = MAPPER.readValue(VPackUtils.toVPack(JSON), new TypeReference<Map<UUID,Object>>() { });
         assertNotNull(result);
         assertEquals(1, result.size());
    ...
    public void testLocaleKeyMap() throws Exception {
        ...
        String JSON = "{ \"" + key + "\":4}";
        Map<Locale, Object> result = MAPPER.readValue(VPackUtils.toVPack(JSON), new TypeReference<Map<Locale, Object>>() {
        });
        assertNotNull(result);
        assertEquals(1, result.size());
        Object ob = result.keySet().iterator().next();
    ...
    public void testCurrencyKeyMap() throws Exception {
        ...
        String JSON = "{ \"" + key + "\":4}";
        Map<Currency, Object> result = MAPPER.readValue(VPackUtils.toVPack(JSON), new TypeReference<Map<Currency, Object>>() {
        });
        assertNotNull(result);
        assertEquals(1, result.size());
        Object ob = result.keySet().iterator().next();
    ...
    public void testKeyWithCreator() throws Exception
    {
        ...
        KeyType key = MAPPER.readValue(VPackUtils.toVPack(q("abc")), KeyType.class);
        assertEquals("abc", key.value);

        Map<KeyType,Integer> map = MAPPER.readValue(VPackUtils.toVPack("{\"foo\":3}"), new TypeReference<Map<KeyType,Integer>>() {} );
        assertEquals(1, map.size());
    ...
    public void testClassKeyMap() throws Exception {
        ClassStringMap map = MAPPER.readValue(VPackUtils.toVPack(a2q("{'java.lang.String':'foo'}")),
    ...
    public void testcharSequenceKeyMap() throws Exception {
        String JSON = a2q("{'a':'b'}");
        Map<CharSequence,String> result = MAPPER.readValue(VPackUtils.toVPack(JSON), new TypeReference<Map<CharSequence,String>>() { });
        assertNotNull(result);
        assertEquals(1, result.size());
        assertEquals("b", result.get("a"));
    }
    ...
    {
        CustomMap result = MAPPER.readValue(VPackUtils.toVPack(q("xyz")), CustomMap.class);
        assertEquals(1, result.size());
    ...
    public void testMapError() throws Exception
    {
        ...
        try {
            Object result = MAPPER.readValue(VPackUtils.toVPack("[ 1, 2 ]"), TYPE);
        ...
        try {
            Object result = MAPPER.readValue(VPackUtils.toVPack("true"), TYPE);
            fail("Expected an exception, but got result value: "+result);
        } catch (MismatchedInputException jex) {
        ...
        try {
            Object result = MAPPER.readerFor(TYPE)
                    .withValueToUpdate(map)
                    .readValue(VPackUtils.toVPack("true"));
            fail("Expected an exception, but got result value: "+result);
        } catch (MismatchedInputException jex) {
            verifyException(jex, "from Boolean value (token `JsonToken.VALUE_TRUE`)");
        }
    ...
    {
        try {
            /*BrokenMap result =*/ MAPPER.readValue(VPackUtils.toVPack("{ \"a\" : 3 }"), BrokenMap.class);
    ...
    public void testCanDeserializeMap2757() throws Exception
    {
        ...
        MyMap2757 x = MAPPER.readValue(VPackUtils.toVPack(json), MyMap2757.class);
