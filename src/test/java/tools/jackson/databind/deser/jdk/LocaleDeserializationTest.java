...
public class LocaleDeserializationTest
{
    ...
    public void testLocale() throws Exception
    {
        ...
        assertEquals(new Locale("en"),
                MAPPER.readValue(VPackUtils.toVPack(q("en")), Locale.class));
    }
    ...
    public void testLocaleTwoPart() throws IOException
    {
        ...
        assertEquals(new Locale("es", "ES"),
                MAPPER.readValue(VPackUtils.toVPack(q("es-ES")), Locale.class));
        assertEquals(new Locale("es", "ES"),
                MAPPER.readValue(VPackUtils.toVPack(q("es_ES")), Locale.class));
        assertEquals(new Locale("en", "US"),
                MAPPER.readValue(VPackUtils.toVPack(q("en-US")), Locale.class));
        assertEquals(new Locale("en", "US"),
                MAPPER.readValue(VPackUtils.toVPack(q("en_US")), Locale.class));

        assertEquals(Locale.CHINA,
                MAPPER.readValue(VPackUtils.toVPack(q("zh-CN")), Locale.class));
        assertEquals(Locale.CHINA,
                MAPPER.readValue(VPackUtils.toVPack(q("zh_CN")), Locale.class));
    }

    public void testLocaleThreePart() throws IOException
    {
        assertEquals(new Locale("FI", "fi", "savo"),
                MAPPER.readValue(VPackUtils.toVPack(q("fi_FI_savo")), Locale.class));
    }
    ...
    public void testLocaleDeserializeNonBCPFormat1() throws Exception
    {
        ...
        Locale deSerializedLocale = MAPPER.readValue(VPackUtils.toVPack(VPackUtils.toJson(MAPPER.writeValueAsBytes(locale))), Locale.class);
        assertBaseValues(locale, deSerializedLocale);

        locale = new Locale("en");
        deSerializedLocale = MAPPER.readValue(VPackUtils.toVPack(VPackUtils.toJson(MAPPER.writeValueAsBytes(locale))), Locale.class);
        assertBaseValues(locale, deSerializedLocale);
    ...
    public void testLocaleDeserializeNonBCPFormat2() throws Exception
    {
        ...
        deSerializedLocale = MAPPER.readValue(VPackUtils.toVPack(VPackUtils.toJson(MAPPER.writeValueAsBytes(locale))),
                Locale.class);
        assertBaseValues(locale, deSerializedLocale);
    ...
    public void testLocaleDeserializeWithExtension() throws Exception {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(locale));
        Locale deSerializedLocale = MAPPER.readValue(VPackUtils.toVPack(json), Locale.class);
    ...
    public void testLocaleVarargMultiple5231() {
        ...
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(cfg));

        DateTimeParserConfig5231 result = mapper.readValue(VPackUtils.toVPack(json), DateTimeParserConfig5231.class);
