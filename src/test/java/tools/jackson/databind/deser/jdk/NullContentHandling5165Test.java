    ...
    extends DatabindTestUtil
{
    ...
    public void testNullsFail_Collection() {
        ...
        assertThrows(
                ...
                () -> mapper.readValue(VPackUtils.toVPack("{\"list\":[\"\"]}"), new TypeReference<CollectionDst>(){})
        );
    }
    ...
    public void testNullsSkip_Collection() throws Exception {
        ...
        CollectionDst dst = mapper.readValue(VPackUtils.toVPack("{\"list\":[\"\"]}"), new TypeReference<CollectionDst>() {});
    ...
    public void testNullsFail_Map() {
        ...
        assertThrows(
                InvalidNullException.class,
                () -> mapper.readValue(VPackUtils.toVPack("{\"map\":{\"key\":\"\"}}"), new TypeReference<MapDst>(){})
        );
    }
    ...
    public void testNullsSkip_Map() throws Exception {
        ObjectMapper mapper = VPackMapper.builder()
                .changeDefaultNullHandling(n -> JsonSetter.Value.forContentNulls(Nulls.SKIP))
                .build();
        MapDst dst = mapper.readValue(VPackUtils.toVPack("{\"map\":{\"key\":\"\"}}"), new TypeReference<MapDst>() {});
    ...
    public void testNullsFail_ObjectArray() {
        ...
        assertThrows(
                InvalidNullException.class,
                () -> mapper.readValue(VPackUtils.toVPack("{\"array\":[\"\"]}"), ObjectArrayDst.class)
        );
    }
    ...
    public void testNullsSkip_ObjectArray() throws Exception {
        ...
        ObjectArrayDst dst = mapper.readValue(VPackUtils.toVPack("{\"array\":[\"\"]}"), ObjectArrayDst.class);
        // NOTE! Relies on default coercion of "" into `null` for `Integer`s...
    ...
    public void testNullsVanilla_StringArray() {
        ...
        String[] arr = mapper.readValue(VPackUtils.toVPack("[ ]"), String[].class);
        assertEquals(0, arr.length);

        arr = mapper.readValue(VPackUtils.toVPack("[null ]"), String[].class);
        assertEquals(1, arr.length);
        assertNull(arr[0]);

        arr = mapper.readValue(VPackUtils.toVPack("[ \"abc\", null ]"), String[].class);
    ...
    public void testNullsFail_StringArray() {
        ...
        assertThrows(
                InvalidNullException.class,
                () -> mapper.readValue(VPackUtils.toVPack("{\"array\":[\"\"]}"), StringArrayDst.class)
        );
    }
    ...
    public void testNullsSkip_StringArray() throws Exception {
        ...
        StringArrayDst dst = mapper.readValue(VPackUtils.toVPack("{\"array\":[\"\"]}"), StringArrayDst.class);
        assertEquals(0, dst.array.length, "Null values should be skipped");
    }
    ...
    public void testNullsFail_StringCollection() {
        ...
        assertThrows(
                InvalidNullException.class,
                () -> mapper.readValue(VPackUtils.toVPack("{\"list\":[\"\"]}"), StringCollectionDst.class)
        );
    }
    ...
    public void testNullsSkip_StringCollection() throws Exception {
        ...
        StringCollectionDst dst = mapper.readValue(VPackUtils.toVPack("{\"list\":[\"\"]}"), StringCollectionDst.class);
