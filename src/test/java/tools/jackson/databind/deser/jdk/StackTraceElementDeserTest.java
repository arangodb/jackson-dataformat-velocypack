...
public class StackTraceElementDeserTest extends DatabindTestUtil
{
    ...
    public void testBasicStackTraceElement() throws Exception
    {
        ...
        StackTraceElement result = MAPPER.readValue(VPackUtils.toVPack(json), StackTraceElement.class);
    ...
    public void testWithEmptyObject() throws Exception
    {
        ...
        StackTraceElement result = MAPPER.readValue(VPackUtils.toVPack("{}"), StackTraceElement.class);
        assertNotNull(result);
    ...
    public void testRoundTripFromActualException() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(first));
        StackTraceElement result = MAPPER.readValue(VPackUtils.toVPack(json), StackTraceElement.class);
    ...
    public void testStackTraceInHolder() throws Exception
    {
        String json = a2q("{'trace':["
                ...
                + "]}");
        StackTraceHolder result = MAPPER.readValue(VPackUtils.toVPack(json), StackTraceHolder.class);
        assertNotNull(result);
    ...
    public void testSingleValueArrayUnwrap() throws Exception
    {
        ...
        StackTraceElement result = r.readValue(VPackUtils.toVPack(json));
        assertNotNull(result);
    ...
    public void testStackTraceElementWithCustom() throws Exception
    {
        ...
        StackTraceBean bean = MAPPER.readValue(VPackUtils.toVPack(a2q("{'Location':'foobar'}")),
        ...
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        StackTraceElement elem = mapper.readValue(VPackUtils.toVPack("123"), StackTraceElement.class);
        assertNotNull(elem);
        assertEquals(StackTraceBean.NUM, elem.getLineNumber());

        // and finally, even as part of real exception

        IOException ioe = mapper.readValue(VPackUtils.toVPack(a2q("{'stackTrace':[ 123, 456 ]}")),
                IOException.class);
        assertNotNull(ioe);
