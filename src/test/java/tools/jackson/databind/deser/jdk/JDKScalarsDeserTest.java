    ...
    extends DatabindTestUtil
{
    ...
    public void testBooleanPrimitive() throws Exception
    {
        ...
        result = MAPPER.readValue(VPackUtils.toVPack("{\"v\":1}"), BooleanBean.class);
        assertNotNull(result);
        assertTrue(result._v);

        // should work with arrays too..
        boolean[] array = MAPPER.readValue(VPackUtils.toVPack("[ null, false ]"), boolean[].class);
        assertNotNull(array);
    ...
    {
        Boolean result = MAPPER.readValue(VPackUtils.toVPack("true"), Boolean.class);
        assertEquals(Boolean.TRUE, result);
        result = MAPPER.readValue(VPackUtils.toVPack("false"), Boolean.class);
    ...
    {
        Byte result = MAPPER.readValue(VPackUtils.toVPack("   -42\t"), Byte.class);
        assertEquals(Byte.valueOf((byte)-42), result);

        // Also: should be able to coerce floats, strings:
        result = MAPPER.readValue(VPackUtils.toVPack(" \"-12\""), Byte.class);
        assertEquals(Byte.valueOf((byte)-12), result);

        result = MAPPER.readValue(VPackUtils.toVPack(" 39.07"), Byte.class);
    ...
    public void testByteFromFloatOverflow() throws Exception
    {
        ...
        // Wrapper Byte:
        try {
            Byte b = MAPPER.readValue(VPackUtils.toVPack("300.5"), Byte.class);
            fail("Should have failed for value out of `byte` range; got "+b);
        } catch (InputCoercionException e) {
            verifyException(e, "out of range of `byte`");
        }
        try {
            Byte b = MAPPER.readValue(VPackUtils.toVPack("-200.5"), Byte.class);
            fail("Should have failed for value out of `byte` range; got "+b);
        } catch (InputCoercionException e) {
            verifyException(e, "out of range of `byte`");
        }
        ...
        try {
            PrimitivesBean bean = MAPPER.readValue(VPackUtils.toVPack("{\"byteValue\":300.5}"), PrimitivesBean.class);
            fail("Should have failed for value out of `byte` range; got "+bean.byteValue);
        } catch (InputCoercionException e) {
            verifyException(e, "out of range of `byte`");
        }
        try {
            PrimitivesBean bean = MAPPER.readValue(VPackUtils.toVPack("{\"byteValue\":-200.5}"), PrimitivesBean.class);
            fail("Should have failed for value out of `byte` range; got "+bean.byteValue);
        } catch (InputCoercionException e) {
            verifyException(e, "out of range of `byte`");
        }
    ...
    {
        Short result = MAPPER.readValue(VPackUtils.toVPack("37"), Short.class);
        assertEquals(Short.valueOf((short)37), result);

        // Also: should be able to coerce floats, strings:
        result = MAPPER.readValue(VPackUtils.toVPack(" \"-1009\""), Short.class);
        assertEquals(Short.valueOf((short)-1009), result);

        result = MAPPER.readValue(VPackUtils.toVPack("-12.9"), Short.class);
    ...
    public void testCharacterWrapper() throws Exception
    {
        ...
        assertEquals(Character.valueOf('a'), MAPPER.readValue(VPackUtils.toVPack(q("a")), Character.class));

        // But can also pass in ascii code
        Character result = MAPPER.readValue(VPackUtils.toVPack(" "+((int) 'X')), Character.class);
        ...
        assertEquals(Character.valueOf(' '), MAPPER.readValue(VPackUtils.toVPack(q(" ")), Character.class));

        final CharacterWrapperBean wrapper = MAPPER.readValue(VPackUtils.toVPack("{\"v\":null}"), CharacterWrapperBean.class);
        ...
        try {
            MAPPER.readerFor(CharacterBean.class)
                ...
                .readValue(VPackUtils.toVPack("{\"v\":null}"));
    ...
    {
        Integer result = MAPPER.readValue(VPackUtils.toVPack("   -42\t"), Integer.class);
        assertEquals(Integer.valueOf(-42), result);

        // Also: should be able to coerce floats, strings:
        result = MAPPER.readValue(VPackUtils.toVPack(" \"-1200\""), Integer.class);
        assertEquals(Integer.valueOf(-1200), result);

        result = MAPPER.readValue(VPackUtils.toVPack(" 39.07"), Integer.class);
    ...
    {
        // first, simple case:
        IntBean result = MAPPER.readValue(VPackUtils.toVPack("{\"v\":3}"), IntBean.class);
        assertEquals(3, result._v);

        result = MAPPER.readValue(VPackUtils.toVPack("{\"v\":null}"), IntBean.class);
        assertNotNull(result);
        assertEquals(0, result._v);

        // should work with arrays too..
        int[] array = MAPPER.readValue(VPackUtils.toVPack("[ null ]"), int[].class);
        assertNotNull(array);
        ...
        try {
            MAPPER.readerFor(IntBean.class)
                ...
                .readValue(VPackUtils.toVPack("{\"v\":[3]}"));
        ...
        result = unwrappingR.readValue(VPackUtils.toVPack("{\"v\":[3]}"));
        assertEquals(3, result._v);
        ...
        try {
            unwrappingR.readValue(VPackUtils.toVPack("[{\"v\":[3,3]}]"));
        ...
        result = unwrappingR.readValue(VPackUtils.toVPack("{\"v\":[null]}"));
        assertNotNull(result);
        assertEquals(0, result._v);

        array = MAPPER.readerFor(int[].class)
                .with(DeserializationFeature.UNWRAP_SINGLE_VALUE_ARRAYS)
                .readValue(VPackUtils.toVPack("[ [ null ] ]"));
        assertNotNull(array);
        assertEquals(1, array.length);
        assertEquals(0, array[0]);
    }
    ...
    {
        Long result = MAPPER.readValue(VPackUtils.toVPack("12345678901"), Long.class);
        assertEquals(Long.valueOf(12345678901L), result);

        // Also: should be able to coerce floats, strings:
        result = MAPPER.readValue(VPackUtils.toVPack(" \"-9876\""), Long.class);
        assertEquals(Long.valueOf(-9876), result);

        result = MAPPER.readValue(VPackUtils.toVPack("1918.3"), Long.class);
    ...
    {
        // first, simple case:
        LongBean result = MAPPER.readValue(VPackUtils.toVPack("{\"v\":3}"), LongBean.class);
        assertEquals(3, result._v);
        result = MAPPER.readValue(VPackUtils.toVPack("{\"v\":null}"), LongBean.class);
        assertNotNull(result);
        assertEquals(0, result._v);

        // should work with arrays too..
        long[] array = MAPPER.readValue(VPackUtils.toVPack("[ null ]"), long[].class);
        assertNotNull(array);
        assertEquals(1, array.length);
        assertEquals(0, array[0]);
    ...
    {
        IntBean2 result = MAPPER.readValue(VPackUtils.toVPack("{\"v\":8}"), IntBean2.class);
    ...
    public void testDoublePrimitive() throws Exception
    {
        ...
        // then [JACKSON-79]:
        result = MAPPER.readValue(VPackUtils.toVPack("{\"v\":null}"), DoubleBean.class);
        assertNotNull(result);
        assertEquals(0.0, result._v);

        // should work with arrays too..
        double[] array = MAPPER.readValue(VPackUtils.toVPack("[ null ]"), double[].class);
        assertNotNull(array);
        assertEquals(1, array.length);
    ...
    public void testFloatWrapper() throws Exception
    {
        ...
        for (String str : STRS) {
            ...
            if (NAN_STRING != str) {
                ...
                result = MAPPER.readValue(VPackUtils.toVPack(str), Float.class);
    ...
    public void testDoubleWrapper() throws Exception
    {
        ...
        for (String str : STRS) {
            ...
            if (NAN_STRING != str) {
                result = MAPPER.readValue(VPackUtils.toVPack(str), Double.class);
                assertEquals(exp, result);
            }
            // and then as coerced String:
            result = MAPPER.readValue(VPackUtils.toVPack(" \""+str+"\""), Double.class);
    ...
    public void testDoubleAsArray() throws Exception
    {
        ...
        try {
            MAPPER.readerFor(DoubleBean.class)
                .without(DeserializationFeature.UNWRAP_SINGLE_VALUE_ARRAYS)
                .readValue(VPackUtils.toVPack("{\"v\":[" + value + "]}"));
            fail("Did not throw exception when reading a value from a single value array with the UNWRAP_SINGLE_VALUE_ARRAYS feature disabled");
        } catch (MismatchedInputException e) {
        ...
        DoubleBean result = unwrappingR.readValue(VPackUtils.toVPack("{\"v\":[" + value + "]}"));
        assertEquals(value, result._v);

        result = unwrappingR.readValue(VPackUtils.toVPack("[{\"v\":[" + value + "]}]"));
        assertEquals(value, result._v);

        try {
            unwrappingR.readValue(VPackUtils.toVPack("[{\"v\":[" + value + "," + value + "]}]"));
            fail("Did not throw exception while reading a value from a multi value array with UNWRAP_SINGLE_VALUE_ARRAY feature enabled");
        } catch (MismatchedInputException e) {
    ...
    public void testBase64Variants() throws Exception
    {
        ...
        assertArrayEquals(INPUT, MAPPER.readValue(
                VPackUtils.toVPack(q("YWJjZGVmZ2hpamtsbW5vcHFyc3R1dnd4eXoxMjM0NTY3ODkwYWJjZGVmZ2hpamtsbW5vcHFyc3R1dnd4eXoxMjM0NTY3ODkwWA==")),
                byte[].class));
        ObjectReader reader = MAPPER.readerFor(byte[].class);
        assertArrayEquals(INPUT, (byte[]) reader.with(Base64Variants.MIME_NO_LINEFEEDS).readValue(VPackUtils.toVPack(
        ...
        assertArrayEquals(INPUT, (byte[]) reader.with(Base64Variants.MIME).readValue(VPackUtils.toVPack(
                q("YWJjZGVmZ2hpamtsbW5vcHFyc3R1dnd4eXoxMjM0NTY3ODkwYWJjZGVmZ2hpamtsbW5vcHFyc3R1\\ndnd4eXoxMjM0NTY3ODkwWA=="
        ))));
        assertArrayEquals(INPUT, (byte[]) reader.with(Base64Variants.MODIFIED_FOR_URL).readValue(VPackUtils.toVPack(
                q("YWJjZGVmZ2hpamtsbW5vcHFyc3R1dnd4eXoxMjM0NTY3ODkwYWJjZGVmZ2hpamtsbW5vcHFyc3R1dnd4eXoxMjM0NTY3ODkwWA"
        ))));
        // PEM mandates 64 char lines:
        assertArrayEquals(INPUT, (byte[]) reader.with(Base64Variants.PEM).readValue(VPackUtils.toVPack(
    ...
    {
        WrappersBean bean = MAPPER.readValue(VPackUtils.toVPack("{\"byteValue\":\"\"}"), WrappersBean.class);
        assertNull(bean.byteValue);

        // char/Character is different... not sure if this should work or not:
        bean = MAPPER.readValue(VPackUtils.toVPack("{\"charValue\":\"\"}"), WrappersBean.class);
        assertNull(bean.charValue);

        bean = MAPPER.readValue(VPackUtils.toVPack("{\"shortValue\":\"\"}"), WrappersBean.class);
        assertNull(bean.shortValue);
        bean = MAPPER.readValue(VPackUtils.toVPack("{\"intValue\":\"\"}"), WrappersBean.class);
        assertNull(bean.intValue);
        bean = MAPPER.readValue(VPackUtils.toVPack("{\"longValue\":\"\"}"), WrappersBean.class);
    ...
    {
        WrappersBean bean = MAPPER.readValue(VPackUtils.toVPack("{\"floatValue\":\"\"}"), WrappersBean.class);
        assertNull(bean.floatValue);
        bean = MAPPER.readValue(VPackUtils.toVPack("{\"doubleValue\":\"\"}"), WrappersBean.class);
    ...
    {
        PrimitivesBean bean = MAPPER.readValue(VPackUtils.toVPack("{\"booleanValue\":\"\"}"), PrimitivesBean.class);
    ...
    {
        PrimitivesBean bean = MAPPER.readValue(VPackUtils.toVPack("{\"byteValue\":\"\"}"), PrimitivesBean.class);
        assertEquals((byte) 0, bean.byteValue);
        bean = MAPPER.readValue(VPackUtils.toVPack("{\"charValue\":\"\"}"), PrimitivesBean.class);
        assertEquals((char) 0, bean.charValue);
        bean = MAPPER.readValue(VPackUtils.toVPack("{\"shortValue\":\"\"}"), PrimitivesBean.class);
        assertEquals((short) 0, bean.shortValue);
        bean = MAPPER.readValue(VPackUtils.toVPack("{\"intValue\":\"\"}"), PrimitivesBean.class);
        assertEquals(0, bean.intValue);
        bean = MAPPER.readValue(VPackUtils.toVPack("{\"longValue\":\"\"}"), PrimitivesBean.class);
    ...
    {
        PrimitivesBean bean = MAPPER.readValue(VPackUtils.toVPack("{\"floatValue\":\"\"}"), PrimitivesBean.class);
        assertEquals(0.0f, bean.floatValue);
        bean = MAPPER.readValue(VPackUtils.toVPack("{\"doubleValue\":\"\"}"), PrimitivesBean.class);
    ...
    public void testNullForPrimitivesDefault() throws IOException
    {
        ...
        PrimitivesBean bean = MAPPER.readValue(
                VPackUtils.toVPack("{\"intValue\":null, \"booleanValue\":null, \"doubleValue\":null}"),
        ...
        bean = MAPPER.readValue(VPackUtils.toVPack("{\"byteValue\":null, \"longValue\":null, \"floatValue\":null}"),
                PrimitivesBean.class);
        assertNotNull(bean);
        assertEquals((byte) 0, bean.byteValue);
        assertEquals(0L, bean.longValue);
    ...
    public void testNullForPrimitivesNotAllowedInts() throws IOException
    {
        ...
        try {
            reader.readValue(VPackUtils.toVPack("{\"byteValue\":null}"));
        ...
        try {
            reader.readValue(VPackUtils.toVPack("{\"shortValue\":null}"));
        ...
        try {
            reader.readValue(VPackUtils.toVPack("{\"intValue\":null}"));
        ...
        try {
            reader.readValue(VPackUtils.toVPack("{\"longValue\":null}"));
    ...
    public void testNullForPrimitivesNotAllowedFP() throws IOException
    {
        ...
        // float/double
        try {
            reader.readValue(VPackUtils.toVPack("{\"floatValue\":null}"));
        ...
        try {
            reader.readValue(VPackUtils.toVPack("{\"doubleValue\":null}"));
    ...
    public void testNullForPrimitivesNotAllowedMisc() throws IOException
    {
        ...
        // boolean
        try {
            reader.readValue(VPackUtils.toVPack("{\"booleanValue\":null}"));
        ...
        try {
            reader.readValue(VPackUtils.toVPack("{\"charValue\":null}"));
    ...
    public void testNullForPrimitivesViaCreator() throws IOException
    {
        try {
            /*PrimitiveCreatorBean bean =*/ MAPPER
                    ...
                    .with(DeserializationFeature.FAIL_ON_NULL_FOR_PRIMITIVES)
                    .readValue(VPackUtils.toVPack(a2q("{'a': null}")));
            ...
            boolean testEmptyString) throws IOException
    {
        ...
        Object ob = readerCoerceOk.forType(cls).readValue(VPackUtils.toVPack(JSON_WITH_NULL));
        assertEquals(1, Array.getLength(ob));
        assertEquals(defValue, Array.get(ob, 0));
        try {
            readerNoNulls.readValue(VPackUtils.toVPack(JSON_WITH_NULL));
        ...
        if (testEmptyString) {
            ob = readerCoerceOk.forType(cls).readValue(VPackUtils.toVPack(EMPTY_STRING_JSON));
            assertEquals(1, Array.getLength(ob));
            assertEquals(defValue, Array.get(ob, 0));
        }
    }
    ...
    public void testVoidDeser() throws Exception
    {
        ...
        VoidBean bean = MAPPER.readValue(VPackUtils.toVPack(a2q("{'value' : 123 }")),
                VoidBean.class);
        assertNull(bean.value);

        // Then `Void` and `void` (Void.TYPE) as root values
        assertNull(MAPPER.readValue(VPackUtils.toVPack("{}"), Void.class));
        assertNull(MAPPER.readValue(VPackUtils.toVPack("1234"), Void.class));
        assertNull(MAPPER.readValue(VPackUtils.toVPack("[ 1, true ]"), Void.class));

        assertNull(MAPPER.readValue(VPackUtils.toVPack("{}"), Void.TYPE));
        assertNull(MAPPER.readValue(VPackUtils.toVPack("1234"), Void.TYPE));
        assertNull(MAPPER.readValue(VPackUtils.toVPack("[ 1, true ]"), Void.TYPE));
    }
...
//        _testInvalidStringCoercionFail(char[].class);
            ...
            throws IOException
    {
        ...
        try {
            MAPPER.readerFor(cls).readValue(VPackUtils.toVPack(JSON));
            fail("Should not pass");
        } catch (MismatchedInputException e) {
    ...
    {
        try {
            MAPPER.readValue(VPackUtils.toVPack(a2q("{'value':12}")), targetType);
            fail("Should not pass");
        } catch (MismatchedInputException e) {
