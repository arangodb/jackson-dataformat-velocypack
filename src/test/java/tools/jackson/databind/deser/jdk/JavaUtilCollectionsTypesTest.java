...
public class JavaUtilCollectionsTypesTest
{
    ...
    public void testArraysAsList() throws Exception
    {
        ...
        String json = VPackUtils.toJson(DEFAULT_MAPPER.writeValueAsBytes(input));
        @SuppressWarnings("unchecked")
        List<String> result = (List<String>) DEFAULT_MAPPER.readValue(VPackUtils.toVPack(json), List.class);
    ...
    protected Collection<?> _writeReadCollection(Collection<?> input) throws Exception {
        final String json = VPackUtils.toJson(DEFAULT_MAPPER.writeValueAsBytes(input));
        return DEFAULT_MAPPER.readValue(VPackUtils.toVPack(json), Collection.class);
    }

    protected void _verifyMap(Map<?,?> exp) throws Exception
    {
        String json = VPackUtils.toJson(DEFAULT_MAPPER.writeValueAsBytes(exp));
        Map<?,?> act = DEFAULT_MAPPER.readValue(VPackUtils.toVPack(json), Map.class);
