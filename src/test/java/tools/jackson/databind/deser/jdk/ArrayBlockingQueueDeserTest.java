...
public class ArrayBlockingQueueDeserTest extends DatabindTestUtil
{
    ...
    {
        ArrayBlockingQueue<String> result = MAPPER.readValue(VPackUtils.toVPack("[]"),
    ...
    {
        ArrayBlockingQueue<String> result = MAPPER.readValue(VPackUtils.toVPack("[\"hello\"]"),
                new TypeReference<ArrayBlockingQueue<String>>() { });
        assertNotNull(result);
    ...
    {
        ArrayBlockingQueue<Integer> result = MAPPER.readValue(VPackUtils.toVPack("[1, 2, 3, 4, 5]"),
    ...
    {
        ArrayBlockingQueue<String> result = MAPPER.readValue(VPackUtils.toVPack(a2q("['a','b','c']")),
                new TypeReference<ArrayBlockingQueue<String>>() { });
        assertNotNull(result);
    ...
    {
        ArrayBlockingQueue<PojoItem> result = MAPPER.readValue(VPackUtils.toVPack(a2q("[{'name':'first','value':1},{'name':'second','value':2}]")),
    ...
    void testQueueAsProperty() throws Exception
    {
        StringQueueBean result = MAPPER.readValue(
                VPackUtils.toVPack(a2q("{'items':['x','y','z']}")), StringQueueBean.class);
        assertNotNull(result);
    ...
    {
        StringQueueBean result = MAPPER.readValue(
                VPackUtils.toVPack(a2q("{'items':[]}")), StringQueueBean.class);
        assertNotNull(result);
        assertNotNull(result.items);
    ...
    void testIntQueueAsProperty() throws Exception
    {
        IntQueueBean result = MAPPER.readValue(
                VPackUtils.toVPack(a2q("{'numbers':[10,20,30]}")), IntQueueBean.class);
        assertNotNull(result);
    ...
    void testRoundTrip() throws Exception
    {
        ...
        ArrayBlockingQueue<String> result = MAPPER.readValue(VPackUtils.toVPack(json),
                new TypeReference<ArrayBlockingQueue<String>>() { });
        assertNotNull(result);
        assertEquals(3, result.size());
    ...
    void testNullElementsInQueueFails() throws Exception
    {
        ...
        try {
            MAPPER.readValue(VPackUtils.toVPack(a2q("[null, 'hello', null]")),
                    new TypeReference<ArrayBlockingQueue<String>>() { });
    ...
    void testLargeQueue() throws Exception
    {
        ...
        ArrayBlockingQueue<Integer> result = MAPPER.readValue(VPackUtils.toVPack(sb.toString()),
                new TypeReference<ArrayBlockingQueue<Integer>>() { });
        assertNotNull(result);
