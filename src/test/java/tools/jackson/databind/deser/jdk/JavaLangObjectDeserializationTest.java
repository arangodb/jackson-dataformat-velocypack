...
public class JavaLangObjectDeserializationTest
{
    ...
    public void testSampleDoc() throws Exception
    {
        ...
        Object root = MAPPER.readValue(VPackUtils.toVPack(JSON), Object.class);
    ...
    public void testUntypedMap() throws Exception
    {
        ...
        @SuppressWarnings("unchecked")
        Map<Object,Object> result = (Map<Object,Object>)MAPPER.readValue(VPackUtils.toVPack(JSON), Object.class);
    ...
    {
        assertEquals("foo", OBJECT_READER.readValue(VPackUtils.toVPack(q("foo"))));
        assertEquals("foo", OBJECT_READER.withValueToUpdate("xxx").readValue(VPackUtils.toVPack(q("foo"))));

        assertEquals(Boolean.FALSE, OBJECT_READER.readValue(VPackUtils.toVPack("false")));
        assertEquals(Boolean.TRUE, OBJECT_READER.readValue(VPackUtils.toVPack(" true ")));

        assertEquals(Integer.valueOf(13), OBJECT_READER.readValue(VPackUtils.toVPack("13 ")));
        assertEquals(Double.valueOf(0.5), OBJECT_READER.readValue(VPackUtils.toVPack("0.5 ")));
    }

    @Test
    public void testSimpleVanillaStructured() throws Exception
    {
        List<?> list = (List<?>) OBJECT_READER.readValue(VPackUtils.toVPack("[ 1, 2, 3]"));
    ...
    public void testNestedUntyped() throws Exception
    {
        ...
        Object root = OBJECT_READER.readValue(VPackUtils.toVPack(a2q("{'a':3,'b':[1,2], 'c':[3]}")));
        assertInstanceOf(Map.class, root);
    ...
    public void testUntypedWithCustomScalarDesers() throws Exception
    {
        ...
        Object ob = mapper.readValue(VPackUtils.toVPack("{\"a\":\"b\", \"nr\":1 }"), Object.class);
    ...
    public void testNonVanilla() throws Exception
    {
        ...
        List<?> l = (List<?>) r.readValue(VPackUtils.toVPack("[ true, false, 7, 0.5, \"foo\", null]"));
        ...
        // And Maps
        Map<?,?> map = (Map<?,?>) r.readValue(VPackUtils.toVPack(a2q("{'a':0.25,'b':3,'c':true,'d':false}")));
        assertEquals(Map.of("a", 0.25, "b", 3, "c", true, "d", false), map);

        // And Scalars too; regular and "updating" readers
        l = new ArrayList<>();
        assertEquals(Integer.valueOf(42), r.readValue(VPackUtils.toVPack("42")));
        assertEquals(Integer.valueOf(42), r.withValueToUpdate(l).readValue(VPackUtils.toVPack("42")));
        assertEquals(Double.valueOf(2.5), r.readValue(VPackUtils.toVPack("2.5")));
        assertEquals(Double.valueOf(2.5), r.withValueToUpdate(l).readValue(VPackUtils.toVPack("2.5")));
        // custom String deserializer
        assertEquals("ABC", r.readValue(VPackUtils.toVPack(q("abc"))));
        assertEquals("ABC", r.withValueToUpdate(l).readValue(VPackUtils.toVPack(q("abc"))));
        assertEquals(true, r.readValue(VPackUtils.toVPack("true")));
        assertEquals(true, r.withValueToUpdate(l).readValue(VPackUtils.toVPack("true")));
        assertEquals(false, r.readValue(VPackUtils.toVPack("false")));
        assertEquals(false, r.withValueToUpdate(l).readValue(VPackUtils.toVPack("false")));
        assertNull(r.readValue(VPackUtils.toVPack("null")));
        assertSame(l, r.withValueToUpdate(l).readValue(VPackUtils.toVPack("null")));
        
        // and minimal nesting
        l = (List<?>) mapper.readValue(VPackUtils.toVPack("[ {}, [] ]"), Object.class);
    ...
    public void testUntypedWithListDeser() throws Exception
    {
        ...
        assertEquals(List.of("X1", "X2", "Xtrue"),
                r.readValue(VPackUtils.toVPack("[1, 2, true]")));
        ...
        Object ob2 = r.with(DeserializationFeature.USE_JAVA_ARRAY_FOR_JSON_ARRAY)
                .readValue(VPackUtils.toVPack("[1, 2, true]"));
    ...
    public void testUntypedWithMapDeser() throws Exception
    {
        ...
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        // And then list...
        Object ob = mapper.readValue(VPackUtils.toVPack("{\"a\":true}"), Object.class);
        assertInstanceOf(Map.class, ob);
        Map<?,?> map = (Map<?,?>) ob;
    ...
    public void testNestedUntyped989() throws Exception
    {
        ...
        pojo = r.readValue(VPackUtils.toVPack("[]"));
        ...
        pojo = r.readValue(VPackUtils.toVPack("{\"a\":[]}"));
        assertInstanceOf(Map.class, pojo.value);
    }
    ...
    {
        // by default we get:
        Object ob = MAPPER.readValue(VPackUtils.toVPack("[1]"), Object.class);
        ...
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        ob = mapper.readValue(VPackUtils.toVPack("[1, false, true, 0.5, {}]"), Object.class);
    ...
    public void testSerializable() throws Exception
    {
        ...
        SerContainer cont = MAPPER.readValue(VPackUtils.toVPack(JSON1), SerContainer.class);
        assertEquals(Integer.valueOf(123), cont.value);

        cont = MAPPER.readValue(VPackUtils.toVPack(a2q("{ 'value' : true }")), SerContainer.class);
        assertEquals(Boolean.TRUE, cont.value);

        // But also via Map value, even key
        Map<?,?> map = MAPPER.readValue(VPackUtils.toVPack(JSON1), new TypeReference<Map<String, Serializable>>() { });
        assertEquals(1, map.size());
        assertEquals(Integer.valueOf(123), map.get("value"));

        map = MAPPER.readValue(VPackUtils.toVPack(JSON1), new TypeReference<Map<Serializable, Object>>() { });
        assertEquals(1, map.size());
    ...
    public void testValueUpdateVanillaUntyped() throws Exception
    {
        ...
        result = r.readValue(VPackUtils.toVPack(a2q("{'b': 0.25, 'c': [] }")));
        ...
        result = r.readValue(VPackUtils.toVPack("[ true, -0.5, { } ]"));
        ...
        result = r.readValue(VPackUtils.toVPack("[ 42, -0.25, false, null ]"));
        ...
        map.put("a", 0.5);
        map.put("b", null);
        result = r.readValue(VPackUtils.toVPack(a2q("{'a': 0.5, 'b': null}")));
    ...
    public void testValueUpdateCustomUntyped() throws Exception
    {
        ...
        final ObjectMapper customMapper = vpackMapperBuilder()
                .addModule(m)
                .build();
        ...
        Object result = r.readValue(VPackUtils.toVPack(a2q("{'b': 'value', 'c': 111222333444, 'enabled': true}")));
        assertSame(map, result);
        ...
        result = r.readValue(VPackUtils.toVPack(a2q("[ 2, 'foobar' ]")));
        assertSame(list, result);
    ...
    public void testUntypedCustomMapWithDups() throws Exception
    {
        ...
        assertEquals(Map.of("a", 0), r.readValue(VPackUtils.toVPack(a2q("{'a': false, 'a': 0}"))));
        assertEquals(Map.of("a", 1, "b", false),
                r.readValue(VPackUtils.toVPack(a2q("{'a':0, 'b': false, 'a': 1}"))));

        Object ob = r.readValue(VPackUtils.toVPack(a2q("""
    ...
    public void testObjectSerializeWithLong() throws Exception
    {
        ...
        // works fine as node
        JsonNode deserialized = mapper.readTree(VPackUtils.toVPack(serialized));
        assertEquals(VALUE, deserialized.get("timestamp").asLong());
        // and actually should work for Maps too
        Map<?,?> deserMap = mapper.readValue(VPackUtils.toVPack(serialized), Map.class);
    ...
    {
        ObjectReader rDefault = vpackMapperBuilder()
                .polymorphicTypeValidator(new NoCheckSubTypeValidator())
                .build()
        ...
        w = rDefault.readValue(VPackUtils.toVPack(a2q("{'value':10}")));
        assertEquals(Integer.valueOf(10), w.value);
        w = rAlt.readValue(VPackUtils.toVPack(a2q("{'value':10}")));
        ...
        Object ob = MAPPER.readerFor(Object.class)
                ...
                .readValue(VPackUtils.toVPack(INT_ARRAY_JSON));
        ...
        w = rDefault.readValue(VPackUtils.toVPack(a2q("{'value': ['java.util.Date', 123]}")));
        assertThat(w.value).isInstanceOf(Date.class);
    }
    ...
    public void testPolymorphicUntypedCustom() throws Exception
    {
        ...
        WrappedPolymorphicUntyped w = rDefault.readValue(VPackUtils.toVPack(a2q("{'value':10}")));
        assertEquals(Integer.valueOf(10), w.value);

        w = rDefault.readValue(VPackUtils.toVPack(a2q("{'value':9988776655}")));
        assertEquals(Long.valueOf(9988776655L), w.value);
        w = rDefault.readValue(VPackUtils.toVPack(a2q("{'value':0.75}")));
        assertEquals(Double.valueOf(0.75), w.value);

        w = rDefault.readValue(VPackUtils.toVPack(a2q("{'value':'abc'}")));
        assertEquals("ABC", w.value);
        w = rDefault.readValue(VPackUtils.toVPack(a2q("{'value':false}")));
        assertEquals(Boolean.FALSE, w.value);
        w = rDefault.readValue(VPackUtils.toVPack(a2q("{'value':null}")));
        assertNull(w.value);

        // but... actually how about real type id?
        final Object SHORT = Short.valueOf((short) 3);
        String json = VPackUtils.toJson(customMapper.writeValueAsBytes(new WrappedPolymorphicUntyped(SHORT)));

        WrappedPolymorphicUntyped result = rDefault.readValue(VPackUtils.toVPack(json));
    ...
    {
        assertEquals(List.of(), MAPPER.readValue(VPackUtils.toVPack("[]"), Object.class));
        assertEquals(Map.of(), MAPPER.readValue(VPackUtils.toVPack("{}"), Object.class));
    }

    @Test
    public void testSingleElementArrayAndObject() throws Exception
    {
        assertEquals(List.of(42), MAPPER.readValue(VPackUtils.toVPack("[42]"), Object.class));
        assertEquals(Map.of("key", true),
                MAPPER.readValue(VPackUtils.toVPack("{\"key\": true}"), Object.class));
    }
    ...
    {
        Object result = MAPPER.readValue(VPackUtils.toVPack("1.5"), Object.class);
        assertInstanceOf(Double.class, result);
        result = MAPPER.readValue(VPackUtils.toVPack("2.718281828"), Object.class);
        assertInstanceOf(Double.class, result);
    }
    ...
    public void testNaNHandling() throws Exception
    {
        ...
        // .enable(VPackReadFeature.ALLOW_NON_NUMERIC_NUMBERS)
                .build();

        Object result = mapper.readValue(VPackUtils.toVPack("NaN"), Object.class);
        assertInstanceOf(Double.class, result);
    ...
    {
        // Null as root value
        Object result = MAPPER.readValue(VPackUtils.toVPack("null"), Object.class);
        assertNull(result);

        // Null in array
        List<?> list = (List<?>) MAPPER.readValue(VPackUtils.toVPack("[null, 1, null]"), Object.class);
        assertEquals(3, list.size());
        ...
        // Null in object
        Map<?,?> map = (Map<?,?>) MAPPER.readValue(VPackUtils.toVPack("{\"a\":null,\"b\":2}"), Object.class);
    ...
    public void testBigIntegerCoercion() throws Exception
    {
        ...
        Object result = mapper.readValue(VPackUtils.toVPack("12345678901234567890"), Object.class);
        assertNotNull(result);
    ...
    public void testLargeArray() throws Exception
    {
        ...
        List<?> result = (List<?>) MAPPER.readValue(VPackUtils.toVPack(json.toString()), Object.class);
    ...
    public void testLargeObject() throws Exception
    {
        ...
        Map<?,?> result = (Map<?,?>) MAPPER.readValue(VPackUtils.toVPack(json.toString()), Object.class);
    ...
    public void testMixedTypesInArray() throws Exception
    {
        ...
        List<?> result = (List<?>) MAPPER.readValue(VPackUtils.toVPack(json), Object.class);
    ...
    public void testDeeplyNestedStructures() throws Exception
    {
        ...
        Map<?,?> result = (Map<?,?>) MAPPER.readValue(VPackUtils.toVPack(json), Object.class);
