    ...
    extends DatabindTestUtil
{
    ...
    public void testHandlingOfUnrecognized() throws Exception
    {
        ...
        try {
            MAPPER.readerFor(Bean.class)
                    ...
                    .readValue(VPackUtils.toVPack("{\"bar\":3}"));
    ...
    {
        try {
            Object result = MAPPER.readValue(VPackUtils.toVPack("    "), Object.class);
    ...
    {
        JsonParser p = MAPPER.createParser(VPackUtils.toVPack("  3"));
    ...
    {
        try {
            NoCreatorsBean b = MAPPER.readValue(VPackUtils.toVPack("{}"), NoCreatorsBean.class);
