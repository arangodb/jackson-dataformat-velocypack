...
public class ThrowableDeserializerTest extends DatabindTestUtil
{
    ...
    public void testSimpleIOException() throws Exception
    {
        IOException result = MAPPER.readValue(
                VPackUtils.toVPack(a2q("{'message':'test error'}")), IOException.class);
    ...
    public void testIOExceptionRoundTrip() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(orig));
        IOException result = MAPPER.readValue(VPackUtils.toVPack(json), IOException.class);
    ...
    public void testDefaultCtorException() throws Exception
    {
        DefaultCtorException result = MAPPER.readValue(
                VPackUtils.toVPack(a2q("{}")), DefaultCtorException.class);
        assertNotNull(result);
    }
    ...
    public void testDefaultCtorExceptionWithMessage() throws Exception
    {
        ...
        DefaultCtorException result = MAPPER.readValue(
                VPackUtils.toVPack(a2q("{'message':'ignored'}")), DefaultCtorException.class);
        assertNotNull(result);
    ...
    public void testDualCtorWithMessage() throws Exception
    {
        DualCtorException result = MAPPER.readValue(
                VPackUtils.toVPack(a2q("{'message':'dual ctor test'}")), DualCtorException.class);
        assertNotNull(result);
    ...
    {
        DualCtorException result = MAPPER.readValue(
                VPackUtils.toVPack(a2q("{}")), DualCtorException.class);
        assertNotNull(result);
        assertNull(result.getMessage());
    }
    ...
    {
        IOException result = MAPPER.readValue(
                VPackUtils.toVPack(a2q("{'message':null}")), IOException.class);
        assertNotNull(result);
        assertNull(result.getMessage());
    }
    ...
    {
        Exception exc = MAPPER.readValue(VPackUtils.toVPack(a2q(
    ...
    public void testWithNullMessageNonNullInclusion() throws Exception
    {
        final ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(new IOException((String) null)));
        IOException result = mapper.readValue(VPackUtils.toVPack(json), IOException.class);
        assertNotNull(result);
        assertNull(result.getMessage());
    }
    ...
    {
        MyNoArgException exc = MAPPER.readValue(VPackUtils.toVPack("{}"), MyNoArgException.class);
        assertNotNull(exc);
    }
    ...
    {
        Exception exc = MAPPER.readValue(VPackUtils.toVPack("{\"suppressed\":[]}"), IOException.class);
        assertNotNull(exc);
    }
    ...
    public void testCauseDeserializationRoundTrip() throws Exception
    {
        ...
        final String value = VPackUtils.toJson(MAPPER.writeValueAsBytes(exp));
        final IOException act = MAPPER.readValue(VPackUtils.toVPack(value), IOException.class);
    ...
    public void testCustomPropException() throws Exception
    {
        ...
        CustomPropException result = MAPPER.readValue(VPackUtils.toVPack(json), CustomPropException.class);
        assertNotNull(result);
    ...
    public void testWithCreator() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new MyException(MSG, 3)));

        MyException result = MAPPER.readValue(VPackUtils.toVPack(json), MyException.class);
    ...
    public void testAnySetterException() throws Exception
    {
        ...
        AnySetterException result = MAPPER.readValue(VPackUtils.toVPack(json), AnySetterException.class);
        assertNotNull(result);
    ...
    public void testSingleValueArrayDeserialization() throws Exception
    {
        ...
        final IOException cloned = mapper.readValue(VPackUtils.toVPack(value), IOException.class);
    ...
    public void testSingleValueArrayDeserializationException() throws Exception {
        ...
        try {
            mapper.readValue(VPackUtils.toVPack(value), IOException.class);
    ...
    {
        final ObjectMapper renamingMapper = VPackMapper.builder()
    ...
    private void _testRoundtripWith(ObjectMapper mapper) throws Exception
    {
        ...
        final String json = VPackUtils.toJson(mapper.writer()
                .writeValueAsBytes(leaf));
        Exception result = mapper.readValue(VPackUtils.toVPack(json), Exception.class);
    ...
    public void testWithDups() throws Exception
    {
        ...
        IOException exc = MAPPER.readValue(VPackUtils.toVPack(a2q(sb.toString())), IOException.class);
        assertNotNull(exc);
    ...
    public void testCustomExceptionDefaultCtorRoundTrip() throws Exception
    {
        assertNotNull(MAPPER.readValue(
                VPackUtils.toVPack(VPackUtils.toJson(MAPPER.writeValueAsBytes(new CustomThrowable4071()))), CustomThrowable4071.class));
        assertNotNull(MAPPER.readValue(
                VPackUtils.toVPack(VPackUtils.toJson(MAPPER.writeValueAsBytes(new CustomRuntimeException4071()))), CustomRuntimeException4071.class));
        assertNotNull(MAPPER.readValue(
                VPackUtils.toVPack(VPackUtils.toJson(MAPPER.writeValueAsBytes(new CustomCheckedException4071()))), CustomCheckedException4071.class));
    }
    ...
    {
        assertNotNull(MAPPER.readValue(
                VPackUtils.toVPack(VPackUtils.toJson(MAPPER.writeValueAsBytes(new CustomRuntimeException4071()))), Throwable.class));
        assertNotNull(MAPPER.readValue(
                VPackUtils.toVPack(VPackUtils.toJson(MAPPER.writeValueAsBytes(new CustomCheckedException4071()))), Throwable.class));
        assertNotNull(MAPPER.readValue(
                VPackUtils.toVPack(VPackUtils.toJson(MAPPER.writeValueAsBytes(new CustomThrowable4071()))), Throwable.class));
    }
    ...
    public void testSubclassedExceptionWithCauseCreator() throws Exception
    {
        ...
        String serialized = VPackUtils.toJson(mapper.writeValueAsBytes(input));
        SubclassedExceptionWithCause deserialized = mapper.readValue(VPackUtils.toVPack(serialized), SubclassedExceptionWithCause.class);
