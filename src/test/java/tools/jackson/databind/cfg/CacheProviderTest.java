...
public class CacheProviderTest
{
    ...
    public void testDefaultCacheProviderConfigDeserializerCache() throws Exception
    {
        ...
        assertNotNull(mapper.readValue(VPackUtils.toVPack("{\"point\":24}"), RandomBean.class));
    }
    ...
    public void testDefaultCacheProviderSharesCache() throws Exception
    {
        ...
        ObjectMapper mapper1 = VPackMapper.builder()
                .cacheProvider(cacheProvider)
                .build();
        ...
        mapper1.readValue(VPackUtils.toVPack("{\"point\":24}"), RandomBean.class);
        mapper2.readValue(VPackUtils.toVPack("{\"height\":24}"), AnotherBean.class);
    ...
    private void _verifySerializeSuccess(CacheProvider cacheProvider) throws Exception
    {
        ...
        assertEquals("{\"slide\":123}",
                VPackUtils.toJson(mapper.writeValueAsBytes(new SerBean())));
    }
