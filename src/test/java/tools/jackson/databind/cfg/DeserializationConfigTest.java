...
public class DeserializationConfigTest extends DatabindTestUtil
{
    ...
    {
        // NOTE: Using VPack-specific features since JSON-specific ones (ALLOW_JAVA_COMMENTS, ALLOW_MISSING_VALUES) don't exist
        final VPackReadFeature DISABLED_BY_DEFAULT = VPackReadFeature.FAIL_ON_TAGGED_VALUES;
        final VPackReadFeature DISABLED_BY_DEFAULT2 = VPackReadFeature.FAIL_ON_CUSTOM_TYPES;
        DeserializationConfig config = MAPPER.deserializationConfig();
