...
public class RecordTypeInfo3342Test extends DatabindTestUtil
{
    ...
    private final ObjectMapper MAPPER_3786 = vpackMapperBuilder()
    ...
    public void testSerializeDeserializeJsonSubType_LOW() throws Exception {
        ...
        Example value = MAPPER.readValue(VPackUtils.toVPack(json), Example.class);
    ...
    public void testDeserializeRecordWithAbstractMember() throws Exception {
        RootRecord249 value = MAPPER.readValue(
                VPackUtils.toVPack("{\"member\":{\"@class\":\"string\",\"val\":\"Hello, abstract member!\"}}"),
                RootRecord249.class);
    ...
    public void testCustomObjectRoundTrip3786() {
        ...
        String json = VPackUtils.toJson(MAPPER_3786.writeValueAsBytes(myContainer));

        Container3786<?> result = MAPPER_3786.readValue(VPackUtils.toVPack(json), new TypeReference<Container3786<?>>() { });
    ...
    public void testStringValueRoundTrip3786() {
        ...
        String json = VPackUtils.toJson(MAPPER_3786.writeValueAsBytes(strContainer));
    ...
    public void testIntegerValueRoundTrip3786() {
        ...
        String json = VPackUtils.toJson(MAPPER_3786.writeValueAsBytes(intContainer));
    ...
    public void testBooleanValueRoundTrip3786() {
        ...
        String json = VPackUtils.toJson(MAPPER_3786.writeValueAsBytes(boolContainer));
