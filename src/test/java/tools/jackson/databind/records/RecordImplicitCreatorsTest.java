...
public class RecordImplicitCreatorsTest extends DatabindTestUtil
{
    ...
    public void testDeserializeUsingImplicitIntegerFactoryMethod() throws Exception {
        RecordWithImplicitFactoryMethods factoryMethodValue = MAPPER.readValue(VPackUtils.toVPack("123"), RecordWithImplicitFactoryMethods.class);
    ...
    public void testDeserializeUsingImplicitDoubleFactoryMethod() throws Exception {
        RecordWithImplicitFactoryMethods value = MAPPER.readValue(VPackUtils.toVPack("123.4"), RecordWithImplicitFactoryMethods.class);
    ...
    public void testDeserializeUsingImplicitFactoryMethod_WithAutoDetectCreatorsDisabled_WillFail() throws Exception {
        ...
        try {
            mapper.readValue(VPackUtils.toVPack("123"), RecordWithImplicitFactoryMethods.class);
    ...
    public void testDeserializeUsingImplicitSingleValueConstructor() throws Exception {
        try {
            ...
            MAPPER.readValue(VPackUtils.toVPack("123"), RecordWithSingleValueConstructor.class);
        ...
        RecordWithSingleValueConstructor value = MAPPER.readValue(VPackUtils.toVPack("{\"id\":123}"), RecordWithSingleValueConstructor.class);
    ...
    public void testDeserializeUsingImplicitSingleValueConstructor_WithJsonValue() throws Exception {
        ...
        try {
            ...
            MAPPER.readValue(VPackUtils.toVPack("{\"id\":123}"), RecordWithSingleValueConstructorWithJsonValue.class);
    ...
    public void testDeserializeUsingImplicitSingleValueConstructor_WithJsonValueAccessor() throws Exception {
        ...
        try {
            // Can no longer use properties-based creator
            MAPPER.readValue(VPackUtils.toVPack("{\"id\":123}"), RecordWithSingleValueConstructorWithJsonValueAccessor.class);
    ...
    public void testDeserializeUsingImplicitPropertiesBasedConstructor() throws Exception {
        RecordWithAltSingleValueConstructor value = MAPPER.readValue(
                VPackUtils.toVPack("{\"id\":123,\"name\":\"PropertiesBasedConstructor\"}"),
    ...
    public void testDeserializeUsingImplicitDelegatingConstructor() throws Exception {
        RecordWithAltSingleValueConstructor value = MAPPER.readValue(VPackUtils.toVPack("123"), RecordWithAltSingleValueConstructor.class);
    ...
    {
        RecordWithNonCanonicalConstructor value = MAPPER.readValue(
                VPackUtils.toVPack("{\"id\":123,\"email\":\"bob@example.com\"}"),
                RecordWithNonCanonicalConstructor.class);
    ...
    public void testDeserializeMultipleConstructors_UsingMultiValueCanonicalConstructor() throws Exception {
        ...
        RecordWithMultiValueCanonAndSingleValueAltConstructor value = mapper.readValue(
                VPackUtils.toVPack(a2q("{'id':123,'name':'Bob'}")),
    ...
    public void testDeserializeMultipleConstructors_UsingSingleValueCanonicalConstructor() throws Exception {
        ...
        RecordWithSingleValueCanonAndMultiValueAltConstructor value = mapper.readValue(
                VPackUtils.toVPack(a2q("{'name':'Bob'}")),
    ...
    public void testDeserializeMultipleConstructors_WillIgnoreMultiValueAltConstructor() throws Exception {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        try {
            mapper.readValue(VPackUtils.toVPack(a2q("{'name':'Bob','email':'bob@email.com'}")), RecordWithSingleValueCanonAndMultiValueAltConstructor.class);
