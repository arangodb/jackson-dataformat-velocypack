...
public class RecordWithVPackUnwrappedTest extends DatabindTestUtil
{
    ...
    private final ObjectMapper MAPPER_5716 = VPackMapper.builder()
    ...
    void unwrappedPojoShouldRoundTrip() throws Exception
    {
        ...
        BarPojo5115 output = MAPPER.readValue(VPackUtils.toVPack(json), BarPojo5115.class);
    ...
    void unwrappedRecordShouldRoundTripPass() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(input));
        BarRecordPass5115 output = MAPPER.readValue(VPackUtils.toVPack(json), BarRecordPass5115.class);
    ...
    void unwrappedRecordShouldRoundTrip() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(input));
        BarRecordFail5115 output = MAPPER.readValue(VPackUtils.toVPack(json), BarRecordFail5115.class);
    ...
    void unwrappedRecordShouldKeepDeclarationOrder() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER_5716.writeValueAsBytes(input));
    ...
    public void testPrefixedUnwrappingWithRecord() throws Exception {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(source));
        assertEquals("{\"_name\":\"Bubba\",\"_location\":{\"x\":2,\"y\":3}}", json);
        WithPrefix3178 bean = MAPPER.readValue(VPackUtils.toVPack(json), WithPrefix3178.class);
