...
public class RecordUnknownProps5897Test extends DatabindTestUtil
{
    ...
    public void testSkipUnknowns_defaultConfig() throws Exception {
        VPackMapper mapper = vpackMapperBuilder()
                .disable(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES)
                .build();
        Point p = mapper.readValue(VPackUtils.toVPack(JSON_WITH_EXTRAS), Point.class);
        assertEquals(1, p.x());
        assertEquals(2, p.y());
    }
    ...
    public void testFailOnUnknown_stillThrows() throws Exception {
        ...
        assertThrows(UnrecognizedPropertyException.class,
                () -> mapper.readValue(VPackUtils.toVPack(JSON_WITH_EXTRAS), Point.class));
    }
    ...
    public void testNonFinalPolymorphic_subPropertyPreserved() throws Exception {
        ...
        Animal a = mapper.readValue(VPackUtils.toVPack(json), Animal.class);
