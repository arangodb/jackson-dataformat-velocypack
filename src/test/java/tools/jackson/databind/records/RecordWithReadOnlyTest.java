...
public class RecordWithReadOnlyTest extends DatabindTestUtil
{
    ...
    static class ReadOnly5049Pojo
    {
        ...
        ReadOnly5049Pojo(
                @JsonProperty(value = "a", access = Access.READ_ONLY) String a,
                @JsonProperty(value = "b", access = Access.READ_ONLY) String b) {
            this.a = a;
            this.b = b;
        }
    ...
    public void testSerializeReadOnlyProperty() throws Exception {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new RecordWithReadOnly(123, "Bob")));
        assertEquals(a2q("{'id':123,'name':'Bob'}"), json);
    }

    @Test
    public void testDeserializeReadOnlyProperty() throws Exception {
        RecordWithReadOnly value = MAPPER.readValue(VPackUtils.toVPack(a2q("{'id':123,'name':'Bob'}")), RecordWithReadOnly.class);
    ...
    public void testSerializeReadOnlyNamedProperty() throws Exception {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new RecordWithReadOnlyNamedProperty(123, "Bob")));
        assertEquals(a2q("{'id':123,'name':'Bob'}"), json);
    }
    ...
    public void testDeserializeReadOnlyNamedProperty() throws Exception {
        RecordWithReadOnlyNamedProperty value = MAPPER.readValue(VPackUtils.toVPack(a2q("{'id':123,'name':'Bob'}")),
    ...
    {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new ReadOnly5049Pojo("hello", "world")));
        ReadOnly5049Pojo pojo = MAPPER.readerFor(ReadOnly5049Pojo.class).readValue(VPackUtils.toVPack(json));
        assertNotNull(pojo);
        assertNull(pojo.a);
        assertNull(pojo.b);
    }
    ...
    {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new ReadOnly5049Record("hello", "world")));
        ReadOnly5049Record record = MAPPER.readValue(VPackUtils.toVPack(json), ReadOnly5049Record.class);
    ...
    public void testSerializeReadOnlyAccessor() throws Exception {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new RecordWithReadOnlyAccessor(123, "Bob")));
        assertEquals(a2q("{'id':123,'name':'Bob'}"), json);
    }
    ...
    public void testDeserializeReadOnlyAccessor() throws Exception {
        ...
        assertEquals(expected, MAPPER.readValue(VPackUtils.toVPack(a2q("{'id':123}")), RecordWithReadOnlyAccessor.class));
        assertEquals(expected, MAPPER.readValue(VPackUtils.toVPack(a2q("{'id':123,'name':null}")), RecordWithReadOnlyAccessor.class));
        assertEquals(expected, MAPPER.readValue(VPackUtils.toVPack(a2q("{'id':123,'name':'Bob'}")), RecordWithReadOnlyAccessor.class));
    }
    ...
    public void testSerializeReadOnlyComponentOverrideAccessor() throws Exception {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new RecordWithReadOnlyComponentOverriddenAccessor(123, "Bob")));
        assertEquals(a2q("{'id':123,'name':'Bob'}"), json);
    }
    ...
    public void testDeserializeReadOnlyComponentOverrideAccessor() throws Exception {
        ...
        assertEquals(expected, MAPPER.readValue(VPackUtils.toVPack(a2q("{'id':123}")), RecordWithReadOnlyComponentOverriddenAccessor.class));
        assertEquals(expected, MAPPER.readValue(VPackUtils.toVPack(a2q("{'id':123,'name':null}")), RecordWithReadOnlyComponentOverriddenAccessor.class));
        assertEquals(expected, MAPPER.readValue(VPackUtils.toVPack(a2q("{'id':123,'name':'Bob'}")), RecordWithReadOnlyComponentOverriddenAccessor.class));
    }
    ...
    public void testSerializeReadOnlyPrimitiveTypeProperty() throws Exception {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new RecordWithReadOnlyPrimitiveType(123, "Bob")));
        assertEquals(a2q("{'id':123,'name':'Bob'}"), json);
    }

    @Test
    public void testDeserializeReadOnlyPrimitiveTypeProperty() throws Exception {
        RecordWithReadOnlyPrimitiveType value = MAPPER.readValue(VPackUtils.toVPack(a2q("{'id':123,'name':'Bob'}")),
    ...
    public void testSerializeReadOnlyAllProperties() throws Exception {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new RecordWithReadOnlyAll(123, "Bob")));
        assertEquals(a2q("{'id':123,'name':'Bob'}"), json);
    }

    @Test
    public void testDeserializeReadOnlyAllProperties() throws Exception {
        RecordWithReadOnlyAll value = MAPPER.readValue(VPackUtils.toVPack(a2q("{'id':123,'name':'Bob'}")),
    ...
    public void testSerializeReadOnlyAllProperties_WithNoArgConstructor() throws Exception {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new RecordWithReadOnlyAllAndNoArgConstructor(123, "Bob")));
        assertEquals(a2q("{'id':123,'name':'Bob'}"), json);
    }

    @Test
    public void testDeserializeReadOnlyAllProperties_WithNoArgConstructor() throws Exception {
        RecordWithReadOnlyAllAndNoArgConstructor value = MAPPER.readValue(VPackUtils.toVPack(a2q("{'id':123,'name':'Bob'}")),
