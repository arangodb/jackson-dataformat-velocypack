...
public class RecordBasicsTest extends DatabindTestUtil
{
    ...
    public void testSerializeSimpleRecord() throws Exception {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new SimpleRecord(123, "Bob")));
        final Object EXP = map("id", Integer.valueOf(123), "name", "Bob");
        assertEquals(EXP, MAPPER.readValue(VPackUtils.toVPack(json), Object.class));
    }

    @Test
    public void testDeserializeSimpleRecord() throws Exception {
        assertEquals(new SimpleRecord(123, "Bob"),
                MAPPER.readValue(VPackUtils.toVPack("{\"id\":123,\"name\":\"Bob\"}"), SimpleRecord.class));
    }

    @Test
    public void testSerializeEmptyRecord() throws Exception {
        assertEquals("{}", VPackUtils.toJson(MAPPER.writeValueAsBytes(new EmptyRecord())));
    }

    @Test
    public void testDeserializeEmptyRecord() throws Exception {
        assertEquals(new EmptyRecord(),
                MAPPER.readValue(VPackUtils.toVPack("{}"), EmptyRecord.class));
    }
    ...
    public void testSerializeRecordOfRecord() throws Exception {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(record));
    ...
    public void testDeserializeRecordOfRecord() throws Exception {
        assertEquals(new RecordOfRecord(new SimpleRecord(123, "Bob")),
                MAPPER.readValue(VPackUtils.toVPack("{\"record\":{\"id\":123,\"name\":\"Bob\"}}"),
    ...
    public void testDeserializeSimpleRecord_DisableAnnotationIntrospector() throws Exception {
        VPackMapper mapper = VPackMapper.builder()
                .configure(MapperFeature.USE_ANNOTATIONS, false)
                .build();
        SimpleRecord value = mapper.readValue(VPackUtils.toVPack("{\"id\":123,\"name\":\"Bob\"}"), SimpleRecord.class);
    ...
    public void testSerializeJsonRename() throws Exception {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new RecordWithRename(123, "Bob")));
    ...
    public void testDeserializeJsonRename() throws Exception {
        RecordWithRename value = MAPPER.readValue(VPackUtils.toVPack("{\"id\":123,\"rename\":\"Bob\"}"),
    ...
    public void testDeserializeHeaderInjectRecord4218() throws Exception {
        ...
        assertNotNull(reader.readValue(VPackUtils.toVPack("{\"id\":123}")));
    }
    ...
    public void testDeserializeConstructorInjectRecord4218() throws Exception {
        ObjectReader reader = MAPPER.readerFor(RecordWithConstructorInject.class)
                .with(new InjectableValues.Std().addValue(String.class, "Bob"));
        RecordWithConstructorInject value = reader.readValue(VPackUtils.toVPack("{\"id\":123}"));
    ...
    public void testNamingStrategy() throws Exception
    {
        ...
        SnakeRecord output = MAPPER.readValue(VPackUtils.toVPack(json), SnakeRecord.class);
    ...
    public void testDeserializeJsonDeserializeRecord() throws Exception {
        RecordWithJsonDeserialize value = MAPPER.readValue(VPackUtils.toVPack("{\"id\":123,\"name\":\"   Bob   \"}"), RecordWithJsonDeserialize.class);
    ...
    public void testSerialize_SingleWriteOnlyParameter() throws Exception {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new RecordSingleWriteOnly(123)));
    ...
    public void testDeserialize_SingleWriteOnlyParameter() throws Exception {
        RecordSingleWriteOnly value = MAPPER.readValue(VPackUtils.toVPack("{\"id\":123}"), RecordSingleWriteOnly.class);
    ...
    public void testSerialize_SomeWriteOnlyParameter() throws Exception {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new RecordSomeWriteOnly(123, "Bob", "bob@example.com")));
    ...
    public void testDeserialize_SomeWriteOnlyParameter() throws Exception {
        RecordSomeWriteOnly value = MAPPER.readValue(
                VPackUtils.toVPack("{\"id\":123,\"name\":\"Bob\",\"email\":\"bob@example.com\"}"),
    ...
    public void testSerialize_AllWriteOnlyParameter() throws Exception {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new RecordAllWriteOnly(123, "Bob", "bob@example.com")));
    ...
    public void testSerializeWithSettersForGetters() throws Exception {
        ...
        assertEquals(VPackUtils.toJson(MAPPER.writeValueAsBytes(input)),
                VPackUtils.toJson(mapperWithSetters.writeValueAsBytes(input)));
    }
    ...
    public void testSerializePrivateTextRecord() throws Exception {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(textRecord));
    ...
    public void testDeserializePrivateTextRecord() throws Exception {
        assertEquals(new PrivateTextRecord4175("anything"),
                MAPPER.readValue(VPackUtils.toVPack("{\"text\":\"anything\"}"), PrivateTextRecord4175.class));
    }
    ...
    public void recordWithRenamedPropertyRoundTrips() throws Exception
    {
        ...
        RenamedRecord5967 result = MAPPER.readValue(VPackUtils.toVPack(json), RenamedRecord5967.class);
    ...
    void testJsonDeserializeOnRecord() throws Exception
    {
        ...
        Animal188 result = MAPPER.readValue(VPackUtils.toVPack(JSON), Animal188.class);
