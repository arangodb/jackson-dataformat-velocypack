...
public class RecordUpdateValueIgnoreView5966Test extends DatabindTestUtil
{
    ...
    public void testJsonIgnore_normalDeser_negativeControl() throws Exception {
        ...
        SecretRecord result = MAPPER.readValue(VPackUtils.toVPack("{\"name\":\"alice\",\"secret\":\"s3cr3t\"}"), SecretRecord.class);
    ...
    public void test5966_updateValueBypassesJsonIgnore() throws Exception {
        ...
        SecretRecord updated = MAPPER.updateValue(original, MAPPER.readTree(VPackUtils.toVPack(maliciousJson)));
    ...
    public void test5966_updateValueBypassesJsonIgnoreProperties() throws Exception {
        ...
        IgnoredPropsRecord updated = MAPPER.updateValue(original, MAPPER.readTree(VPackUtils.toVPack(maliciousJson)));
    ...
    public void test5966_updateValueBypassesJsonView() throws Exception {
        ...
        ViewRecord updated = MAPPER
            ...
            .readValue(VPackUtils.toVPack(maliciousJson));
    ...
    public void test5966_updateValueRespectsInjectionOnly() throws Exception {
        ...
        InjectRecord updated = mapper.updateValue(original, mapper.readTree(VPackUtils.toVPack(maliciousJson)));
    ...
    public void test5966_updateValueEmptyJsonRetainsIgnored() throws Exception {
        ...
        SecretRecord updated = MAPPER.updateValue(original, MAPPER.readTree(VPackUtils.toVPack("{}")));
