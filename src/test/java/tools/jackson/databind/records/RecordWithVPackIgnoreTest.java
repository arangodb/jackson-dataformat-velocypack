...
public class RecordWithVPackIgnoreTest extends DatabindTestUtil
{
    ...
    public void testSerializeJsonIgnoreRecord() throws Exception {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new RecordWithIgnore(123, "Bob")));
        assertEquals("{\"id\":123}", json);
    }

    @Test
    public void testDeserializeJsonIgnoreRecord() throws Exception {
        RecordWithIgnore value = MAPPER.readValue(VPackUtils.toVPack("{\"id\":123,\"name\":\"Bob\"}"),
    ...
    public void testSerializeJsonIgnoreAndJsonPropertyRecord() throws Exception {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new RecordWithIgnoreJsonProperty(123, "Bob")));
        assertEquals("{\"id\":123}", json);
    }

    @Test
    public void testDeserializeJsonIgnoreAndJsonPropertyRecord() throws Exception {
        RecordWithIgnoreJsonProperty value = MAPPER.readValue(VPackUtils.toVPack("{\"id\":123,\"name\":\"Bob\"}"),
    ...
    public void testDeserializeJsonIgnoreRecordWithDifferentName() throws Exception {
        RecordWithIgnoreJsonPropertyDifferentName value = MAPPER.readValue(VPackUtils.toVPack("{\"id\":123,\"name\":\"Bob\"}"),
    ...
    public void testSerializeJsonIgnoreAccessorRecord() throws Exception {
        assertEquals("{\"id\":123}",
                VPackUtils.toJson(MAPPER.writeValueAsBytes(new RecordWithIgnoreAccessor(123, "Bob"))));
    }
    ...
    public void testDeserializeJsonIgnoreAccessorRecord() throws Exception {
        ...
        assertEquals(expected, MAPPER.readValue(VPackUtils.toVPack("{\"id\":123}"), RecordWithIgnoreAccessor.class));
        assertEquals(expected, MAPPER.readValue(VPackUtils.toVPack("{\"id\":123,\"name\":null}"), RecordWithIgnoreAccessor.class));
        assertEquals(expected, MAPPER.readValue(VPackUtils.toVPack("{\"id\":123,\"name\":\"Bob\"}"), RecordWithIgnoreAccessor.class));
    }
    ...
    public void testSerializeJsonIgnorePrimitiveTypeRecord() throws Exception {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new RecordWithIgnorePrimitiveType(123, "Bob")));
        assertEquals("{\"name\":\"Bob\"}", json);
    }

    @Test
    public void testDeserializeJsonIgnorePrimitiveTypeRecord() throws Exception {
        RecordWithIgnorePrimitiveType value = vpackMapperBuilder()
                .disable(DeserializationFeature.FAIL_ON_NULL_FOR_PRIMITIVES)
                .build()
                .readValue(VPackUtils.toVPack("{\"id\":123,\"name\":\"Bob\"}"), RecordWithIgnorePrimitiveType.class);
    ...
    public void testJsonIgnoreWithOverriddenAccessor3992() throws Exception {
        ...
        String json = VPackUtils.toJson(MAPPER.writer()
                .writeValueAsBytes(new HelloRecord("hello", beanWithRecursion)));
        assertEquals(a2q("{'text':'hello'}"), json);

        HelloRecord result = MAPPER.readValue(VPackUtils.toVPack(json), HelloRecord.class);
    ...
    public void testDeserializeJsonIgnoreWithOverride4626() throws Exception {
        ...
        assertEquals(expected, MAPPER.readValue(VPackUtils.toVPack(a2q("{'text':'hello'}")), HelloRecord.class));
        assertEquals(expected, MAPPER.readValue(VPackUtils.toVPack(a2q("{'text':'hello','hidden':null}")), HelloRecord.class));
        assertEquals(expected, MAPPER.readValue(VPackUtils.toVPack(a2q("{'text':'hello','hidden':{'all': []}}")), HelloRecord.class));
    }
    ...
    void testDeserializeWithIgnoredNonComponentGetter5184() throws Exception {
        ...
        var testData = MAPPER.readValue(VPackUtils.toVPack(json), TestData5184.class);
    ...
    void testDeserializeWithIgnoredNonComponentGetterOnClass5184() throws Exception {
        ...
        var testData = MAPPER.readValue(VPackUtils.toVPack(json), TestData5184Class.class);
    ...
    void testDeserializeWithIgnoredAlternateNonComponentGetter5184() throws Exception {
        ...
        var testData = MAPPER.readValue(VPackUtils.toVPack(json), TestData5184Alternate.class);
    ...
    void testDeserializeIgnoresWrongPropertyName5184() throws Exception {
        ...
        TestData5184 testData = MAPPER.readValue(VPackUtils.toVPack(json), TestData5184.class);
