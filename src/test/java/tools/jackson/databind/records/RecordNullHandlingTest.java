...
public class RecordNullHandlingTest extends DatabindTestUtil
{
    ...
    private final ObjectMapper NULL_MAPPER = VPackMapper.builder()
    ...
    public void testPojoNullHandlingValid() throws Exception {
        Pojo3847 pojo = NULL_MAPPER.readValue(VPackUtils.toVPack(a2q("{'fieldName': 'value'}")), Pojo3847.class);
    ...
    public void testPojoNullHandlingNullValue() throws Exception {
        try {
            NULL_MAPPER.readValue(VPackUtils.toVPack(a2q("{'fieldName': null}")), Pojo3847.class);
    ...
    public void testPojoNullHandlingEmptyJson() throws Exception {
        assertNotNull(NULL_MAPPER.readValue(VPackUtils.toVPack("{}"), Pojo3847.class));
    }

    @Test
    public void testRecordNullHandlingValid() throws Exception {
        PlainRecord plainRecord = NULL_MAPPER.readValue(VPackUtils.toVPack(a2q("{'fieldName': 'value'}")), PlainRecord.class);
    ...
    public void testRecordNullHandlingNullValue() throws Exception {
        try {
            NULL_MAPPER.readValue(VPackUtils.toVPack(a2q("{'fieldName': null}")), PlainRecord.class);
            fail("should expect InvalidNullException");
        } catch (InvalidNullException e) {
            verifyException(e, "Invalid `null` value encountered for property \"fieldName\"");
        }
    ...
    public void testRecordNullHandlingEmptyJson() throws Exception {
        try {
            NULL_MAPPER.readValue(VPackUtils.toVPack("{}"), PlainRecord.class);
            fail("should expect InvalidNullException");
        } catch (InvalidNullException e) {
            verifyException(e, "Invalid `null` value encountered for property \"fieldName\"");
        }
    ...
    public void testRecordFixedNullHandlingValid() throws Exception {
        FixedRecord fixedRecord = NULL_MAPPER.readValue(VPackUtils.toVPack(a2q("{ 'field_name': 'value' }")), FixedRecord.class);
    ...
    public void testRecordFixedNullHandlingNullValue() throws Exception {
        try {
            NULL_MAPPER.readValue(VPackUtils.toVPack(a2q("{ 'field_name': null }")), FixedRecord.class);
            fail("should expect InvalidNullException");
        } catch (InvalidNullException e) {
    ...
    public void testRecordFixedNullHandlingEmptyJson() throws Exception {
        try {
            NULL_MAPPER.readValue(VPackUtils.toVPack("{}"), FixedRecord.class);
            fail("should expect InvalidNullException");
        } catch (InvalidNullException e) {
            verifyException(e, "Invalid `null` value encountered for property \"field_name\"");
        }
    ...
    public void testRecordDefaultNullDeserialization() throws Exception {
        PlainRecord pr = DEFAULT_MAPPER.readValue(VPackUtils.toVPack("{}"), PlainRecord.class);
    ...
    void testEmptyObjectIntoRecordWithListOfRecord() throws Exception {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        Foo foo = mapper.readValue(VPackUtils.toVPack("{}"), Foo.class);
        assertNull(foo.list());
    }
    ...
    void testNonEmptyListIntoRecordWithListOfRecord() throws Exception {
        ObjectMapper mapper = vpackMapperBuilder()
                .changeDefaultNullHandling(h -> h.withContentNulls(Nulls.AS_EMPTY))
                .build();
        Foo foo = mapper.readValue(VPackUtils.toVPack("{\"list\":[{\"name\":\"a\",\"value\":\"b\"}]}"), Foo.class);
    ...
    public void testNonAbsentInclusionViaDefaultConfig5418() throws Exception
    {
        ...
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(new TestRecord5418("test subject", null)));
        assertEquals(a2q("{'subject':'test subject'}"), json);

        // Both null
        json = VPackUtils.toJson(mapper.writeValueAsBytes(new TestRecord5418(null, null)));
        assertEquals("{}", json);

        // Both present
        json = VPackUtils.toJson(mapper.writeValueAsBytes(new TestRecord5418("test subject", "test body")));
    ...
    public void testDeserializeWithNullAsEmpty() throws Exception
    {
        ...
        // First, regular case
        RecordWithNonNullDefs2974 value = r.readValue(VPackUtils.toVPack(a2q(
"{'names':['bob'],'agesByNames':{'bob':39}}")));
        ...
        // Then leave out list
        value = r.readValue(VPackUtils.toVPack(a2q("{'agesByNames':{'bob':42}}")));
    ...
    public void testDeserializeWithFailForNull() throws Exception
    {
        ...
        try {
            r.readValue(VPackUtils.toVPack(a2q("{'names':['bob']}")));
