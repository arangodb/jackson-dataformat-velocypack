    ...
    extends DatabindTestUtil
{
    ...
    public void testDataBindingUsage( ) throws Exception
    {
      ...
      ObjectWriter objectWriter = objectMapper.writerWithView(Views.View.class);
      Object object = new ComplexTestData();
      String json = VPackUtils.toJson(objectWriter.writeValueAsBytes(object));
    ...
    public void testIssue560() throws Exception
    {
        ...
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        String json = VPackUtils.toJson(mapper.writerWithView(AView.class).writeValueAsBytes(a));
