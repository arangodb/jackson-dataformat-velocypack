    ...
    extends DatabindTestUtil
{
    ...
    static class MyPairMixIn8 { // with and without <Long, String>
         @JsonCreator
         static Pair2020 with(@JsonProperty("value0") Object value0,
    ...
    public void testForConstructor() throws IOException
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        BaseClassWithPrivateCtor result = mapper.readValue(VPackUtils.toVPack("\"?\""), BaseClassWithPrivateCtor.class);
    ...
    public void testForFactoryAndCtor() throws IOException
    {
        ...
        result = new VPackMapper().readValue(VPackUtils.toVPack("\"string\""), BaseClass.class);
        ...
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        result = mapper.readValue(VPackUtils.toVPack("\"string\""), BaseClass.class);
    ...
    public void testFactoryDelegateMixIn() throws IOException
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        StringWrapper result = mapper.readValue(VPackUtils.toVPack("\"a\""), StringWrapper.class);
    ...
    public void testFactoryPropertyMixin() throws Exception
    {
        ...
        Pair2020 pair2 = mapper.readValue(VPackUtils.toVPack(doc), Pair2020.class);
