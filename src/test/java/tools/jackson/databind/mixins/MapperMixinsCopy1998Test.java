...
public class MapperMixinsCopy1998Test extends DatabindTestUtil
{
    ...
    public void testSharedBuilder() throws Exception
    {
        ...
        String postResult = VPackUtils.toJson(mapper.writeValueAsBytes(myModelInstance));
        ...
        mapper = B
                ...
                .build();
        String result = VPackUtils.toJson(mapper
                .writerWithView(MyModelView.class)
                .writeValueAsBytes(myModelInstance));
    ...
    {
        return vpackMapperBuilder().changeDefaultPropertyInclusion(incl ->
