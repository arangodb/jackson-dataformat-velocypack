...
public class ContextualKeyTypesTest extends DatabindTestUtil
{
    ...
    public void testSimpleKeySer() throws Exception
    {
        ...
        String json = VPackUtils.toJson(mapper.writerFor(defaultTypeFactory().constructMapType(HashMap.class, String.class, Object.class))
    ...
    public void testSimpleKeyDeser() throws Exception
    {
        ...
        ObjectMapper mapper = vpackMapperBuilder()
                .addModule(module)
                .build();
        MapBean result = mapper.readValue(VPackUtils.toVPack("{\"map\":{\"a\":3}}"), MapBean.class);
