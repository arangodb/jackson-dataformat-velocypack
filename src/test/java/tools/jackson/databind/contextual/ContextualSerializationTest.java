...
public class ContextualSerializationTest
{
    ...
    public void testMethodAnnotations() throws Exception
    {
        ...
        ObjectMapper mapper = vpackMapperBuilder()
                .addModule(module)
                .build();
        assertEquals("{\"value\":\"see:foobar\"}", VPackUtils.toJson(mapper.writeValueAsBytes(new ContextualBean("foobar"))));
    }
    ...
    public void testClassAnnotations() throws Exception
    {
        ...
        ObjectMapper mapper = vpackMapperBuilder()
                .addModule(module)
                .build();
        assertEquals("{\"value\":\"Voila->xyz\"}", VPackUtils.toJson(mapper.writeValueAsBytes(new BeanWithClassConfig("xyz"))));
    }
    ...
    public void testWrappedBean() throws Exception
    {
        ...
        ObjectMapper mapper = vpackMapperBuilder()
                .addModule(module)
                .build();
        assertEquals("{\"wrapped\":{\"value\":\"see:xyz\"}}", VPackUtils.toJson(mapper.writeValueAsBytes(new ContextualBeanWrapper("xyz"))));
    }
    ...
    public void testMethodAnnotationInArray() throws Exception
    {
        ...
        assertEquals("{\"beans\":[\"array->123\"]}", VPackUtils.toJson(mapper.writeValueAsBytes(beans)));
    }
    ...
    public void testMethodAnnotationInList() throws Exception
    {
        ...
        assertEquals("{\"beans\":[\"list->abc\"]}", VPackUtils.toJson(mapper.writeValueAsBytes(beans)));
    }
    ...
    public void testMethodAnnotationInMap() throws Exception
    {
        ...
        assertEquals("{\"beans\":{\"first\":\"map->In Map\"}}", VPackUtils.toJson(mapper.writeValueAsBytes(map)));
    }
    ...
    public void testContextualViaAnnotation() throws Exception
    {
        ...
        assertEquals("{\"value\":\"prefix->abc\"}", VPackUtils.toJson(mapper.writeValueAsBytes(bean)));
    }
    ...
    public void testResolveOnContextual() throws Exception
    {
        ...
        ObjectMapper mapper = vpackMapperBuilder()
                .addModule(module)
                .build();
        assertEquals(q("contextual=1,resolved=1"), VPackUtils.toJson(mapper.writeValueAsBytes("abc")));

        // also: should NOT be called again
        assertEquals(q("contextual=1,resolved=1"), VPackUtils.toJson(mapper.writeValueAsBytes("foo")));
    }
    ...
    public void testContextualArrayElement() throws Exception
    {
        ...
        assertEquals("{\"beans\":[\"elem->456\"]}", VPackUtils.toJson(mapper.writeValueAsBytes(beans)));
    }
    ...
    public void testRootContextualization2429() throws Exception
    {
        ...
        // .disable(VPackWriteFeature.ESCAPE_FORWARD_SLASHES)
                ...
                .build();
        assertEquals(q("/ROOT/foo"), VPackUtils.toJson(mapper.writeValueAsBytes("foo")));
        assertEquals(q("/ROOT/bar"), VPackUtils.toJson(mapper.writeValueAsBytes("bar")));
        assertEquals(q("/ROOT/3"), VPackUtils.toJson(mapper.writeValueAsBytes("3")));
    }
}
