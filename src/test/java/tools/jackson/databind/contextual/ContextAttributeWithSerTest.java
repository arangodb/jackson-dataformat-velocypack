...
public class ContextAttributeWithSerTest
{
    ...
    public void testSimpleDefaults() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writer().withAttribute(KEY, Integer.valueOf(3))
                .writeValueAsBytes(INPUT));
        assertEquals(EXP, json);

        String json2 = VPackUtils.toJson(MAPPER.writer().withAttribute(KEY, Integer.valueOf(3))
                .writeValueAsBytes(INPUT));
    ...
    public void testDefaultsViaMapper() throws Exception
    {
        ...
        assertEquals(EXP1, VPackUtils.toJson(mapper.writeValueAsBytes(INPUT)));
