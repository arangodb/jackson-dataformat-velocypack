...
public class ContextAttributeWithDeserTest
{
    ...
    public void testSimplePerCall() throws Exception
    {
        ...
        TestPOJO[] pojos = MAPPER.readerFor(TestPOJO[].class).readValue(VPackUtils.toVPack(INPUT));
        ...
        TestPOJO[] pojos2 = MAPPER.readerFor(TestPOJO[].class).readValue(VPackUtils.toVPack(INPUT));
