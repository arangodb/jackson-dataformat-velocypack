...
public class AbsentNodeToMissing5861Test extends DatabindTestUtil
{
    ...
    private final ObjectMapper MISSING_MAPPER = vpackMapperBuilder()
    ...
    {
        CreatorBean5861 result = DEFAULT_MAPPER.readValue(VPackUtils.toVPack("{}"), CreatorBean5861.class);
    ...
    {
        CreatorBean5861 result = MISSING_MAPPER.readValue(VPackUtils.toVPack("{}"), CreatorBean5861.class);
    ...
    {
        CreatorBean5861 result = MISSING_MAPPER.readValue(VPackUtils.toVPack("{\"node\":null}"), CreatorBean5861.class);
        assertNotNull(result.node);
    ...
    {
        CreatorBean5861 result = MISSING_MAPPER.readValue(VPackUtils.toVPack("{\"node\":42}"), CreatorBean5861.class);
        assertNotNull(result.node);
