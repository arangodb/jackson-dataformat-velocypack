 ...
 */
public class VPackNodeBasicTest extends NodeTestBase
{
    ...
    public void testBoolean() throws Exception
    {
        ...
        JsonNode result = objectMapper().readTree(VPackUtils.toVPack("true\n"));
    ...
    public void testArrayWithDefaultTyping() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
            ...
            .build();
        JsonNode array = mapper.readTree(VPackUtils.toVPack("[ 1, 2 ]"));
        assertTrue(array.isArray());
        assertEquals(2, array.size());
        JsonNode obj = mapper.readTree(VPackUtils.toVPack("{ \"a\" : 2 }"));
