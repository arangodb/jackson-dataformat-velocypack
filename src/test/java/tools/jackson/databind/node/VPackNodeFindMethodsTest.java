...
public class VPackNodeFindMethodsTest
    extends DatabindTestUtil
{
    ...
    {
        JsonNode root = MAPPER.readTree(VPackUtils.toVPack(JSON_SAMPLE));
    ...
    {
        JsonNode rootNode = MAPPER.readTree(VPackUtils.toVPack(JSON_4229));
