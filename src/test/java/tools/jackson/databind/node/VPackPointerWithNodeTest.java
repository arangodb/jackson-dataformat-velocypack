...
public class VPackPointerWithNodeTest
    extends DatabindTestUtil
{
    ...
    {
        final JsonNode SAMPLE_ROOT = MAPPER.readTree(VPackUtils.toVPack(SAMPLE_DOC_JSON_SPEC));
    ...
    public void testLongNumbers() throws Exception
    {
        ...
        JsonNode root = MAPPER.readTree(VPackUtils.toVPack("{\"123\" : 456}"));
        JsonNode jn2 = root.at("/123");
        assertEquals(456, jn2.asInt());

        // and then with above int-32:
        root = MAPPER.readTree(VPackUtils.toVPack("{\"35361706045\" : 1234}"));
    ...
    {
        JsonNode tree = MAPPER.readTree(VPackUtils.toVPack("{\"\" : 123}"));
