...
public class NodeContext2049Test extends DatabindTestUtil
{
    ...
    private ObjectMapper objectMapper = VPackMapper.builder()
    ...
    public void testReadNoBuffering() throws Exception {
        Parent obj = objectMapper.readerFor(Parent.class).readValue(VPackUtils.toVPack(JSON));
    ...
    public void testReadFromTree() throws Exception {
        JsonNode tree = objectMapper.readTree(VPackUtils.toVPack(JSON));
