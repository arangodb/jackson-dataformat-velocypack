 ...
 */
public class VPackNodeConversionsTest extends DatabindTestUtil
{
    static class Root {
        public Leaf leaf;
    }
    ...
    public void testTreeToValue() throws Exception
    {
        ...
        root = mapper.readTree(VPackUtils.toVPack(JSON));
    ...
    public void testIssue709() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(node));
        Issue709Bean resultFromString = MAPPER.readValue(VPackUtils.toVPack(json), Issue709Bean.class);
    ...
    {
        ObjectMapper mapper = new VPackMapper(VPackFactory.builder()
    ...
    public void testConversionOfPojos() throws Exception
    {
        ...
        assertEquals(EXP, VPackUtils.toJson(MAPPER.writeValueAsBytes(tree)));

        JsonNode tree2 = MAPPER.writer().valueToTree(input);
        assertEquals(EXP, VPackUtils.toJson(MAPPER.writeValueAsBytes(tree2)));
    }
    ...
    public void testBufferedLongViaCoercion() throws Exception {
        ...
        JsonNode tree = MAPPER.readTree(VPackUtils.toVPack("{\"longObj\": "+EXP+".0, \"_class\": \""+LongContainer1940.class.getName()+"\"}"));
    ...
    {
        ObjectNode src = (ObjectNode) MAPPER.readTree(VPackUtils.toVPack("{}"));
        JsonNode node = src;
    ...
    public void testValueToTree() throws Exception
    {
        ...
        ObjectMapper wrapRootMapper = vpackMapperBuilder()
                .enable(SerializationFeature.WRAP_ROOT_VALUE)
                .build();

        // Act & Assert
        String expected = "{\"event\":{\"id\":1,\"name\":\"foo\"}}";
        assertEquals(wrapRootMapper.readValue(VPackUtils.toVPack(expected), Map.class), wrapRootMapper.readValue(VPackUtils.toVPack(VPackUtils.toJson(wrapRootMapper.writeValueAsBytes(value))), Map.class));
        assertEquals(wrapRootMapper.readValue(VPackUtils.toVPack(expected), Map.class), wrapRootMapper.readValue(VPackUtils.toVPack(wrapRootMapper.valueToTree(value).toString()), Map.class));
    }
