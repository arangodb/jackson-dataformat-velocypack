...
public class TreeWithTypeTest extends DatabindTestUtil
{
    ...
    public void testValueAsStringWithoutDefaultTyping() throws Exception {
        ...
        JsonNode jsonNode = MAPPER.readTree(VPackUtils.toVPack(json));
    ...
    public void testIssue353() throws Exception
    {
        ...
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(savedCookie));
        SavedCookie out = mapper.readerFor(SavedCookie.class).readValue(VPackUtils.toVPack(json));
