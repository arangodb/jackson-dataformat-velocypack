 ...
 */
public class VPackNodeMapTest extends NodeTestBase
{
    ...
    {
        JsonNode node = MAPPER.readTree(VPackUtils.toVPack("42"));
    ...
    {
        JsonNode node = MAPPER.readTree(VPackUtils.toVPack("null"));
    ...
    {
        JsonNode node = MAPPER.readTree(VPackUtils.toVPack("{\"name\":\"John\",\"age\":30}"));
    ...
    {
        JsonNode node = MAPPER.readTree(VPackUtils.toVPack("[1,2,3,4,5]"));
    ...
    {
        JsonNode node = MAPPER.readTree(VPackUtils.toVPack("{\"x\":10,\"y\":20}"));
