    ...
    extends DatabindTestUtil
{
    ...
    public void testReadFromString() throws Exception
    {
        ...
        JsonNode jNode = mapper.readValue(VPackUtils.toVPack(json), JsonNode.class);

        String generated = VPackUtils.toJson(mapper.writeValueAsBytes( jNode));  //back slashes are gone
        JsonNode out = mapper.readValue( VPackUtils.toVPack(generated), JsonNode.class );   //crashes here
