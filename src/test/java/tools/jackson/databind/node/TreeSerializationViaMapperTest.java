    ...
    extends DatabindTestUtil
{
        ...
        throws Exception
    {
        ...
        JsonGenerator jg = mapper.createGenerator(out);
        mapper.writeTree(jg, n);

        Map<String,Object> result = (Map<String,Object>) mapper.readValue(out.toByteArray(), Map.class);
