 ...
 */
public class VPackPointerRemoval1981Test extends DatabindTestUtil
{
    ...
    public void testRemoveSimpleProperty() throws Exception
    {
        ...
        assertEquals(MAPPER.readTree(VPackUtils.toVPack(a2q("""
                {
                   "a": 1,
                   "c": 3
                }
    ...
    public void testRemoveNestedProperty() throws Exception
    {
        ...
        ObjectNode root = (ObjectNode) MAPPER.readTree(VPackUtils.toVPack(json));
        ...
        assertEquals(MAPPER.readTree(
                VPackUtils.toVPack(a2q("{'a':{'b':{'d':14},'e':15},'f':16}"))),
                root);
    }
    ...
    public void testRemoveArrayElement() throws Exception
    {
        ...
        assertEquals(MAPPER.readTree(VPackUtils.toVPack("[10,30,40]")), array);
    }
    ...
    public void testRemoveFromNestedArray() throws Exception
    {
        ...
        assertEquals(MAPPER.readTree(VPackUtils.toVPack(a2q("{'array':[1,2,4,5]}"))), root);
    }
    ...
    public void testRemoveWithCompiledPointer() throws Exception
    {
        ...
        assertEquals(MAPPER.readTree(VPackUtils.toVPack(a2q("{'y':200}"))), root);
    }
    ...
    public void testRemoveNonExistentProperty() throws Exception
    {
        ...
        assertEquals(MAPPER.readTree(VPackUtils.toVPack(a2q("{'a':1}"))), root);
    }
    ...
    public void testRemoveNonExistentArrayIndex() throws Exception
    {
        ...
        assertEquals(MAPPER.readTree(VPackUtils.toVPack("[1, 2]")), array);
    }
    ...
    public void testRemoveNonExistentNestedPath() throws Exception
    {
        ...
        // Structure should be unchanged
        assertEquals(MAPPER.readTree(VPackUtils.toVPack(json)), root);
    }
    ...
    public void testRemoveEntireObject() throws Exception
    {
        ...
        assertEquals(MAPPER.readTree(VPackUtils.toVPack(a2q("{'outer':{}}"))), root);
    }
    ...
    public void testRemoveEntireArray() throws Exception
    {
        ...
        assertEquals(MAPPER.readTree(VPackUtils.toVPack(a2q("{'data':{}}"))), root);
    }
