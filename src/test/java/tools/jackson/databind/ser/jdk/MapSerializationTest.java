...
public class MapSerializationTest extends DatabindTestUtil
{
    ...
    private final ObjectMapper SORTING_MAPPER = vpackMapperBuilder()
    ...
    public void testUsingObjectWriter() throws IOException
    {
        ...
        map.put("a", 1);
        String json = VPackUtils.toJson(w.writeValueAsBytes(map));
    ...
    {
        assertEquals("\"{a=b, c=d}\"", VPackUtils.toJson(MAPPER.writeValueAsBytes(new PseudoMap("a", "b", "c", "d"))));
    }
    ...
    public void testMapKeySetValuesSerialization() throws IOException
    {
        ...
        map.put("a", "b");
        assertEquals("[\"a\"]", VPackUtils.toJson(MAPPER.writeValueAsBytes(map.keySet())));
        assertEquals("[\"b\"]", VPackUtils.toJson(MAPPER.writeValueAsBytes(map.values())));

        // TreeMap has similar inner class(es):
        map = new TreeMap<String,String>();
        map.put("c", "d");
        assertEquals("[\"c\"]", VPackUtils.toJson(MAPPER.writeValueAsBytes(map.keySet())));
        assertEquals("[\"d\"]", VPackUtils.toJson(MAPPER.writeValueAsBytes(map.values())));

        // and for [JACKSON-533], same for concurrent maps
        map = new ConcurrentHashMap<String,String>();
        map.put("e", "f");
        assertEquals("[\"e\"]", VPackUtils.toJson(MAPPER.writeValueAsBytes(map.keySet())));
        assertEquals("[\"f\"]", VPackUtils.toJson(MAPPER.writeValueAsBytes(map.values())));
    }
    ...
    public void testOrderByKey() throws IOException
    {
        ...
        assertEquals("{\"b\":3,\"a\":6}", VPackUtils.toJson(m.writeValueAsBytes(map)));
        // but can be changed
        ObjectWriter sortingW =  m.writer(SerializationFeature.ORDER_MAP_ENTRIES_BY_KEYS);
        assertEquals("{\"a\":6,\"b\":3}", VPackUtils.toJson(sortingW.writeValueAsBytes(map)));
    }
    ...
    public void testOrderByWithNulls() throws IOException
    {
        ...
        try {
            /*String json =*/ VPackUtils.toJson(sortingW.writeValueAsBytes(mapWithNullKey));
    ...
    public void testConcurrentMaps() throws Exception
    {
        ...
        input.put("x", "y");
        input.put("a", "b");
        json = VPackUtils.toJson(w.writeValueAsBytes(input));
        assertEquals(a2q("{'a':'b','x':'y'}"), json);
    ...
    public void testDynamicMapKeys() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(stuff));
    ...
    public void testClassAsKey() throws Exception {
        ...
        String actual = VPackUtils.toJson(MAPPER.writeValueAsBytes(map));
    ...
    public void testClassAsValue() throws Exception {
        ...
        String actual = VPackUtils.toJson(MAPPER.writeValueAsBytes(mapA));
    ...
    public void testNotKarl() throws Exception {
        final String serialized = VPackUtils.toJson(MAPPER.writeValueAsBytes(new NotKarlBean()));
        assertEquals("{\"map\":{\"Not Karl\":1}}", serialized);
    }

    @Test
    public void testKarl() throws Exception {
        final String serialized = VPackUtils.toJson(MAPPER.writeValueAsBytes(new KarlBean()));
    ...
    public void testBoth() throws Exception
    {
        ...
        final String value1 = VPackUtils.toJson(mapper.writeValueAsBytes(new NotKarlBean()));
        assertEquals("{\"map\":{\"Not Karl\":1}}", value1);
        final String value2 = VPackUtils.toJson(mapper.writeValueAsBytes(new KarlBean()));
    ...
    public void testCustomForEnum() throws Exception
    {
        ...
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(new ABCMapWrapper()));
    ...
    public void testCustomNullSerializers() throws Exception
    {
        ...
        json = VPackUtils.toJson(mapper.writeValueAsBytes(new Object[] { 1, null, true }));
    ...
    public void testUnWrappedMapWithKeySerializer() throws Exception{
        ...
        String json = VPackUtils.toJson(mapper.writerFor(new TypeReference<Map<ABCKey,BAR<?>>>() {})
    ...
    public void testUnWrappedMapWithDefaultType() throws Exception{
        ...
        TypeResolverBuilder<?> typer = new DefaultTypeResolverBuilder(
                ...
                JsonTypeInfo.As.PROPERTY, Id.NAME, null)
        ...
        stuff.put(ABCKey.B, "bar");
        String json = VPackUtils.toJson(mapper.writerFor(new TypeReference<Map<ABCKey, String>>() {})
                .writeValueAsBytes(stuff));
    ...
    public void testMapKeyRecursion1679() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(objectMap));
        assertNotNull(json);
    }
            ...
            throws Exception
    {
        ...
        try {
            VPackUtils.toJson(SORTING_MAPPER.writer()
    ...
    void testSerializationWithGenericObjectKeys() throws Exception
    {
        ...
        String jsonResult = VPackUtils.toJson(SORTING_MAPPER.writeValueAsBytes(entity));
