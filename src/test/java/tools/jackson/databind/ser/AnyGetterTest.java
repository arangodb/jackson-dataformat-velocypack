...
public class AnyGetterTest extends DatabindTestUtil
{
    ...
    public void testDynaFieldBean() throws Exception
    {
        ...
        DynaFieldBean result = MAPPER.readValue(VPackUtils.toVPack("{\"id\":2,\"name\":\"Joe\"}"), DynaFieldBean.class);
    ...
    public void testDynaFieldOrderedBean() throws Exception
    {
        ...
        assertEquals("{\"id\":123,\"nameA\":\"Ailly\",\"nameB\":\"Billy\",\"nameC\":\"Cilly\"}", VPackUtils.toJson(MAPPER.writeValueAsBytes(b)));
    }
    ...
    public void testAnyOnly() throws Exception
    {
        ...
        m = vpackMapperBuilder()
                ...
                .build();
        assertEquals("{\"a\":3}", VPackUtils.toJson(m.writeValueAsBytes(new AnyOnlyBean())));

        // then without fail
        String json = VPackUtils.toJson(m.writer()
    ...
    {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new NotEvenAnyBean()));
    ...
    void anyBeanWithSort518() throws Exception
    {
        ...
        extra.put("y", 4);
        extra.put("x", 3);
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new Bean518(2, 1, extra)));
    ...
    public void testIgnoreProperties() throws Exception {
        ...
        bean.map.put("b", 3);
        assertEquals(a2q("{'a':1,'b':3}"), VPackUtils.toJson(MAPPER.writeValueAsBytes(bean)));

        // Respect @JsonIgnoreProperties 'b' from Pojo, but not from map
        IgnorePropertiesOnAnyGetterPojo bean2 = new IgnorePropertiesOnAnyGetterPojo();
        bean2.map.put("b", 3);
        assertEquals(a2q("{'a':1,'b':2}"), VPackUtils.toJson(MAPPER.writeValueAsBytes(bean2)));

        // Respect @JsonIgnore from Pojo, but not from map
        IgnoreOnFieldPojo bean3 = new IgnoreOnFieldPojo();
        bean3.map.put("b", 3);
        assertEquals(a2q("{'a':1,'b':3}"), VPackUtils.toJson(MAPPER.writeValueAsBytes(bean3)));
    }
    ...
    public void testSortingOnAnyGetter() throws Exception {
        ...
        assertEquals(a2q("{" +
            ...
            "'zb':2," +
            "'zc':3," +
            "'zd':4}"), VPackUtils.toJson(MAPPER.writeValueAsBytes(bean)));
    }
    ...
    public void testSortingOnClassNotPropagateToAnyGetter() throws Exception {
        ...
        assertEquals(a2q("{" +
            ...
            "'zc':3," +
            "'za':1," +
            "'zb':2}"), VPackUtils.toJson(MAPPER.writeValueAsBytes(bean)));
    }

    @Test
    public void testLinkUnlinkWithJsonIgnore() throws Exception {
        LinkUnlinkConflictPojo pojo = new LinkUnlinkConflictPojo();
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(pojo));
    ...
    public void dynaBean5215() throws Exception
    {
        ...
        assertEquals(a2q("{" +
                ...
                "'l':'3'," +
                "'b':'4'," +
                "'z':'5'}"), VPackUtils.toJson(mapper.writeValueAsBytes(b)));
    }
}
