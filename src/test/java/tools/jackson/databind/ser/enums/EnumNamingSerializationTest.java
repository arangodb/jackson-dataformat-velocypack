...
public class EnumNamingSerializationTest extends DatabindTestUtil
{
    ...
    */
    ...
    public void enumNamingShouldOverrideToStringFeature() throws Exception {
        String resultStr = VPackUtils.toJson(MAPPER.writer()
    ...
    public void enumNamingStrategyNotApplied() throws Exception {
        String resultString = VPackUtils.toJson(MAPPER.writeValueAsBytes(EnumSauceC.SRIRACHA_MAYO));
    ...
    public void enumNamingStrategyStartingUnderscoreBecomesUpperCase() throws Exception {
        String flavor = VPackUtils.toJson(MAPPER.writeValueAsBytes(EnumFlavorD._PEANUT_BUTTER));
        assertEquals(q("PeanutButter"), flavor);
    }

    @Test
    public void enumNamingStrategyNonPrefixContiguousUnderscoresBecomeOne() throws Exception {
        String flavor1 = VPackUtils.toJson(MAPPER.writeValueAsBytes(EnumFlavorD.PEANUT__BUTTER));
        assertEquals(q("peanutButter"), flavor1);

        String flavor2 = VPackUtils.toJson(MAPPER.writeValueAsBytes(EnumFlavorD.PEANUT_BUTTER));
    ...
    public void enumSetWrite() throws Exception {
        ...
        assertEquals("[\"ketchUp\"]", VPackUtils.toJson(MAPPER.writeValueAsBytes(value)));
    }
    ...
    public void enumNamingStrategyWithOverride() throws Exception {
        String almond = VPackUtils.toJson(MAPPER.writeValueAsBytes(EnumFlavorE.ALMOND_BUTTER));
        assertEquals(q("almond"), almond);

        String peanut = VPackUtils.toJson(MAPPER.writeValueAsBytes(EnumFlavorE.PEANUT_BUTTER));
