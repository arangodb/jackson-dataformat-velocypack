    ...
    extends DatabindTestUtil
{
    ...
    {
        assertEquals("\"B\"", VPackUtils.toJson(MAPPER.writeValueAsBytes(TestEnum.B)));
    }
    ...
    public void testEnumSet() throws Exception
    {
        ...
        assertEquals("[\"B\"]", VPackUtils.toJson(MAPPER.writeValueAsBytes(value)));
    }
    ...
    {
        assertEquals("\"c2\"", VPackUtils.toJson(MAPPER.writeValueAsBytes(AnnotatedTestEnum.C2)));
    }

    @Test
    public void testSubclassedEnums() throws Exception
    {
        assertEquals("\"B\"", VPackUtils.toJson(MAPPER.writeValueAsBytes(EnumWithSubClass.B)));
    }

    @Test
    public void testEnumsWithJsonValue() throws Exception {
        assertEquals("\"value:bar\"", VPackUtils.toJson(MAPPER.writeValueAsBytes(EnumWithJsonValue.B)));
    }
    ...
    public void testEnumsWithJsonValueInMap() throws Exception
    {
        ...
        assertEquals("{\"value:bar\":\"x\"}", VPackUtils.toJson(MAPPER.writeValueAsBytes(input)));
    }
    ...
    {
        assertEquals("\"foo\"", VPackUtils.toJson(MAPPER.writeValueAsBytes(SerializableEnum.A)));
    }
    ...
    public void testToStringEnum() throws Exception
    {
        ObjectMapper m = vpackMapperBuilder()
                ...
                .build();
        assertEquals("\"b\"", VPackUtils.toJson(m.writeValueAsBytes(LowerCaseEnum.B)));

        // [databind#749] but should also be able to dynamically disable
        assertEquals("\"B\"",
                VPackUtils.toJson(m.writer().without(EnumFeature.WRITE_ENUMS_USING_TO_STRING)
    ...
    public void testToStringEnumWithEnumMap() throws Exception
    {
        ...
        assertEquals("{\"c\":\"value\"}", VPackUtils.toJson(m.writeValueAsBytes(enums)));
    }
    ...
    public void testAsIndex() throws Exception
    {
        ...
        assertEquals(q("B"), VPackUtils.toJson(m.writeValueAsBytes(TestEnum.B)));

        // but we can change (dynamically, too!) it to be number-based
        m = vpackMapperBuilder()
                .enable(EnumFeature.WRITE_ENUMS_USING_INDEX)
                .build();
        assertEquals("1", VPackUtils.toJson(m.writeValueAsBytes(TestEnum.B)));
    }

    @Test
    public void testAnnotationsOnEnumCtor() throws Exception
    {
        assertEquals(q("V1"), VPackUtils.toJson(MAPPER.writeValueAsBytes(OK.V1)));
        assertEquals(q("V1"), VPackUtils.toJson(MAPPER.writeValueAsBytes(NOT_OK.V1)));
        assertEquals(q("V2"), VPackUtils.toJson(MAPPER.writeValueAsBytes(NOT_OK2.V2)));
    }
    ...
    public void testGenericEnumSerializer() throws Exception
    {
        ...
        ObjectMapper mapper = vpackMapperBuilder()
                .addModule(module)
                .build();
        assertEquals(q("b"), VPackUtils.toJson(mapper.writeValueAsBytes(TestEnum.B)));
    }
    ...
    public void testEnumMapSerDefault() throws Exception {
        ...
        assertEquals("{\"A\":\"value\"}", VPackUtils.toJson(mapper.writeValueAsBytes(m)));
    }
    ...
    public void testEnumMapSerDisableToString() throws Exception {
        ...
        EnumMap<LC749Enum, String> m = new EnumMap<LC749Enum, String>(LC749Enum.class);
        m.put(LC749Enum.A, "value");
        assertEquals("{\"A\":\"value\"}", VPackUtils.toJson(w.writeValueAsBytes(m)));
    }
    ...
    public void testEnumsWithJsonProperty() throws Exception {
        assertEquals(q("aleph"), VPackUtils.toJson(MAPPER.writeValueAsBytes(EnumWithJsonProperty.A)));
    }

    @Test
    public void testEnumsWithJsonPropertyEnableToString() throws Exception {
        String result = VPackUtils.toJson(MAPPER.writerFor(EnumWithJsonProperty.class)
    ...
    public void testEnumKeysWithJsonProperty() throws Exception {
        ...
        assertEquals(a2q("{'aleph':13}"), VPackUtils.toJson(MAPPER.writeValueAsBytes(input)));
    }
    ...
    {
        assertEquals("[\"aleph\"]",
                VPackUtils.toJson(MAPPER.writeValueAsBytes(EnumSet.of(EnumWithJsonProperty.A))));
    }
    ...
    public void testEnumsWithJsonPropertyAsKey() throws Exception
    {
        ...
        assertEquals("{\"aleph\":\"b\"}", VPackUtils.toJson(MAPPER.writeValueAsBytes(input)));
    }
    ...
    public void testEnumWithJsonKey() throws Exception
    {
        ...
        assertEquals(a2q("{'key:a':'value:b'}"), VPackUtils.toJson(MAPPER.writeValueAsBytes(input1)));
        ...
        assertEquals(a2q("{'key:a':'value:b'}"), VPackUtils.toJson(MAPPER.writeValueAsBytes(input2)));
    }
