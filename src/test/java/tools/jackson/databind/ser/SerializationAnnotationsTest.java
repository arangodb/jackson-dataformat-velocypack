    ...
    extends DatabindTestUtil
{
    ...
    public void testClassSerializer() throws Exception
    {
        ...
        MAPPER.writeValue(out, new ClassSerializer());
        assertEquals("true", VPackUtils.toJson(out.toByteArray()));
    }
    ...
    {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        MAPPER.writeValue(out, new ClassMethodSerializer(13));
        assertEquals("{\"x\":\"X13X\"}", VPackUtils.toJson(out.toByteArray()));
    }

    @Test
    public void testInactiveMethodSerializer() throws Exception
    {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new InactiveClassMethodSerializer(8)));
