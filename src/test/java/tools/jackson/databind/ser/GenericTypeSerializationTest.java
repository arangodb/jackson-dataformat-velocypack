...
public class GenericTypeSerializationTest extends DatabindTestUtil
{
    ...
    private final ObjectMapper WRAP_ROOT_MAPPER = vpackMapperBuilder()
    ...
    public void testIssue468a() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(p1));
    ...
    public void testIssue468b() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(p2));
    ...
    public void testRootTypeForCollections727() throws Exception
    {
        ...
        assertEquals(EXP, VPackUtils.toJson(MAPPER.writeValueAsBytes(input)));
        assertEquals(EXP, VPackUtils.toJson(MAPPER.writer().writeValueAsBytes(input)));

        // but enforcing type will hinder:
        TypeReference<?> typeRef = new TypeReference<List<Base727>>() { };
        assertEquals(EXP, VPackUtils.toJson(MAPPER.writer().forType(typeRef).writeValueAsBytes(input)));
    }
    ...
    public void testTypeResolution2821() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(val));
        assertNotNull(json);
    }
    ...
    {
        GenericWrapper<Account, String> wrapper = MAPPER.readValue(VPackUtils.toVPack("{\"first\":{\"id\":1,\"name\":\"name\"},\"second\":\"str\"}"),
    ...
    {
        GenericSpecificityWrapper0<Object, Account> wrapper = MAPPER.readValue(VPackUtils.toVPack("{\"first\":\"1\",\"second\":{\"id\":1,\"name\":\"name\"}}"),
    ...
    {
        GenericSpecificityWrapper1<StringStub, Account> wrapper = MAPPER.readValue(VPackUtils.toVPack("{\"first\":\"1\",\"second\":{\"id\":1,\"name\":\"name\"}}"),
    ...
    {
        GenericSpecificityWrapper2<Stub<Object>, Account> wrapper = MAPPER.readValue(VPackUtils.toVPack("{\"first\":\"1\",\"second\":{\"id\":1,\"name\":\"name\"}}"),
    ...
    {
        WildcardWrapperImpl<Account, Account> wrapper = MAPPER.readValue(VPackUtils.toVPack("{\"first\":{\"id\":1,\"name\":\"name1\"},\"second\":{\"id\":2,\"name\":\"name2\"}}"),
    ...
    {
        SimpleWrapper<Account> wrapper = MAPPER.readValue(VPackUtils.toVPack("{\"object\":{\"id\":1,\"name\":\"name1\"}}"),
    ...
    public void testIndexedListExample() throws Exception
    {
        ...
        IndexedList<TestIndexed, String> value = MAPPER.readValue(VPackUtils.toVPack(String.format("[\"%s\"]", uuid.toString())),
    ...
    public void testSuperClass() throws Exception
    {
        ...
        String json = VPackUtils.toJson(w.writeValueAsBytes(bean));
        result = (Map<String,Object>)VANILLA_MAPPER.readValue(VPackUtils.toVPack(json), Map.class);
    ...
    public void testSuperInterface() throws Exception
    {
        ...
        String json = VPackUtils.toJson(w.writeValueAsBytes(bean));
        @SuppressWarnings("unchecked")
        Map<String,Object> result = VANILLA_MAPPER.readValue(VPackUtils.toVPack(json), Map.class);
    ...
    public void testInArray() throws Exception
    {
        ...
        String json = VPackUtils.toJson(mapper.writerFor(BaseInterface[].class).writeValueAsBytes(ob));
    ...
    public void testIncompatibleRootType() throws Exception
    {
        ...
        try {
            VPackUtils.toJson(w.writeValueAsBytes(bean));
    ...
    public void testJackson398() throws Exception
    {
        ...
        // First simplest way:
        String json = VPackUtils.toJson(VANILLA_MAPPER.writerFor(collectionType).writeValueAsBytes(typedList));
    ...
    {
        String json = VPackUtils.toJson(WRAP_ROOT_MAPPER.writeValueAsBytes(new StringWrapper("abc")));
    ...
    {
        assertEquals("123", VPackUtils.toJson(VANILLA_MAPPER.writerFor(Integer.TYPE).writeValueAsBytes(Integer.valueOf(123))));
        assertEquals("456", VPackUtils.toJson(VANILLA_MAPPER.writerFor(Long.TYPE).writeValueAsBytes(Long.valueOf(456L))));
    }

    @Test
    public void testRootNameAnnotation() throws Exception
    {
        String json = VPackUtils.toJson(WRAP_ROOT_MAPPER.writeValueAsBytes(new WithRootName()));
    ...
    public void testRootNameWithExplicitType() throws Exception
    {
        ...
        String json =  VPackUtils.toJson(writer.writeValueAsBytes(cmd));
    ...
    {
        String singleJson = VPackUtils.toJson(VANILLA_MAPPER.writerFor(Issue822Interface.class)
                .writeValueAsBytes(new Issue822Impl()));
    ...
    {
        assertEquals("[{\"a\":3}]", VPackUtils.toJson(VANILLA_MAPPER.writerFor(Issue822Interface[].class).writeValueAsBytes(
    ...
    public void testTypedRootLists() throws Exception
    {
        ...
        String listJson = VPackUtils.toJson(VANILLA_MAPPER.writerFor(new TypeReference<List<Issue822Interface>>(){})
    ...
    public void testTypedRootMaps() throws Exception
    {
        ...
        String listJson = VPackUtils.toJson(VANILLA_MAPPER
