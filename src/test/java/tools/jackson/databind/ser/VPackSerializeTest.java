...
public class VPackSerializeTest
    extends DatabindTestUtil
{
    ...
    private final ObjectMapper STATIC_MAPPER = vpackMapperBuilder()
    ...
    {
        try {
            VPackUtils.toJson(MAPPER.writeValueAsBytes(new BrokenClass()));
    ...
    public void testStaticTypingWithMap() throws Exception
    {
        ...
        assertEquals("{\"a\":{\"x\":3}}", VPackUtils.toJson(STATIC_MAPPER.writeValueAsBytes(map)));
    }
    ...
    public void testStaticTypingWithArrayList() throws Exception
    {
        ...
        assertEquals("[{\"x\":3}]", VPackUtils.toJson(STATIC_MAPPER.writeValueAsBytes(list)));
    }
    ...
    public void testStaticTypingWithArray() throws Exception
    {
        ...
        assertEquals("[{\"x\":3}]", VPackUtils.toJson(STATIC_MAPPER.writeValueAsBytes(array)));
    }
    ...
    public void testIssue294() throws Exception
    {
        ...
        assertEquals("{\"bar\":\"barId\",\"id\":\"fooId\"}",
                VPackUtils.toJson(mapper.writeValueAsBytes(new Foo294("fooId", "barId"))));
    }
    ...
    public void testWithIsGetter() throws Exception
    {
        ...
        assertEquals(a2q("{'a':'x','something':true}"),
                VPackUtils.toJson(mapper.writeValueAsBytes(new Response())));
    }
    ...
    public void testSerializedAsListWithClassAnnotations() throws IOException
    {
        ...
        assertEquals("[{\"value\":\"foo\"}]", VPackUtils.toJson(MAPPER.writeValueAsBytes(list)));
    }
    ...
    public void testSerializedAsMapWithClassAnnotations() throws IOException
    {
        ...
        assertEquals("{\"toString:x\":{\"value\":\"y\"}}", VPackUtils.toJson(MAPPER.writeValueAsBytes(map)));
    }
    ...
    public void testSerializedAsListWithPropertyAnnotations() throws IOException
    {
        ...
        assertEquals("{\"values\":[{\"value\":\"bar\"}]}", VPackUtils.toJson(MAPPER.writeValueAsBytes(input)));
    }
    ...
    public void testSerializedAsMapWithClassSerializer() throws IOException
    {
        ...
        assertEquals("{\"key abc\":\"value 123\"}", VPackUtils.toJson(MAPPER.writeValueAsBytes(map)));
    }
    ...
    public void testSerializedAsListWithPropertyAnnotations2() throws IOException
    {
        ...
        assertEquals("{\"values\":[\"value abc\"]}", VPackUtils.toJson(MAPPER.writeValueAsBytes(input)));
    }
    ...
    public void testSerializedAsMapWithPropertyAnnotations2() throws IOException
    {
        ...
        assertEquals("{\"values\":{\"key foo\":\"value b\"}}", VPackUtils.toJson(MAPPER.writeValueAsBytes(input)));
    }
    ...
    public void testEmptyInclusionContainers() throws IOException
    {
        ...
        assertEquals("{\"list\":[]}", VPackUtils.toJson(defMapper.writeValueAsBytes(list)));
        assertEquals("{}", VPackUtils.toJson(inclMapper.writeValueAsBytes(list)));
        assertEquals("{}", VPackUtils.toJson(inclMapper.writeValueAsBytes(new ListWrapper<String>())));

        MapWrapper<String,Integer> map = new MapWrapper<String,Integer>(new HashMap<String,Integer>());
        assertEquals("{\"map\":{}}", VPackUtils.toJson(defMapper.writeValueAsBytes(map)));
        assertEquals("{}", VPackUtils.toJson(inclMapper.writeValueAsBytes(map)));
        assertEquals("{}", VPackUtils.toJson(inclMapper.writeValueAsBytes(new MapWrapper<String,Integer>(null))));

        ArrayWrapper<Integer> array = new ArrayWrapper<Integer>(new Integer[0]);
        assertEquals("{\"array\":[]}", VPackUtils.toJson(defMapper.writeValueAsBytes(array)));
        assertEquals("{}", VPackUtils.toJson(inclMapper.writeValueAsBytes(array)));
        assertEquals("{}", VPackUtils.toJson(inclMapper.writeValueAsBytes(new ArrayWrapper<Integer>(null))));
    }

    @Test
    public void testNullSerializer() throws Exception
    {
        assertEquals("{\"value\":null}", VPackUtils.toJson(MAPPER.writeValueAsBytes(new NullBean())));
    }
    ...
    public void testSerializeAsInClass() throws Exception {
        assertEquals("{\"foo\":42}", VPackUtils.toJson(WRITER.writeValueAsBytes(new FooImpl())));
    }

    @Test
    public void testSerializeAsForArrayProp() throws Exception {
        assertEquals("{\"foos\":[{\"foo\":42}]}",
                VPackUtils.toJson(WRITER.writeValueAsBytes(new Fooables())));
    }

    @Test
    public void testSerializeAsForSimpleProp() throws Exception {
        assertEquals("{\"foo\":{\"foo\":42}}",
                VPackUtils.toJson(WRITER.writeValueAsBytes(new FooableWrapper())));
    }

    @Test
    public void testSerializeWithFieldAnno() throws Exception {
        assertEquals("{\"foo\":{\"foo\":42}}",
                VPackUtils.toJson(WRITER.writeValueAsBytes(new FooableWithFieldWrapper())));
    }
    ...
    public void testSpecializedContentAs() throws Exception {
        assertEquals(a2q("{'values':[{'a':1,'b':2}]}"),
                VPackUtils.toJson(WRITER.writeValueAsBytes(new Bean5476Wrapper(1))));
    }
    ...
    public void testSpecializedAsIntermediate() throws Exception {
        assertEquals(a2q("{'value':{'a':1,'b':2}}"),
                VPackUtils.toJson(WRITER.writeValueAsBytes(new Bean5476Holder())));
    }

    // Test for key parameter
    @Test
    public void testSpecializedKeyAs() throws Exception {
        String json = VPackUtils.toJson(WRITER.writeValueAsBytes(new MapKeyWrapper()));
    ...
    public void testLegacySerializeAsInClass() throws Exception {
        assertEquals("{\"foo\":42}", VPackUtils.toJson(WRITER.writeValueAsBytes(new LegacyFooImpl())));
    }

    @Test
    public void testLegacySerializeAsForArrayProp() throws Exception {
        assertEquals("{\"foos\":[{\"foo\":42}]}",
                VPackUtils.toJson(WRITER.writeValueAsBytes(new LegacyFooables())));
    }

    @Test
    public void testLegacySerializeAsForSimpleProp() throws Exception {
        assertEquals("{\"foo\":{\"foo\":42}}",
                VPackUtils.toJson(WRITER.writeValueAsBytes(new LegacyFooableWrapper())));
    }
    ...
    public void testLegacySerializeWithFieldAnno() throws Exception {
        assertEquals("{\"foo\":{\"foo\":42}}",
                VPackUtils.toJson(WRITER.writeValueAsBytes(new LegacyFooableWithFieldWrapper())));
    }
    ...
    public void testLegacySpecializedContentAs1178() throws Exception {
        assertEquals(a2q("{'values':[{'a':1,'b':2}]}"),
                VPackUtils.toJson(WRITER.writeValueAsBytes(new Bean1178Wrapper(1))));
    }
    ...
    public void testLegacySpecializedAsIntermediate1231() throws Exception {
        assertEquals(a2q("{'value':{'a':1,'b':2}}"),
                VPackUtils.toJson(WRITER.writeValueAsBytes(new Bean1178Holder())));
    }
}
