...
public class SerializationIgnoreTest extends DatabindTestUtil
{
    ...
    {
        assertEquals("{\"value\":13}", VPackUtils.toJson(MAPPER.writeValueAsBytes(new NonIgnoredType())));
    }
    ...
    {
        assertEquals("{\"toInclude\":2}", VPackUtils.toJson(MAPPER.writeValueAsBytes(new IgnoreAndProperty3357())));
    }
}
