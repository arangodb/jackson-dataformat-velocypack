 ...
 */
public class VPackFilterTest extends DatabindTestUtil
{
    ...
    public void testSimpleInclusionFilter() throws Exception
    {
        ...
        assertEquals("{\"a\":\"a\"}", VPackUtils.toJson(MAPPER.writer(prov).writeValueAsBytes(new Bean())));

        ObjectMapper mapper = vpackMapperBuilder()
                .filterProvider(prov)
                .build();
        assertEquals("{\"a\":\"a\"}", VPackUtils.toJson(mapper.writeValueAsBytes(new Bean())));
    }
    ...
    public void testIncludeAllFilter() throws Exception
    {
        ...
        assertEquals("{\"a\":\"a\",\"b\":\"b\"}", VPackUtils.toJson(MAPPER.writer(prov).writeValueAsBytes(new Bean())));
    }
    ...
    public void testExcludeAllFilter() throws Exception
    {
        ...
        assertEquals("{}", VPackUtils.toJson(MAPPER.writer(prov).writeValueAsBytes(new Bean())));
    }
    ...
    public void testSimpleExclusionFilter() throws Exception
    {
        ...
        assertEquals("{\"b\":\"b\"}", VPackUtils.toJson(MAPPER.writer(prov).writeValueAsBytes(new Bean())));
    }
    ...
    public void testMissingFilter() throws Exception
    {
        ...
        try {
            VPackUtils.toJson(MAPPER.writeValueAsBytes(new Bean()));
        ...
        ObjectMapper mapper = vpackMapperBuilder()
                .filterProvider(fp)
                .build();
        assertEquals("{\"a\":\"a\",\"b\":\"b\"}", VPackUtils.toJson(mapper.writeValueAsBytes(new Bean())));
    }
    ...
    public void testIssue89() throws Exception
    {
        ...
        assertEquals("{\"username\":\"Bob\"}", VPackUtils.toJson(MAPPER.writeValueAsBytes(pod)));

        Pod pod2 = MAPPER.readValue(VPackUtils.toVPack("{\"username\":\"Bill\",\"user_password\":\"foo!\"}"), Pod.class);
    ...
    public void testFilterOnProperty() throws Exception
    {
        ...
        assertEquals("{\"first\":{\"a\":\"a\"},\"second\":{\"b\":\"b\"}}",
                VPackUtils.toJson(MAPPER.writer(prov).writeValueAsBytes(new FilteredProps())));
    }
    ...
    public void testAllFiltersWithSameOutput() throws Exception
    {
        ...
        for (SimpleBeanPropertyFilter filter : allPossibleFilters) {
            ...
            assertEquals(a2q("{'a':'aa','b':'bb'}"), VPackUtils.toJson(MAPPER.writer(prov).writeValueAsBytes(beanB)));
        }
    }
    ...
    public void testAddFilterLastOneRemains() throws Exception {
        ...
        assertEquals("{}", VPackUtils.toJson(MAPPER.writer(prov).writeValueAsBytes(beanB)));
    }
    ...
    public void testAddFilterLastOneRemainsFlip() throws Exception {
        ...
        String jsonString = VPackUtils.toJson(MAPPER.writer(prov).writeValueAsBytes(beanB));
        Map<?,?> actualMap = MAPPER.readValue(VPackUtils.toVPack(jsonString), Map.class);
    ...
    public void testAddFilterWithEmptyStringId() throws Exception {
        ...
        String jsonString = VPackUtils.toJson(MAPPER.writer(prov).writeValueAsBytes(bean));
        Map<?,?> actualMap = MAPPER.readValue(VPackUtils.toVPack(jsonString), Map.class);
        Map<String, Object> expectedMap = new LinkedHashMap<>();
    ...
    public void testAddingNullFilter2ThrowsException() throws Exception {
        ...
        try {
            VPackUtils.toJson(writer.writeValueAsBytes(beanD));
