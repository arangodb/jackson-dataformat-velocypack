...
public class VPackIncludeCollectionTest extends DatabindTestUtil
{
    ...
    {
        assertEquals("{}", VPackUtils.toJson(MAPPER.writeValueAsBytes(new NonEmptyEnumSet())));
        assertEquals("{\"v\":[\"B\"]}", VPackUtils.toJson(MAPPER.writeValueAsBytes(new NonEmptyEnumSet(ABC.B))));
    }
    ...
    public void testCustomFilterWithList() throws Exception {
        assertEquals(a2q("{'items':['1','2']}"),
                VPackUtils.toJson(MAPPER_CONTAINERS.writeValueAsBytes(new FooListBean().add("1").add("foo").add("2"))));
    }

    @Test
    public void testNonNullContentInclusion() throws Exception {
        assertEquals(a2q("{'items':['1','2']}"),
                VPackUtils.toJson(MAPPER_CONTAINERS.writeValueAsBytes(new NonNullListBean().add("1").add(null).add("2"))));
    }

    @Test
    public void testNonEmptyContentInclusion() throws Exception {
        assertEquals(a2q("{'items':['1','2']}"),
                VPackUtils.toJson(MAPPER_CONTAINERS.writeValueAsBytes(new NonEmptyListBean().add("1").add("").add("2"))));
    }

    @Test
    public void testNonDefaultContentInclusion() throws Exception {
        assertEquals(a2q("{'items':['1','2']}"),
                VPackUtils.toJson(MAPPER_CONTAINERS.writeValueAsBytes(new NonDefaultListBean().add("1").add(null).add("2"))));
    }

    @Test
    public void testCustomFilterWithSet() throws Exception {
        assertEquals(a2q("{'items':['1','2']}"),
                VPackUtils.toJson(MAPPER_CONTAINERS.writeValueAsBytes(new FooSetBean().add("1").add("foo").add("2"))));
    }

    @Test
    public void testCustomFilterWithIntegerList() throws Exception {
        assertEquals(a2q("{'values':[1,2]}"),
                VPackUtils.toJson(MAPPER_CONTAINERS.writeValueAsBytes(new IntegerListPojo().add(1).add(42).add(2))));
    }

    @Test
    public void testCustomFilterWithShortList() throws Exception {
        assertEquals(a2q("{'values':[1,2]}"),
                VPackUtils.toJson(MAPPER_CONTAINERS.writeValueAsBytes(
    ...
    public void testCustomFilterWithNumbers() throws Exception {
        assertEquals(a2q("{'numbers':[1,3]}"),
                VPackUtils.toJson(MAPPER_CONTAINERS.writeValueAsBytes(new NumberListBean().add(1).add(42).add(3))));
    }

    @Test
    public void testEmptyListWithCustomFilter() throws Exception {
        assertEquals(a2q("{'items':[]}"),
                VPackUtils.toJson(MAPPER_CONTAINERS.writeValueAsBytes(new FooListBean())));
    }
    ...
    public void testContentIncludeOverrideForCollection() throws Exception {
        ...
        assertEquals(a2q("{'values':['1','2']}"),
                VPackUtils.toJson(mapper.writeValueAsBytes(new SimpleList5369Bean().add("1").add("foo").add("2"))));
    }
    ...
    public void testIterableWithContentFilteringForNulls() throws Exception
    {
        ...
        assertEquals("{\"values\":[1,2,3]}", VPackUtils.toJson(MAPPER_CONTAINERS.writeValueAsBytes(pojo)));
    }
    ...
    public void testIterableWithContentFilteringMagicNumber() throws Exception
    {
        ...
        assertEquals("{\"values\":[5369]}", VPackUtils.toJson(MAPPER_CONTAINERS.writeValueAsBytes(pojo)));
    }
    ...
    public void testIterableNonEmptyWithWildcardElementType() throws Exception
    {
        ...
        assertEquals(a2q("{'values':[{'k':'v'},['x']]}"),
                VPackUtils.toJson(MAPPER_CONTAINERS.writeValueAsBytes(pojo)));
    }
}
