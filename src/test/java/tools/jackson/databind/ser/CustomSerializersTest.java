...
public class CustomSerializersTest extends DatabindTestUtil
{
    ...
    public void testCustomLists() throws Exception
    {
        ...
        ObjectMapper mapper = vpackMapperBuilder()
                .addModule(module)
                .build();
        assertEquals("null", VPackUtils.toJson(mapper.writeValueAsBytes(new ArrayList<Object>())));
    }
    ...
    public void testDelegating() throws Exception
    {
        ...
        ObjectMapper mapper = vpackMapperBuilder()
                .addModule(module)
                .build();
        assertEquals("{\"x\":3,\"y\":7}", VPackUtils.toJson(mapper.writeValueAsBytes(new Immutable())));
    }
    ...
    public void testCustomEscapes() throws Exception
    {
        assertEquals(q("foo\\u0062\\Ar"),
                VPackUtils.toJson(MAPPER.writer(new CustomEscapes()).writeValueAsBytes("foobar")));
    }
    ...
    public void testNumberSubclass() throws Exception
    {
        assertEquals(a2q("{'x':42}"),
                VPackUtils.toJson(MAPPER.writeValueAsBytes(new LikeNumber(42))));
    }
    ...
    public void testWithCurrentValue() throws Exception
    {
        assertEquals(a2q("{'prop':'Issue631Bean/42'}"),
                VPackUtils.toJson(MAPPER.writer()
                    .writeValueAsBytes(new Issue631Bean(42))));
    }
    ...
    public void testWithCustomElements() throws Exception
    {
        ...
        assertEquals(a2q("{'list':['A',null,'B']}"),
                VPackUtils.toJson(MAPPER.writeValueAsBytes(wr)));
        ...
        assertEquals(q("FOOBAR"), VPackUtils.toJson(mapper.writeValueAsBytes("foobar")));
        assertEquals(a2q("['FOO',null]"),
                VPackUtils.toJson(mapper.writeValueAsBytes(new String[] { "foo", null })));

        List<String> list = Arrays.asList("foo", null);
        assertEquals(a2q("['FOO',null]"), VPackUtils.toJson(mapper.writeValueAsBytes(list)));

        Set<String> set = new LinkedHashSet<String>(Arrays.asList("foo", null));
        assertEquals(a2q("['FOO',null]"), VPackUtils.toJson(mapper.writeValueAsBytes(set)));
    }
    ...
    public void testConvertingSerializerIsEmpty() throws Exception {
        ...
        assertEquals(a2q("{'other':'a'}"),
                VPackUtils.toJson(MAPPER.writeValueAsBytes(new ConvertingIsEmptyBean("NULL", "a"))));

        // Converted to "" -> delegate isEmpty() returns true -> property excluded
        assertEquals(a2q("{'other':'b'}"),
                VPackUtils.toJson(MAPPER.writeValueAsBytes(new ConvertingIsEmptyBean("EMPTY", "b"))));

        // Converted to non-empty -> isEmpty() returns false -> property included
        assertEquals(a2q("{'text':'hello','other':'c'}"),
                VPackUtils.toJson(MAPPER.writeValueAsBytes(new ConvertingIsEmptyBean("hello", "c"))));
    }
    ...
    public void testIssue2475() throws Exception {
        ...
        assertEquals(a2q("{'id':'ID-1','set':[]}"),
                VPackUtils.toJson(writer.writeValueAsBytes(new Item2475(new ArrayList<String>(), "ID-1"))));

        assertEquals(a2q("{'id':'ID-2','set':[]}"),
                VPackUtils.toJson(writer.writeValueAsBytes(new Item2475(new HashSet<String>(), "ID-2"))));
    }
    ...
    public void testIssue4575() throws Exception {
        ...
        assertEquals("{\"@type\":\"Super\"}", VPackUtils.toJson(mapper.writeValueAsBytes(new Super4575())));
        assertEquals("{\"@type\":\"Sub\"}", VPackUtils.toJson(mapper.writeValueAsBytes(new Sub4575())));
        assertEquals("null", VPackUtils.toJson(mapper.writeValueAsBytes(Super4575.NULL)));
    }
    ...
    void testRegisteredDelegatingSerializer()
    {
        ObjectMapper mapper = VPackMapper.builder()
                ...
                .build();
        assertEquals("\"'foo'\"", VPackUtils.toJson(mapper.writeValueAsBytes("foo")));
    }
    ...
    public void testPropertyRemoval() throws Exception
    {
        ...
        assertEquals("{\"b\":\"b\"}", VPackUtils.toJson(mapper.writeValueAsBytes(bean)));
    }
    ...
    public void testPropertyReorder() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        ModifierBean bean = new ModifierBean();
        assertEquals("{\"a\":\"a\",\"b\":\"b\"}", VPackUtils.toJson(mapper.writeValueAsBytes(bean)));
    }
    ...
    public void testBuilderReplacement() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        ModifierBean bean = new ModifierBean();
        assertEquals("17", VPackUtils.toJson(mapper.writeValueAsBytes(bean)));
    }
    ...
    public void testSerializerReplacement() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        ModifierBean bean = new ModifierBean();
        assertEquals("123", VPackUtils.toJson(mapper.writeValueAsBytes(bean)));
    }
    ...
    public void testModifyArraySerializer() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        assertEquals("123", VPackUtils.toJson(mapper.writeValueAsBytes(new Integer[] { 1, 2 })));
    }
    ...
    public void testModifyCollectionSerializer() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        assertEquals("123", VPackUtils.toJson(mapper.writeValueAsBytes(new ArrayList<Integer>())));
    }
    ...
    public void testModifyMapSerializer() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        assertEquals("123", VPackUtils.toJson(mapper.writeValueAsBytes(new HashMap<String,String>())));
    }
    ...
    public void testModifyEnumSerializer() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        assertEquals("123", VPackUtils.toJson(mapper.writeValueAsBytes(ABC.C)));
    }
    ...
    public void testModifyKeySerializer() throws Exception
    {
        ...
        map.put("x", 3);
        assertEquals("{\"foo\":3}", VPackUtils.toJson(mapper.writeValueAsBytes(map)));
    }
    ...
    public void modifierIssue1612Test() throws Exception
    {
        ...
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        try {
            VPackUtils.toJson(mapper.writeValueAsBytes(new Bean1612(0, 1, 2d)));
    ...
    {
        var mapper = VPackMapper.builder()
                .addModule(new HiddenFieldModule5414())
                .build();
        User5414 user = new User5414("John", "123456");
        String userJson = VPackUtils.toJson(mapper.writeValueAsBytes(user));
