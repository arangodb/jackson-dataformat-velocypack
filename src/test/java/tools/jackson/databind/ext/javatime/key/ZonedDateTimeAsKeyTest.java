...
//    private static final Instant DATE_TIME_0_INSTANT = DATE_TIME_0.toInstant();
    ...
    public void testSerialization0() throws Exception {
        String value = VPackUtils.toJson(MAPPER.writerFor(TYPE_REF).writeValueAsBytes(asMap(DATE_TIME_0, "test")));
        assertEquals(mapAsString(DATE_TIME_0_STRING, "test"), value);
    }

    @Test
    public void testSerialization1() throws Exception {
        String value = VPackUtils.toJson(MAPPER.writerFor(TYPE_REF).writeValueAsBytes(asMap(DATE_TIME_1, "test")));
        assertEquals(mapAsString(DATE_TIME_1_STRING, "test"), value);
    }

    @Test
    public void testSerialization2() throws Exception {
        String value = VPackUtils.toJson(MAPPER.writerFor(TYPE_REF).writeValueAsBytes(asMap(DATE_TIME_2, "test")));
    ...
    public void testDeserialization0() throws Exception {
        assertEquals(asMap(DATE_TIME_0, "test"),
                READER.readValue(VPackUtils.toVPack(mapAsString(DATE_TIME_0_STRING, "test"))));
    }

    @Test
    public void testDeserialization1() throws Exception {
        assertEquals(asMap(DATE_TIME_1, "test"),
                READER.readValue(VPackUtils.toVPack(mapAsString(DATE_TIME_1_STRING, "test"))));
    }

    @Test
    public void testDeserialization2() throws Exception {
        assertEquals(asMap(DATE_TIME_2_OFFSET, "test"),
                READER.readValue(VPackUtils.toVPack(mapAsString(DATE_TIME_2_STRING, "test"))));
    }

    @Test
    public void testSerializationToInstantWithNanos() throws Exception {
        String value = VPackUtils.toJson(mapperBuilder().enable(DateTimeFeature.WRITE_DATE_KEYS_AS_TIMESTAMPS).build()
            .writerFor(TYPE_REF).writeValueAsBytes(asMap(DATE_TIME_1, "test")));
    ...
    public void testSerializationToInstantWithoutNanos() throws Exception {
        String value = VPackUtils.toJson(mapperBuilder().enable(DateTimeFeature.WRITE_DATE_KEYS_AS_TIMESTAMPS)
