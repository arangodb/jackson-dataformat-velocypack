...
public class LocalTimeAsKeyTest extends DateTimeTestBase
{
    ...
    public void testSerialization1() throws Exception {
        assertEquals(mapAsString(TIME_STRING, "test"),
                VPackUtils.toJson(MAPPER.writeValueAsBytes(asMap(TIME, "test"))));
    }

    @Test
    public void testDeserialization0() throws Exception {
        assertEquals(asMap(TIME_0, "test"), READER.readValue(VPackUtils.toVPack(mapAsString(TIME_0_STRING, "test"))),
                "Value is incorrect");
    }

    @Test
    public void testDeserialization1() throws Exception {
        assertEquals(asMap(TIME, "test"), READER.readValue(VPackUtils.toVPack(mapAsString(TIME_STRING, "test"))),
                "Value is incorrect");
    }
}
