...
public class ZoneOffsetAsKeyTest extends DateTimeTestBase
{
    ...
    public void testSerialization0() throws Exception {
        String value = VPackUtils.toJson(MAPPER.writeValueAsBytes(asMap(OFFSET_0, "test")));
        assertEquals(mapAsString(OFFSET_0_STRING, "test"), value);
    }

    @Test
    public void testSerialization1() throws Exception {
        String value = VPackUtils.toJson(MAPPER.writeValueAsBytes(asMap(OFFSET_1, "test")));
        assertEquals(mapAsString(OFFSET_1_STRING, "test"), value);
    }

    @Test
    public void testDeserialization0() throws Exception {
        Map<ZoneOffset, String> value = MAPPER.readValue(VPackUtils.toVPack(mapAsString(OFFSET_0_STRING, "test")), TYPE_REF);
        assertEquals(asMap(OFFSET_0, "test"), value);
    }

    @Test
    public void testDeserialization1() throws Exception {
        Map<ZoneOffset, String> value = MAPPER.readValue(VPackUtils.toVPack(mapAsString(OFFSET_1_STRING, "test")), TYPE_REF);
