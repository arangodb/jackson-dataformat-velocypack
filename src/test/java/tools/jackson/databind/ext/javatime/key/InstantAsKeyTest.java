...
public class InstantAsKeyTest extends DateTimeTestBase
{
    ...
    public void testSerialization0() throws Exception {
        String value = VPackUtils.toJson(MAPPER.writeValueAsBytes(asMap(INSTANT_0, "test")));
        assertEquals(mapAsString(INSTANT_0_STRING, "test"), value);
    }

    @Test
    public void testSerialization1() throws Exception {
        String value = VPackUtils.toJson(MAPPER.writeValueAsBytes(asMap(INSTANT, "test")));
        assertEquals(mapAsString(INSTANT_STRING, "test"), value);
    }

    @Test
    public void testDeserialization0() throws Exception {
        Map<Instant, String> value = READER.readValue(VPackUtils.toVPack(mapAsString(INSTANT_0_STRING, "test")));
    ...
    public void testDeserialization1() throws Exception {
        Map<Instant, String> value = READER.readValue(VPackUtils.toVPack(mapAsString(INSTANT_STRING, "test")));
