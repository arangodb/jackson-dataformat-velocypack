...
public class TruncateToMillisecondsTest extends DatabindTestUtil
{
    ...
    private final ObjectMapper MAPPER_TRUNCATE_WRITE = vpackMapperBuilder()
        .enable(DateTimeFeature.TRUNCATE_TO_MSECS_ON_WRITE)
        .build();

    private final ObjectMapper MAPPER_TRUNCATE_READ = vpackMapperBuilder()
        .enable(DateTimeFeature.TRUNCATE_TO_MSECS_ON_READ)
        .build();

    private final ObjectMapper MAPPER_TRUNCATE_BOTH = vpackMapperBuilder()
        .enable(DateTimeFeature.TRUNCATE_TO_MSECS_ON_WRITE)
        .enable(DateTimeFeature.TRUNCATE_TO_MSECS_ON_READ)
        .build();

    private final ObjectMapper MAPPER_WRITE_AS_TIMESTAMPS = vpackMapperBuilder()
        .enable(DateTimeFeature.WRITE_DATES_AS_TIMESTAMPS)
        .build();

    private final ObjectMapper MAPPER_TRUNCATE_WRITE_AS_TIMESTAMPS = vpackMapperBuilder()
        .enable(DateTimeFeature.TRUNCATE_TO_MSECS_ON_WRITE)
        .enable(DateTimeFeature.WRITE_DATES_AS_TIMESTAMPS)
        .build();
    ...
    public void testInstantSerializationTruncation() throws Exception {
        ...
        String json1 = VPackUtils.toJson(MAPPER.writeValueAsBytes(instant));
        ...
        String json2 = VPackUtils.toJson(MAPPER_TRUNCATE_WRITE.writeValueAsBytes(instant));
    ...
    public void testLocalDateTimeSerializationTruncation() throws Exception {
        ...
        // Without truncation
        String json1 = VPackUtils.toJson(MAPPER.writeValueAsBytes(ldt));
        assertTrue(json1.contains("123456789") || json1.contains("45.123456789"),
            "Expected nanoseconds in: " + json1);

        // With truncation
        String json2 = VPackUtils.toJson(MAPPER_TRUNCATE_WRITE.writeValueAsBytes(ldt));
    ...
    public void testLocalTimeSerializationTruncation() throws Exception {
        ...
        // Without truncation
        String json1 = VPackUtils.toJson(MAPPER.writeValueAsBytes(time));
        assertTrue(json1.contains("123456789") || json1.contains("45.123456789"),
            "Expected nanoseconds in: " + json1);

        // With truncation
        String json2 = VPackUtils.toJson(MAPPER_TRUNCATE_WRITE.writeValueAsBytes(time));
        assertFalse(json2.contains("456789"), "Expected truncated value in: " + json2);
    }
    ...
    public void testDurationSerializationTruncation() throws Exception {
        ...
        // Without truncation
        String json1 = VPackUtils.toJson(MAPPER.writeValueAsBytes(duration));
        assertTrue(json1.contains("456789012") || json1.contains(".456789012"),
            "Expected nanoseconds in: " + json1);

        // With truncation
        String json2 = VPackUtils.toJson(MAPPER_TRUNCATE_WRITE.writeValueAsBytes(duration));
    ...
    public void testInstantDeserializationTruncation() throws Exception {
        ...
        // Without truncation - preserves full nanoseconds
        Instant instant1 = MAPPER.readValue(VPackUtils.toVPack(json), Instant.class);
        assertEquals(123456789, instant1.getNano());

        // With truncation - only milliseconds
        Instant instant2 = MAPPER_TRUNCATE_READ.readValue(VPackUtils.toVPack(json), Instant.class);
    ...
    public void testLocalDateTimeDeserializationTruncation() throws Exception {
        ...
        // Without truncation
        LocalDateTime ldt1 = MAPPER.readValue(VPackUtils.toVPack(json), LocalDateTime.class);
        assertEquals(123456789, ldt1.getNano());

        // With truncation
        LocalDateTime ldt2 = MAPPER_TRUNCATE_READ.readValue(VPackUtils.toVPack(json), LocalDateTime.class);
    ...
    public void testLocalTimeDeserializationTruncation() throws Exception {
        ...
        // Without truncation
        LocalTime time1 = MAPPER.readValue(VPackUtils.toVPack(json), LocalTime.class);
        assertEquals(123456789, time1.getNano());

        // With truncation
        LocalTime time2 = MAPPER_TRUNCATE_READ.readValue(VPackUtils.toVPack(json), LocalTime.class);
    ...
    public void testDurationDeserializationTruncation() throws Exception {
        ...
        // Without truncation
        Duration duration1 = MAPPER.readValue(VPackUtils.toVPack(json), Duration.class);
        assertEquals(456789012, duration1.getNano());

        // With truncation
        Duration duration2 = MAPPER_TRUNCATE_READ.readValue(VPackUtils.toVPack(json), Duration.class);
    ...
    public void testRoundTripWithBothFeaturesEnabled() throws Exception {
        ...
        String json = VPackUtils.toJson(MAPPER_TRUNCATE_BOTH.writeValueAsBytes(original));

        // Deserialize with truncation
        Instant result = MAPPER_TRUNCATE_BOTH.readValue(VPackUtils.toVPack(json), Instant.class);
    ...
    public void testRoundTripSerializeTruncateDeserializeWithout() throws Exception {
        ...
        // Serialize with truncation
        String json = VPackUtils.toJson(MAPPER_TRUNCATE_WRITE.writeValueAsBytes(original));

        // Deserialize without truncation (value is already truncated)
        LocalDateTime result = MAPPER.readValue(VPackUtils.toVPack(json), LocalDateTime.class);
    ...
    public void testInstantNumericTimestampTruncation() throws Exception {
        ...
        String json = VPackUtils.toJson(MAPPER_TRUNCATE_WRITE_AS_TIMESTAMPS.writeValueAsBytes(instant));

        // The numeric value should not contain nanoseconds beyond milliseconds
        Instant result = MAPPER.readValue(VPackUtils.toVPack(json), Instant.class);
    ...
    public void testAlreadyTruncatedValueRemains() throws Exception {
        ...
        String json = VPackUtils.toJson(MAPPER_TRUNCATE_WRITE.writeValueAsBytes(instant));
        Instant result = MAPPER_TRUNCATE_READ.readValue(VPackUtils.toVPack(json), Instant.class);
    ...
    public void testNegativeDurationTruncation() throws Exception {
        ...
        String json = VPackUtils.toJson(MAPPER_TRUNCATE_WRITE.writeValueAsBytes(duration));

        // Deserialize with truncation
        Duration result = MAPPER_TRUNCATE_READ.readValue(VPackUtils.toVPack(json), Duration.class);
        ...
        String json2 = VPackUtils.toJson(MAPPER_TRUNCATE_WRITE.writeValueAsBytes(duration2));
        Duration result2 = MAPPER_TRUNCATE_READ.readValue(VPackUtils.toVPack(json2), Duration.class);
    ...
    public void testTruncationIndependentOfNanosecondFeature() throws Exception {
        ObjectMapper mapperNanosOff = vpackMapperBuilder()
        ...
        String json = VPackUtils.toJson(mapperNanosOff.writeValueAsBytes(instant));
        Instant result = MAPPER.readValue(VPackUtils.toVPack(json), Instant.class);
    ...
    public void testOffsetDateTimeTruncation() throws Exception {
        ...
        // Serialize with truncation
        String json = VPackUtils.toJson(MAPPER_TRUNCATE_WRITE.writeValueAsBytes(odt));

        // Deserialize with truncation
        OffsetDateTime result = MAPPER_TRUNCATE_READ.readValue(VPackUtils.toVPack(json), OffsetDateTime.class);
    ...
    public void testZonedDateTimeTruncation() throws Exception {
        ...
        // Serialize with truncation
        String json = VPackUtils.toJson(MAPPER_TRUNCATE_WRITE.writeValueAsBytes(zdt));

        // Deserialize with truncation
        ZonedDateTime result = MAPPER_TRUNCATE_READ.readValue(VPackUtils.toVPack(json), ZonedDateTime.class);
