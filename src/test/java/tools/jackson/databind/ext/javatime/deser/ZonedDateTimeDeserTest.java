...
public class ZonedDateTimeDeserTest extends DateTimeTestBase
{
    ...
    private final ObjectReader READER_NON_NORMALIZED_ZONEID = VPackMapper.builder()
    ...
    static class WrapperWithFeatures {
        @JsonFormat(without = Feature.ADJUST_DATES_TO_CONTEXT_TIME_ZONE)
    ...
    public void testDeserFromString() throws Exception
    {
        assertEquals(ZonedDateTime.of(2000, 1, 1, 12, 0, 0, 0, ZoneOffset.UTC),
                READER.readValue(VPackUtils.toVPack(q("2000-01-01T12:00Z"))),
    ...
    public void testDeserFromStringNoZoneIdNormalization() throws Exception
    {
        ...
        assertEquals(ZonedDateTime.of(2000, 1, 1, 12, 0, 0, 0, TimeZone.getTimeZone("UTC").toZoneId()),
                READER_NON_NORMALIZED_ZONEID.readValue(VPackUtils.toVPack(q("2000-01-01T12:00Z"))),
                "The value is not correct.");
    }
    ...
    public void testDeserializationAsInt01() throws Exception
    {
        ...
        WrapperWithReadTimestampsAsNanosDisabled actual =
            reader.readValue(VPackUtils.toVPack(a2q("{'value':1001}")));
    ...
    public void testDeserializationAsInt02() throws Exception
    {
        ...
        WrapperWithReadTimestampsAsNanosEnabled actual =
            reader.readValue(VPackUtils.toVPack(a2q("{'value':1}")));
        assertEquals(date, actual.value, "The value is not correct.");
    }
    ...
    public void testDeserializationComparedToStandard() throws Throwable
    {
        ...
        assertEquals(DateTimeFormatter.ISO_ZONED_DATE_TIME.parse(inputString, ZonedDateTime::from),
                READER.readValue(VPackUtils.toVPack(q(inputString))),
                "The value is not correct.");
    }
    ...
    public void testDeserializationComparedToStandard2() throws Throwable
    {
        ...
        ZonedDateTime converted = newMapperBuilder()
                ...
                .build()
                .readerFor(ZonedDateTime.class).readValue(VPackUtils.toVPack(q(inputString)));
    ...
    {
        try {
            READER.readValue(VPackUtils.toVPack(q("notazone")));
    ...
    {
        try {
            READER.readValue(VPackUtils.toVPack("[\"2000-01-01T12:00Z\"]"));
    ...
    public void testDeserializationAsArrayEnabled() throws Throwable
    {
        ZonedDateTime value = newMapper()
    			.readerFor(ZonedDateTime.class)
               .with(DeserializationFeature.UNWRAP_SINGLE_VALUE_ARRAYS)
    			.readValue(VPackUtils.toVPack("[\"2000-01-01T12:00Z\"]"));
        assertEquals(ZonedDateTime.of(2000, 1, 1, 12, 0, 0, 0, ZoneOffset.UTC),
                value,
                "The value is not correct.");
    }
    ...
    public void testDeserializationWithZonePreserved() throws Throwable
    {
        WrapperWithFeatures wrapper = newMapper()
                ...
                .readValue(VPackUtils.toVPack("{\"value\":\"2000-01-01T12:00+01:00\"}"));
    ...
    public void testLenientDeserializeFromEmptyString() throws Exception {
        ...
        Map<String, ZonedDateTime> actualMapFromNullStr = objectReader.readValue(VPackUtils.toVPack(valueFromNullStr));
        ...
        Map<String, ZonedDateTime> actualMapFromEmptyStr = objectReader.readValue(VPackUtils.toVPack(valueFromEmptyStr));
    ...
    public void testDeserializationWithoutColonInOffset() throws Throwable
    {
        WrapperWithFeatures wrapper = READER
                ...
                .readValue(VPackUtils.toVPack("{\"value\":\"2000-01-01T12:00+0100\"}"));
    ...
    public void testDeserializationWithoutColonInTimeZoneWithTZDB() throws Throwable
    {
        WrapperWithFeatures wrapper = READER
                .forType(WrapperWithFeatures.class)
                .readValue(VPackUtils.toVPack("{\"value\":\"2000-01-01T12:00+0100[Europe/Paris]\"}"));
    ...
    public void ZonedDateTime_with_offset_can_be_deserialized() throws Exception {
        ...
        for (String offset : Arrays.asList("+00", "-00")) {
            ...
            if (!System.getProperty("java.version").startsWith("1.8")) {
                ...
                assertEquals(ZonedDateTime.parse("2015-07-24T12:23:34.184Z"), r.readValue(VPackUtils.toVPack('"' + time + '"')));
            }
            assertEquals(ZonedDateTime.parse("2015-07-24T12:23:34.184Z"), r.readValue(VPackUtils.toVPack('"' + time + "00" + '"')));
            assertEquals(ZonedDateTime.parse("2015-07-24T12:23:34.184Z"), r.readValue(VPackUtils.toVPack('"' + time + ":00" + '"')));
            assertEquals(ZonedDateTime.parse("2015-07-24T12:23:34.184" + offset + ":30" ), r.readValue(VPackUtils.toVPack('"' + time + "30" + '"')));
            assertEquals(ZonedDateTime.parse("2015-07-24T12:23:34.184" + offset + ":30" ), r.readValue(VPackUtils.toVPack('"' + time + ":30" + '"')));
        }
        ...
        for (String prefix : Arrays.asList("-", "+")) {
            for (String hours : Arrays.asList("00", "01", "02", "03", "11", "12")) {
                ...
                if (!System.getProperty("java.version").startsWith("1.8")) {
                    // JDK 8 cannot parse hour offsets without minutes
                    assertEquals(expectedHour, r.readValue(VPackUtils.toVPack('"' + time + '"')));
                }
                assertEquals(expectedHour, r.readValue(VPackUtils.toVPack('"' + time + "00" + '"')));
                assertEquals(expectedHour, r.readValue(VPackUtils.toVPack('"' + time + ":00" + '"')));
                assertEquals(ZonedDateTime.parse(time + ":30"), r.readValue(VPackUtils.toVPack('"' + time + "30" + '"')));
                assertEquals(ZonedDateTime.parse(time + ":30"), r.readValue(VPackUtils.toVPack('"' + time + ":30" + '"')));
            }
        }
    }
