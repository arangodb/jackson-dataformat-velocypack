...
public class ZoneOffsetDeserTest extends DateTimeTestBase
{
    ...
    {
        assertEquals(ZoneOffset.of("Z"), READER.readValue(VPackUtils.toVPack("\"Z\"")),
                "The value is not correct.");
        assertEquals(ZoneOffset.of("+0300"), READER.readValue(VPackUtils.toVPack(q("+0300"))),
                "The value is not correct.");
        assertEquals(ZoneOffset.of("-0630"), READER.readValue(VPackUtils.toVPack("\"-06:30\"")),
                "The value is not correct.");
    }
    ...
    public void testPolymorphicZoneOffsetDeser() throws Exception
    {
        ObjectMapper mapper = newMapperBuilder()
            ...
            .build();
        ZoneId value = mapper.readValue(VPackUtils.toVPack("[\"" + ZoneOffset.class.getName() + "\",\"+0415\"]"), ZoneId.class);
    ...
    {
        try {
            READER.readValue(VPackUtils.toVPack("\"notazonedoffset\""));
    ...
    {
        try {
            READER.readValue(VPackUtils.toVPack("[\"+0300\"]"));
            fail("expected MismatchedInputException");
        } catch (MismatchedInputException e) {
    ...
    public void testDeserializationAsArrayEnabled() throws Throwable
    {
        ZoneOffset value = READER
               .with(DeserializationFeature.UNWRAP_SINGLE_VALUE_ARRAYS)
               .readValue(VPackUtils.toVPack("[\"+0300\"]"));
    ...
    public void testLenientDeserializeFromEmptyString() throws Exception {
        ...
        Map<String, ZoneOffset> actualMapFromNullStr = objectReader.readValue(VPackUtils.toVPack(valueFromNullStr));
        ...
        Map<String, ZoneOffset> actualMapFromEmptyStr = objectReader.readValue(VPackUtils.toVPack(valueFromEmptyStr));
    ...
    public void testZoneOffsetDeserFromEmpty() throws Exception
    {
        ...
        assertNull(MAPPER.readValue(VPackUtils.toVPack(q("  ")), ZoneOffset.class));
