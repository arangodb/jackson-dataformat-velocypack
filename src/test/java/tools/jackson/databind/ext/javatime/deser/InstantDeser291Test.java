...
{
    private final VPackMapper MAPPER = VPackMapper.builder()
    ...
    public void testNormalNumericalString() throws Exception {
        assertEquals(INSTANT_3_SEC_AFTER_EPOC, READER.readValue(VPackUtils.toVPack(STR_3_SEC)));
    }

    @Test
    public void testNegativeNumericalString() throws Exception {
        assertEquals(INSTANT_3_SEC_BEFORE_EPOC, READER.readValue(VPackUtils.toVPack(STR_NEGATIVE_3)));
    }

    @Test
    public void testAllowedPlusSignNumericalString() throws Exception {
        assertEquals(INSTANT_3_SEC_AFTER_EPOC, READER.readValue(VPackUtils.toVPack(STR_POSITIVE_3)));
    }
}
