...
public class LocalTimeDeserTest extends DateTimeTestBase
{
    ...
    public void testDeserializationAsTimestamp01() throws Exception
    {
        ...
        LocalTime value = READER.readValue(VPackUtils.toVPack("[15,43]"));
    ...
    public void testDeserializationAsTimestamp02() throws Exception
    {
        ...
        LocalTime value = READER.readValue(VPackUtils.toVPack("[9,22,57]"));
        assertEquals(time, value, "The value is not correct.");
    }
    ...
    public void testDeserializationAsTimestamp03Nanoseconds() throws Exception
    {
        LocalTime value = READER
                ...
                .readValue(VPackUtils.toVPack("[9,22,0,57]"));
    ...
    public void testDeserializationAsTimestamp04Nanoseconds() throws Exception
    {
        LocalTime value = READER
                .with(DateTimeFeature.READ_DATE_TIMESTAMPS_AS_NANOSECONDS)
                .readValue(VPackUtils.toVPack("[22,31,5,829837]"));
    ...
    public void testDeserializationAsTimestamp04Milliseconds02() throws Exception
    {
        LocalTime value = READER
                .without(DateTimeFeature.READ_DATE_TIMESTAMPS_AS_NANOSECONDS)
                .readValue(VPackUtils.toVPack("[22,31,5,829]"));
    ...
    public void testDeserializationAsTimestamp05Nanoseconds() throws Exception
    {
        ...
        WrapperWithReadTimestampsAsNanosEnabled actual = wrapperReader
            .readValue(VPackUtils.toVPack(a2q("{'value':[9,22,0,57]}")));
    ...
    public void testDeserializationAsTimestamp05Milliseconds02() throws Exception
    {
        ObjectReader wrapperReader =
            newMapper().readerFor(WrapperWithReadTimestampsAsNanosDisabled.class);
        WrapperWithReadTimestampsAsNanosDisabled actual = wrapperReader
            .readValue(VPackUtils.toVPack(a2q("{'value':[9,22,0,4257]}")));
    ...
    {
        LocalTime time = LocalTime.of(15, 43);
        LocalTime value = READER.readValue(VPackUtils.toVPack('"' + time.toString() + '"'));
        assertEquals(time, value, "The value is not correct.");
    ...
    {
        try {
            READER.readValue(VPackUtils.toVPack(q("notalocaltime")));
    ...
    {
        try {
            READER.readValue(VPackUtils.toVPack(a2q("['12:00']")));
    ...
    public void testDeserializationAsArrayEnabled() throws Throwable
    {
        LocalTime value = READER
               ...
               .readValue(VPackUtils.toVPack(a2q("['12:00']")));
    ...
    public void testDeserializationAsEmptyArrayEnabled() throws Throwable
    {
        LocalTime value = READER
                ...
                .readValue(VPackUtils.toVPack(a2q("[]")));
        assertNull(value);
    }    
    ...
    public void testDeserializationWithTypeInfo01() throws Exception
    {
        ...
        Temporal value = mapper.readerFor(Temporal.class)
                .with(DateTimeFeature.READ_DATE_TIMESTAMPS_AS_NANOSECONDS)
                .readValue(VPackUtils.toVPack("[\"" + LocalTime.class.getName() + "\",[22,31,5,829837]]"));
    ...
    public void testDeserializationWithTypeInfo02() throws Exception
    {
        ...
        Temporal value = mapper.readerFor(Temporal.class)
                .without(DateTimeFeature.READ_DATE_TIMESTAMPS_AS_NANOSECONDS)
                .readValue(VPackUtils.toVPack("[\"" + LocalTime.class.getName() + "\",[22,31,5,422]]"));
        assertInstanceOf(LocalTime.class, value, "The value should be a LocalTime.");
        assertEquals(time, value, "The value is not correct.");
    }
    ...
    public void testDeserializationWithTypeInfo03() throws Exception
    {
        ...
        Temporal value = mapper.readValue(
                VPackUtils.toVPack("[\"" + LocalTime.class.getName() + "\",\"" + time.toString() + "\"]"), Temporal.class
                );
        assertInstanceOf(LocalTime.class, value, "The value should be a LocalTime.");
        assertEquals(time, value, "The value is not correct.");
    }
    ...
    public void testLenientDeserializeFromEmptyString() throws Exception {
        ...
        Map<String, LocalTime> actualMapFromNullStr = objectReader.readValue(VPackUtils.toVPack(valueFromNullStr));
        ...
        Map<String, LocalTime> actualMapFromEmptyStr = objectReader.readValue(VPackUtils.toVPack(valueFromEmptyStr));
    ...
    public void testStrictCustomFormatInvalidTime() throws Exception
    {
        assertThrows(InvalidFormatException.class,
                () -> /*StrictWrapper w =*/ MAPPER.readValue(VPackUtils.toVPack("{\"value\":\"25:45\"}"), StrictWrapper.class));
    }

    private void expectSuccess(Object exp, String aposJson) throws Exception {
        final LocalTime value = READER.readValue(VPackUtils.toVPack(a2q(aposJson)));
        expect(exp, value);
    }
