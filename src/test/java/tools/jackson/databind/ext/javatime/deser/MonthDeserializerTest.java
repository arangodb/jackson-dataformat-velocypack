...
public class MonthDeserializerTest extends DateTimeTestBase
{
    ...
    public void testDeserializationAsString01_oneBased(Month expectedMonth) throws Exception
    {
        ...
        assertEquals(expectedMonth, readerForOneBased().readValue(VPackUtils.toVPack("\"" + monthNum + '"')));
    }
    ...
    public void testDeserializationAsString01_zeroBased(Month expectedMonth) throws Exception
    {
        ...
        assertEquals(expectedMonth, readerForZeroBased().readValue(VPackUtils.toVPack("\"" + monthNum + '"')));
    }
    ...
    {
        assertEquals(month, readerForOneBased().readValue(VPackUtils.toVPack("\"" + month.name() + '"')));
    }
    ...
    public void testBadDeserializationAsString01_oneBased(String monthSpec, String expectedMessage) {
        ...
        assertError(
            () -> readerForOneBased().readValue(VPackUtils.toVPack(value)),
    ...
    {
        assertEquals(Month.FEBRUARY, readerForZeroBased().readValue(VPackUtils.toVPack("1")));
    }

    @Test
    public void testDeserialization01_oneBased() throws Exception
    {
        assertEquals(Month.JANUARY, readerForOneBased().readValue(VPackUtils.toVPack("1")));
    }

    @Test
    public void testDeserialization02_zeroBased() throws Exception
    {
        assertEquals(Month.SEPTEMBER, readerForZeroBased().readValue(VPackUtils.toVPack("\"8\"")));
    }

    @Test
    public void testDeserialization02_oneBased() throws Exception
    {
        assertEquals(Month.AUGUST, readerForOneBased().readValue(VPackUtils.toVPack("\"8\"")));
    }
    ...
    public void testDeserializationWithTypeInfo01_oneBased() throws Exception
    {
        ...
        TemporalAccessor value = MAPPER.readValue(VPackUtils.toVPack("[\"java.time.Month\",11]"), TemporalAccessor.class);
    ...
    public void testFormatAnnotation_zeroBased() throws Exception
    {
        Wrapper output = readerForZeroBased()
                ...
                .readValue(VPackUtils.toVPack("{\"value\":\"11\"}"));
    ...
    public void testDeserializeFromEmptyString() throws Exception
    {
        ...
        Month m = MAPPER.readerFor(Month.class).readValue(VPackUtils.toVPack(" null "));
        assertNull(m);
        ...
        try {
            ObjectMapper strictMapper = mapperBuilder()
                    ...
                    .build();
            Month result = strictMapper.readerFor(Month.class).readValue(VPackUtils.toVPack("\"\""));
        ...
        ObjectMapper emptyStringMapper = mapperBuilder()
                ...
                .build();
        m = emptyStringMapper.readerFor(Month.class).readValue(VPackUtils.toVPack("\"\""));
        assertNull(m);
    }
    ...
    public void testDeserializationAsInt_zeroBased(Month expectedMonth) throws Exception
    {
        ...
        assertEquals(expectedMonth, readerForZeroBased().readValue(VPackUtils.toVPack(String.valueOf(monthIndex))));
    }
    ...
    {
        int monthNum = expectedMonth.getValue();
        assertEquals(expectedMonth, readerForOneBased().readValue(VPackUtils.toVPack(String.valueOf(monthNum))));
    }
    ...
    {
        assertError(
            () -> readerForZeroBased().readValue(VPackUtils.toVPack(String.valueOf(invalidValue))),
    ...
    {
        assertError(
            () -> readerForOneBased().readValue(VPackUtils.toVPack(String.valueOf(invalidValue))),
            MismatchedInputException.class,
    ...
    public void testDeserializationAsEmptyArray() throws Exception
    {
        ...
        assertError(
            () -> readerForOneBased().readValue(VPackUtils.toVPack("[]")),
            MismatchedInputException.class,
            "Cannot deserialize"
        );
    }
    ...
    public void testDeserializationAsEmptyArray_withFeatureEnabled() throws Exception
    {
        ...
        Month result = mapper.readerFor(Month.class).readValue(VPackUtils.toVPack("[]"));
        assertNull(result);
    }
    ...
    public void testDeserializationAsArrayWithIntValue() throws Exception
    {
        ...
        assertError(
            () -> readerForOneBased().readValue(VPackUtils.toVPack("[3]")),
            MismatchedInputException.class,
            "from Array value"
        );
    }
    ...
    public void testDeserializationAsArrayWithIntValue_withFeatureEnabled() throws Exception
    {
        ...
        Month result = r.readValue(VPackUtils.toVPack("[3]"));
    ...
    public void testDeserializationAsArrayWithIntValue_zeroBased() throws Exception
    {
        // [databind#5957]: Single-element int array now requires UNWRAP_SINGLE_VALUE_ARRAYS
        assertError(
            () -> readerForZeroBased().readValue(VPackUtils.toVPack("[3]")),
            MismatchedInputException.class,
            "from Array value"
        );
    }
    ...
    public void testDeserializationAsArrayWithMoreThanOneElement() throws Exception
    {
        ...
        assertError(
            () -> readerForOneBased().readValue(VPackUtils.toVPack("[1, 2]")),
            MismatchedInputException.class,
            "from Array value"
        );
    }
    ...
    public void testDeserializationAsArrayWithWrongToken() throws Exception
    {
        ...
        assertError(
            () -> readerForOneBased().readValue(VPackUtils.toVPack("[true]")),
            MismatchedInputException.class,
            "from Array value"
        );
    }
    ...
    public void testDeserializationAsArrayWithStringUnwrapDisabled() throws Exception
    {
        ...
        assertError(
            () -> readerForOneBased().readValue(VPackUtils.toVPack("[\"JANUARY\"]")),
            MismatchedInputException.class,
            "from Array value"
        );
    }
    ...
    public void testDeserializationAsArrayWithFloatUnwrapDisabled() throws Exception
    {
        ...
        assertError(
            () -> readerForOneBased().readValue(VPackUtils.toVPack("[1.5]")),
            MismatchedInputException.class,
            "from Array value"
        );
    }
    ...
    public void testDeserializationAsArrayWithStringUnwrapEnabled() throws Exception
    {
        ...
        Month result = MAPPER.readerFor(Month.class)
                ...
                .readValue(VPackUtils.toVPack("[\"JANUARY\"]"));
    ...
    public void testDeserializationAsArrayWithNumericStringUnwrapEnabled() throws Exception
    {
        ...
        Month result = MAPPER.readerFor(Month.class)
                .with(DeserializationFeature.UNWRAP_SINGLE_VALUE_ARRAYS)
                .with(DateTimeFeature.ONE_BASED_MONTHS)
                .readValue(VPackUtils.toVPack("[\"5\"]"));
    ...
    public void testDeserializationAsArrayWithMoreThanOneString() throws Exception
    {
        ...
        assertError(
            () -> MAPPER.readerFor(Month.class)
                    .with(DeserializationFeature.UNWRAP_SINGLE_VALUE_ARRAYS)
                    .readValue(VPackUtils.toVPack("[\"JANUARY\", \"FEBRUARY\"]")),
            MismatchedInputException.class,
            "Attempted to unwrap"
        );
    }
    ...
    public void testBadDeserializationAsString_zeroBasedOutOfRange(String monthSpec, String expectedMessage) {
        ...
        assertError(
            () -> readerForZeroBased().readValue(VPackUtils.toVPack(value)),
            InvalidFormatException.class,
            expectedMessage
        );
    }
    ...
    public void testDeserializationWithWhitespace() throws Exception
    {
        ...
        Month result = readerForOneBased().readValue(VPackUtils.toVPack("\" JANUARY \""));
        assertEquals(Month.JANUARY, result);
    }
    ...
    public void testDeserializationWithWhitespaceNumeric() throws Exception
    {
        ...
        Month result = readerForOneBased().readValue(VPackUtils.toVPack("\" 6 \""));
    ...
    {
        WrapperWithFormat result = MAPPER.readValue(VPackUtils.toVPack("{\"value\":\"Jan\"}"), WrapperWithFormat.class);
    ...
    {
        WrapperWithFormat result = MAPPER.readValue(VPackUtils.toVPack("{\"value\":\"Mar\"}"), WrapperWithFormat.class);
    ...
    {
        assertError(
            () -> MAPPER.readValue(VPackUtils.toVPack("{\"value\":\"NotAMonth\"}"), WrapperWithFormat.class),
            InvalidFormatException.class,
            "could not be parsed"
        );
    }
    ...
    public void testDeserializationWithFullMonthFormat() throws Exception
    {
        WrapperWithFullMonthFormat result = MAPPER.readValue(
                VPackUtils.toVPack("{\"value\":\"January\"}"), WrapperWithFullMonthFormat.class);
        assertEquals(Month.JANUARY, result.value);
    }
