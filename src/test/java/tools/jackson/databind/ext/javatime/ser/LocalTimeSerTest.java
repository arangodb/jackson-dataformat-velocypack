...
public class LocalTimeSerTest extends DateTimeTestBase
{
    ...
    {
        String json = VPackUtils.toJson(writer.with(DateTimeFeature.WRITE_DATES_AS_TIMESTAMPS)
                .writeValueAsBytes(LocalTime.of(15, 43)));
    ...
    {
        String json = VPackUtils.toJson(writer.with(DateTimeFeature.WRITE_DATES_AS_TIMESTAMPS)
                .writeValueAsBytes(LocalTime.of(9, 22, 57)));
    ...
    public void testSerializationAsTimestamp03Nanoseconds() throws Exception
    {
        String json = VPackUtils.toJson(writer.with(DateTimeFeature.WRITE_DATES_AS_TIMESTAMPS)
                ...
                .writeValueAsBytes(LocalTime.of(9, 22, 0, 57)));
    ...
    public void testSerializationAsTimestamp03Milliseconds() throws Exception
    {
        ...
        ObjectMapper mapper = newMapperBuilder()
                ...
                .build();
        String value = VPackUtils.toJson(mapper.writeValueAsBytes(time));
    ...
    public void testSerializationAsString01() throws Exception
    {
        ...
        ObjectMapper mapper = newMapperBuilder()
                ...
                .build();
        assertEquals("\"15:43:20\"", VPackUtils.toJson(mapper.writeValueAsBytes(time)));
    }
    ...
    public void testSerializationAsString03() throws Exception
    {
        ...
        ObjectMapper m = newMapperBuilder()
                .configure(DateTimeFeature.WRITE_DATES_AS_TIMESTAMPS, false)
                .build();
        String value = VPackUtils.toJson(m.writeValueAsBytes(time));
        assertEquals('"' + time.toString() + '"', value, "The value is not correct.");
    }
    ...
    {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new CustomWrapper(LocalTime.of(15, 43))));
    ...
    public void testSerializationWithTypeInfo01() throws Exception
    {
        ...
        ObjectMapper m = newMapperBuilder()
                ...
                .build();
        String json = VPackUtils.toJson(m.writeValueAsBytes(time));
