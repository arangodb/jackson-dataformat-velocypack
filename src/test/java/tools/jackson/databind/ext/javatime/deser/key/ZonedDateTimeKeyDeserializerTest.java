    ...
    extends DateTimeTestBase
{
    ...
    public void Instant_style_can_be_deserialized() throws Exception {
        Map<ZonedDateTime, String> map = MAPPER.readValue(VPackUtils.toVPack(getMap("2015-07-24T12:23:34.184Z")),
                MAP_TYPE_REF);
    ...
    public void ZonedDateTime_with_zone_name_can_be_deserialized() throws Exception {
        Map<ZonedDateTime, String> map = MAPPER.readValue(VPackUtils.toVPack(getMap("2015-07-24T12:23:34.184Z[UTC]")),
                MAP_TYPE_REF);
        Map.Entry<ZonedDateTime, String> entry = map.entrySet().iterator().next();
    ...
    public void ZonedDateTime_with_place_name_can_be_deserialized() throws Exception {
        Map<ZonedDateTime, String> map = MAPPER.readValue(VPackUtils.toVPack(getMap("2015-07-24T12:23:34.184Z[Europe/London]")),
                MAP_TYPE_REF);
        Map.Entry<ZonedDateTime, String> entry = map.entrySet().iterator().next();
    ...
    public void ZonedDateTime_with_offset_can_be_deserialized() throws Exception {
        Map<ZonedDateTime, String> map = MAPPER.readValue(VPackUtils.toVPack(getMap("2015-07-24T12:23:34.184+02:00")),
                MAP_TYPE_REF);
        Map.Entry<ZonedDateTime, String> entry = map.entrySet().iterator().next();
