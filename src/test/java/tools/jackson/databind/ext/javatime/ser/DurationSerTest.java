...
//              , without = JsonFormat.Feature.WRITE_DATE_TIMESTAMPS_AS_NANOSECONDS
    ...
    public void testSerializationAsTimestampNanoseconds01() throws Exception
    {
        ...
        String value = VPackUtils.toJson(WRITER
    ...
    public void testSerializationAsTimestampMilliseconds01() throws Exception
    {
        ...
        String value = VPackUtils.toJson(w.writeValueAsBytes(Duration.ofSeconds(45L, 0)));
        assertEquals("45000", value);

        // and with negative value too
        value = VPackUtils.toJson(w.writeValueAsBytes(Duration.ofSeconds(-32L, 0)));
    ...
    public void testSerializationAsTimestampMilliseconds02() throws Exception
    {
        String value = VPackUtils.toJson(WRITER
                .with(DateTimeFeature.WRITE_DURATIONS_AS_TIMESTAMPS)
                .without(DateTimeFeature.WRITE_DATE_TIMESTAMPS_AS_NANOSECONDS)
                .writeValueAsBytes(Duration.ofSeconds(13498L, 8374)));
    ...
    public void testSerializationWithTypeInfo01() throws Exception
    {
        ObjectMapper mapper = newMapperBuilder()
                ...
                .build();
        Duration duration = Duration.ofSeconds(13498L, 8374);
        String value = VPackUtils.toJson(mapper.writeValueAsBytes(duration));
    ...
    public void shouldSerializeInNanos_whenSetAsPattern() throws Exception
    {
        ...
        assertEquals("3600000000000", VPackUtils.toJson(mapper.writeValueAsBytes(Duration.ofHours(1))));
    }
    ...
    public void shouldSerializeInMicros_whenSetAsPattern() throws Exception
    {
        ...
        assertEquals("1000", VPackUtils.toJson(mapper.writeValueAsBytes(Duration.ofMillis(1))));
    }
    ...
    {
        ObjectMapper mapper = _mapperForPatternOverride("MICROS");
        assertEquals("1", VPackUtils.toJson(mapper.writeValueAsBytes(Duration.ofNanos(1500))));
    }
    ...
    public void shouldSerializeInMillis_whenSetAsPattern() throws Exception
    {
        ...
        assertEquals("1000", VPackUtils.toJson(mapper.writeValueAsBytes(Duration.ofSeconds(1))));
    }
    ...
    {
        ObjectMapper mapper = _mapperForPatternOverride("MILLIS");
        assertEquals("1", VPackUtils.toJson(mapper.writeValueAsBytes(Duration.ofNanos(1500000))));
    }
    ...
    public void shouldSerializeInSeconds_whenSetAsPattern() throws Exception
    {
        ...
        assertEquals("60", VPackUtils.toJson(mapper.writeValueAsBytes(Duration.ofMinutes(1))));
    }
    ...
    {
        ObjectMapper mapper = _mapperForPatternOverride("SECONDS");
        assertEquals("1", VPackUtils.toJson(mapper.writeValueAsBytes(Duration.ofMillis(1500))));
    }
    ...
    public void shouldSerializeInMinutes_whenSetAsPattern() throws Exception
    {
        ...
        assertEquals("60", VPackUtils.toJson(mapper.writeValueAsBytes(Duration.ofHours(1))));
    }
    ...
    {
        ObjectMapper mapper = _mapperForPatternOverride("MINUTES");
        assertEquals("1", VPackUtils.toJson(mapper.writeValueAsBytes(Duration.ofSeconds(90))));
    }
    ...
    public void shouldSerializeInHours_whenSetAsPattern() throws Exception
    {
        ...
        assertEquals("24", VPackUtils.toJson(mapper.writeValueAsBytes(Duration.ofDays(1))));
    }
    ...
    {
        ObjectMapper mapper = _mapperForPatternOverride("HOURS");
        assertEquals("1", VPackUtils.toJson(mapper.writeValueAsBytes(Duration.ofMinutes(90))));
    }
    ...
    public void shouldSerializeInHalfDays_whenSetAsPattern() throws Exception
    {
        ...
        assertEquals("2", VPackUtils.toJson(mapper.writeValueAsBytes(Duration.ofDays(1))));
    }
    ...
    public void shouldSerializeInHalfDaysDiscardingFractions_whenSetAsPattern() throws Exception
    {
        ...
        assertEquals("1", VPackUtils.toJson(mapper.writeValueAsBytes(Duration.ofHours(30))));
    }
    ...
    {
        ObjectMapper mapper = _mapperForPatternOverride("DAYS");
        assertEquals("1", VPackUtils.toJson(mapper.writeValueAsBytes(Duration.ofDays(1))));
    }
    ...
    {
        ObjectMapper mapper = _mapperForPatternOverride("DAYS");
        assertEquals("1", VPackUtils.toJson(mapper.writeValueAsBytes(Duration.ofHours(36))));
    }
    ...
    public void testDurationFormatOverrideMinutes() throws Exception
    {
        assertEquals(a2q("{'mins':120}"),
                VPackUtils.toJson(WRITER
                    .with(DateTimeFeature.WRITE_DURATIONS_AS_TIMESTAMPS)
                    .writeValueAsBytes(new MyDto224(Duration.ofHours(2)))));
    }
    ...
    public void testDurationFormatOverrideSeconds() throws Exception
    {
        ...
        assertEquals(a2q("{'duration':"+Long.MIN_VALUE+"}"),
                VPackUtils.toJson(WRITER
                    .with(DateTimeFeature.WRITE_DURATIONS_AS_TIMESTAMPS)
                    .writeValueAsBytes(new Bean282(maxDuration))));
    }
}
