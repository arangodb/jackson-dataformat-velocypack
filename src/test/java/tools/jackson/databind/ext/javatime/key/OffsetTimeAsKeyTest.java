...
public class OffsetTimeAsKeyTest extends DateTimeTestBase
{
    ...
    public void testSerialization0() throws Exception {
        assertEquals(mapAsString(TIME_0_STRING, "test"),
                VPackUtils.toJson(MAPPER.writeValueAsBytes(asMap(TIME_0, "test"))));
    }

    @Test
    public void testSerialization1() throws Exception {
        assertEquals(mapAsString(TIME_1_STRING, "test"),
                VPackUtils.toJson(MAPPER.writeValueAsBytes(asMap(TIME_1, "test"))),
                "Value is incorrect");
    }
    ...
    public void testSerialization2() throws Exception {
        assertEquals(mapAsString(TIME_2_STRING, "test"),
                VPackUtils.toJson(MAPPER.writeValueAsBytes(asMap(TIME_2, "test"))),
                "Value is incorrect");
    }
    ...
    public void testDeserialization0() throws Exception {
        assertEquals(asMap(TIME_0, "test"),
                READER.readValue(VPackUtils.toVPack(mapAsString(TIME_0_STRING, "test"))),
                "Value is incorrect");
    }
    ...
    public void testDeserialization1() throws Exception {
        assertEquals(asMap(TIME_1, "test"),
                READER.readValue(VPackUtils.toVPack(mapAsString(TIME_1_STRING, "test"))),
                "Value is incorrect");
    }
    ...
    public void testDeserialization2() throws Exception {
        assertEquals(asMap(TIME_2, "test"),
                READER.readValue(VPackUtils.toVPack(mapAsString(TIME_2_STRING, "test"))),
                "Value is incorrect");
    }
}
