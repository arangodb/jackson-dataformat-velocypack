...
public class PeriodSerTest extends DateTimeTestBase
{
    ...
    {
        assertEquals(q("P1Y6M15D"), VPackUtils.toJson(MAPPER.writeValueAsBytes(Period.of(1, 6, 15))));
    }

    @Test
    public void testSerialization02() throws Exception
    {
        assertEquals(q("P21D"), VPackUtils.toJson(MAPPER.writeValueAsBytes(Period.of(0, 0, 21))));
    }
    ...
    public void testSerializationWithTypeInfo01() throws Exception
    {
        ...
        final ObjectMapper mapper = mapperBuilder()
                ...
                .build();
        String value = VPackUtils.toJson(mapper.writeValueAsBytes(period));
