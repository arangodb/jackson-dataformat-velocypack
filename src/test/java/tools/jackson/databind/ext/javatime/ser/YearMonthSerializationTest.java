	...
	extends DateTimeTestBase
{
    ...
    public void testSerializationWithTypeInfo01() throws Exception
    {
        ...
        ObjectMapper mapper = newMapperBuilder()
               ...
               .addMixIn(Temporal.class, MockObjectConfiguration.class)
        		.build();
        String value = VPackUtils.toJson(mapper.writeValueAsBytes(yearMonth));
    ...
    {
        YearMonth yearMonth = YearMonth.of(1986, Month.JANUARY);
        YearMonth value = MAPPER.readValue(VPackUtils.toVPack("[1986,1]"), YearMonth.class);
    ...
    {
        YearMonth yearMonth = YearMonth.of(2013, Month.AUGUST);
        YearMonth value = MAPPER.readValue(VPackUtils.toVPack("[2013,8]"), YearMonth.class);
        assertEquals(yearMonth, value);
    }
    ...
    {
        YearMonth yearMonth = YearMonth.of(1986, Month.JANUARY);
        YearMonth value = MAPPER.readValue(VPackUtils.toVPack('"' + yearMonth.toString() + '"'), YearMonth.class);
    ...
    {
        YearMonth yearMonth = YearMonth.of(2013, Month.AUGUST);
        YearMonth value = this.MAPPER.readValue(VPackUtils.toVPack('"' + yearMonth.toString() + '"'), YearMonth.class);
        assertEquals(yearMonth, value);
    }
    ...
    public void testDeserializationWithTypeInfo01() throws Exception
    {
        ...
        ObjectMapper mapper = newMapperBuilder()
        		.addMixIn(Temporal.class, MockObjectConfiguration.class)
        		.build();
        Temporal value = mapper.readValue(VPackUtils.toVPack("[\"" + YearMonth.class.getName() + "\",\"" + yearMonth.toString() + "\"]"), Temporal.class);
    ...
    public void testSerializationWithPattern01() throws Exception
    {
        ...
        String value = VPackUtils.toJson(MAPPER.writeValueAsBytes(simpleAggregate));
    ...
    public void testDeserializationWithPattern01() throws Exception
    {
        ...
        SimpleAggregate value = MAPPER.readValue(VPackUtils.toVPack("{\"yearMonth\":\"1308\"}"), SimpleAggregate.class);
