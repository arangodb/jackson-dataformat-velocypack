...
public class LocalDateDeserTest extends DateTimeTestBase
{
    ...
    public void testDeserializationAsTimestamp01()
    {
        assertEquals(LocalDate.of(1986, Month.JANUARY, 17),
                READER.readValue(VPackUtils.toVPack("[1986,1,17]")));
    }
    ...
    public void testDeserializationAsTimestamp02()
    {
        assertEquals(LocalDate.of(2013, Month.AUGUST, 21),
                READER.readValue(VPackUtils.toVPack("[2013,8,21]")));
    }
    ...
    {
        assertEquals(LocalDate.of(2000, Month.JANUARY, 1), READER.readValue(VPackUtils.toVPack(q("2000-01-01"))));

        LocalDate date = LocalDate.of(1986, Month.JANUARY, 17);
        assertEquals(date, READER.readValue(VPackUtils.toVPack('"' + date.toString() + '"')));
    ...
    public void testDeserializationAsString02()
    {
        ...
        assertEquals(date.toLocalDate(), READER.readValue(VPackUtils.toVPack('"' + date.toString() + '"')));
    }
    ...
    public void testLenientDeserializationAsString01() throws Exception
    {
        ...
        LocalDate value = READER.readValue(VPackUtils.toVPack(q(instant.toString())));
    ...
    {
        Instant instant = Instant.now();
        LocalDate value = READER_USING_TIME_ZONE.readValue(VPackUtils.toVPack(q(instant.toString())));
        assertEquals(LocalDateTime.ofInstant(instant, ZoneOffset.UTC).toLocalDate(), value);
    }
    ...
    public void testLenientDeserializationAsString04(TimeZone zone, String string, LocalDate expected) throws Exception
    {
        ...
        LocalDate value = reader.readValue(VPackUtils.toVPack(q(string)));
    ...
    {
        try {
            READER.readValue(VPackUtils.toVPack(q("notalocaldate")));
    ...
    {
        try {
            READER.readValue(VPackUtils.toVPack(q("2015-06-19TShouldNotParse")));
            fail("Should not pass");
        } catch (MismatchedInputException e) {
            verifyException(e, "Cannot deserialize value of type");
            verifyException(e, "from String \"");
    ...
    public void testDeserializationWithTypeInfo01()
    {
        ...
        Temporal value = mapper.readValue(
                VPackUtils.toVPack("[\"" + LocalDate.class.getName() + "\",\"" + date.toString() + "\"]"), Temporal.class
                );
    ...
    {
        assertEquals(LocalDate.of(1970, Month.JANUARY, 3), READER.readValue(VPackUtils.toVPack("2")));

        assertEquals(LocalDate.of(1970, Month.FEBRUARY, 10), READER.readValue(VPackUtils.toVPack("40")));
    }
    ...
    public void testInvalidEpochDayValueInLenientMode()
    {
        ...
        try {
            READER.readValue(VPackUtils.toVPack("-922337203685"));
            fail("Should not pass");
    ...
    public void testStricDeserializeFromInt()
    {
        ObjectMapper mapper = mapperBuilder()
                ...
                .build();
        try {
            mapper.readValue(VPackUtils.toVPack("2"), LocalDate.class);
            fail("Should not pass");
        } catch (MismatchedInputException e) {
    ...
    public void testLenientDeserializeFromEmptyString()
    {
        ...
        Map<String, LocalDate> actualMapFromNullStr = objectReader.readValue(VPackUtils.toVPack(valueFromNullStr));
        ...
        Map<String, LocalDate> actualMapFromEmptyStr = objectReader.readValue(VPackUtils.toVPack(valueFromEmptyStr));
    ...
    public void testStrictDeserializeFromEmptyString() throws Exception {
        ...
        String valueFromEmptyStr = VPackUtils.toJson(mapper.writeValueAsBytes(asMap("date", dateValAsEmptyStr)));
    ...
    {
        try {
            READER.readValue(VPackUtils.toVPack("[\"2000-01-01\"]"));
    ...
    public void testDeserializationAsArrayEnabled()
    {
        LocalDate actual = READER
                ...
                .readValue(VPackUtils.toVPack("[\"2000-01-01\"]"));
    ...
    {
        Wrapper w = MAPPER.readValue(VPackUtils.toVPack("{\"value\":\"2015_07_28T13:53+0300\"}"), Wrapper.class);
    ...
    public void testStrictWithCustomFormat()
    {
        try {
            /*StrictWrapperWithFormat w =*/ MAPPER.readValue(
                    VPackUtils.toVPack("{\"value\":\"2019-11-31\"}"),
    ...
    public void testStrictCustomFormatForInvalidFormat() throws Exception
    {
        try {
            /*StrictWrapperWithFormat w = */ MAPPER.readValue(
                VPackUtils.toVPack("{\"value\":\"2019-11-30\"}"),
                StrictWrapperWithFormat.class);
            fail("Should not pass");
        } catch (InvalidFormatException e) {
    ...
    public void testStrictCustomFormatForInvalidFormatWithEra() throws Exception
    {
        assertThrows(InvalidFormatException.class, () -> {
            /*StrictWrapperWithYearOfEra w =*/ MAPPER.readValue(VPackUtils.toVPack("{\"value\":\"2019-11-30\"}"), StrictWrapperWithYearOfEra.class);
        });
    }
    ...
    {
        assertThrows(InvalidFormatException.class, () -> {
            /*StrictWrapperWithYearOfEra w =*/ MAPPER.readValue(VPackUtils.toVPack("{\"value\":\"2019-11-31 AD\"}"), StrictWrapperWithYearOfEra.class);
        });
    }
    ...
    {
        StrictWrapperWithYearOfEra w = MAPPER.readValue(VPackUtils.toVPack("{\"value\":\"2019-11-30 AD\"}"), StrictWrapperWithYearOfEra.class);
    ...
    {
        assertThrows(InvalidFormatException.class, () -> {
            /*StrictWrapperWithYearWithoutEra w =*/ MAPPER.readValue(VPackUtils.toVPack("{\"value\":\"2019-11-30 AD\"}"), StrictWrapperWithYearWithoutEra.class);
        });
    }
    ...
    {
        assertThrows(InvalidFormatException.class, () -> {
            /*StrictWrapperWithYearWithoutEra w =*/ MAPPER.readValue(VPackUtils.toVPack("{\"value\":\"2019-11-31\"}"), StrictWrapperWithYearWithoutEra.class);
        });
    }
    ...
    {
        StrictWrapperWithYearWithoutEra w = MAPPER.readValue(VPackUtils.toVPack("{\"value\":\"2019-11-30\"}"), StrictWrapperWithYearWithoutEra.class);
    ...
    public void testLenientDeserializeFromNumberInt() {
        ...
        assertEquals(LocalDate.of(1970, Month.MAY, 4),
            mapper.readValue(VPackUtils.toVPack("123"), LocalDate.class));
    }
    ...
    public void testStrictDeserializeFromNumberInt()
    {
        ...
        ShapeWrapper w = mapper.readValue(VPackUtils.toVPack("{\"date\":123}"), ShapeWrapper.class);
    ...
    public void testStrictDeserializeFromString()
    {
        ObjectMapper mapper = newMapperBuilder()
                ...
                .build();
        try {
            mapper.readValue(VPackUtils.toVPack("{\"value\":123}"), Wrapper.class);
            fail("Should not pass");
        } catch (MismatchedInputException e) {
    ...
    public void testInvalidEpochDayValue()
    {
        ...
        try {
            mapper.readValue(VPackUtils.toVPack("-922337203685"), LocalDate.class);
            fail("Should not pass");
        } catch (DateTimeParseException e) {
            // Verify it's a DateTimeParseException, not DateTimeException
            verifyException(e, "Failed to deserialize");
    ...
    public void testDeserializeFromEmptyStringWithCoercionActionFail() {
        ...
        MismatchedInputException exception = assertThrows(MismatchedInputException.class,
                () -> mapper.readValue(VPackUtils.toVPack(a2q("{'value':''}")), Wrapper.class));
   ...
   private void expectSuccess(ObjectReader reader, Object exp, String json) {
        final LocalDate value = reader.readValue(VPackUtils.toVPack(a2q(json)));
        assertNotNull(value);
