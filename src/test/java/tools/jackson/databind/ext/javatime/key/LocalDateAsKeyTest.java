...
public class LocalDateAsKeyTest extends DateTimeTestBase
{
    ...
    public void testSerialization() throws Exception {
        assertEquals(mapAsString(DATE_STRING, "test"),
                VPackUtils.toJson(MAPPER.writeValueAsBytes(asMap(DATE, "test"))));
    }

    @Test
    public void testDeserialization() throws Exception {
        assertEquals(asMap(DATE, "test"), READER.readValue(VPackUtils.toVPack(mapAsString(DATE_STRING, "test"))));
    }
}
