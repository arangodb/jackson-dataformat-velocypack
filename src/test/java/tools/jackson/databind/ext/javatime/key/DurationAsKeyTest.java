...
public class DurationAsKeyTest extends DateTimeTestBase
{
    ...
    public void testSerialization() throws Exception {
        assertEquals(mapAsString(DURATION_STRING, "test"),
                VPackUtils.toJson(MAPPER.writeValueAsBytes(Collections.singletonMap(DURATION, "test"))));
    }

    @Test
    public void testDeserialization() throws Exception {
        assertEquals(Collections.singletonMap(DURATION, "test"), READER.readValue(VPackUtils.toVPack(mapAsString(DURATION_STRING, "test"))));
    }
}
