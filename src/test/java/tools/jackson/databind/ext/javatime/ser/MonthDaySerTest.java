    ...
    extends DateTimeTestBase
{
    ...
    {
        assertEquals("\"--01-17\"",
                VPackUtils.toJson(MAPPER.writeValueAsBytes(MonthDay.of(Month.JANUARY, 17))));
    }
    ...
    {
        assertEquals("\"--08-21\"",
                VPackUtils.toJson(MAPPER.writeValueAsBytes(MonthDay.of(Month.AUGUST, 21))));
    }
    ...
    public void testSerializationWithTypeInfo01() throws Exception
    {
        ...
        String value = VPackUtils.toJson(mapper.writeValueAsBytes(monthDay));
    ...
    {
        // One with shape
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new ShapeIntWrapper(MonthDay.of(Month.MARCH, 17))));
        assertEquals("{\"value\":[3,17]}", json);

        // One without shape
        json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new NoShapeIntWrapper(MonthDay.of(Month.MARCH, 17))));
    ...
    {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new FrBean(MonthDay.of(Month.MARCH, 17))));
    ...
    {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new ShapeArrayBean(MonthDay.of(Month.DECEMBER, 31))));
