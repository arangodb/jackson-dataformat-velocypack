...
public class ZoneIdAsKeyTest extends DateTimeTestBase
{
    ...
    public void testSerialization0() throws Exception {
        assertEquals(mapAsString(ZONE_0_STRING, "test"),
                VPackUtils.toJson(MAPPER.writeValueAsBytes(asMap(ZONE_0, "test"))));
    }

    @Test
    public void testSerialization1() throws Exception {
        assertEquals(mapAsString(ZONE_1_STRING, "test"),
                VPackUtils.toJson(MAPPER.writeValueAsBytes(asMap(ZONE_1, "test"))));
    }

    @Test
    public void testSerialization2() throws Exception {
        assertEquals(mapAsString(ZONE_2_STRING, "test"),
                VPackUtils.toJson(MAPPER.writeValueAsBytes(asMap(ZONE_2, "test"))));
    }

    @Test
    public void testDeserialization0() throws Exception {
        assertEquals(asMap(ZONE_0, "test"),
                READER.readValue(VPackUtils.toVPack(mapAsString(ZONE_0_STRING, "test"))));
    }

    @Test
    public void testDeserialization1() throws Exception {
        assertEquals(asMap(ZONE_1, "test"),
                READER.readValue(VPackUtils.toVPack(mapAsString(ZONE_1_STRING, "test"))));
    }

    @Test
    public void testDeserialization2() throws Exception {
        assertEquals(asMap(ZONE_2, "test"),
                READER.readValue(VPackUtils.toVPack(mapAsString(ZONE_2_STRING, "test"))));
    }
}
