...
public class InstantDeserTest extends DateTimeTestBase
{
    ...
    public void testDeserializationAsFloat01() throws Exception {
        assertEquals(Instant.ofEpochSecond(0L),
                READER.readValue(VPackUtils.toVPack("0.000000000")));
    }
    ...
    public void testDeserializationAsFloatEdgeCase01() throws Exception
    {
        ...
        Instant value = READER.readValue(VPackUtils.toVPack(input));
    ...
    public void testDeserializationAsFloatEdgeCase03() throws Exception
    {
        ...
        assertThrows(DateTimeParseException.class, () -> READER.readValue(VPackUtils.toVPack(input)));
    }
    ...
    public void testDeserializationAsFloatEdgeCase06() throws Exception
    {
        ...
        Instant value = READER.readValue(VPackUtils.toVPack("1e64"));
    ...
    {
        Instant value = READER.readValue(VPackUtils.toVPack("1e10000000"));
        assertEquals(0, value.getEpochSecond());
    }
    ...
    {
        Instant value = READER.readValue(VPackUtils.toVPack("1e-10000000"));
        assertEquals(0, value.getEpochSecond());
    }
    ...
    public void testDeserializationAsInt02Nanoseconds() throws Exception
    {
        ...
        Instant value = READER
                .with(DateTimeFeature.READ_DATE_TIMESTAMPS_AS_NANOSECONDS)
                .readValue(VPackUtils.toVPack(String.valueOf(ts)));
        assertEquals(date, value);
    }
    ...
    public void testDeserializationAsInt03Nanoseconds() throws Exception
    {
        ...
        Instant value = READER
                .with(DateTimeFeature.READ_DATE_TIMESTAMPS_AS_NANOSECONDS)
                .readValue(VPackUtils.toVPack(Long.toString(date.getEpochSecond())));
        assertEquals(date, value);
    }
    ...
    public void testDeserializationAsInt04Nanoseconds() throws Exception
    {
        ...
        WrapperWithReadTimestampsAsNanosEnabled actual = reader.readValue(VPackUtils.toVPack(
    ...
    public void testDeserializationAsInt03Milliseconds() throws Exception
    {
        ...
        Instant value = READER
                .without(DateTimeFeature.READ_DATE_TIMESTAMPS_AS_NANOSECONDS)
                .readValue(VPackUtils.toVPack(Long.toString(date.toEpochMilli())));
        assertEquals(date, value);
    }
    ...
    public void testDeserializationAsInt04Milliseconds() throws Exception
    {
        ...
        WrapperWithReadTimestampsAsNanosDisabled actual = reader.readValue(VPackUtils.toVPack(
    ...
    public void testInvalidEpochSecondValue() throws Exception
    {
        ...
        try {
            READER.readValue(VPackUtils.toVPack(String.valueOf(invalidValue)));
    ...
    {
        Instant date = Instant.ofEpochSecond(0L);
        Instant value = READER.readValue(VPackUtils.toVPack('"' + FORMATTER.format(date) + '"'));
        assertEquals(date, value);
    }
    ...
    public void testDeserializationWithTypeInfo02() throws Exception
    {
        ...
        ObjectMapper m = newMapperBuilder()
                ...
                .build();
        Temporal value = m.readValue(
                VPackUtils.toVPack("[\"" + Instant.class.getName() + "\",123456789]"), Temporal.class
                );
        assertInstanceOf(Instant.class, value, "The value should be an Instant.");
        assertEquals(date, value);
    }
    ...
    public void testDeserializationWithTypeInfo03() throws Exception
    {
        ...
        ObjectMapper m = newMapperBuilder()
                ...
                .build();
        Temporal value = m.readValue(
                VPackUtils.toVPack("[\"" + Instant.class.getName() + "\",123456789422]"), Temporal.class
                );
    ...
    public void testDeserializationWithTypeInfo04() throws Exception
    {
        ...
        ObjectMapper m = newMapperBuilder()
                ...
                .build();
        Temporal value = m.readValue(
                VPackUtils.toVPack("[\"" + Instant.class.getName() + "\",\"" + FORMATTER.format(date) + "\"]"), Temporal.class
                );
        assertInstanceOf(Instant.class, value, "The value should be an Instant.");
        assertEquals(date, value);
    }
    ...
    public void testCustomPatternWithAnnotations02() throws Exception
    {
        ...
        WrapperWithCustomPattern result = MAPPER.readValue(VPackUtils.toVPack(json), WrapperWithCustomPattern.class);
    ...
    public void testRoundTripOfInstantAndJavaUtilDate() throws Exception
    {
        ...
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(java.util.Date.from(givenInstant)));
        Instant actual = mapper.readValue(VPackUtils.toVPack(json), Instant.class);
    ...
    public void testLenientDeserializeFromEmptyString() throws Exception {
        ...
        Map<String, Duration> actualMapFromNullStr = objectReader.readValue(VPackUtils.toVPack(valueFromNullStr));
        ...
        Map<String, Duration> actualMapFromEmptyStr = objectReader.readValue(VPackUtils.toVPack(valueFromEmptyStr));
    ...
    public void testStrictDeserializeFromEmptyString() throws Exception {
        ...
        Map<String, Instant> actualMapFromNullStr = objectReader.readValue(VPackUtils.toVPack(valueFromNullStr));
