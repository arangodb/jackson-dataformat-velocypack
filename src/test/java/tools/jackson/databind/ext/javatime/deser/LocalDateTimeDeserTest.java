    ...
    extends DateTimeTestBase
{
    ...
    private final ObjectReader READER_USING_TIME_ZONE = VPackMapper.builder()
    ...
    {
        LocalDateTime value = READER.readValue(VPackUtils.toVPack("[1986,1,17,15,43]"));
    ...
    {
        LocalDateTime value = READER.readValue(VPackUtils.toVPack("[2013,8,21,9,22,57]"));
    ...
    public void testDeserializationAsTimestamp03Nanoseconds()
    {
        ...
        LocalDateTime value = r.readValue(VPackUtils.toVPack("[2013,8,21,9,22,0,57]"));
    ...
    public void testDeserializationAsTimestamp04Nanoseconds()
    {
        ObjectReader r = MAPPER.readerFor(LocalDateTime.class)
                .with(DateTimeFeature.READ_DATE_TIMESTAMPS_AS_NANOSECONDS);
        LocalDateTime value = r.readValue(VPackUtils.toVPack("[2005,11,5,22,31,5,829837]"));
    ...
    public void testDeserializationAsTimestamp04Milliseconds02()
    {
        ObjectReader r = READER
                .without(DateTimeFeature.READ_DATE_TIMESTAMPS_AS_NANOSECONDS);
        LocalDateTime value = r.readValue(VPackUtils.toVPack("[2005,11,5,22,31,5,829]"));
    ...
    public void testDeserializationAsTimestamp05Nanoseconds() throws Exception
    {
        ...
        WrapperWithReadTimestampsAsNanosEnabled actual =
            r.readValue(VPackUtils.toVPack(a2q("{'value':[2013,8,21,9,22,0,57]}")));
        LocalDateTime time = LocalDateTime.of(2013, Month.AUGUST, 21, 9, 22, 0, 57);
    ...
    public void testDeserializationAsTimestamp05Milliseconds02() throws Exception
    {
        ObjectReader r = MAPPER.readerFor(WrapperWithReadTimestampsAsNanosDisabled.class);
        WrapperWithReadTimestampsAsNanosDisabled actual =
            r.readValue(VPackUtils.toVPack(a2q("{'value':[2013,8,21,9,22,0,4257]}")));
    ...
    public void testDeserializationAsString01()
    {
        ...
        LocalDateTime value = READER.readValue(VPackUtils.toVPack(q(exp.toString())));
        assertEquals(exp, value, "The value is not correct.");

        assertEquals(LocalDateTime.of(2000, Month.JANUARY, 1, 12, 0),
                READER.readValue(VPackUtils.toVPack(q("2000-01-01T12:00"))),
    ...
    {
        LocalDateTime time = LocalDateTime.of(2013, Month.AUGUST, 21, 9, 22, 57);
        LocalDateTime value = MAPPER.readValue(VPackUtils.toVPack(q(time.toString())), LocalDateTime.class);
        assertEquals(time, value, "The value is not correct.");
    }
    ...
    public void testAllowZuluIfLenient()
    {
        ...
        // First, defaults:
        assertEquals(EXP, r.readValue(VPackUtils.toVPack(input)), "The value is not correct.");
    ...
    public void testUseTimeZoneForZuluIfEnabled(TimeZone zone, String string, LocalDateTime expected) throws Exception
    {
        ...
        LocalDateTime value = reader.readValue(VPackUtils.toVPack(q(string)));
    ...
    {
        try {
            STRICT_MAPPER.readValue(VPackUtils.toVPack(q("2020-10-22T00:16:20.504Z")), LocalDateTime.class);
    ...
    {
        try {
            READER.readValue(VPackUtils.toVPack(q("notalocaldatetime")));
            fail("expected fail");
        } catch (InvalidFormatException e) {
            verifyException(e, "Cannot deserialize value of type");
    ...
    public void testLenientDeserializeFromEmptyString()
    {
        ...
        String valueFromNullStr = VPackUtils.toJson(mapper.writeValueAsBytes(asMap(key, dateValAsNullStr)));
        Map<String, LocalDateTime> actualMapFromNullStr = objectReader.readValue(VPackUtils.toVPack(valueFromNullStr));
        ...
        Map<String, LocalDateTime> actualMapFromEmptyStr = objectReader.readValue(VPackUtils.toVPack(valueFromEmptyStr));
    ...
    public void testStrictDeserializeFromEmptyString() throws Exception {
        ...
        String valueFromNullStr = VPackUtils.toJson(STRICT_MAPPER.writeValueAsBytes(asMap(key, dateValAsNullStr)));
        Map<String, LocalDateTime> actualMapFromNullStr = objectReader.readValue(VPackUtils.toVPack(valueFromNullStr));
        assertNull(actualMapFromNullStr.get(key));

        String dateValAsEmptyStr = "";
        // TODO: nothing stops us from writing an empty string, maybe there should be a check there too?
        String valueFromEmptyStr = VPackUtils.toJson(STRICT_MAPPER.writeValueAsBytes(asMap("date", dateValAsEmptyStr)));
    ...
    {
        try {
            READER.readValue(VPackUtils.toVPack("[\"2000-01-01T12:00\"]"));
        } catch (MismatchedInputException e) {
    ...
    public void testDeserializationAsEmptyArrayDisabled() throws Throwable
    {
        ...
        assertNull(READER.readValue(VPackUtils.toVPack("[]")));
    }
    ...
    public void testDeserializationAsArrayEnabled() throws Throwable
    {
        LocalDateTime value = READER
                ...
                .readValue(VPackUtils.toVPack("[\"2000-01-01T12:00\"]"));
    ...
    public void testDeserializationWithTypeInfo03() throws Exception
    {
        ...
        Temporal value = m.readValue(
                VPackUtils.toVPack("[\"" + LocalDateTime.class.getName() + "\",\"" + time.toString() + "\"]"), Temporal.class
        );
        assertInstanceOf(LocalDateTime.class, value, "The value should be a LocalDateTime.");
        assertEquals(time, value, "The value is not correct.");
    }
    ...
    public void testDateTimeExceptionIsHandled() throws Throwable
    {
        ...
        assertEquals(now, handledMapper.readValue(VPackUtils.toVPack(q("now")), LocalDateTime.class));
    }
    ...
    public void testUnexpectedTokenIsHandled() throws Throwable
    {
        ...
        ObjectMapper handledMapper = mapperBuilder().addHandler(handler).build();
        assertEquals(now, handledMapper.readValue(VPackUtils.toVPack("true"), LocalDateTime.class));
    }
    ...
    public void testDeserializeToDate() throws Exception
    {
        ObjectMapper m = newMapperBuilder()
            ...
            .build();
        String localDateTimeJson = VPackUtils.toJson(m.writeValueAsBytes(LocalDateTime.of(1999,10,12,13,45,5)));
        assertEquals("\"1999-10-12T13:45:05\"", localDateTimeJson);
        Date date = m.readValue(VPackUtils.toVPack(localDateTimeJson),Date.class);
        assertNotNull(date);
    ...
    public void testDeserilizeFromSimpleTimestamp() throws Exception
    {
        ...
        LocalDateTime value;
        try {
            value = r.readValue(VPackUtils.toVPack("1235"));
    ...
    public void testDeserializationCaseInsensitiveDisabled_InvalidDate() throws Throwable
    {
        ...
        for(String json : jsons) {
            try {
                reader.readValue(VPackUtils.toVPack(a2q(json)));
                fail("Should nae pass");
            } catch (MismatchedInputException e) {
    ...
    public void testStrictCustomFormatForInvalidFormat() throws Exception
    {
        assertThrows(InvalidFormatException.class,
            () -> /*StrictWrapper w =*/ MAPPER.readValue(VPackUtils.toVPack("{\"value\":\"2019-11-30 15:45\"}"), StrictWrapper.class));
    }
    ...
    {
        assertThrows(InvalidFormatException.class,
            () -> /*StrictWrapperWithYearOfEra w =*/ MAPPER.readValue(VPackUtils.toVPack("{\"value\":\"2019-11-30 15:45\"}"), StrictWrapperWithYearOfEra.class));
    }
    ...
    {
        assertThrows(InvalidFormatException.class,
            () -> /*StrictWrapperWithYearOfEra w =*/ MAPPER.readValue(VPackUtils.toVPack("{\"value\":\"2019-11-31 15:45 AD\"}"), StrictWrapperWithYearOfEra.class));
    }
    ...
    {
        assertThrows(InvalidFormatException.class,
            () -> /*StrictWrapperWithYearOfEra w =*/ MAPPER.readValue(VPackUtils.toVPack("{\"value\":\"2019-11-30 25:45 AD\"}"), StrictWrapperWithYearOfEra.class));
    }
    ...
    {
        assertThrows(InvalidFormatException.class,
            () -> /*StrictWrapperWithYearOfEra w =*/ MAPPER.readValue(VPackUtils.toVPack("{\"value\":\"2019-11-31 25:45 AD\"}"), StrictWrapperWithYearOfEra.class));
    ...
    {
        StrictWrapperWithYearOfEra w = MAPPER.readValue(VPackUtils.toVPack("{\"value\":\"2019-11-30 20:45 AD\"}"), StrictWrapperWithYearOfEra.class);
    ...
    {
        assertThrows(InvalidFormatException.class,
            () -> /*StrictWrapperWithYearWithoutEra w =*/ MAPPER.readValue(VPackUtils.toVPack("{\"value\":\"2019-11-30 15:45 AD\"}"), StrictWrapperWithYearWithoutEra.class));
    }
    ...
    {
        assertThrows(InvalidFormatException.class,
            () -> /*StrictWrapperWithYearWithoutEra w =*/ MAPPER.readValue(VPackUtils.toVPack("{\"value\":\"2019-11-30 25:45\"}"), StrictWrapperWithYearWithoutEra.class));
    }
    ...
    {
        assertThrows(InvalidFormatException.class,
            () -> /*StrictWrapperWithYearWithoutEra w =*/ MAPPER.readValue(VPackUtils.toVPack("{\"value\":\"2019-11-31 15:45\"}"), StrictWrapperWithYearWithoutEra.class));
    }
    ...
    {
        assertThrows(InvalidFormatException.class,
            () -> /*StrictWrapperWithYearWithoutEra w =*/ MAPPER.readValue(VPackUtils.toVPack("{\"value\":\"2019-11-31 25:45\"}"), StrictWrapperWithYearWithoutEra.class));
    }

    @Test
    public void testStrictCustomFormatForValidDateAndTimeWithoutEra() throws Exception
    {
        StrictWrapperWithYearWithoutEra w = MAPPER.readValue(VPackUtils.toVPack("{\"value\":\"2019-11-30 20:45\"}"),
    ...
    private void _testLocalDateTimeRoundTrip(ObjectMapper mapper, LocalDateTime localDateTime)
        throws Exception
    {
        String ser = VPackUtils.toJson(mapper.writeValueAsBytes(localDateTime));
        LocalDateTime result = mapper.readValue(VPackUtils.toVPack(ser), LocalDateTime.class);
        assertEquals(localDateTime, result);
    }

    private void expectSuccess(ObjectReader reader, Object exp, String json) throws IOException {
        final LocalDateTime value = reader.readValue(VPackUtils.toVPack(a2q(json)));
