...
public class PeriodAsKeyTest extends DateTimeTestBase
{
    ...
    public void testSerialization0() throws Exception {
        assertEquals(mapAsString(PERIOD_0_STRING, "test"),
                VPackUtils.toJson(MAPPER.writeValueAsBytes(asMap(PERIOD_0, "test"))),
                "Value is incorrect");
    }
    ...
    public void testSerialization1() throws Exception {
        assertEquals(mapAsString(PERIOD_STRING, "test"),
                VPackUtils.toJson(MAPPER.writeValueAsBytes(asMap(PERIOD, "test"))),
                "Value is incorrect");
    }
    ...
    public void testDeserialization0() throws Exception {
        assertEquals(asMap(PERIOD_0, "test"),
                READER.readValue(VPackUtils.toVPack(mapAsString(PERIOD_0_STRING, "test"))),
                "Value is incorrect");
    }
    ...
    public void testDeserialization1() throws Exception {
        assertEquals(asMap(PERIOD, "test"),
                READER.readValue(VPackUtils.toVPack(mapAsString(PERIOD_STRING, "test"))),
                "Value is incorrect");
    }
}
