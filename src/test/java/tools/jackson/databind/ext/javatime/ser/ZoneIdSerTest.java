...
public class ZoneIdSerTest extends DateTimeTestBase
{
    ...
    {
        final String value = VPackUtils.toJson(MAPPER.writeValueAsBytes(ZoneId.of("America/Chicago")));
    ...
    {
        final String value = VPackUtils.toJson(MAPPER.writeValueAsBytes(ZoneId.of("America/Anchorage")));
    ...
    {
        String value = VPackUtils.toJson(MOCK_OBJECT_MIXIN_MAPPER.writeValueAsBytes(ZoneId.of("America/Denver")));
