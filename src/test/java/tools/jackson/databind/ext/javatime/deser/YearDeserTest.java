...
public class YearDeserTest extends DateTimeTestBase
{
    ...
    {
        assertEquals(Year.of(2000), READER.readValue(VPackUtils.toVPack(q("2000"))),
    ...
    {
        try {
            READER.readValue(VPackUtils.toVPack(q("notayear")));
    ...
    public void testDeserializationAsArrayEnabled() throws Throwable
    {
        Year value= newMapper()
             ...
             .with(DeserializationFeature.UNWRAP_SINGLE_VALUE_ARRAYS)
             .readValue(VPackUtils.toVPack(a2q("['2000']")));
    ...
    {
        Year value = READER.readValue(VPackUtils.toVPack("1986"));
        assertEquals(Year.of(1986), value, "The value is not correct.");
        value = READER.readValue(VPackUtils.toVPack("2013"));
    ...
    public void testDeserializationWithTypeInfo() throws Exception
    {
        ObjectMapper mapper = newMapperBuilder()
                ...
                .build();
        Temporal value = mapper.readValue(VPackUtils.toVPack("[\"" + Year.class.getName() + "\",2005]"), Temporal.class);
    ...
    public void testWithCustomFormat() throws Exception
    {
        ...
        FormattedYear result = MAPPER.readValue(VPackUtils.toVPack(json), FormattedYear.class);
    ...
    public void testWithFormatViaConfigOverride() throws Exception
    {
        ...
        Year result = mapper.readValue(VPackUtils.toVPack(json), Year.class);
    ...
    public void testWithCustomFormat78() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(input));
        assertEquals("{\"value\":\"Y2018\"}", json);
        ObjectTest result = MAPPER.readValue(VPackUtils.toVPack(json), ObjectTest.class);
        assertEquals(input, result);
    }
    ...
    public void testDeserializeFromEmptyString() throws Exception
    {
        ...
        Map<String, Year> actualMapFromNullStr = objectReader.readValue(VPackUtils.toVPack(doc));
        assertNull(actualMapFromNullStr.get(key));

        doc = VPackUtils.toJson(MAPPER.writeValueAsBytes(asMap("date", "")));
        Map<String, Year> actualMapFromEmptyStr = objectReader.readValue(VPackUtils.toVPack(doc));
