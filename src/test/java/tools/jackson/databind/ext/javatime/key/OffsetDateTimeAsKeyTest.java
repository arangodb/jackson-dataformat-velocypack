...
public class OffsetDateTimeAsKeyTest extends DateTimeTestBase
{
    ...
    public void testSerialization0() throws Exception {
        String value = VPackUtils.toJson(MAPPER.writeValueAsBytes(asMap(DATE_TIME_0, "test")));
    ...
    public void testSerialization1() throws Exception {
        assertEquals(mapAsString(DATE_TIME_1_STRING, "test"),
                VPackUtils.toJson(MAPPER.writeValueAsBytes(asMap(DATE_TIME_1, "test"))),
                "Value is incorrect");
    }
    ...
    public void testSerialization2() throws Exception {
        assertEquals(mapAsString(DATE_TIME_2_STRING, "test"),
                VPackUtils.toJson(MAPPER.writeValueAsBytes(asMap(DATE_TIME_2, "test"))),
                "Value is incorrect");
    }

    @Test
    public void testDeserialization0() throws Exception {
        assertEquals(asMap(DATE_TIME_0, "test"), READER.readValue(VPackUtils.toVPack(mapAsString(DATE_TIME_0_STRING, "test"))),
                "Value is incorrect");
    }

    @Test
    public void testDeserialization1() throws Exception {
        assertEquals(asMap(DATE_TIME_1, "test"), READER.readValue(VPackUtils.toVPack(mapAsString(DATE_TIME_1_STRING, "test"))),
                "Value is incorrect");
    }
