    ...
    extends DatabindTestUtil
{
    ...
    {
        Issue905Bean b = MAPPER.readValue(VPackUtils.toVPack(a2q("{'y':3,'x':2}")),
                Issue905Bean.class);
        assertEquals(2, b._x);
        assertEquals(3, b._y);
    }
    ...
    {
        String json = "{\"bar\":3}";
        Ambiguity amb = MAPPER.readValue(VPackUtils.toVPack(json), Ambiguity.class);
        assertNotNull(amb);
    ...
    public void testConstructorPropertiesInference() throws Exception
    {
        ...
        Lombok1371Bean result = MAPPER.readValue(VPackUtils.toVPack(JSON), Lombok1371Bean.class);
        ...
        result = mapper.readValue(VPackUtils.toVPack(JSON), Lombok1371Bean.class);
    ...
    {
        List<Value3252> testData = MAPPER.readValue(VPackUtils.toVPack(a2q(
"[\n"+
"      {'name': 'first entry'},\n"+
...
//System.err.println("JsON: "+VPackUtils.toJson(MAPPER.writer().writeValueAsBytes(testData)));
    ...
    {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new Test4310("foo")));
        Test4310 result = MAPPER.readValue(VPackUtils.toVPack(json), Test4310.class);
    ...
    public void testConstructorPropertyAndJsonCreator() throws Exception {
        Something4908 value = MAPPER.readValue(VPackUtils.toVPack(a2q("{'value':'abc'}")),
                Something4908.class);
