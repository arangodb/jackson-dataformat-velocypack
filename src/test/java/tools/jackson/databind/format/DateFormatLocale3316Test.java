...
public class DateFormatLocale3316Test extends DatabindTestUtil
{
    ...
    public void testRoundTripWithCompoundLocale() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(input));
        DateWithLocaleUnderscore result = MAPPER.readValue(VPackUtils.toVPack(json), DateWithLocaleUnderscore.class);
    ...
    public void testLocalDateWithCompoundLocale() throws Exception
    {
        ...
        LocalDateWithLocale result = MAPPER.readValue(VPackUtils.toVPack(json), LocalDateWithLocale.class);
    ...
    public void testDeserializationWithFrenchLocale() throws Exception
    {
        ...
        DateWithFrenchLocale result = MAPPER.readValue(VPackUtils.toVPack(json), DateWithFrenchLocale.class);
