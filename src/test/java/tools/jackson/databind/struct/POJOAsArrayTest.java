...
public class POJOAsArrayTest extends DatabindTestUtil
{
    ...
    static class ForceArraysIntrospector extends JacksonAnnotationIntrospector
    {
        ...
        public JsonFormat.Value findFormat(MapperConfig<?> config, Annotated a) {
            return new JsonFormat.Value().withShape(Shape.ARRAY);
        }
    }
    ...
    private final static ObjectMapper MAPPER_WITH_VIEWS = vpackMapperBuilder()
    ...
    public void testReadSimplePropertyValue() throws Exception
    {
        ...
        PojoAsArrayWrapper p = MAPPER.readValue(VPackUtils.toVPack(json), PojoAsArrayWrapper.class);
    ...
    public void testReadSimpleRootValue() throws Exception
    {
        ...
        FlatPojo p = MAPPER.readValue(VPackUtils.toVPack(json), FlatPojo.class);
    ...
    {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new PojoAsArrayWrapper("Foobar", 42, 13, true)));
    ...
    {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new FlatPojo("Bubba", 1, 2, false)));
        // will have wrapper POJO, then POJO-as-array..
    ...
    {
        assertEquals("[null,\"bar\"]", VPackUtils.toJson(MAPPER.writeValueAsBytes(new TwoStringsBean())));
    }
    ...
    public void testSerializeAsArrayWithSingleProperty() throws Exception {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(new SingleBean()));
    ...
    public void testBeanAsArrayUnwrapped() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        SingleBean result = mapper.readValue(VPackUtils.toVPack("[\"foobar\"]"), SingleBean.class);
    ...
    public void testAnnotationOverride() throws Exception
    {
        ...
        assertEquals("{\"value\":{\"x\":1,\"y\":2}}", VPackUtils.toJson(MAPPER.writeValueAsBytes(new A())));

        // but override should change it:
        ObjectMapper mapper2 = vpackMapperBuilder()
                .annotationIntrospector(new ForceArraysIntrospector())
                .build();
        assertEquals("[[1,2]]", VPackUtils.toJson(mapper2.writeValueAsBytes(new A())));
    ...
    public void testWithMaps() throws Exception
    {
        ...
        AsArrayWithMap output = MAPPER.readValue(VPackUtils.toVPack(json), AsArrayWithMap.class);
...
//        CreatorWithIndex value = MAPPER.readValue(aposToQuotes("{'b':1,'a':2}"),
        CreatorWithIndex value = MAPPER.readValue(VPackUtils.toVPack(a2q("[2,1]")),
    ...
    public void testWithConfigOverrides() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                .withConfigOverride(NonAnnotatedXY.class,
                        o -> o.setFormat(JsonFormat.Value.forShape(Shape.ARRAY)))
                .build();
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(new NonAnnotatedXY(2, 3)));
        assertEquals("[2,3]", json);

        // also, read it back
        NonAnnotatedXY result = mapper.readValue(VPackUtils.toVPack(json), NonAnnotatedXY.class);
        assertNotNull(result);
    ...
    public void testMedaItemRoundtrip() throws Exception
    {
        ...
        byte[] vpack = MAPPER.writer().writeValueAsBytes(input);

        MediaItemAsArray output = MAPPER.readValue(vpack, MediaItemAsArray.class);
        assertNotNull(output);
    ...
    public void testWithView() throws Exception
    {
        ...
        input.b = 2;
        input.c = 3;
        String json = VPackUtils.toJson(MAPPER_WITH_VIEWS.writerWithView(ViewA.class).writeValueAsBytes(input));
        ...
        AsArrayWithView result = MAPPER_WITH_VIEWS.readerFor(AsArrayWithView.class).withView(ViewB.class)
                .readValue(VPackUtils.toVPack("[1,2,3]"));
    ...
    public void testWithCreatorsOrdered() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER_WITH_VIEWS.writeValueAsBytes(input));
        assertEquals("[3,4,1,2]", json);

        // and should get back in proper order, too
        CreatorAsArray output = MAPPER_WITH_VIEWS.readValue(VPackUtils.toVPack(json), CreatorAsArray.class);
    ...
    public void testWithCreatorsShuffled() throws Exception
    {
        ...
        // and should get back in proper order, too
        CreatorAsArrayShuffled output = MAPPER_WITH_VIEWS.readValue(VPackUtils.toVPack(json), CreatorAsArrayShuffled.class);
        assertEquals(1, output.a);
        assertEquals(2, output.b);
        assertEquals(3, output.x);
        assertEquals(4, output.y);
    ...
    {
        ValueClassXY value = MAPPER.readValue(VPackUtils.toVPack("[1,2]"), ValueClassXY.class);
    ...
    public void testBuilderWithUpdate() throws Exception
    {
        try {
            /*value =*/ MAPPER.readerFor(ValueClassXY.class)
                    ...
                    .readValue(VPackUtils.toVPack("[1,2]"));
    ...
    public void testWithCreator() throws Exception
    {
        ...
        CreatorValue value = r.readValue(VPackUtils.toVPack("[1,2,3]"));
        assertEquals(1, value.a);
        assertEquals(2, value.b);
        assertEquals(3, value.c);

        // and should be ok with partial too?
        value = r.readValue(VPackUtils.toVPack("[1,2]"));
        assertEquals(1, value.a);
        assertEquals(2, value.b);
        assertEquals(0, value.c);

        value = r.readValue(VPackUtils.toVPack("[1]"));
        assertEquals(1, value.a);
        assertEquals(0, value.b);
        assertEquals(0, value.c);

        value = r.readValue(VPackUtils.toVPack("[]"));
    ...
    public void testWithCreatorAndView() throws Exception
    {
        ...
        value = reader.withView(String.class).readValue(VPackUtils.toVPack("[1,2,3]"));
        assertEquals(1, value.a);
        assertEquals(2, value.b);
        assertEquals(3, value.c);

        // then not including view
        value = reader.withView(Character.class).readValue(VPackUtils.toVPack("[1,2,3]"));
        assertEquals(1, value.a);
        assertEquals(2, value.b);
        assertEquals(0, value.c);
    }
    ...
    {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new DirectLayout()));

        Layout instance = MAPPER.readValue(VPackUtils.toVPack(json), Layout.class);
    ...
    public void testWithCustomTypeId() throws Exception {
        ...
        String json = VPackUtils.toJson(MAPPER.writer().writeValueAsBytes(outer));

        Outer646 result = MAPPER.readValue(VPackUtils.toVPack(json), Outer646.class);
        assertNotNull(result);
