...
public class UnwrappedBasicTest extends DatabindTestUtil
{
    ...
    // [databind#1709]
    private final ObjectMapper MAPPER_ENABLED = vpackMapperBuilder()
            .enable(DeserializationFeature.USE_NULL_FOR_EMPTY_UNWRAPPED)
            .build();

    private final ObjectMapper MAPPER_DISABLED = vpackMapperBuilder()
    ...
    public void testSimpleUnwrappingSerialize() throws Exception {
        ...
        assertEquals("{\"x\":1,\"y\":2,\"name\":\"Tatu\"}",
                VPackUtils.toJson(mapper.writeValueAsBytes(new Unwrapping("Tatu", 1, 2))));
    }
    ...
    public void testDeepUnwrappingSerialize() throws Exception {
        VPackMapper mapper = VPackMapper.builder().enable(MapperFeature.SORT_PROPERTIES_ALPHABETICALLY).build();
        assertEquals("{\"x\":1,\"y\":2,\"name\":\"Tatu\"}",
                VPackUtils.toJson(mapper.writeValueAsBytes(new DeepUnwrapping("Tatu", 1, 2))));
    }
    ...
    {
        Unwrapping bean = MAPPER.readValue(VPackUtils.toVPack("{\"name\":\"Tatu\",\"y\":7,\"x\":-13}"),
                Unwrapping.class);
    ...
    {
        TwoUnwrappedProperties bean = MAPPER.readValue(VPackUtils.toVPack("{\"first\":\"Joe\",\"y\":7,\"last\":\"Smith\",\"x\":-13}"),
    ...
    {
        DeepUnwrapping bean = MAPPER.readValue(VPackUtils.toVPack("{\"x\":3,\"name\":\"Bob\",\"y\":27}"),
    ...
    {
        UnwrappingWithCreator bean = MAPPER.readValue(VPackUtils.toVPack("{\"x\":1,\"y\":2,\"name\":\"Tatu\"}"),
    ...
    public void testIssue615() throws Exception
    {
        ...
        Parent output = MAPPER.readValue(VPackUtils.toVPack(json), Parent.class);
    ...
    public void testUnwrappedAsPropertyIndicator() throws Exception
    {
        ...
        String actual = VPackUtils.toJson(MAPPER.writeValueAsBytes(outer));
    ...
    public void testCaseInsensitiveUnwrap() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        Person p = mapper.readValue(VPackUtils.toVPack("{ }"), Person.class);
        assertNotNull(p);
    }
    ...
    {
        Issue2088Bean bean = MAPPER.readValue(VPackUtils.toVPack("{\"x\":1,\"a\":2,\"y\":3,\"b\":4}"), Issue2088Bean.class);
    ...
    public void testRecursiveUsage() throws Exception
    {
        ...
        RecursivePerson p = MAPPER.readValue(VPackUtils.toVPack(a2q(JSON)), RecursivePerson.class);
        assertNotNull(p);
    ...
    public void testUnwrappedWithSamePropertyName() throws Exception {
        ...
        UnwrappedWithSamePropertyName result = MAPPER.readValue(VPackUtils.toVPack(a2q(JSON)), UnwrappedWithSamePropertyName.class);
    ...
    public void testDefaultUnwrappedWithTypeInfo() throws Exception
    {
        ...
        try {
            VPackUtils.toJson(MAPPER.writeValueAsBytes(outer));
    ...
    public void testUnwrappedWithTypeInfoAndFeatureDisabled() throws Exception
    {
        ...
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(outer));
    ...
    public void testUnwrappedCaching() throws Exception {
        ...
        final ObjectMapper mapperOrder1 = newVPackMapper();
        assertEquals(EXP_OUTER, VPackUtils.toJson(mapperOrder1.writeValueAsBytes(outer)));
        assertEquals(EXP_INNER, VPackUtils.toJson(mapperOrder1.writeValueAsBytes(inner)));
        assertEquals(EXP_OUTER, VPackUtils.toJson(mapperOrder1.writeValueAsBytes(outer)));

        final ObjectMapper mapperOrder2 = newVPackMapper();
        assertEquals(EXP_INNER, VPackUtils.toJson(mapperOrder2.writeValueAsBytes(inner)));
        //  Used to fail here
        assertEquals(EXP_OUTER, VPackUtils.toJson(mapperOrder2.writeValueAsBytes(outer)));
    }
    ...
    {
        Holder holder = MAPPER.readValue(VPackUtils.toVPack("{\"value1\": -60.0, \"value2\": -60.0}"), Holder.class);
    ...
    public void testEmptyUnwrappedAsNull() throws Exception {
        ...
        Container1709 result = MAPPER_ENABLED.readValue(VPackUtils.toVPack(json), Container1709.class);
    ...
    public void testEmptyJsonEmptyUnwrappedAsNull() throws Exception {
        Container1709 result = MAPPER_ENABLED.readValue(VPackUtils.toVPack("{}"), Container1709.class);
        assertNotNull(result);
    ...
    public void testEmptyUnwrappedAsNullWhenDisabled() throws Exception {
        String json = a2q("{'name':'test'}");
        Container1709 result = MAPPER_DISABLED.readValue(VPackUtils.toVPack(json), Container1709.class);
        assertNotNull(result);
        assertEquals("test", result.name);
        assertNotNull(result.u);
    ...
    public void testEmptyJsonEmptyUnwrappedAsNullWhenDisabled() throws Exception {
        Container1709 result = MAPPER_DISABLED.readValue(VPackUtils.toVPack("{}"), Container1709.class);
        assertNotNull(result);
        assertNull(result.name);
        assertNotNull(result.u);
        assertNull(result.u.s);
    ...
    public void testUnwrappedWithJsonCreatorWithExplicitWithoutName() throws Exception
    {
        ...
        ExplicitWithoutName outer = MAPPER.readValue(VPackUtils.toVPack(json), ExplicitWithoutName.class);
    ...
    {
        String json = "{\"unrelated\": \"unrelatedValue\", \"property1\": \"value1\", \"property2\": \"value2\"}";
        ExplicitWithName outer = MAPPER.readValue(VPackUtils.toVPack(json), ExplicitWithName.class);
    ...
    {
        String json = "{\"unrelated\": \"unrelatedValue\", \"property1\": \"value1\", \"property2\": \"value2\"}";
        ImplicitWithName outer = MAPPER.readValue(VPackUtils.toVPack(json), ImplicitWithName.class);
    ...
    public void testUnwrappedWithTwoUnwrappedProperties() throws Exception
    {
        ...
        WithTwoUnwrappedProperties outer = MAPPER.readValue(VPackUtils.toVPack(json), WithTwoUnwrappedProperties.class);
    ...
    public void testUnwrappedWithPrefixCreator() throws Exception
    {
        ...
        PrefixOuter outer = MAPPER.readValue(VPackUtils.toVPack(json), PrefixOuter.class);
    ...
    public void testPrefixedUnwrappingSerialize() throws Exception
    {
        ...
        assertEquals("{\"_x\":1,\"_y\":2,\"name\":\"Tatu\"}",
                VPackUtils.toJson(mapper.writeValueAsBytes(new PrefixUnwrap("Tatu", 1, 2))));
    }
    ...
    {
        VPackMapper mapper = VPackMapper.builder().enable(MapperFeature.SORT_PROPERTIES_ALPHABETICALLY).build();
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(new DeepPrefixUnwrap("Bubba", 1, 1)));
    ...
    {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new ConfigRoot("Fred", 25)));
    ...
    {
        PrefixUnwrap bean = MAPPER.readValue(VPackUtils.toVPack("{\"name\":\"Axel\",\"_x\":4,\"_y\":7}"), PrefixUnwrap.class);
        assertNotNull(bean);
    ...
    {
        DeepPrefixUnwrap bean = MAPPER.readValue(VPackUtils.toVPack("{\"u.name\":\"Bubba\",\"u._x\":2,\"u._y\":3}"),
    ...
    {
        ConfigRoot root = MAPPER.readValue(VPackUtils.toVPack("{\"general.names.name\":\"Bob\",\"misc.value\":3}"),
                ConfigRoot.class);
    ...
    public void testHierarchicConfigRoundTrip() throws Exception
    {
        ...
        ConfigAlternate root = MAPPER.readValue(VPackUtils.toVPack(json), ConfigAlternate.class);
    ...
    public void testIssue226() throws Exception
    {
        ...
        Parent226 output = MAPPER.readValue(VPackUtils.toVPack(json), Parent226.class);
    ...
    public void testFailOnUnknownPropertyUnwrapped() throws Exception {
        ...
        try {
            STRICT_MAPPER.readValue(VPackUtils.toVPack(json), A650.class);
    ...
    public void testWorkOnUnknownWithAnnotation() throws Exception {
        final String json = a2q("{'field': 'value', 'bad': 'bad value'}");
        A650WithUnknownsOk a = STRICT_MAPPER.readValue(VPackUtils.toVPack(json), A650WithUnknownsOk.class);
    ...
    public void testWorksOnRegularPropertyUnwrapped() throws Exception {
        A650 value = STRICT_MAPPER.readValue(VPackUtils.toVPack(a2q("{'field': 'value'}")), A650.class);
    ...
    public void testFailOnUnknownPropertyUnwrappedWithPrefix() throws Exception {
        ...
        try {
            STRICT_MAPPER.readValue(VPackUtils.toVPack(json), A650WithPrefix.class);
            fail("Exception was not thrown on unknown property");
        } catch (UnrecognizedPropertyException e) {
            verifyException(e, "Unrecognized property");
        }
    ...
    public void testWorkOnUnknownWithPrefixAndAnnotation() throws Exception {
        final String json = a2q("{'nested.field': 'value', 'bad': 'bad value'}");
        A650WithPrefixUnknownsOk a = STRICT_MAPPER.readValue(VPackUtils.toVPack(json), A650WithPrefixUnknownsOk.class);
        assertEquals("value", a.b.field);
    }

    @Test
    public void testWorksOnRegularPropertyUnwrappedWithPrefix() throws Exception {
        A650WithPrefix value = STRICT_MAPPER.readValue(VPackUtils.toVPack(a2q("{'nested.field': 'value'}")), A650WithPrefix.class);
        assertEquals("value", value.b.field);
    }
    ...
    public void testFailOnUnknownPropertyWithCreator() throws Exception {
        ...
        try {
            STRICT_MAPPER.readValue(VPackUtils.toVPack(json), A650WithCreator.class);
            fail("Exception was not thrown on unknown property");
        } catch (UnrecognizedPropertyException e) {
            verifyException(e, "Unrecognized property");
        }
    ...
    public void testWorkOnUnknownWithCreatorAndAnnotation() throws Exception {
        final String json = a2q("{'name': 'test', 'field': 'value', 'bad': 'bad value'}");
        A650WithCreatorUnknownsOk a = STRICT_MAPPER.readValue(VPackUtils.toVPack(json), A650WithCreatorUnknownsOk.class);
    ...
    public void testWorksOnRegularPropertyWithCreator() throws Exception {
        A650WithCreator value = STRICT_MAPPER.readValue(VPackUtils.toVPack(a2q("{'name': 'test', 'field': 'value'}")), A650WithCreator.class);
    ...
    public void testFailOnUnknownPropertyWithCreatorAndPrefix() throws Exception {
        ...
        try {
            STRICT_MAPPER.readValue(VPackUtils.toVPack(json), A650WithCreatorAndPrefix.class);
            fail("Exception was not thrown on unknown property");
        } catch (UnrecognizedPropertyException e) {
            verifyException(e, "Unrecognized property");
        }
    ...
    public void testWorkOnUnknownWithCreatorAndPrefixAndAnnotation() throws Exception {
        final String json = a2q("{'name': 'test', 'nested.field': 'value', 'bad': 'bad value'}");
        A650WithCreatorAndPrefixUnknownsOk a = STRICT_MAPPER.readValue(VPackUtils.toVPack(json), A650WithCreatorAndPrefixUnknownsOk.class);
        assertEquals("test", a.name);
        assertEquals("value", a.b.field);
    }
    ...
    public void testWorksOnRegularPropertyWithCreatorAndPrefix() throws Exception {
        A650WithCreatorAndPrefix value = STRICT_MAPPER.readValue(
                VPackUtils.toVPack(a2q("{'name': 'test', 'nested.field': 'value'}")), A650WithCreatorAndPrefix.class);
        assertEquals("test", value.name);
        assertEquals("value", value.b.field);
    }
}
