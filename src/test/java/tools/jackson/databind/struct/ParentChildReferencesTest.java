    ...
    extends DatabindTestUtil
{
    ...
    static class ContainerWithList3304 {
        @JsonManagedReference
        public List<IChild3304> children;
    }
    ...
    public void testSimpleRefs() throws Exception
    {
        ...
        SimpleTreeNode resultNode = MAPPER.readValue(VPackUtils.toVPack(json), SimpleTreeNode.class);
    ...
    public void testSimpleRefsWithGetter() throws Exception
    {
        ...
        SimpleTreeNode2 resultNode = MAPPER.readValue(VPackUtils.toVPack(json), SimpleTreeNode2.class);
        assertEquals("root", resultNode.name);
    ...
    public void testFullRefs() throws Exception
    {
        ...
        FullTreeNode resultNode = MAPPER.readValue(VPackUtils.toVPack(json), FullTreeNode.class);
        assertEquals("root", resultNode.name);
    ...
    public void testArrayOfRefs() throws Exception
    {
        ...
        NodeArray result = MAPPER.readValue(VPackUtils.toVPack(json), NodeArray.class);
    ...
    public void testListOfRefs() throws Exception
    {
        ...
        NodeList result = MAPPER.readValue(VPackUtils.toVPack(json), NodeList.class);
    ...
    public void testMapOfRefs() throws Exception
    {
        ...
        NodeMap result = MAPPER.readValue(VPackUtils.toVPack(json), NodeMap.class);
    ...
    public void testAbstract368() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(parent));

        AbstractNode root = MAPPER.readValue(VPackUtils.toVPack(json), AbstractNode.class);
    ...
    {
        Advertisement708 ad = MAPPER.readValue(VPackUtils.toVPack("{\"title\":\"Hroch\",\"photos\":[{\"id\":3}]}"), Advertisement708.class);
        assertNotNull(ad);
    }
    ...
    public void testChildDeserialization() throws Exception {
        Child1878 child = MAPPER.readValue(VPackUtils.toVPack("{\"b\": {}}"), Child1878.class);
    ...
    public void testForwardRef() throws IOException {
        ...
        mapper.readValue(VPackUtils.toVPack("{" +
    ...
    {
        PropertySheet input = MAPPER.readValue(VPackUtils.toVPack(JSON), PropertySheet.class);
        assertEquals(JSON, VPackUtils.toJson(MAPPER.writeValueAsBytes(input)));
    }
    ...
    public void testSerialize() throws IOException
    {
        ...
        String actual = VPackUtils.toJson(MAPPER.writeValueAsBytes(sheet));
    ...
    public void testBackRefOnSubtypeOnly_array() {
        InvalidDefinitionException ex = assertThrows(
                ...
                () -> MAPPER.readValue(
                        VPackUtils.toVPack("{\"children\":[{\"type\":\"SIMPLE\",\"value\":\"x\"}]}"),
                        Container3304.class));
    ...
    public void testWithParentCreator() throws Exception {
        String json = a2q(
                ...
                "}");
        ParentWithCreator result = MAPPER.readValue(VPackUtils.toVPack(json), ParentWithCreator.class);
    ...
    public void testWithParentNoCreator() throws Exception {
        String json = a2q(
                ...
                "  'child': { 'id': 'def', 'name':'Bert' }\n" +
                "}");
        ParentWithoutCreator result = MAPPER.readValue(VPackUtils.toVPack(json), ParentWithoutCreator.class);
        assertNotNull(result);
        assertNotNull(result.child);
        assertSame(result, result.child.parent);
    }
    ...
    public void testManagedReferenceOnCreator() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(car));
        Car result = MAPPER.readValue(VPackUtils.toVPack(json), Car.class);
    ...
    public void testBuildWithBackRefs2686() throws Exception {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(container));
        Container2686 result = MAPPER.readValue(VPackUtils.toVPack(json), Container2686.class);
