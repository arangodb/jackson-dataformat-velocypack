...
public class CustomTypeIdResolverTest extends DatabindTestUtil
{
    ...
    public void testCustomTypeIdResolver() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new CustomBean[] { new CustomBeanImpl(28) }));
        ...
        CustomResolver.initTypes = types;
        CustomBean[] result = MAPPER.readValue(VPackUtils.toVPack(json), CustomBean[].class);
    ...
    public void testCustomWithExternal() throws Exception
    {
        ...
        ExtBeanWrapper out = MAPPER.readValue(VPackUtils.toVPack(json), ExtBeanWrapper.class);
        assertNotNull(out);
    ...
    public void testPolymorphicTypeViaCustom() throws Exception {
        ...
        top.b = req;
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(top));
        ...
        Top1270 itemRead = MAPPER.readValue(VPackUtils.toVPack(json), Top1270.class);
