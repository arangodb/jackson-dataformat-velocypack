...
public class TestPolymorphicWithDefaultImpl extends DatabindTestUtil
{
    ...
    {
        Inter inter = MAPPER.readerFor(Inter.class).readValue(VPackUtils.toVPack("{\"type\": \"mine\", \"blah\": [\"a\", \"b\", \"c\"]}"));
    ...
    {
        Inter inter = MAPPER.readerFor(Inter.class).readValue(VPackUtils.toVPack("\"a,b,c,d\""));
    ...
    {
        Inter inter = MAPPER.readerFor(Inter.class).readValue(VPackUtils.toVPack("[\"a\", \"b\"]"));
        assertInstanceOf(LegacyInter.class, inter);
    ...
    public void testDefaultAsVoid() throws Exception
    {
        ...
        Object ob = MAPPER.readerFor(DefaultWithVoidAsDefault.class).readValue(VPackUtils.toVPack("{ }"));
        assertNull(ob);
        ob = MAPPER.readerFor(DefaultWithVoidAsDefault.class).readValue(VPackUtils.toVPack("{ \"bogus\":3 }"));
        assertNull(ob);
    }
    ...
    public void testBadTypeAsNull() throws Exception
    {
        ...
        Object ob = r.readValue(VPackUtils.toVPack("{}"));
        assertNull(ob);
        ob = r.readValue(VPackUtils.toVPack("{ \"whatever\":13}"));
        assertNull(ob);
    }
    ...
    public void testInvalidTypeId511() throws Exception {
        ...
        Good goodResult = reader.forType(Good.class).readValue(VPackUtils.toVPack(json)) ;
        assertNotNull(goodResult) ;
        Bad badResult = reader.forType(Bad.class).readValue(VPackUtils.toVPack(json));
    ...
    {
        BaseFor656 value = MAPPER.readValue(VPackUtils.toVPack(a2q("{'foobar':{'a':3}}")), BaseFor656.class);
        assertNotNull(value);
    ...
    public void testUnknownTypeIDRecovery() throws Exception
    {
        ...
        CallRecord r = reader.readValue(VPackUtils.toVPack(json));
        assertNull(r.item);
        assertNotNull(r.item2);

        json = a2q("{'item':{'type':'xevent','location':'location1'}, 'version':0.0,'application':'123'}");
        CallRecord r3 = reader.readValue(VPackUtils.toVPack(json));
        assertNull(r3.item);
    ...
    public void testUnknownClassAsSubtype() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        BaseWrapper w = mapper.readValue(VPackUtils.toVPack(a2q
    ...
    public void testWithoutEmptyStringAsNullObject1533() throws Exception
    {
        ...
        InvalidTypeIdException e = assertThrows(InvalidTypeIdException.class,
                () -> r.readValue(VPackUtils.toVPack("{ \"value\": \"\" }")));
    ...
    public void testWithEmptyStringAsNullObject1533() throws Exception
    {
        ...
        AsPropertyWrapper wrapper = r.readValue(VPackUtils.toVPack("{ \"value\": \"\" }"));
    ...
    public void testIncompatibleDefaultImpl1565() throws Exception
    {
        ...
        CDerived1565 result = MAPPER.readValue(VPackUtils.toVPack(value), CDerived1565.class);
    ...
    public void testWithIncompatibleTargetType1861() throws Exception
    {
        ...
        Impl1861A result = MAPPER.readValue(VPackUtils.toVPack(a2q("{'type':'a','base':'foo','valueA':3}")),
                Impl1861A.class);
        assertNotNull(result);
    }
    ...
    public void testDefaultImplFromAnnotation() throws Exception
    {
        ...
        SuperTypeWithDefault bean = MAPPER.readValue(VPackUtils.toVPack("{\"a\":13}"), SuperTypeWithDefault.class);
        assertEquals(DefaultImpl.class, bean.getClass());
        assertEquals(13, ((DefaultImpl) bean).a);

        // and then with unmapped info
        bean = MAPPER.readValue(VPackUtils.toVPack("{\"a\":14,\"#type\":\"foobar\"}"), SuperTypeWithDefault.class);
        assertEquals(DefaultImpl.class, bean.getClass());
        assertEquals(14, ((DefaultImpl) bean).a);

        bean = MAPPER.readValue(VPackUtils.toVPack("{\"#type\":\"foobar\",\"a\":15}"), SuperTypeWithDefault.class);
        assertEquals(DefaultImpl.class, bean.getClass());
        assertEquals(15, ((DefaultImpl) bean).a);

        bean = MAPPER.readValue(VPackUtils.toVPack("{\"#type\":\"foobar\"}"), SuperTypeWithDefault.class);
        assertEquals(DefaultImpl.class, bean.getClass());
    ...
    public void testDefaultImplViaModule() throws Exception
    {
        ...
        InvalidTypeIdException e = assertThrows(InvalidTypeIdException.class,
                () -> MAPPER.readValue(VPackUtils.toVPack(JSON), SuperTypeWithoutDefault.class));
        verifyException(e, "missing type id property '#type'");
        ...
        ObjectMapper mapper = vpackMapperBuilder()
                .addModule(module)
                .build();
        SuperTypeWithoutDefault bean = mapper.readValue(VPackUtils.toVPack(JSON), SuperTypeWithoutDefault.class);
        assertNotNull(bean);
        assertEquals(DefaultImpl505.class, bean.getClass());
        assertEquals(123, ((DefaultImpl505) bean).a);

        bean = mapper.readValue(VPackUtils.toVPack("{\"#type\":\"foobar\"}"), SuperTypeWithoutDefault.class);
        assertEquals(DefaultImpl505.class, bean.getClass());
    ...
    public void testDontWriteIfDefaultImpl() throws Exception {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new MyInter()));
