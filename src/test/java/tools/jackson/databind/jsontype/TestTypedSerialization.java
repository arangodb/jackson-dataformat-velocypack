    ...
    extends DatabindTestUtil
{
    ...
    public void testInArray() throws Exception
    {
        ...
        Map<String,Object> result = m.readValue(VPackUtils.toVPack(json), Map.class);
        assertEquals(1, result.size());
    ...
    public void testEmptyBean() throws Exception
    {
        ObjectMapper m = vpackMapperBuilder()
                ...
                .build();
        assertEquals("{\"@type\":\"empty\"}", VPackUtils.toJson(m.writeValueAsBytes(new Empty())));
    }
    ...
    public void testTypedMaps() throws Exception
    {
        ...
        list.add(new A());
        map.put(1L, list);
        String json = VPackUtils.toJson(mapper.writerFor(new TypeReference<Map<Long, Collection<Super>>>() {}).writeValueAsBytes(map));
    ...
    public void testCollectionWithTypeInfo() throws Exception {
        ...
        String result = VPackUtils.toJson(writer.writeValueAsBytes(input));
...
"[{'@class':'."+CLASS_NAME+"$List1451A','a':'a1'},{'@class':'."+CLASS_NAME+"$List1451B','a':'a2','b':'b'}]"
        ...
        List<List1451A> output = mapper.readerFor(typeRef)
                .readValue(VPackUtils.toVPack(result));
