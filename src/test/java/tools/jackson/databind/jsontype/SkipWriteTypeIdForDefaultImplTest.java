...
public class SkipWriteTypeIdForDefaultImplTest extends DatabindTestUtil
{
    ...
    public void testPropertyDefaultImplSkipped() throws Exception
    {
        ...
        dog.name = "Rex";
        dog.breed = "Lab";
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(dog));
    ...
    public void testPropertySubclassOfDefaultImplHasTypeId() throws Exception
    {
        ...
        puppy.breed = "Poodle";
        puppy.isSmall = true;
        String json = VPackUtils.toJson(MAPPER.writerFor(Animal.class).writeValueAsBytes(puppy));
    ...
    public void testPropertyRoundTrip() throws Exception
    {
        ...
        dog.name = "Rex";
        dog.breed = "Lab";
        String json = VPackUtils.toJson(MAPPER.writerFor(Animal.class).writeValueAsBytes(dog));
        Animal result = MAPPER.readValue(VPackUtils.toVPack(json), Animal.class);
        ...
        cat.name = "Whiskers";
        cat.lives = 9;
        json = VPackUtils.toJson(MAPPER.writerFor(Animal.class).writeValueAsBytes(cat));
        result = MAPPER.readValue(VPackUtils.toVPack(json), Animal.class);
    ...
    public void testWrapperArrayDefaultImplSkipped() throws Exception
    {
        ...
        dog.name = "Rex";
        dog.breed = "Lab";
        String json = VPackUtils.toJson(MAPPER.writerFor(Animal2.class).writeValueAsBytes(dog));
    ...
    public void testWrapperArrayNonDefaultHasTypeId() throws Exception
    {
        ...
        cat.name = "Whiskers";
        cat.lives = 9;
        String json = VPackUtils.toJson(MAPPER.writerFor(Animal2.class).writeValueAsBytes(cat));
    ...
    public void testWrapperArrayRoundTrip() throws Exception
    {
        ...
        Animal2 result = MAPPER.readValue(VPackUtils.toVPack(json), Animal2.class);
    ...
    public void testWrapperObjectDefaultImplSkipped() throws Exception
    {
        ...
        dog.name = "Rex";
        dog.breed = "Lab";
        String json = VPackUtils.toJson(MAPPER.writerFor(Animal3.class).writeValueAsBytes(dog));
    ...
    public void testWrapperObjectNonDefaultHasTypeId() throws Exception
    {
        ...
        cat.name = "Whiskers";
        cat.lives = 9;
        String json = VPackUtils.toJson(MAPPER.writerFor(Animal3.class).writeValueAsBytes(cat));
    ...
    public void testWrapperObjectNonDefaultRoundTrip() throws Exception
    {
        ...
        cat.lives = 9;
        String json = VPackUtils.toJson(MAPPER.writerFor(Animal3.class).writeValueAsBytes(cat));
        Animal3 result = MAPPER.readValue(VPackUtils.toVPack(json), Animal3.class);
    ...
    public void testExternalPropertyDefaultImplRoundTrip() throws Exception
    {
        ...
        wrapper.animal = dog;
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(wrapper));
        AnimalWrapper result = MAPPER.readValue(VPackUtils.toVPack(json), AnimalWrapper.class);
    ...
    public void testExistingPropertyDefaultImplTypeFieldStillWritten() throws Exception
    {
        ...
        dog.breed = "Lab";
        dog.type = "dog";
        String json = VPackUtils.toJson(MAPPER.writerFor(Animal5.class).writeValueAsBytes(dog));
    ...
    public void testExistingPropertyNonDefaultHasTypeId() throws Exception
    {
        ...
        cat.lives = 9;
        cat.type = "cat";
        String json = VPackUtils.toJson(MAPPER.writerFor(Animal5.class).writeValueAsBytes(cat));
    ...
    public void testBaseTypeAsDefaultImplSkipped() throws Exception
    {
        ...
        base.name = "Generic";
        String json = VPackUtils.toJson(MAPPER.writerFor(AnimalBase.class).writeValueAsBytes(base));
    ...
    public void testBaseTypeAsDefaultImplSubclassHasTypeId() throws Exception
    {
        ...
        dog.name = "Rex";
        dog.breed = "Lab";
        String json = VPackUtils.toJson(MAPPER.writerFor(AnimalBase.class).writeValueAsBytes(dog));
        assertTrue(json.contains("\"@type\":\"dog\""),
    ...
    public void testFeatureOffAlwaysWritesTypeId() throws Exception
    {
        ...
        dog.name = "Rex";
        dog.breed = "Lab";
        String json = VPackUtils.toJson(MAPPER.writerFor(AnimalOff.class).writeValueAsBytes(dog));
