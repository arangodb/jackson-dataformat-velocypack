...
public class DeductionWithAbstractSubtype4708Test extends DatabindTestUtil
{
    ...
    sealed interface Ingredient permits Ingredient.Item {
        ...
        @JsonTypeInfo(use = JsonTypeInfo.Id.DEDUCTION)
        @JsonSubTypes({
            @JsonSubTypes.Type(AbstractItemById.class), // Abstract class registered!
            @JsonSubTypes.Type(ItemById.class),
            @JsonSubTypes.Type(ItemByTag.class)
        })
        sealed interface Item extends Ingredient
            permits AbstractItemById, ItemByTag {
        }
    ...
    public void testDeductionWithAbstractIntermediateClass() throws Exception
    {
        ...
        Ingredient result1 = MAPPER.readValue(VPackUtils.toVPack(json1), Ingredient.class);
        ...
        Ingredient result2 = MAPPER.readValue(VPackUtils.toVPack(json2), Ingredient.class);
    ...
    public void testDeductionWithItemInterface() throws Exception
    {
        ...
        Ingredient.Item result = MAPPER.readValue(VPackUtils.toVPack(json), itemType);
    ...
    public void testInterfaceIgnored() throws Exception
    {
        ...
        Pet result1 = MAPPER.readValue(VPackUtils.toVPack(json1), Pet.class);
        ...
        Pet result2 = MAPPER.readValue(VPackUtils.toVPack(json2), Pet.class);
    ...
    public void testFeatureCanBeDisabled() throws Exception
    {
        ...
        InvalidDefinitionException e = assertThrows(InvalidDefinitionException.class,
                () -> mapper.readValue(VPackUtils.toVPack(json), Ingredient.class));
