...
public class TestWithGenerics extends DatabindTestUtil
{
    ...
    public void testWrapperWithGetter() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new ContainerWithGetter<Animal>(dog)));
    ...
    {
        Dog dog = new Dog("Fluffy", 3);
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new ContainerWithField<Animal>(dog)));
        if (json.indexOf("\"object-type\":\"doggy\"") < 0) {
            fail("polymorphic type not kept, result == "+json+"; should contain 'object-type':'...'");
        }
    }
    ...
    public void testWrapperWithExplicitType() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writerFor(MAPPER.getTypeFactory().constructParametricType(ContainerWithGetter.class,
    ...
    public void testJackson387() throws Exception
    {
        ...
        String json = VPackUtils.toJson(om.writeValueAsBytes( mc ));

        MyClass mc2 = om.readValue(VPackUtils.toVPack(json), MyClass.class );
        assertNotNull(mc2);
    ...
    public void testValueWithMoreGenericParameters() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(wrappedContainerWithField));
        assertNotNull(json);
    }
    ...
    public void testIssue1128() throws Exception
    {
        ...
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(devMContainer1));

        final DevMContainer devMContainer = mapper.readValue(VPackUtils.toVPack(json), DevMContainer.class);
    ...
    public void testGeneric2331() throws Exception {
        ...
        String json = VPackUtils.toJson(newVPackMapper().writeValueAsBytes(root));
        assertNotNull(json);
    }
