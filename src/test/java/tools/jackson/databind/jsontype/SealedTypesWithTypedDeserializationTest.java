    ...
    extends DatabindTestUtil
{
    ...
    {
        Animal a = MAPPER.readValue(VPackUtils.toVPack(asJSONObjectValueString(MAPPER,
    ...
    public void testTypeAsWrapper() throws Exception
    {
        ...
        Animal a = m.readValue(VPackUtils.toVPack(JSON), Animal.class);
    ...
    public void testListAsArray() throws Exception
    {
        ...
        List<Animal> animals = MAPPER.readValue(VPackUtils.toVPack(JSON), expType);
    ...
    public void testCagedAnimal() throws Exception
    {
        ...
        AnimalContainer cont = MAPPER.readValue(VPackUtils.toVPack(JSON), AnimalContainer.class);
        assertNotNull(cont);
    ...
    public void testAbstractEmptyBaseClass() throws Exception
    {
        DummyBase result = MAPPER.readValue(
                VPackUtils.toVPack("[\""+DummyImpl.class.getName()+"\",{\"x\":3}]"), DummyBase.class);
    ...
    public void testIssue506WithDate() throws Exception
    {
        ...
        Issue506DateBean output = MAPPER.readValue(VPackUtils.toVPack(json), Issue506DateBean.class);
    ...
    public void testIssue506WithNumber() throws Exception
    {
        ...
        Issue506NumberBean output = MAPPER.readValue(VPackUtils.toVPack(json), Issue506NumberBean.class);
    ...
    private String asJSONObjectValueString(ObjectMapper mapper, Object... args)
    {
        ...
        return VPackUtils.toJson(mapper.writeValueAsBytes(map));
    }
    ...
    public void testIntAsTypeId1751Array() throws Exception
    {
        ...
        value = MAPPER.readValue(VPackUtils.toVPack("[0, { }]"), Issue1751ArrBase.class);
        assertNotNull(value);
    ...
    public void testIntAsTypeId1751Prop() throws Exception
    {
        ...
        // Should allow both String and Int:
        value = MAPPER.readValue(VPackUtils.toVPack("{\"type\" : \"1\"}"), Issue1751PropBase.class);
        assertNotNull(value);
    ...
    public void testTypeAsArrayWithNullableType() throws Exception
    {
        ...
        Animal a = m.readValue(
                VPackUtils.toVPack("[\""+Fish.class.getName()+"\"]"), Animal.class);
        assertNull(a);
    }
    ...
    public void testTypeAsArrayWithCustomDeserializer() throws Exception
    {
        ObjectMapper m = vpackMapperBuilder()
                ...
                .build();
        Animal a = m.readValue(
                VPackUtils.toVPack("[\""+NullAnimal.class.getName()+"\"]"), Animal.class);
        assertNotNull(a);
