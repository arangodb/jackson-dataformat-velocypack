...
public class CustomTypeIdResolver4407Test extends DatabindTestUtil
{
    ...
    void testTypeIdProp4407NonNull() throws Exception
    {
        ...
        assertEquals(EXP,
                VPackUtils.toJson(MAPPER.writeValueAsBytes(new Wrapper4407Prop("xyz"))));
        Wrapper4407Prop result = MAPPER.readValue(VPackUtils.toVPack(EXP), Wrapper4407Prop.class);
    ...
    void testTypeIdProp4407Null() throws Exception
    {
        ...
        assertEquals(EXP,
                VPackUtils.toJson(MAPPER.writeValueAsBytes(new Wrapper4407PropNull("xyz"))));
        assertNotNull(MAPPER.readValue(VPackUtils.toVPack(EXP), Wrapper4407PropNull.class));
        Wrapper4407Prop result = MAPPER.readValue(VPackUtils.toVPack(EXP), Wrapper4407Prop.class);
        assertNotNull(result);
        assertNotNull(result.wrapped);
    ...
    void testTypeIdWrapperArray4407NonNull() throws Exception
    {
        ...
        assertEquals(EXP,
                VPackUtils.toJson(MAPPER.writeValueAsBytes(new Wrapper4407WrapperArray("xyz"))));
        Wrapper4407WrapperArray result = MAPPER.readValue(VPackUtils.toVPack(EXP), Wrapper4407WrapperArray.class);
        assertNotNull(result);
        assertNotNull(result.wrapped);
        assertEquals(Impl4407.class, result.wrapped.getClass());
    }
    ...
    void testTypeIdWrapperArray4407Null() throws Exception
    {
        ...
        final String EXP = a2q("{'wrapped':{'value':'xyz'}}");
        assertEquals(EXP,
                VPackUtils.toJson(MAPPER.writeValueAsBytes(new Wrapper4407WrapperArrayNull("xyz"))));
        Wrapper4407WrapperArray result = MAPPER.readValue(VPackUtils.toVPack(EXP), Wrapper4407WrapperArray.class);
        assertNotNull(result);
        assertNotNull(result.wrapped);
        assertEquals(Default4407.class, result.wrapped.getClass());
    ...
    void testTypeIdWrapperObject4407NonNull() throws Exception
    {
        ...
        final String EXP = a2q("{'wrapped':{'typeX':{'value':'xyz'}}}");
        assertEquals(EXP,
                VPackUtils.toJson(MAPPER.writeValueAsBytes(new Wrapper4407WrapperObject("xyz"))));
        Wrapper4407WrapperObject result = MAPPER.readValue(VPackUtils.toVPack(EXP), Wrapper4407WrapperObject.class);
        assertNotNull(result);
        assertNotNull(result.wrapped);
        assertEquals(Impl4407.class, result.wrapped.getClass());
    }
    ...
    void testTypeIdWrapperObject4407Null() throws Exception
    {
        ...
        final String EXP = a2q("{'wrapped':{'value':'xyz'}}");
        assertEquals(EXP,
                VPackUtils.toJson(MAPPER.writeValueAsBytes(new Wrapper4407WrapperObjectNull("xyz"))));
        Wrapper4407WrapperObject result = MAPPER.readValue(VPackUtils.toVPack(EXP), Wrapper4407WrapperObject.class);
        assertNotNull(result);
        assertNotNull(result.wrapped);
        assertEquals(Default4407.class, result.wrapped.getClass());
