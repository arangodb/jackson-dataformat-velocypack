...
public class ExternalTypeCustomResolver1288Test extends DatabindTestUtil
{
    ...
    public static class ClassesWithoutBuilder {
        ...
        public static class PaymentMean {
            ...
            @JsonTypeInfo(use = Id.CUSTOM, include = JsonTypeInfo.As.EXTERNAL_PROPERTY, property = "form_of_payment", visible = true)
...
+"'province':'Ile-de-France','country_code':'FR','description':'John Doe personal credit card'}}"
        ...
        ClassesWithoutBuilder.PaymentMean ob1 = MAPPER.readValue(VPackUtils.toVPack(asJson1), ClassesWithoutBuilder.PaymentMean.class);
        assertNotNull(ob1);
    }
...
+" 'name':'Mr John Doe encrypted credit card'}}"
        ...
        ClassesWithBuilder.PaymentMean ob2 = MAPPER.readValue(VPackUtils.toVPack(asJson2), ClassesWithBuilder.PaymentMean.class);
        assertNotNull(ob2);
    }
}
