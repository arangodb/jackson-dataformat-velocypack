...
public class ExternalTypeIdTest extends DatabindTestUtil
{
    ...
    static class Envelope928 {
        ...
        @JsonTypeInfo(use= Id.CLASS, include= As.EXTERNAL_PROPERTY, property="class")
        Object payload) {
            _payload = payload;
        }
    }
    ...
    public void testSimpleSerialization() throws Exception
    {
        ...
        assertEquals("{\"bean\":{\"value\":11},\"extType\":\"vbean\"}",
                VPackUtils.toJson(mapper.writeValueAsBytes(new ExternalBean(11))));
    }
    ...
    public void testImproperExternalIdSerialization() throws Exception
    {
        ...
        assertEquals("{\"extType\":\"funk\",\"i\":3}",
                VPackUtils.toJson(mapper.writeValueAsBytes(new FunkyExternalBean())));
    }
    ...
    public void testExternalTypeIdWithNull() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        ExternalBean b;
        b = mapper.readValue(VPackUtils.toVPack(a2q("{'bean':null,'extType':'vbean'}")),
                ExternalBean.class);
        assertNotNull(b);
        b = mapper.readValue(VPackUtils.toVPack(a2q("{'extType':'vbean','bean':null}")),
                ExternalBean.class);
        assertNotNull(b);
    }
    ...
    public void testSimpleDeserialization() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                .registerSubtypes(ValueBean.class)
                .build();
        ExternalBean result = mapper.readValue(VPackUtils.toVPack("{\"bean\":{\"value\":11},\"extType\":\"vbean\"}"), ExternalBean.class);
        ...
        result = mapper.readValue(VPackUtils.toVPack("{\"extType\":\"vbean\", \"bean\":{\"value\":13}}"), ExternalBean.class);
        assertNotNull(result);
        assertNotNull(result.bean);
    ...
    public void testMultipleTypeIdsDeserialization() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                .registerSubtypes(ValueBean.class)
                .build();
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(new ExternalBean3(3)));
        ExternalBean3 result = mapper.readValue(VPackUtils.toVPack(json), ExternalBean3.class);
        assertNotNull(result);
    ...
    public void testExternalTypeWithCreator() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                .registerSubtypes(ValueBean.class)
                .build();
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(new ExternalBeanWithCreator(7)));
        ExternalBeanWithCreator result = mapper.readValue(VPackUtils.toVPack(json), ExternalBeanWithCreator.class);
        assertNotNull(result);
    ...
    {
        FunkyExternalBean result = MAPPER.readValue(VPackUtils.toVPack("{\"extType\":\"funk\",\"i\":3}"),
                FunkyExternalBean.class);
        assertNotNull(result);
        assertEquals(3, result.i);

        result = MAPPER.readValue(VPackUtils.toVPack("{\"i\":4,\"extType\":\"funk\"}"),
                FunkyExternalBean.class);
        assertNotNull(result);
    ...
    public void testIssue798() throws Exception
    {
        ...
        String generatedJson = VPackUtils.toJson(MAPPER.writeValueAsBytes(baseContainer));
        BaseContainer baseContainer2 = MAPPER.readValue(VPackUtils.toVPack(generatedJson), BaseContainer.class);
    ...
    public void testIssue831() throws Exception
    {
        final String JSON = "{ \"petType\": \"dog\",\n"
                +"\"pet\": { \"name\": \"Pluto\" }\n}";
        House831 result = MAPPER.readValue(VPackUtils.toVPack(JSON), House831.class);
        assertNotNull(result);
    ...
    public void testWithScalar118() throws Exception
    {
        ...
        ExternalTypeWithNonPOJO result = MAPPER.readValue(VPackUtils.toVPack(json), ExternalTypeWithNonPOJO.class);
        assertNotNull(result.value);
        assertInstanceOf(Date.class, result.value);
    }
    ...
    public void testWithNaturalScalar118() throws Exception
    {
        ...
        json = VPackUtils.toJson(MAPPER.writeValueAsBytes(input));
        assertNotNull(json);
        result = MAPPER.readValue(VPackUtils.toVPack(json), ExternalTypeWithNonPOJO.class);
        assertNotNull(result.value);
    ...
    public void testInverseExternalId928() throws Exception
    {
        ...
        Envelope928 envelope1 = mapper.readValue(VPackUtils.toVPack(successCase), Envelope928.class);
        ...
        Envelope928 envelope2 = mapper.readValue(VPackUtils.toVPack(failCase), Envelope928.class);
    ...
    public void testIssue3008() throws Exception
    {
        ...
        Box3008 deserOrangeBox = r.readValue(VPackUtils.toVPack("{\"type\":null,\"fruit\":null}"));
    ...
    {
        ObjectMapper mapper96 = vpackMapperBuilder()
        ...
        String fullJson = VPackUtils.toJson(mapper96.writeValueAsBytes(input));
        ExternalBeanWithDefault output = mapper96.readValue(VPackUtils.toVPack(fullJson), ExternalBeanWithDefault.class);
        assertNotNull(output);
        assertNotNull(output.bean);
        // and then try without type info...
        ExternalBeanWithDefault defaulted = mapper96.readValue(VPackUtils.toVPack("{\"bean\":{\"value\":13}}"),
    ...
    public void testExternalPropertyWithJsonIgnore4185() throws Exception
    {
        Parent4185 parent = MAPPER.readValue(
                VPackUtils.toVPack(a2q("{'child': {'childType': 'A', 'subChild':{} } }")),
                Parent4185.class);
    ...
    public void testExternalPropertyWithIgnoreUnknown2611() throws Exception
    {
        ...
        List<Wrapper2611> result = MAPPER.readValue(VPackUtils.toVPack(data), new TypeReference<List<Wrapper2611>>() {});
    ...
    public void testDoubleMetadata() throws Exception {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(doub));
    ...
    public void testDecimalMetadata() throws Exception {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(dec));
        assertEquals(expected, json, "Serialized json not equivalent");
    }
...
+"}"
    ...
    private void _testMultipleValuesSingleExtId291(String json) throws Exception
    {
        ...
        {
            Container291 c = MAPPER.readValue(VPackUtils.toVPack(json), Container291.class);
            assertNotNull(c);
        ...
        {
            ContainerWithExtra291 c = MAPPER.readValue(VPackUtils.toVPack(json), ContainerWithExtra291.class);
            assertNotNull(c);
