...
public class ExternalPropertyWithVPackValueNull3547Test extends DatabindTestUtil
{
    ...
    public void deserializeWithNonNullJsonValue() throws Exception {
        ...
        Container container = MAPPER.readValue(VPackUtils.toVPack(json), Container.class);
    ...
    public void roundtripWithNonNullJsonValue() throws Exception {
        ...
        Container out = MAPPER.readValue(VPackUtils.toVPack(json), Container.class);
