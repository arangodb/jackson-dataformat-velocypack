...
public class SealedTypesWithSubtypesTest extends DatabindTestUtil
{
    ...
    public void testSerialization() throws Exception
    {
        ...
        assertEquals("{\"@type\":\"SealedTypesWithSubtypesTest$SubD\",\"d\":0}", VPackUtils.toJson(mapper.writeValueAsBytes(new SubD())));
    }
    ...
    public void testDeserializationNonNamed() throws Exception
    {
        ...
        SuperType bean = mapper.readValue(VPackUtils.toVPack("{\"@type\":\"SealedTypesWithSubtypesTest$SubC\", \"c\":1}"), SuperType.class);
