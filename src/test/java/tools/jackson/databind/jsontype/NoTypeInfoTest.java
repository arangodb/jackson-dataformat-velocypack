...
class NoTypeInfoTest extends DatabindTestUtil
{
    ...
    void withoutNoTypeElementOverrideSerAndDeserCollection() throws Exception {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new Value1654TypedContainer(
                new Value1654(1),
                new Value1654(2)
        )));
        ...
        Value1654TypedContainer result = MAPPER.readValue(VPackUtils.toVPack(json), Value1654TypedContainer.class);
    ...
    void withNoTypeInfoDefaultSerCollection() throws Exception {
        ...
        assertEquals(a2q("{'values':[{'x':3},{'x':7}]}"),
                VPackUtils.toJson(MAPPER.writeValueAsBytes(cont)));
    }
    ...
    void withNoTypeInfoDefaultDeserCollection() throws Exception {
        ...
        Value1654UntypedContainer unResult = MAPPER.readValue(VPackUtils.toVPack(noTypeJson),
    ...
    void withNoTypeInfoOverrideDeserCollection() throws Exception {
        ...
        Value1654UsingCustomSerDeserUntypedContainer unResult = MAPPER.readValue(VPackUtils.toVPack(noTypeJson),
    ...
    void singleWithNoTypeInfoOverrideSer() throws Exception {
        ...
        assertEquals(a2q("{'value':{'v':42}}"),
                VPackUtils.toJson(MAPPER.writeValueAsBytes(wrapper)));
    }
    ...
    void singleWithNoTypeInfoOverrideDeser() throws Exception {
        ...
        SingleValue1654UsingCustomSerDeserUntyped result = MAPPER.readValue(VPackUtils.toVPack(noTypeJson),
    ...
    void withoutNoTypeElementOverrideSerAndDeserMap() throws Exception {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new Value1654TypedMapContainer(map)));
        String typeId = Value1654.class.getName();
        typeId = "'@type':'" + typeId.substring(typeId.lastIndexOf('.') + 1) + "'";
        assertEquals(a2q("{'values':{'first':{"+typeId+",'x':1},'second':{"+typeId+",'x':2}}}"), json);

        Value1654TypedMapContainer result = MAPPER.readValue(VPackUtils.toVPack(json), Value1654TypedMapContainer.class);
        assertEquals(2, result.values.size());
    ...
    void withNoTypeInfoDefaultDeserMap() throws Exception {
        ...
        Value1654UntypedMapContainer unResult = MAPPER.readValue(VPackUtils.toVPack(noTypeJson),
    ...
    void withNoTypeInfoOverrideDeserMap() throws Exception {
        ...
        Value1654UsingCustomSerDeserUntypedMapContainer unResult = MAPPER.readValue(VPackUtils.toVPack(noTypeJson),
    ...
    void withoutNoTypeElementOverrideSerAndDeserOptional() throws Exception {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(cont));
        String typeId = Value1654.class.getName();
        typeId = "'@type':'" + typeId.substring(typeId.lastIndexOf('.') + 1) + "'";
        assertEquals(a2q("{'value':{"+typeId+",'x':42}}"), json);

        Value1654TypedOptionalContainer result = MAPPER.readValue(VPackUtils.toVPack(json), Value1654TypedOptionalContainer.class);
    ...
    void withNoTypeInfoDefaultSerOptional() throws Exception {
        ...
        assertEquals(a2q("{'value':{'x':42}}"), VPackUtils.toJson(MAPPER.writeValueAsBytes(cont)));
    }
    ...
    void withNoTypeInfoDefaultDeserOptional() throws Exception {
        ...
        Value1654UntypedOptionalContainer result = MAPPER.readValue(VPackUtils.toVPack(noTypeJson),
    ...
    void withNoTypeInfoOverrideSerOptional() throws Exception {
        ...
        assertEquals(a2q("{'value':{'v':42}}"), VPackUtils.toJson(MAPPER.writeValueAsBytes(cont)));
    }
    ...
    void withNoTypeInfoOverrideDeserOptional() throws Exception {
        String noTypeJson = a2q("{'value':{'v':42}}");
        Value1654UsingCustomSerDeserUntypedOptionalContainer result = MAPPER.readValue(VPackUtils.toVPack(noTypeJson),
    ...
    void withoutNoTypeElementOverrideSerAndDeserAtomicRef() throws Exception {
        ...
        Value1654TypedAtomicRefContainer result = MAPPER.readValue(VPackUtils.toVPack(json), Value1654TypedAtomicRefContainer.class);
        assertEquals(42, result.value.get().x);
    }
    ...
    void withNoTypeInfoOverrideDeserAtomicRef() throws Exception {
        String noTypeJson = a2q("{'value':{'v':42}}");
        Value1654UsingCustomSerDeserUntypedAtomicRefContainer result = MAPPER.readValue(VPackUtils.toVPack(noTypeJson),
    ...
    public void testWithIdNone() throws Exception
    {
        ...
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(new NoType()));
        assertEquals("{\"a\":3}", json);

        // and deserialize successfully
        NoTypeInterface bean = mapper.readValue(VPackUtils.toVPack("{\"a\":6}"), NoTypeInterface.class);
        assertNotNull(bean);
    ...
    public void testCollectionWithOverride() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
            .activateDefaultTypingAsProperty(NoCheckSubTypeValidator.instance,
                    ...
                    "$type")
            .build();
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(new ListWrapper()));
        assertEquals(a2q("{'stuff':[]}"), json);

        // And verify deserialization works too
        ListWrapper result = mapper.readValue(VPackUtils.toVPack(json), ListWrapper.class);
