...
public class PolymorphicDeserErrorHandlingTest extends DatabindTestUtil
{
    ...
    public void testUnknownClassAsSubtype() throws Exception
    {
        ...
        BaseUnknownWrapper w = reader.readValue(VPackUtils.toVPack(a2q
    ...
    public void testSubType2668() throws Exception
    {
        ...
        InvalidTypeIdException e = assertThrows(InvalidTypeIdException.class,
                () -> MAPPER.readValue(VPackUtils.toVPack(json), Child1.class)); // Deserializing into Child1
    ...
    public void testWrongSubtype() throws Exception {
        ...
        String serialized = VPackUtils.toJson(mapper.writeValueAsBytes(plantInfo));
        PlantInfo newInfo0 = mapper.readValue(VPackUtils.toVPack(serialized), PlantInfo.class);
        ...
        InvalidTypeIdException e = assertThrows(InvalidTypeIdException.class, () ->
                mapper.readValue(VPackUtils.toVPack(serialized), AnimalInfo.class));
    ...
    public void testBlockingOfRunnable() throws Exception {
        ...
        String serialized = VPackUtils.toJson(mapper.writeValueAsBytes(animalInfo));
        AnimalInfo newInfo0 = mapper.readValue(VPackUtils.toVPack(serialized), AnimalInfo.class);
        ...
        InvalidDefinitionException e = assertThrows(InvalidDefinitionException.class,
                () -> mapper.readValue(VPackUtils.toVPack(serialized), RunnableInfo.class));
