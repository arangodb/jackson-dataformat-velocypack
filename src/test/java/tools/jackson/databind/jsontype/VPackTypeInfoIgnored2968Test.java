...
public class VPackTypeInfoIgnored2968Test extends DatabindTestUtil {
    /*
    /**********************************************************
    /* Set up
    /**********************************************************
    ...
    private static final ObjectMapper MAPPER = vpackMapperBuilder().disable(MapperFeature.REQUIRE_TYPE_ID_FOR_SUBTYPES).build();
    ...
    public void testDeserializeParentPositiveWithTypeId() throws Exception {
        ...
        Animal cat = MAPPER.readValue(VPackUtils.toVPack(json), Animal.class);
    ...
    public void testDeserializeParentNegativeWithOutTypeId() throws Exception {
        ...
        try {
            MAPPER.readValue(VPackUtils.toVPack(json), Animal.class);
    ...
    public void testDeserializedAsConcreteTypeSuccessfulWithOutPropertySet() throws Exception {
        ...
        Cat cat = MAPPER.readValue(VPackUtils.toVPack(json), Cat.class);
    ...
    public void testDeserializationWrapperWithDefaultTyping() throws Exception {
        ...
        BallValueWrapper wrapper = mapper.readValue(VPackUtils.toVPack(defaultTypedJson), BallValueWrapper.class);
    ...
    public void testDeserializationBaseClassWithDefaultTyping() throws Exception {
        ...
        try {
            mapper.readValue(VPackUtils.toVPack(concreteTypeJson), SimpleBall.class);
