    ...
    extends DatabindTestUtil
{
    ...
    public void testBeanAsObject() throws Exception
    {
        ...
        String str = VPackUtils.toJson(mapper.writeValueAsBytes(new Object[] { new StringBean("abc") }));

        _verifySerializationAsMap(str);

        // Ok: serialization seems to work as expected. Now deserialize:
        Object ob = mapper.readValue(VPackUtils.toVPack(str), Object[].class);
        assertNotNull(ob);
    ...
    public void testBeanAsObjectUsingAsProperty() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        // note: need to wrap, to get declared as Object
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(new StringBean("abc")));
    ...
    public void testAsPropertyWithPTV() throws Exception {
        ObjectMapper m = vpackMapperBuilder()
                .activateDefaultTypingAsProperty(new BlockAllPTV(),
                        ...
                        "@classy")
                .build();
        String json = VPackUtils.toJson(m.writeValueAsBytes(new StringBean("abc")));
        InvalidDefinitionException e = assertThrows(InvalidDefinitionException.class,
                () -> m.readValue(VPackUtils.toVPack(json), Object.class));
    ...
    public void testAbstractBean() throws Exception
    {
        ...
        ObjectMapper m0 = newVPackMapper();
        AbstractBean[] input = new AbstractBean[] { new StringBean("xyz") };
        String serial0 = VPackUtils.toJson(m0.writeValueAsBytes(input));
        InvalidDefinitionException e = assertThrows(InvalidDefinitionException.class,
                () -> m0.readValue(VPackUtils.toVPack(serial0), AbstractBean[].class));
        ...
        ObjectMapper m = vpackMapperBuilder()
                ...
                .build();
        String serial = VPackUtils.toJson(m.writeValueAsBytes(input));
        AbstractBean[] beans = m.readValue(VPackUtils.toVPack(serial), AbstractBean[].class);
    ...
    public void testNonFinalBean() throws Exception
    {
        ...
        assertEquals("{\"name\":\"x\"}", VPackUtils.toJson(m.writeValueAsBytes(bean)));
        ...
        assertEquals("[\""+StringBean.class.getName()+"\",{\"name\":\"x\"}]",
            VPackUtils.toJson(m.writeValueAsBytes(bean)));
    }
    ...
    public void testNullValue() throws Exception
    {
        ...
        String json = VPackUtils.toJson(m.writeValueAsBytes(h));
        assertNotNull(json);
        BeanHolder result = m.readValue(VPackUtils.toVPack(json), BeanHolder.class);
        assertNotNull(result);
    ...
    public void testEnumAsObject() throws Exception
    {
        ...
        assertEquals("[\"YES\"]", VPackUtils.toJson(MAPPER.writeValueAsBytes(input)));
        assertEquals("[\"MAYBE\"]", VPackUtils.toJson(MAPPER.writeValueAsBytes(input2)));
        ...
        Object[] output = m.readValue(VPackUtils.toVPack(json), Object[].class);
        assertEquals(1, output.length);
        assertEquals(Choice.YES, output[0]);

        // ditto for more complicated enum
        json = VPackUtils.toJson(m.writeValueAsBytes(input2));
        assertEquals("[[\""+ComplexChoice.class.getName()+"\",\"MAYBE\"]]", json);
        output = m.readValue(VPackUtils.toVPack(json), Object[].class);
        assertEquals(1, output.length);
    ...
    public void testJackson311() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                .activateDefaultTyping(NoCheckSubTypeValidator.instance,
                        DefaultTyping.NON_FINAL)
                .build();
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(new PolymorphicType("hello", 2)));
        PolymorphicType value = mapper.readValue(VPackUtils.toVPack(json), PolymorphicType.class);
    ...
    public void testTokenBuffer() throws Exception
    {
        ...
        buf.writeEndObject();
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(new ObjectHolder(buf)));
        ObjectHolder holder = mapper.readValue(VPackUtils.toVPack(json), ObjectHolder.class);
        ...
        buf.writeEndArray();
        json = VPackUtils.toJson(mapper.writeValueAsBytes(new ObjectHolder(buf)));
        holder = mapper.readValue(VPackUtils.toVPack(json), ObjectHolder.class);
        assertNotNull(holder.value);
        assertSame(TokenBuffer.class, holder.value.getClass());
    ...
    public void testIssue352() throws Exception
    {
        ...
        DomainBeanWrapper result = mapper.readValue(VPackUtils.toVPack(json), DomainBeanWrapper.class);
        assertNotNull(result);
    ...
    public void testFeature432() throws Exception
    {
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(new BeanHolder(new StringBean("punny"))));
    ...
    public void testWithFinalClass_NonFinal() throws Exception
    {
        ...
        assertEquals(a2q("{'name':'abc'}"),
                VPackUtils.toJson(mapper.writeValueAsBytes(new FinalStringBean("abc"))));
    ...
    public void testDeserializationConcreteClassWithDefaultTyping() throws Exception {
        ...
        BasketBall basketBall = mapper.readValue(VPackUtils.toVPack(concreteTypeJson), BasketBall.class);
    ...
    {
        String json = VPackUtils.toJson(w.writeValueAsBytes(input));

        Point1093 result = (Point1093) r.readValue(VPackUtils.toVPack(json));
    ...
    {
        ObjectMapper mapper3235 = vpackMapperBuilder()
        ...
        String doc = a2q(
                ...
                "  'objectField': {}" +
                "}");
        Object o = mapper3235.readValue(VPackUtils.toVPack(doc), AbstractParentWithoutDefault3235.class);
    ...
    {
        ObjectMapper defMapper = vpackMapperBuilder()
                .activateDefaultTyping(NoCheckSubTypeValidator.instance,
                        DefaultTyping.NON_FINAL, JsonTypeInfo.As.PROPERTY)
                .build();
        FooTreeNode foo = new FooTreeNode("baz");
        String json = VPackUtils.toJson(defMapper.writeValueAsBytes(foo));

        JsonNode jsonNode = defMapper.readTree(VPackUtils.toVPack(json));
    ...
    private void _verifySerializationAsMap(String str) throws Exception
    {
        ...
        List<Object> list = m.readValue(VPackUtils.toVPack(str), List.class);
