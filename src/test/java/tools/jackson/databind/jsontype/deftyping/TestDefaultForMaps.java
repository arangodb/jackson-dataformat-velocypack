...
//        serializerTyper = serializerTyper.inclusion(JsonTypeInfo.As.PROPERTY);
        ObjectMapper serMapper = vpackMapperBuilder()
        ...
        String json = VPackUtils.toJson(serMapper.writeValueAsBytes(holder));
...
//        deserializerTyper = deserializerTyper.inclusion(JsonTypeInfo.As.PROPERTY);
        ObjectMapper deserMapper = vpackMapperBuilder()
                .setDefaultTyping(deserializerTyper)
                .build();
        MapHolder result = deserMapper.readValue(VPackUtils.toVPack(json), MapHolder.class);
    ...
    public void testList() throws Exception
    {
        ...
        String json = VPackUtils.toJson(mapper.writer().writeValueAsBytes(parent));

        Object o = mapper.readValue(VPackUtils.toVPack(json), ItemList.class);
        assertNotNull(o);
    }
    ...
    public void testMap() throws Exception
    {
        ...
        String json = VPackUtils.toJson(mapper.writer().writeValueAsBytes(parent));
        Object o = mapper.readValue(VPackUtils.toVPack(json), ItemMap.class);
        assertNotNull(o);
    }
