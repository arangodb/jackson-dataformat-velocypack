...
class PolymorphicArrays3194Test extends DatabindTestUtil
{
    ...
    {
        ObjectMapper mapper = VPackMapper
                .builder()
    ...
    void twoDimensionalArrayViaDefaultTyping() throws Exception
    {
        ...
        String json = VPackUtils.toJson(mapper
                .writer()
                .writeValueAsBytes(instance));

        ArrayBean3194 result = mapper.readValue(VPackUtils.toVPack(json), ArrayBean3194.class);
    ...
    void twoDimensionalPrimitiveArrayViaDefaultTyping() throws Exception
    {
        ...
        UntypedBean3194 result = mapper.readValue(VPackUtils.toVPack(json), UntypedBean3194.class);
    ...
    void twoDimensionalPojoArrayViaDefaultTyping() throws Exception
    {
        ...
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(instance));
