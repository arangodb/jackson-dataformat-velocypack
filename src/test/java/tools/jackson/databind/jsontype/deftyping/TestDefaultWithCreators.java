    ...
    extends DatabindTestUtil
{
    ...
    public void testWithCreators() throws Exception
    {
        ...
        assertNotNull(json);
        Job output = mapper.readValue(VPackUtils.toVPack(json), Job.class);
    ...
    public void testWithCreatorAndJsonValue() throws Exception
    {
        ...
        ObjectMapper mapper = vpackMapperBuilder()
                .activateDefaultTyping(NoCheckSubTypeValidator.instance)
                .build();
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(new Bean1385Wrapper(
                new Bean1385(BYTES)
        )));
        Bean1385Wrapper result = mapper.readValue(VPackUtils.toVPack(json), Bean1385Wrapper.class);
