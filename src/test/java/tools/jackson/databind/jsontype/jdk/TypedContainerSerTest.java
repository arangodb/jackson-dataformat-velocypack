	...
	extends DatabindTestUtil
{
    ...
    public void testIssue329() throws Exception
    {
        ...
        String json = VPackUtils.toJson(mapper.writerFor(rootType).writeValueAsBytes(animals.iterator()));
    ...
    public void testIssue508() throws Exception
    {
        ...
        String json = VPackUtils.toJson(mapper.writerFor(typeRef).writeValueAsBytes(l));

        List<?> output = mapper.readValue(VPackUtils.toVPack(json), typeRef);
