...
"{'id':'"+ID1+"','items':[{'id':'"+ID2+"','property':'value'}]}");
        ...
        Data data = m.readValue(VPackUtils.toVPack(json), Data.class);
    ...
    public void testMapKeyRefinement1384() throws Exception
    {
        ...
        ObjectMapper mapper = vpackMapperBuilder()
                ...
                .build();
        TestClass testInstance = mapper.readValue(VPackUtils.toVPack(TEST_INSTANCE_SERIALIZED), TestClass.class);
        ...
        String testInstanceSerialized = VPackUtils.toJson(mapper.writeValueAsBytes(testInstance));
