    ...
    extends DatabindTestUtil
{
    ...
    public void testListWithPolymorphic() throws Exception
    {
        ...
        assertEquals("{\"beans\":[{\"@type\":\"bean\",\"x\":0}]}", VPackUtils.toJson(MAPPER.writeValueAsBytes(beans)));
        // Related to [JACKSON-364]
        ObjectWriter w = MAPPER.writerWithView(Object.class);
        assertEquals("{\"beans\":[{\"@type\":\"bean\",\"x\":0}]}", VPackUtils.toJson(w.writeValueAsBytes(beans)));
    }
    ...
    public void testIntArray() throws Exception
    {
        ...
        assertEquals("{\""+clsName+"\":[1,2,3]}", VPackUtils.toJson(m.writeValueAsBytes(input)));
    }
    ...
    public void testGenericArray() throws Exception
    {
        ...
        ObjectMapper m = vpackMapperBuilder()
                ...
                .build();
        assertEquals(EXP, VPackUtils.toJson(m.writeValueAsBytes(input)));
    }
}
