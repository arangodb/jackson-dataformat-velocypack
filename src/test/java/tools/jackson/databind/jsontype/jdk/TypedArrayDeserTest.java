    ...
    extends DatabindTestUtil
{
    ...
    public void testIntList() throws Exception
    {
        ...
        TypedListAsWrapper<Integer> result = m.readValue(VPackUtils.toVPack(JSON), type);
    ...
    public void testBooleanListAsProp() throws Exception
    {
        ...
        TypedListAsProp<Object> result = m.readValue(VPackUtils.toVPack(JSON), type);
        assertNotNull(result);
    ...
    public void testLongListAsWrapper() throws Exception
    {
        ...
        TypedListAsWrapper<Object> result = m.readValue(VPackUtils.toVPack(JSON), type);
        assertNotNull(result);
        assertEquals(2, result.size());
    ...
    public void testLongArray() throws Exception
    {
        ...
        long[] value = mapper.readValue(VPackUtils.toVPack(JSON), long[].class);
        assertNotNull(value);
