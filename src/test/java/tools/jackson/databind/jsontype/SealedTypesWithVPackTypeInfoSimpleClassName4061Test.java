 ...
 */
public class SealedTypesWithVPackTypeInfoSimpleClassName4061Test extends DatabindTestUtil {
  ...
  public void testMinimalInnerClass() throws Exception {
    String jsonStr =
        a2q("{'@c':'.SealedTypesWithVPackTypeInfoSimpleClassName4061Test$MinimalInnerSub4061A'}");
  ...
  public void testMixedClass() throws Exception {
    ...
    // ser
    assertEquals(jsonStr, VPackUtils.toJson(MAPPER.writeValueAsBytes(new MixedSub4061AForSealedClasses())));
  ...
  public void testMixedMinimalClass() throws Exception {
    ...
    // ser
    assertEquals(jsonStr, VPackUtils.toJson(MAPPER.writeValueAsBytes(new MixedMinimalSub4061AForSealedClasses())));
  ...
  public void testPolymorphicNewObjectCaseInsensitive() throws Exception {
    String jsonStr = "{\"child\": { \"@type\": \"mergechilda\", \"name\": \"I'm child A\" }}";
    ObjectMapper mapper =
        vpackMapperBuilder().enable(MapperFeature.ACCEPT_CASE_INSENSITIVE_VALUES).build();
  ...
  public void testPolymorphicNewObjectUnknownTypeId() throws Exception {
    try {
      MAPPER.readValue(VPackUtils.toVPack("{\"child\": { \"@type\": \"UnknownChildA\", \"name\": \"I'm child A\" }}"),
          Root.class);
...
final class MixedSub4061AForSealedClasses
    extends SealedTypesWithVPackTypeInfoSimpleClassName4061Test.MixedSuper4061 {
}
...
final class MixedMinimalSub4061AForSealedClasses
    extends SealedTypesWithVPackTypeInfoSimpleClassName4061Test.MixedMinimalSuper4061 {
}
...
final class DuplicateSubClassForSealedClasses
    extends SealedTypesWithVPackTypeInfoSimpleClassName4061Test.DuplicateSuperClass {
}
