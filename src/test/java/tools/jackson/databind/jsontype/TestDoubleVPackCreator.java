...
public class TestDoubleVPackCreator extends DatabindTestUtil
{
    static final class UnionExample {
        ...
        @JsonSubTypes(@JsonSubTypes.Type(DoubleWrapper.class))
    ...
    public void testDeserializationTypeFieldLast() throws Exception {
        ...
        UnionExample actual = MAPPER.readValue(VPackUtils.toVPack(a2q("{'double': 2.0,'type':'double'}")),
    ...
    public void testDeserializationTypeFieldFirst() throws Exception {
        UnionExample expected = UnionExample.double_(AliasDouble.of(2.0D));
        UnionExample actual = MAPPER.readValue(VPackUtils.toVPack(a2q("{'type':'double','double': 2.0}")),
                new TypeReference<UnionExample>() {});
        assertEquals(expected, actual);
    }
    ...
    public void testDeserializeFPAsObject() throws Exception
    {
        ...
        Value4138Base value = MAPPER.readValue(VPackUtils.toVPack(JSON), Value4138Base.class);
