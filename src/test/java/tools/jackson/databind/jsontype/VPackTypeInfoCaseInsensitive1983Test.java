...
public class VPackTypeInfoCaseInsensitive1983Test extends DatabindTestUtil
{
    ...
    void readMixedCaseSubclass() throws Exception
    {
        ...
        InvalidTypeIdException e = assertThrows(InvalidTypeIdException.class,
                () -> MAPPER.readValue(VPackUtils.toVPack(serialised), Filter.class));
        ...
        Filter result = mapper.readValue(VPackUtils.toVPack(serialised), Filter.class);
