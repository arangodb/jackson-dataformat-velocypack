...
public class TypeFactoryTest extends DatabindTestUtil
{
    ...
    {
        JavaType t = TF.constructType(Calendar.class);
        String can = t.toCanonical();
        assertEquals("java.util.Calendar", can);
        assertEquals(t, TF.constructFromCanonical(can));

        // Generic maps and collections will default to Object.class if type-erased
        t = TF.constructType(ArrayList.class);
        can = t.toCanonical();
        assertEquals("java.util.ArrayList<java.lang.Object>", can);
        assertEquals(t, TF.constructFromCanonical(can));

        t = TF.constructType(TreeMap.class);
        can = t.toCanonical();
    ...
    public void testSneakyBeanProperties() throws Exception
    {
        ...
        StringLongMapBean bean = mapper.readValue(VPackUtils.toVPack("{\"value\":{\"a\":123}}"), StringLongMapBean.class);
        assertNotNull(bean);
        Map<String,Long> map = bean.value;
        assertEquals(1, map.size());
        assertEquals(Long.valueOf(123), map.get("a"));

        StringListBean bean2 = mapper.readValue(VPackUtils.toVPack("{\"value\":[\"...\"]}"), StringListBean.class);
        assertNotNull(bean2);
    ...
    {
        ObjectMapper mapper = new VPackMapper();
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(new SneakyBean2()));
    ...
    public void testBasePropertiesIncludedWhenSerializingSubWhenSubTypeLoadedAfterBaseType() throws IOException {
        ...
        String serialized = VPackUtils.toJson(mapper.writeValueAsBytes(sub));
    ...
    public void testNestedTypes1604Simple() throws Exception
    {
        ...
        String json = VPackUtils.toJson(mapper.writeValueAsBytes(badOuter));
        assertNotNull(json);
   }
