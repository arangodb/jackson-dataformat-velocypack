...
public class GenericTypeTest extends DatabindTestUtil
{
    ...
    {
        IntBeanWrapper<?> result = MAPPER.readValue(VPackUtils.toVPack("{\"wrapped\":{\"x\":3}}"),
    ...
    public void testBounded() throws Exception
    {
        BoundedWrapper<IntBean> result = MAPPER.readValue
            (VPackUtils.toVPack("{\"values\":[ {\"x\":3} ] } "), new TypeReference<BoundedWrapper<IntBean>>() {});
    ...
    public void testGenericsComplex() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(in));
        DoubleRange out = MAPPER.readValue(VPackUtils.toVPack(json), DoubleRange.class);
        assertNotNull(out);
    ...
    public void testIssue778() throws Exception
    {
        ...
        ResultSetWithDoc<MyDoc> rs = MAPPER.readValue(VPackUtils.toVPack(json), type);
    ...
    public void testCrossReferencingGenericBounds() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(codebook));
        assertNotNull(json);
    }
    ...
    public void testGenericFieldInSubtype677() throws Exception
    {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(s));
    ...
    {
        BaseType.SubType<?> r = MAPPER.readValue(VPackUtils.toVPack("{}"), BaseType.SubType.class);
        assertNotNull(r);
    }
    ...
    public void testLocalPartialType609() throws Exception {
        ...
        EntityContainer output = MAPPER.readValue(VPackUtils.toVPack(json), EntityContainer.class);
    ...
    public void testAliasResolutionIssue743() throws Exception
    {
        ...
        Child743.ChildData d = MAPPER.readValue(VPackUtils.toVPack(s3), Child743.ChildData.class);
    ...
    public void testPolymorphicWithOverride() throws Exception
    {
        ...
        String serialized = VPackUtils.toJson(MAPPER.writeValueAsBytes(list));

        StringyList<String> deserialized = MAPPER.readValue(VPackUtils.toVPack(serialized), type);
