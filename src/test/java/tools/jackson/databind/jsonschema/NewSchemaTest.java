...
public class NewSchemaTest extends DatabindTestUtil
{
    ...
    public void testJsonValueFormatHandling() throws Exception
    {
        ...
        assertEquals(EXP, VPackUtils.toJson(MAPPER.writeValueAsBytes(JsonValueFormat.HOST_NAME)));

        // and second, deserialize ok from that as well
        assertSame(JsonValueFormat.HOST_NAME, MAPPER.readValue(VPackUtils.toVPack(EXP), JsonValueFormat.class));
    }
