...
public class CaseInsensitiveDeserTest extends DatabindTestUtil
{
    ...
    private final ObjectMapper INSENSITIVE_MAPPER = vpackMapperBuilder()
    ...
    public void testCaseInsensitiveDeserialization() throws Exception
    {
        ...
        try {
            mapper.readValue(VPackUtils.toVPack(JSON), Issue476Bean.class);
        ...
        Issue476Bean result = r.readValue(VPackUtils.toVPack(JSON));
...
//        final String json = "{\"errorCode\":2,\"debugMessage\":\"Signature not valid!\"}";
        ...
        BaseResponse response = INSENSITIVE_MAPPER.readValue(VPackUtils.toVPack(json), BaseResponse.class);
    ...
    public void testCaseInsensitiveWithFormat() throws Exception {
        CaseInsensitiveRoleWrapper w = MAPPER.readValue
                (VPackUtils.toVPack(a2q("{'role':{'id':'12','name':'Foo'}}")),
    ...
    public void testCreatorWithInsensitive() throws Exception
    {
        ...
        InsensitiveCreator bean = INSENSITIVE_MAPPER.readValue(VPackUtils.toVPack(json), InsensitiveCreator.class);
    ...
    public void testCaseInsensitiveViaConfigOverride() throws Exception
    {
        ...
        Role role = mapper.readValue
                (VPackUtils.toVPack(a2q("{'id':'12','name':'Foo'}")),
                        Role.class);
        assertNotNull(role);
    ...
    public void testIssue1854() throws Exception
    {
        ...
        Obj1854 result = INSENSITIVE_MAPPER.readValue(VPackUtils.toVPack(DOC), Obj1854.class);
    ...
    public void testCaseInsensitiveViaClassAnnotation() throws Exception
    {
        ...
        CaseInsensitiveRoleContainer cont = MAPPER.readValue(VPackUtils.toVPack(CONTAINED),
        ...
        CaseInsensitiveRole role = MAPPER.readValue
                (VPackUtils.toVPack(a2q("{'id':'12','name':'Billy'}")),
        ...
        try {
            /*CaseSensitiveRoleContainer r =*/ vpackMapperBuilder()
                    .enable(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES).build()
                    .readValue(VPackUtils.toVPack(CONTAINED), CaseSensitiveRoleContainer.class);
