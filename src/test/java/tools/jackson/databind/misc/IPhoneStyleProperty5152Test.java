    ...
    extends DatabindTestUtil
{
    ...
    public void testIPhoneStyleProperty() throws Exception {
        ...
        IPhoneBean result = MAPPER.readValue(VPackUtils.toVPack(json), IPhoneBean.class);
    ...
    public void testRegularPojoProperty() throws Exception {
        ...
        RegularBean result = MAPPER.readValue(VPackUtils.toVPack(json), RegularBean.class);
        assertNotNull(result);
    ...
    public void testDLogHeaderStyleProperty() throws Exception {
        ...
        DLogHeaderBean result = MAPPER.readValue(VPackUtils.toVPack(json), DLogHeaderBean.class);
        assertNotNull(result);
    ...
    public void testKBSBroadCastingStyleProperty() throws Exception {
        ...
        KBSBroadCastingBean result = MAPPER.readValue(VPackUtils.toVPack(json), KBSBroadCastingBean.class);
        assertNotNull(result);
    ...
    public void testPhoneStyleProperty() throws Exception {
        ...
        PhoneBean result = MAPPER.readValue(VPackUtils.toVPack(json), PhoneBean.class);
        assertNotNull(result);
    ...
    public void testOAuthProperty() throws Exception {
        assertEquals(a2q("{'oAuthToken':'123'}"),
                VPackUtils.toJson(MAPPER.writeValueAsBytes(new OAuthTokenBean("123"))));
    }
}
