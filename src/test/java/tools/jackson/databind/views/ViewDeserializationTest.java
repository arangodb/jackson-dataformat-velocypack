...
public class ViewDeserializationTest extends DatabindTestUtil
{
    ...
    public void testSimple() throws Exception
    {
        ...
        Bean bean = mapper
                .readValue(VPackUtils.toVPack("{\"a\":3, \"aa\":\"foo\", \"b\": 9 }"), Bean.class);
        ...
        bean = mapper.readerWithView(ViewAA.class)
                .forType(Bean.class)
                .readValue(VPackUtils.toVPack("{\"a\":3, \"aa\":\"foo\", \"b\": 9 }"));
        ...
        bean = mapper.readerWithView(ViewA.class)
                .forType(Bean.class)
                .readValue(VPackUtils.toVPack("{\"a\":1, \"aa\":\"x\", \"b\": 3 }"));
        ...
        bean = mapper.readerFor(Bean.class)
                ...
                .readValue(VPackUtils.toVPack("{\"a\":-3, \"aa\":\"y\", \"b\": 2 }"));
    ...
    public void testWithoutDefaultInclusion() throws Exception
    {
        ...
        DefaultsBean bean = mapper
                .readValue(VPackUtils.toVPack("{\"a\":3, \"b\": 9 }"), DefaultsBean.class);
        assertEquals(3, bean.a);
        assertEquals(9, bean.b);

        ObjectMapper myMapper = vpackMapperBuilder()
        ...
        bean = myMapper.readerWithView(ViewAA.class)
                ...
                .readValue(VPackUtils.toVPack("{\"a\":1, \"b\": 2 }"));
    ...
    public void testWithCreatorAndViews() throws Exception
    {
        ...
        result = mapper.readerFor(ViewsAndCreatorBean.class)
                ...
                .readValue(VPackUtils.toVPack(a2q("{'a':1,'b':2}")));
        ...
        result = mapper.readerFor(ViewsAndCreatorBean.class)
                .withView(ViewB.class)
                .readValue(VPackUtils.toVPack(a2q("{'a':[ 1, 23, { } ],'b':2}")));
        assertEquals(null, result.a);
        assertEquals(2, result.b);
    }
}
