...
public class ViewsWithCreatorTest extends DatabindTestUtil
{
    ...
    public void testWithJsonCreator() throws Exception
    {
        ...
        // serialize first,
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new ObjWithCreator("a", "b", "c")));
        // then back
        assertEquals("a-b-null", reader.readValue(VPackUtils.toVPack(json)).toString());
    }
    ...
    public void testWithoutJsonCreator() throws Exception
    {
        ...
        // serialize first,
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new ObjWithoutCreator("a", "b", "c")));
        // then back
        assertEquals("a-b-null", reader.readValue(VPackUtils.toVPack(json)).toString());
    }
}
