...
public class ApplyViewSerializationTest extends DatabindTestUtil
{
    ...
    private final ObjectMapper MAPPER_NO_DEFAULT_INCLUSION = vpackMapperBuilder()
    ...
    public void testJsonApplyView() {
        ...
        MAPPER.writerWithView(ViewA.class).writeValue(out, bean2);
        Map<?,?> bean2Map = MAPPER.readValue(out.toByteArray(), Map.class);
    ...
    public void testJsonApplyViewNested() {
        ...
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        MAPPER.writerWithView(ViewAA.class).writeValue(out, bean3);
        Map<?,?> bean3Map = MAPPER.readValue(out.toByteArray(), Map.class);
    ...
    public void testJsonApplyViewOverridesOuter() {
        ...
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        MAPPER.writerWithView(ViewB.class).writeValue(out, bean4);
        Map<?,?> bean4Map = MAPPER.readValue(out.toByteArray(), Map.class);
    ...
    public void testJsonApplyViewWithoutDefaultInclusion() {
        ...
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        MAPPER_NO_DEFAULT_INCLUSION.writerWithView(ViewA.class).writeValue(out, bean2);
        Map<?,?> bean2Map = MAPPER_NO_DEFAULT_INCLUSION.readValue(out.toByteArray(), Map.class);
        assertEquals(2, bean2Map.size());
