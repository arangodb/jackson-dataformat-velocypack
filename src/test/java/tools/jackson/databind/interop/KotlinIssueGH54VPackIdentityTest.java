...
public class KotlinIssueGH54VPackIdentityTest
    extends DatabindTestUtil
{
    ...
    void testDeserWithIdentityInfo() throws Exception {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(entity1));

        Entity1 result = MAPPER.readValue(VPackUtils.toVPack(json), Entity1.class);
