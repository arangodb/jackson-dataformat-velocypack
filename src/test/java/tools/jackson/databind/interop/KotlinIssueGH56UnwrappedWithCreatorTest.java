    ...
    extends DatabindTestUtil
{
    ...
    public void serializes() throws Exception {
        ...
        String result = VPackUtils.toJson(mapper.writeValueAsBytes(widget));
        assertEquals(validJson, result);
    }

    @Test
    public void deserializesSuccessful() throws Exception {
        TestGalleryWidget_BAD obj = mapper.readValue(VPackUtils.toVPack(validJson), TestGalleryWidget_BAD.class);
