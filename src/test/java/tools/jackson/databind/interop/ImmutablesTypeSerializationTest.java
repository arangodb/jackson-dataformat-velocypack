...
public class ImmutablesTypeSerializationTest
{
    ...
    static final class ImmutableKey<T>
        ...
        static <T> ImmutableKey<T> fromJson(Json<T> json) {
            Builder<T> builder = ImmutableKey.<T>builder();
            if (json.id != null) {
                builder.id(json.id);
            }
            return builder.build();
        ...
        public static final class Builder<T> {
            ...
            public final Builder<T> from(Key<T> instance) {
                Objects.requireNonNull(instance, "instance");
                id(instance.getId());
                return this;
            }
    ...
    static final class ImmutableEntry<K, V>
        ...
        static <K, V> ImmutableEntry<K, V> fromJson(Json<K, V> json) {
            Builder<K, V> builder = ImmutableEntry.<K, V>builder();
            if (json.key != null) {
    ...
    public void testImmutablesSimpleDeserialization() throws IOException {
        Account expected = ImmutableAccount.builder()
                ...
                .name("foo")
                .build();
        Account actual = MAPPER.readValue(VPackUtils.toVPack("{\"id\": 1,\"name\":\"foo\"}"), Account.class);
    ...
    public void testImmutablesSimpleRoundTrip() throws IOException {
        ...
        Account deserialized = MAPPER.readValue(VPackUtils.toVPack(json), Account.class);
    ...
    public void testImmutablesSimpleGenericDeserialization() throws IOException {
        Key<Account> expected = ImmutableKey.<Account>builder()
                .id(ImmutableAccount.builder()
                        ...
                        .build())
                .build();
        Key<Account> actual = MAPPER.readValue(VPackUtils.toVPack("{\"id\":{\"id\": 1,\"name\":\"foo\"}}"),
    ...
    public void testImmutablesSimpleGenericRoundTrip() throws IOException {
        Key<Account> original = ImmutableKey.<Account>builder()
                ...
                .build();
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(original));
        Key<Account> deserialized = MAPPER.readValue(VPackUtils.toVPack(json), new TypeReference<Key<Account>>() {});
        assertEquals(original, deserialized);
    }
    ...
    public void testImmutablesMultipleTypeParametersDeserialization() throws IOException {
        Entry<Key<Account>, Account> expected = ImmutableEntry.<Key<Account>, Account>builder()
                ...
                .value(ImmutableAccount.builder()
                        ...
                        .build())
                .build();
        Entry<Key<Account>, Account> actual = MAPPER.readValue(VPackUtils.toVPack("{\"key\":{\"id\":{\"id\": 1,\"name\":\"foo\"}},\"value\":{\"id\":2,\"name\":\"bar\"}}"),
    ...
    public void testImmutablesMultipleTypeParametersRoundTrip() throws IOException {
        Entry<Key<Account>, Account> original = ImmutableEntry.<Key<Account>, Account>builder()
                ...
                .build();
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(original));
        Entry<Key<Account>, Account> deserialized = MAPPER.readValue(VPackUtils.toVPack(json), new TypeReference<Entry<Key<Account>, Account>>() {});
        assertEquals(original, deserialized);
    }
}
