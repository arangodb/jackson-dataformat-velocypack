    ...
    extends DatabindTestUtil
{
    ...
    {
        try (JsonParser p = MAPPER.createParser(VPackUtils.toVPack(a2q("{ 'x' : 9 }")))) {
    ...
    {
        try (JsonParser p = MAPPER.createParser(VPackUtils.toVPack(a2q("{ 'x' : 7 }")))) {
    ...
    {
        try (JsonParser p = MAPPER.createParser(VPackUtils.toVPack(a2q("{ 'x' : 42 }")))) {
