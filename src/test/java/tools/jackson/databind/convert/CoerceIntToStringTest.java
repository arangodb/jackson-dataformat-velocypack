...
public class CoerceIntToStringTest
{
    ...
    {
        assertNull(MAPPER_TO_NULL.readValue(VPackUtils.toVPack("1"), String.class));
        StringWrapper w = MAPPER_TO_NULL.readValue(VPackUtils.toVPack("{\"str\": -5}"), StringWrapper.class);
        assertNull(w.str);
        String[] arr = MAPPER_TO_NULL.readValue(VPackUtils.toVPack("[ 2 ]"), String[].class);
    ...
    {
        assertEquals("", MAPPER_TO_EMPTY.readValue(VPackUtils.toVPack("3"), String.class));
        StringWrapper w = MAPPER_TO_EMPTY.readValue(VPackUtils.toVPack("{\"str\": -5}"), StringWrapper.class);
        assertEquals("", w.str);
        String[] arr = MAPPER_TO_EMPTY.readValue(VPackUtils.toVPack("[ 2 ]"), String[].class);
        assertEquals(1, arr.length);
        assertEquals("", arr[0]);
    }
    ...
    {
        assertEquals("3", objectMapper.readValue(VPackUtils.toVPack("3"), String.class));
        assertEquals("-2", objectMapper.readValue(VPackUtils.toVPack("-2"), String.class));
        {
            StringWrapper w = objectMapper.readValue(VPackUtils.toVPack("{\"str\": -5}"), StringWrapper.class);
            assertEquals("-5", w.str);
            String[] arr = objectMapper.readValue(VPackUtils.toVPack("[ 2 ]"), String[].class);
