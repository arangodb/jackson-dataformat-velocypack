...
public class StringConversionsTest
{
    ...
    public void testLowerCasingSerializer() throws Exception
    {
        assertEquals("{\"value\":\"abc\"}",
                VPackUtils.toJson(MAPPER.writeValueAsBytes(new StringWrapperWithConvert("ABC"))));
    }

    @Test
    public void testLowerCasingDeserializer() throws Exception
    {
        StringWrapperWithConvert value = MAPPER.readValue(VPackUtils.toVPack("{\"value\":\"XyZ\"}"),
