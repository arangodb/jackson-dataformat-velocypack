...
public class BeanConversionsTest
{
    ...
    public void testErrorReporting() throws Exception
    {
        ...
        try {
            MAPPER.readValue(VPackUtils.toVPack("{\"unknownProp\":true}"), BooleanBean.class);
        ...
        // then bad conversion
        try {
            MAPPER.readValue(VPackUtils.toVPack("{\"boolProp\":\"foobar\"}"), BooleanBean.class);
    ...
    {
        ObjectMapper wrappingMapper = vpackMapperBuilder()
        ...
        wrappingMapper = vpackMapperBuilder()
            .enable(DeserializationFeature.UNWRAP_ROOT_VALUE)
    ...
    public void testIssue11() throws Exception
    {
        ...
        assertEquals("{}", VPackUtils.toJson(MAPPER.writer()
                .writeValueAsBytes(plaino)));
