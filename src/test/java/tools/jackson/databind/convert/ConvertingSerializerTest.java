...
public class ConvertingSerializerTest
{
    ...
    {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new ConvertingBean(1, 2)));
    ...
    {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new ConvertingBeanContainer(
    ...
    {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new PointWrapper(3, 4)));
        assertEquals("{\"value\":[3,4]}", json);
    }

    @Test
    public void testPropertyAnnotationForArrays() throws Exception {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new PointListWrapperArray(4, 5)));
        assertEquals("{\"values\":[[4,5],[5,4]]}", json);
    }

    @Test
    public void testPropertyAnnotationForLists() throws Exception {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new PointListWrapperList(7, 8)));
        assertEquals("{\"values\":[[7,8],[8,7]]}", json);
    }

    @Test
    public void testPropertyAnnotationForMaps() throws Exception {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new PointListWrapperMap("a", 1, 2)));
        assertEquals("{\"values\":{\"a\":[1,2]}}", json);
    }

    @Test
    public void testPropertyAnnotationForReferences() throws Exception {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new PointReferenceBean(3, 4)));
        assertEquals("{\"ref\":[3,4]}", json);
    }

    @Test
    public void testPropertyAnnotationForOptionals() throws Exception {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new PointOptionalBean(6, 7)));
    ...
    public void testIssue359() throws Exception {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new Bean359()));
    ...
    {
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new ConvertingBeanWithUntypedConverter(1, 2)));
        // must be  {"a":2,"b":4}
