    ...
    extends DatabindTestUtil
{
    ...
    public void testBeanUpdate() throws Exception
    {
        ...
        Object ob = MAPPER.readerForUpdating(bean).readValue(VPackUtils.toVPack("{ \"b\":\"x\", \"c\":[4,5], \"child\":{ \"a\":\"y\"} }"));
        assertSame(ob, bean);
    ...
    public void testListUpdate() throws Exception
    {
        ...
        Object ob = MAPPER.readerForUpdating(strs).readValue(VPackUtils.toVPack("[ \"b\", \"c\", \"d\" ]"));
        assertSame(strs, ob);
    ...
    public void testMapUpdate() throws Exception
    {
        ...
        Object ob = MAPPER.readerForUpdating(strs).readValue(VPackUtils.toVPack("{ \"c\" : \"c\", \"a\" : \"z\" }"));
        assertSame(strs, ob);
    ...
    public void testUpdatingWithViews() throws Exception
    {
        ...
        Updateable result = MAPPER
                ...
                .readValue(VPackUtils.toVPack("{\"num\": 10, \"str\":\"foobar\"}"));
    ...
    public void testIssue744() throws Exception
    {
        ...
        db.da.i = 11;
        db.k = 13;
        String jsonBString = VPackUtils.toJson(mapper.writeValueAsBytes(db));
        JsonNode jsonBNode = mapper.valueToTree(db);

        // create parent
        DataB dbNewViaString = mapper.readValue(VPackUtils.toVPack(jsonBString), DataB.class);
        ...
        mapper.readerForUpdating(dbUpdViaString).readValue(VPackUtils.toVPack(jsonBString));
    ...
    public void test1831UsingNode() throws Exception {
        String catJson = VPackUtils.toJson(MAPPER.writeValueAsBytes(new Cat()));
        JsonNode jsonNode = MAPPER.readTree(VPackUtils.toVPack(catJson));
    ...
    public void test1831UsingString() throws Exception {
        String catJson = VPackUtils.toJson(MAPPER.writeValueAsBytes(new Cat()));
        AnimalWrapper optionalCat = new AnimalWrapper();
        AnimalWrapper result = MAPPER.readerForUpdating(optionalCat).readValue(VPackUtils.toVPack(catJson));
        assertSame(optionalCat, result);
    }
    ...
    public void testReaderForUpdating3814() throws Exception {
        // Arrange
        JsonNode root = MAPPER.readTree(VPackUtils.toVPack(a2q("{'age': 30 }")));
    ...
    public void testReaderForUpdatingAnonymousClass3229() throws Exception {
        ...
        Object result = MAPPER.readerForUpdating(anonBean).readValue(VPackUtils.toVPack(a2q("{'value':42}")));
    ...
    public void testReaderForUpdatingLocalClass3229() throws Exception {
        ...
        Object result = MAPPER.readerForUpdating(localBean).readValue(VPackUtils.toVPack(a2q("{'x':99,'y':'updated'}")));
    ...
    public void testDeserializeAnonymousClassFails3229() throws Exception {
        ...
        try {
            MAPPER.readValue(VPackUtils.toVPack(a2q("{'value':42}")), anonBean.getClass());
    ...
    public void testDeserializeLocalClassFails3229() throws Exception {
        ...
        try {
            MAPPER.readValue(VPackUtils.toVPack(a2q("{'x':42}")), LocalBean.class);
            fail("Should not pass");
        } catch (DatabindException e) {
            verifyException(e, "Cannot construct instance of");
            verifyException(e, "local/anonymous class");
