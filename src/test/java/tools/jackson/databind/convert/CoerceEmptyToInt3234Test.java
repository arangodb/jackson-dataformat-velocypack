    ...
    extends DatabindTestUtil
{
    ...
    {
        BasicIntWrapper w = READER_INT_BASIC.readValue(VPackUtils.toVPack(a2q("{'value':''}")));
    ...
    {
        BasicLongWrapper w = READER_LONG_BASIC.readValue(VPackUtils.toVPack(a2q("{'value':''}")));
    ...
    {
        BasicDoubleWrapper w = READER_DOUBLE_BASIC.readValue(VPackUtils.toVPack(a2q("{'value':''}")));
