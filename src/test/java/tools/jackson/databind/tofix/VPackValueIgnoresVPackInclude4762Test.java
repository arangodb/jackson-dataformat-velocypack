...
class VPackValueIgnoresVPackInclude4762Test extends DatabindTestUtil
{
    ...
    void jsonValueShouldHonorJsonIncludeOnField() throws Exception {
        ...
        String json = VPackUtils.toJson(MAPPER.writeValueAsBytes(new JsonValueWithInclude(map)));
