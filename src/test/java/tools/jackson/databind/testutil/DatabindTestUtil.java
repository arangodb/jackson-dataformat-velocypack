    ...
    extends JacksonTestUtilBase
{
    ...
    public static VPackMapper newVPackMapper() {
        return vpackMapperBuilder().build();
    }
    public static VPackMapper.Builder vpackMapperBuilder() {
    ...
    {
        String str = VPackUtils.toJson(m.writeValueAsBytes(value));
        return (Map<String,Object>) m.readValue(VPackUtils.toVPack(str), LinkedHashMap.class);
    }

    protected String serializeAsString(ObjectMapper m, Object value)
        throws IOException
    {
        return VPackUtils.toJson(m.writeValueAsBytes(value));
    }
    ...
    {
        return createParserUsingReader(new VPackFactory(), input);
    }

    protected JsonParser createParserUsingReader(VPackFactory f, String input)
        throws JacksonException
    {
        return f.createParser(ObjectReadContext.empty(), VPackUtils.toVPack(input));
    }
}
